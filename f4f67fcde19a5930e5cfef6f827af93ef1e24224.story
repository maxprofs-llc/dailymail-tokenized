...
They used the High-resolution Coronal Imager -LRB- Hi-C -RRB- launched on a rocket last July that obtained roughly five minutes of data before re-entering Earth 's atmosphere .
...
A collage of solar images from NASA 's Solar Dynamics Observatory -LRB- SDO -RRB- shows how Nasa has captured the solar surface in different wavelengths
...
` Here we report observations of magnetic braids in a coronal active region that are reconnecting , relaxing and dissipating sufficient energy to heat the structures to about 4,000,000 C.

` Although our 5-minute observations can not unambiguously identify the field reconnection and subsequent relaxation as the dominant heating mechanism throughout active regions , the energy available from the observed field relaxation in our example is ample for the observed heating . '

The launch of the Hi-C sounding rocket : Researchers used the High-resolution Coronal Imager -LRB- Hi-C -RRB- launched last July that obtained roughly five minutes of data before re-entering Earth 's atmosphere
