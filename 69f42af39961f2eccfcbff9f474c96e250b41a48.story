...
Be My Eyes takes advantage of an iPhone feature called VoiceOver , which lets people who are blind use the device using synthetic speech . To ask for help , a blind person opens the app and requests assistance . This can be anything from knowing the expiry date on the milk -LRB- pictured -RRB- , to navigating new surroundings
...
The volunteer helper gets a notification for help , and a live video connection opens . Using the video , the volunteer can see whatever is in front of the blind person using the phone 's camera . At the end of each session , the app lets both users to rate the call , or report misuse -LRB- sign up screen left and profile right -RRB-

The app -LRB- pictured -RRB- is currently only available for people using an iPhone 4S or above , running iOS 7 . An Android app is in development . Be My Eye 's founder Hans Jørgen Wiberg is visually impaired . He came up with the idea and presented it at a Startup Weekend event in Denmark April 2012
