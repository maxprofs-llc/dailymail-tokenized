...
Dubbed Plotclock , the contraption only displays hours and minutes in 24-hour clock , meaning that the time it takes to write the numbers does n't cause a delay .
...
The Hippocampus clock - named after the part of the brain responsible for spatial navigation and long-term-memory - was unveiled at the M.A.D -LRB- Mechanical Art Devices -RRB- Gallery in Geneva last year .

The contraption only displays hours and minutes in 24-hour clock , meaning that the time it takes to write the time does n't cause a delay

Standing 2.8 m tall , it displays the time via two ` retrograde ' indicators , so named because the hands travel in one direction before snapping back to the start , rather than rotating .

The one to the left shows the minutes ; the one to the right the hours .

More recently , Japanese firm Tokyoflash designed a watch that displays the time in the form of Hermann Rorschach inkblots , whereas the Durr watch , from Oslo-based designers , Theo Tveterås and Lars Vedeler , vibrates at five minute intervals , but does n't show the actual time .
