...
This would allow pilots , ground controllers or security agencies such as the CIA to activate an automatic flight mode that can not be turned off by anyone on board .
...
A spokesman added : ` There are companies working on it , but the technology does n't exist in a practical or useable form yet . '
...
A spokesman said : ` Having at least two pilots on the flight deck has helped make flying an incredibly safe form of public transport . The focus in the wake of this tragic accident is likely to be on ensuring that both pilots always have access to the cockpit and can not be prevented from re-entering .

` With this and any other measures we must act with careful consideration to ensure we do n't create new safety risks or concerns such as those raised by the vulnerability of any form of remote control of a passenger aircraft . '
...
Youngest victim : Seven-month-old Julian Pracz-Bandres , pictured with his mother Marina Bandres -LRB- also right -RRB- , died when the Airbus crashed
...
Patrick Sonderheimer , the pilot of the Germanwings plane , waited to reach cruising altitude at 38,000 ft before stepping out of the cockpit .
...
` Uninterruptible autopilot system ' would allow ground controllers to activate mode that can not be turned off on jet
