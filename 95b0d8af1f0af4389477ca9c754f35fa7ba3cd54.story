...
And what 's more , the app does n't need an internet connection - so you 'll be able to find your car even if it 's lost in an underground car park .
...
The app will also work without a network connection , instead using Bluetooth for car to device connectivity . This means that even if a car is parked underground -LRB- stock image shown -RRB- it could be found
...
Google already has its own version of the service integrated in Google Now , but it 's believed Apple is now planning to roll out its own service for iOS devices -LRB- stock image shown -RRB-
