...
` We do n't know that the woman is the person who stole the camera , but she obviously has had some connection with it in the meantime and I 'd like to speak to her about it . '
...
Device Locator costs $ 2.99 -LRB- # 1.86 -RRB- allows the phone owner to track the location of a misplaced iPhone and take a photo which is then sent to a website where the photo can be viewed . This app also allows the user to trigger an audible alarm on the phone .

GadgetTrak costs $ 3.99 -LRB- # 2.48 -RRB- can generate location reports , send discreet messages to the device and also take a photo of the thief .
