Super Siri ? Students have given Siri a boost by allowing it to take photos , unlock cars and play songs on Spotify -LRB- pictured -RRB-
...
Trickery : The technology is called GoogolPlex and uses a clever linguistic trick , servers and third party apps to enable users to get more from their iPhone by simply talking to it . Here , the technology is used to play a song on a red speaker -LRB- pictured -RRB-
...
on Instagram and control Philips Hue lights using voice commands , -LRB- pictured left and right -RRB-

By creating a server that spoofs the DNS -LRB- domain name system -RRB- of Google.com , the programme is able to send a string of words the user asked Siri to its own server , which in turn allows communication with apps like Instagram and Spotify .
...
It 's getting hot in here : The company said : ` Imagine being able to control your Nest thermostat -LRB- pictured -RRB- and unlock your car through Siri . With GoogolPlex , these are now possible '
