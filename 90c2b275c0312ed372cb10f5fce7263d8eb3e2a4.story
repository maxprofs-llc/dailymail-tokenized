...
It will go on sale by August for as little as $ 5 -LRB- # 3 -RRB- for early adopters , although the price will rise as the programme becomes more sophisticated .
...
Users will be able to choose from avatars such as a Japanese Manga character -LRB- left -RRB- to a horned demon -LRB- right -RRB- as well as create their own to share with friends . The Avatars can carry props to add interest to web chats
...
Realtime tracking collects and analyses data about a person 's facial expressions and head movements to apply the information onto a 3D model or avatar , such as a red panda or horned devil -LRB- pictured -RRB-

The early version of the service can be used in web chats and webcast games and will allow users to change their voice , choose environments and ` dramatic lighting ' as well as create their own props and characters to share with friends . There 's even a karaoke feature -LRB- pictured -RRB-
...
` But this is super-long term . Right now we 're starting with emotions -LSB- and -RSB- expressions on FaceRig , ' they added .

While the current version of the software -LRB- set to be released before August -RRB- tracks head movements and facial expression , a future version could see avatars replicating whole body movements and tracking brainwaves to pick up on the subject 's excitement so the avatar could show accurate pupil dilation or blushing
