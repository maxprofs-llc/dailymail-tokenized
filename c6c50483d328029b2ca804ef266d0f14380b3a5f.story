...
If automatic braking is n't enough for you , then the Cruise RP-1 might be of interest .
...
As it approaches a camera , the Genesis will beep at a distance of 2,600 ft -LRB- 800 metres -RRB- to let the driver know the legal speed , reported Drive .
...
The Genesis car features a number of smart driving features . The Automatic Emergency Braking system uses cameras and radar sensors to detect if a crash is imminent and , if so , can rapidly stop the car . The Heads-Up Display above the dashboard -LRB- pictured -RRB- , meanwhile , displays directional data
