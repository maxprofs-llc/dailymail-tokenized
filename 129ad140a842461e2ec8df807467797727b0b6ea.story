...
Shawna Smith is n't saying whether whether or not Skylor Atilano killed her younger son Terry Smith Jr. , 11 , only that the jailed teen is frightened and she intends to be there for him .
...
` No conclusions ' : Smith would n't say whether or not her son murdered his half-brother
...
var nbcLP ={ -RCB- ; nbcLP.aRandomNumber = Math.floor -LRB- Math.random -LRB- -RRB- * 10000 -RRB- ; nbcLP.currentPageLoc = encodeURIComponent -LRB- window.location.href -RRB- ; nbcLP.currentSiteLoc = encodeURIComponent -LRB- window.location.host -RRB- ; nbcLP.defaultWidth = 634 ; nbcLP.defaultHeight = 357 ; nbcLP.cmsID = `` 216876451 '' ; nbcLP.vidPid = `` AKUj2Hbbrf7X '' ; nbcLP.vidSec = `` news '' ; nbcLP.vidSubSec = `` local '' ; nbcLP.vidFrame = document.getElementById -LRB- `` nbcLP216876451 '' -RRB- ; nbcLP.vidFrame.style.border = `` none '' ; nbcLP.vidFrame.width = nbcLP.defaultWidth ; nbcLP.vidFrame.height = nbcLP.defaultHeight ; nbcLP.vidFrame.scrolling = `` no '' ; nbcLP.vidFrame.src = `` http://www.nbclosangeles.com/templates/nbc_partner_player?cmsID= '' + nbcLP.cmsID + '' & videoID = '' + nbcLP.vidPid + '' & width = '' + nbcLP.defaultWidth + '' & height = '' + nbcLP.defaultHeight + '' & sec = '' + nbcLP.vidSec + '' & subsec = '' + nbcLP.vidSubSec + '' & turl = '' + nbcLP.currentSiteLoc + '' & ourl = '' + nbcLP.currentPageLoc + '' & rand = '' + nbcLP.aRandomNumber ;
...
` Him and -LRB- the half brother -RRB- got into it and it went too far , ' said Smith Sr. .
