...
` For
example , -LSB- Far Out -RSB- might notice that Tuesdays and Thursdays are usually about
...
changes in the course of their lives , so Far Out is n't caught off guard
too often . '
...
Far Out uses ' a nonparametric method that extracts significant and robust patterns in location data , learns their associations with contextual features -LRB- such as day of week -RRB- , and subsequently leverages this information to predict the most likely location at any given time in the future . '
