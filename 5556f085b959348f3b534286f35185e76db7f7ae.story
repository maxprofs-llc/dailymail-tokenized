...
Researchers at Microsoft 's Redmond base in Washington have developed a writing tool for Android smart watches . The Analog Keyboard Project lets users write on the middle of the watch -LRB- shown -RRB- . It can recognise letters , numbers and also some symbols
...
Write lowercase - You can enter lowercase English letters -LRB- print -RRB- , numbers , and basic punctuation symbols . Uppercase letters are not supported .
...
Rare words on the other hand , like names or hashtags , should be written slowly and verified character by character -LRB- auto-correct is suppressed if you pause a little after each character -RRB- .
...
The prototype is compatible both with square Android watches and the circular Moto 360 -LRB- shown -RRB- so far . But while it is available for download now , the team notes that it should be for research purposes only as it is still in a very early stage and may still have a few problems
