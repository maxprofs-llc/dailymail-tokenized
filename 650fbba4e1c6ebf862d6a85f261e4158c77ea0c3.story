...
` The
two USB ports -LSB- allow -RSB- you to free up your UK mains sockets for use with
other appliances . An easy swap and you 're set-up for fast USB
charging . '

If no device is connected , the transformer shuts down and power is not supplied to the USB ports -LRB- pictured -RRB- . Once a device is plugged in this activates the amplifier and power is supplied to the required USB ports
