...
Square Cash , part of San Francisco-based company Square - lets users send up to $ 250 -LRB- # 154 -RRB- a week to any email address , on any email provider without the need to sign up and manage an account each time .
...
Square Cash lets users send up to $ 250 -LRB- # 154 -RRB- a week to any email address . Once a credit or debit card is linked to a email address , a user can send money by typing the recipient name into the ` To ' field , copying in Square Cash , and typing the amount in the Subject line
...
If a user has n't sent or received Square
...
It adds Square Cash conforms with Payment Card Industry Data Security Standards -LRB- PCI-DSS -RRB- .
...
If a payment is sent by mistake it can be cancelled , as long as the payment has n't been redeemed .
