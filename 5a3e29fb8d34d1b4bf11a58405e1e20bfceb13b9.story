...
Published online for all to see : A new web app
called The Beat harvests data from Instagram then links the location
that photos were taken to images from Google Street View

Risque : The app , put together by researchers
from Rutgers University , New Jersey , highlights just how much personal
information we are revealing online , privacy campaigners say
...
Rutgers ' social media information lab put together the website , entitled ` The Beat ' , using data from Instagram 's application programming interface -LRB- API -RRB- .
...
` Stalker 's wet dream ' : The app harvests the
locations from uploaded photos ' GPS metadata , then matches it up with a
street view of the location where the picture was taken
