...
French researchers have demonstrated that a new type of atomic clock is so precise and stable that it could provide a new standard . Under a blue laser light , a cloud of strontium atoms kept in a vacuum fluoresces at a characteristic wavelength -LRB- pictured -RRB- which could be used to redefine the second
...
The atomic clock has been used to define a second in the International System of Units since the 1960s . A cesium frequency standard atomic clock -LRB- pictured -RRB- is accurate to approximately three parts in 10 quadrillion so it loses one second over 100 million years
...
While traditional watch mechanisms -LRB- pictured -RRB- are attractive , stock markets , telecommunications systems and satellite navigation use incredibly accurate atomic clocks
