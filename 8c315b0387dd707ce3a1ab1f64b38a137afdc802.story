...
It 's all about the label : The easiest way to tell these two designs apart is by spotting which one has a label , and which one does n't
...
` But , copying mostly started with the advent of the couture system and designer labels . -LSB- Early and mid 20th century -RSB- couturiers created `` licensed copies '' , which were line-for-line copies with the same materials and technique , except without labels . '
...
` It did n't completely work , ' she said .

` Buyers might buy one garment , but they 'd see the whole collection . Photography and sketches were n't allowed in shows , so they had special copyists and sketchers who would remember . '

But while some people might view fake fashion items as being obviously cheap reproductions , when it came to differentiating between what exhibition pieces were real and which were fake , Ms Elia admitted it was n't always that easy .

` With some of the accessories it 's very difficult to tell whether they 're authentic , ' she explained .

A red sole is a red sole : Often , customers do n't mind whether the product is real or fake , provided it has the same look and feel to it , such as these knock-off Christian Louboutin
...
The exhibition does n't just include exact copies of high-end designs ; there are a number of pieces on display which use particularly distinctive brand logos , such as those used by Louis Vuitton and Gucci , in completely unique designs , for example an original dress created by an independent designer which is then emblazoned with the iconic LV pattern .
...
` Chanel , for one , was into people knocking off her things , ' Ms Elia added . ' I think she understood the fashion system and that there is n't any bad press . '
