...
Way in : Israel believes the rockets would be smuggled into Gaza from Egypt by using the tunnel system connecting the two countries which is currently being rebuilt by Palestinians -LRB- pictured -RRB- , after being destroyed by the Egyptian army following the Arab Spring revolution
