...
Kitestring sends emergency contacts a text message if a user does not reply to a check in message on their phone -LRB- pictured -RRB-
...
The free ` safecall ' service uses text messages so it can be used by people without a smartphone and in areas without an internet connection . To begin using the service , people have to create an account online and add contacts -LRB- pictured -RRB- which will be alerted by text in an emergency

To use the service , people schedule a time and date for when they plan to be out and estimate how long they will be . This can be done online -LRB- pictured -RRB- and via text message
...
A user must reply to the message - or check in on the website - and all is well . If they do n't check in , Kitestring alerts their emergency contacts .
...
does n't hear back from a user within five minutes of checking up on them
with a text message .
...
The service could be sued by backpackers in far flung places , or simply by people walking home in the dark -LRB- illustrated -RRB- , meeting someone for the first time or when travelling through dubious neighborhoods where they feel unsafe . Unlike other services , Kitestring only needs basic mobile reception to send and receive a text
...
Free service does n't rely on an internet connection and can be used by anyone with a mobile phone because there 's no app to download
