...
Do n't install apps from third-party sources other than Apple 's official App Store or the user 's own organization

Do n't click ` Install ' on a pop-up from a third-party web page , no matter what the pop-up says about the app .

When opening an app , if iOS shows an alert with ` Untrusted App Developer ' , as shown in Figure 3 , click on ` Do n't Trust ' and uninstall the app immediately
...
If iOS flashes a warning that says ` Untrusted App Developer , ' users should click on ` Do n't Trust ' and immediately uninstall the app , the bulletin said .
