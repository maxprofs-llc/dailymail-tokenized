...
The site claims the new Xbox will run on custom hardware , including an 8-core , 64-bit CPU running at 1.6 ghz , 800mhz DirectX11 graphics processor units and custom hardware blocks to take help take the pressure off the CPU .

The console is also reportedly capable of delivering stereo 3D content and ships with built-in wifi . Audio output will be via either HDMI or S/PDIF -LRB- optical -RRB- and can support 7.1 channels .
