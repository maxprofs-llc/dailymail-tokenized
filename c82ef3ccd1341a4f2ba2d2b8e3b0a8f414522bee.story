...
The system is now used to control roughly a quarter of the world 's population - 1.75 bn people - in shops around the globe , although Mr Green 's voice is only used in the UK .
...
` If the organisations do n't invest in making the experience as slick as it would be online , they are going to lose business , it 's as simple as that . '

His company is now developing a mobile app for shoppers showing the lengths of queues in shops in a given area .

Terry Green 's is not the only voice we know even if we do n't realise it .
