...
It 's a problem that has perplexed scientists , but now a study claims to have an answer , saying that the heat in star-forming clouds may be hindering stellar formation .
...
` The amount of fuel for star formation outpaces the amount of stars 10 times , so these clusters should be really star-rich , ' said Dr Michael McDonald , a Hubble Fellow in Massachusetts Institute of Technology 's -LRB- MIT -RRB- Kavli Institute for Astrophysics and Space Research .
...
` Some stars will form , but before it gets too out of hand , the black hole will heat everything back up -- it 's like a thermostat for the cluster , ' Dr McDonald said .

` The combination of conduction and precipitation-driven feedback provides a simple , clear picture of how star formation is governed in galaxy clusters . '

Dr McDonald also explained to MailOnline that , if a human were to venture into one of these hot clusters , they ` probably would n't feel hot , because the particles are very low density . '

` So the heat exchange between your body and the hot gas would be very slow , ' he added .

` You 'd likely be killed by the lack of oxygen and extreme low pressure much faster . '

The team collected data from the Chandra X-ray Observatory -LRB- illustration shown -RRB- and the South Pole Telescope - an observatory in Antarctica that searches for far-off massive galaxy clusters .
...
` We 've built a track that clusters follow , ' Dr McDonald said .

` The nice , simple thing about this framework is that you 're stuck in one of two modes , for a very long time , until something very catastrophic bumps you out , like a head-on collision with another cluster . '
