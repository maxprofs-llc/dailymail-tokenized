...
` Injury claims data shows something that crash test results ca n't , and that 's the role that vehicle size plays , ' said Kim Hazelbaker , HLDI senior vice president .

` In most crash tests , the advantage of greater size and weight is masked by using a fixed barrier -LSB- in a test -RSB- . As a result , crash test results are comparable only among similar vehicles . '
