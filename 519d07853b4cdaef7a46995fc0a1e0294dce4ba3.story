...
Researchers were able to send the words ` hola ' and ` ciao ' from a location in India -LRB- left -RRB- to a location in France -LRB- right -RRB- using internet-linked electroencephalogram -LRB- EEG -RRB- and robot-assisted and image-guided transcranial magnetic stimulation -LRB- TMS -RRB- sensors .

In the first-of-its-kind study , an international team of neuroscientists and robotics engineers have demonstrated the viability of direct brain-to-brain communication in humans .

` We wanted to find out if one could communicate directly between two people by reading out the brain activity from one person and injecting brain activity into the second person , and do so across great physical distances by leveraging existing communication pathways , ' said Alvaro Pascual-Leone , of the Beth Israel Deaconess Medical Center -LRB- BIDMC -RRB- and Professor of Neurology at Harvard Medical School .
...
Researchers using internet-linked electroencephalogram -LRB- EEG -RRB- and robot-assisted and image-guided transcranial magnetic stimulation -LRB- TMS -RRB- technologies .

Four healthy participants , aged 28 to 50 , participated in the study .

One of the four subjects was assigned to the brain-computer interface -LRB- BCI -RRB- branch and was the sender of the words ; the other three were assigned to the computer-brain interface -LRB- CBI -RRB- branch of the experiments and received the messages and had to understand them .
...
` By using advanced precision neuro-technologies including wireless EEG and robotized TMS , we were able to directly and noninvasively transmit a thought from one person to another , without them having to speak or write , ' says Pascual-Leone .
...
Previous studies on EEG-based brain-computer interaction -LRB- BCI -RRB- have typically made use of communication between a human brain and computer .
...
The hotspot for brain communications : This image shows the area of the brain the researchers were targeting with to trigger phosphenes , flashes of light that appeared in subjects peripheral vision .
