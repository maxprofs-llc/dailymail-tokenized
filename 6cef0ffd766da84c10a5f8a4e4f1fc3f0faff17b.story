...
This is an illustration of an air waveguide . The filaments leave ` holes ' in the air -LRB- red rods -RRB- that reflect light . Light -LRB- arrows -RRB- passing between these holes stays focused and intense

The air waveguides were made using very short , powerful laser pulses .

A
laser pulse transforms into a narrow beam called a filament , which
happens because the laser light increases the refractive index of the
air in the centre of the beam , as if the pulse is carrying its own lens
with it .
...
Professor
Milchberg has previously shown that the filaments heat up the air as
they pass through , causing it to expand and leave a ` hole ' of
low-density air in their wake .

This
hole has a lower refractive index than the air around it and while the
filament itself lasts for just one trillionth of a second , it takes a
billion times longer for the hole to appear .

The
physicists have previously showed that four filaments were fired in a
square arrangement , produce holes forming the low-density wall needed
for a waveguide .

The
` pipe ' produced by the filaments lasted a few milliseconds , a million
times longer than the laser pulse .

Because
the waveguides are relatively long-lived , he believes a single guide
could be used to send out a laser can collect a signal .
...
The physicists broke down the air with a laser to create a spark and used the air waveguide to conduct light from the spark to a detector a three feet -LRB- 1 metre -RRB- away .
...
Just like a conventional optical fibre -LRB- pictured -RRB- , the wall has a lower refractive index than the core , guiding light along a ` pipe '
...
The next step is for the scientists to show that the waveguides can be used over distances of at least 164ft -LRB- 50 metres -RRB- .
