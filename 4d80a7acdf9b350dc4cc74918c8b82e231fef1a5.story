...
The Dead Men 's Eyes prototype was developed by Dr Stuart Eve from University College London . It uses augmented reality to lay virtual images onto the real world -LRB- virtual huts are shown on the site of a prehistoric settlement on Leskernick Hill , Cornwall -RRB- . The setup uses the camera on an iPad and an augmented reality app

The prototype applications and hardware were developed by Dr Stuart Eve , an honorary research associate at the Institute of Archaeology University College London -LRB- UCL -RRB- and a member of L - P : Archaeology .
...
During the Bronze Age the site on Bodmin Moor was a tin-mining village . When Dr Eve held the camera up to the hill -LRB- left -RRB- a series of huts appeared to make it look like he was exploring the ancient village -LRB- right -RRB- . These reconstructions move and change in real-time as the user moves around the terrain

To make this experience more immersive , the archaeologist also developed the Dead Men 's Nose -LRB- shown being worn by Dr Eve -RRB- . It can emit specific smells and these could include the smell of barbecues wafting through a virtual scene , or the bag could feature smells of woodsmoke and manure
...
The Dead Men 's Nose hardware -LRB- prototype shown -RRB- uses an Arduino microcontroller with standard computer parts and can be used with any scent of the user 's choice . Software-wise , the device connects to a webserver and ` fires off ' smells when connected to the Unity3D technology , for example
...
The name of the prototypes was taken from the Montague Rhodes James ' short story , ` Dead Men 's Eyes -LRB- A View from a Hill -RRB- ' .
