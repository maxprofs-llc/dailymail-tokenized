...
` But it does n't need to change very much to have some effect , ' said planetary scientist Paul Byrne , with the Carnegie Institution 's Department of Terrestrial Magnetism .
...
` We did n't set out to prove the models right , but it turns out this number is exactly what the models have been predicting for 40 years . '
