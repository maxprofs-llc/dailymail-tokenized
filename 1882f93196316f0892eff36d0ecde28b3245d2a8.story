...
And , although Apple 's own range of proprietary headphones still use the traditional 3.5 mm audio jack , Philips has produced a Lightning-compatible pair that can be used with the latest iPhones and iPads called Fidelio M2L .
...
Apple already supports USB audio through its Lightning connector . Although its own range of proprietary headphones still use the traditional 3.5 mm audio jack , Philips has produced a Lightning-compatible pair that can be used with the latest iPhones and iPads called Fidelio M2L -LRB- pictured -RRB-

When using USB audio , the wires carry digital signals all the way to the earbuds , where it is then converted to analog . This prevents the sound quality dropping as it travels through the wire . Removing the audio jack -LRB- pictured right , next to the Lightning connector in the centre -RRB- could also make future devices thinner
...
When using a standard , circular 3.5 mm audio jack the wire with traditional headphones , the wire carries the signal in analog format .
...
When using a standard , circular 3.5 mm audio jack the headphone wire carries the signal in analog format the whole way .
...
However , when the USB port , or Lightning connector , is being used to carry audio it means the same port ca n't be used to charge the device .
