...
` One is fertility , represented by the stones with elongated perforation -LRB- vulva-shape -RRB- and by the very combination of the elongated cell and the circle . '
...
Other findings there include standing stones that reach up to 2.6 feet -LRB- 80 centimeters -RRB- high , stone bowls and stone carvings that have a humanlike shape .

These sites are often clustered together , and in one area the team discovered 44 cult sites in a spot encompassing only 0.8 square kilometers -LRB- less than 200 acres -RRB- .

` Taking in -LSB- to -RSB- consideration the topography , environmental conditions and the small number of known Neolithic habitations in the general southern Negev , the density of cult sites in this region is phenomenal , ' the team , led by wrote in an article published recently in the Journal of the Israel Prehistoric Society .
...
` Since many sites contain several installations -LRB- up to eleven -RRB- and numerous stone objects , support the view that at least some sites were not just temporary .
