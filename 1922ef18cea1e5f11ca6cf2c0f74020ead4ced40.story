...
Dr Chris Scott , of Reading University 's department of meteorology , said : ` Getting a lightning bolt to jump through the air requires a much bigger charge than that in stormclouds . Laboratory tests show that it would require about 150 kilovolts per metre -LRB- kV/m -RRB- to generate lightning , but you would expect to generally see no more than 30 kV/m in a stormcloud .
