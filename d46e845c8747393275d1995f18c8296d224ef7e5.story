...
a -RRB- The eButton contains an -LRB- b -RRB- electronic circuit board and takes automatic photos of food while -LRB- c -RRB- attached to the wearer 's shirt
...
-LRB- a -RRB- original image with user-drawn points -LRB- green -RRB- ; -LRB- b -RRB- dissimilarity map Md ; -LRB- c -RRB- segmentation result
...
Next , a
3D model representing the general shape of the food -LRB- e.g. cylinder or
sphere -RRB- is selected from a pre-constructed shape model library .
...
the 2D food contour -LRB- 3D/2D model-to-image
registration -RRB- .
