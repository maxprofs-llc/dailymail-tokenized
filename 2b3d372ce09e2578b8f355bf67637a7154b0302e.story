...
The flight involved an electroencephalogram -LRB- EEG -RRB- cap and specially-designed software - and it could one day lead to passenger planes being controlled using only brainwaves .

Scroll down for video

Researchers have successfully shown how brainwaves can be used to control and land a drone -LRB- right -RRB- in Portugal . During a public presentation in Lisbon , the team used a high-performance electroencephalogram -LRB- EEG -RRB- cap -LRB- left -RRB- to measure the brain waves of a ` pilot ' . An algorithm converted these signals into commands

The brain-to-computer interface -LRB- BCI -RRB- software was developed as part of the Brainflight project .
...
Brainflight combines aeronautical systems engineering with neuroscience research . The project 's brain-to-computer interface -LRB- BCI -RRB- system has been tested in a four seat , twin engine , propeller driven airplane simulator -LRB- pictured -RRB- and the next step is to use the technology in live flights

The Brainflight work builds on previous brain-computer interface technology and software developed at the University of Minnesota -LRB- pictured -RRB- . Researchers released a video showing students learning to steer a flying robot around a gym , making it turn , rise , dip , and even sail through a ring
...
` The project has successfully demonstrated that the use of the brain computer interface -LRB- BMI -RRB- on a simulator for the Diamond DA42 aircraft , where one pilot controlled the simulator through the Brainflight system , ' said Tekever 's Ricardo Mendes .
