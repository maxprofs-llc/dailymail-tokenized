...
The AntiSec hacking group claims to have over 12 million IDs , known as Unique Device Identifiers , in total - as well as personal information such as user names ,
device names , notification tokens , cell phone numbers and addresses .
...
` During the shell session some files were downloaded from his Desktop folder one of them with the name of '' NCFTA_iOS_devices_intel . csv '' turned to be a list of 12,367,232 Apple iOS devices including Unique Device Identifiers -LRB- UDID -RRB- , user names , name of device , type of device , Apple Push Notification Service tokens , zipcodes , cellphone numbers , addresses , etc. .
...
` However , we have to be grateful they have n't published more personal information and held back data .

` I 'm not sure that there is much harm in the data they have released in
isolation , but questions have to be asked as to why the FBI had this
information in the first place , and what they were planning to do with
it . '
