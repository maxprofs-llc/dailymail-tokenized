...
The instrument includes an extreme sensitivity to infrared -LRB- heat -RRB- radiation from the
...
Once the instrument has finished testing an adaptive optics -LRB- AO -RRB- feed for extremely high-resolution imaging from GeMS -LRB- Gemini Multi-conjugate adaptive optics System -RRB- may be added .
