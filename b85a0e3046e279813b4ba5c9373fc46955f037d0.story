...
Phone intercepts : Leaked documents given to The Intercept by NSA whistleblower Edward Snowden -LRB- pictured -RRB- revealed how the American agency and British-based GCHQ hacked into a Dutch company

With these encryption keys , the intelligence agencies would have the ability to collect both voice and data information - such as text messages - from a large portion of the world 's communications .

The keys are used to decipher the communications between mobile phones and their network providers which would otherwise be received as a ` garbled mess ' .

Stealing them also sidesteps the need to get permission from telecom companies or a warrant for a wire-tap - and it leaves no trace on the wireless provider 's network that communications have been hacked into .
...
It also received slides from GCHQ in which the author boasted : ` Successfully implanted several machines and believe we have their entire network . '

The encrypted connection between a mobile device and its wireless network is what keeps the communications private .

And all mobile communications on a phone depend on the SIM card which guards this encryption key . In some countries , the electronic chips are even used to transfer money safely .

An encryption key known as a ` Ki ' is burned onto them when they are manufactured and a copy of this key is also given to the mobile provider , which is how they recognise a phone on its network .
...
It also wanted to intercept the private communications of employees in Poland which ` could lead to penetration into one or more ' of the factories where the encryption keys were burned onto the SIM cards .

Another GCHQ document from May 2011 indicated it was in the process of ` targeting ' more than a dozen Gemalto facilities across the globe including in Germany , Mexico , Brazil , Canada , China , India , Italy , Russia , Sweden , Spain , Japan and Singapore .
...
It also penetrated ` authentication servers ' which allow it to decrypt data and voice communications between a target 's mobile phone and the connection it makes with its network provider .

An accompanying slide read : ` Very happy with the data so far and working through the vast quantity of product . '
...
As part of the covert operations against Gemalto , spies from GCHQ who were supported by the NSA mined the private communications of unwitting engineers and other company employees in multiple countries .

Gemalto was unaware of the hack and the spying on its employees according to its executive vice president Paul Beverly .

The company which brought in # 1.7 billion in revenue in 2013 - and provides SIM cards for billions of people - is a global leader in digital security , producing banking cards , mobile payment systems , two-factor authentication devices used for online security , hardware tokens used for securing buildings and offices , electronic passports and identification cards .

The Dutch multi-national , whose motto is ` security to be free ' provides chips to Vodafone in Europe , France 's Orange and EE in the UK .

Royal KPN , the largest Dutch wireless network provider , also uses Gemalto technology .

In Asia , Gemalto 's chips are used by China Unicom , Japan 's NTT and Taiwan 's Chungwa Telecom , as well as scores of wireless network providers throughout Africa and the Middle East .
...
` The most important thing for me is to understand exactly how this was done , so we can take every measure to ensure that it does n't happen again , and also to make sure that there 's no impact on the telecom operators that we have served in a very trusted manner for many years .
...
She said : ` We take this publication very seriously and will devote all resources necessary to fully investigate and understand the scope of such highly sophisticated technique to try to obtain SIM card data .
