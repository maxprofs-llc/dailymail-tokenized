...
Wakey wakey ! The Spark Watch -LRB- pictured -RRB- which has yet to be launched , looks like a normal wrist watch but features sensors that can tell if the wearer is awake
...
No more naps : If someone wearing the Spark Watch starts to nod off , the built-in motion detectors will activate a vibrating motor , which will start buzzing . It is designed to keep people alert on long car journeys -LRB- pictured -RRB- when accidents can occur from drivers nodding off , and during boring business meetings
...
` The watch keeps people awake during class , at work , or anything else important . You ca n't always have a cup of coffee , but you can always wear a watch . '

The invention has been launched on Kickstarter , where so far over $ 21,000 -LRB- # 12,000 -RRB- has been raised to put it into production , far exceeding its inventors ' $ 6,000 -LRB- # 3,500 -RRB- goal .

It is available to pre-order for $ 49 -LRB- # 29 plus shipping -RRB- with an estimated shipping date of November .

Eddy Zhong , 17 , from Cambridge , Massachusetts , said : ` Spark is a watch -LRB- pictured -RRB- that keeps you awake by nudging you when you nod off . The watch keeps track of your movement patterns and uses a unique algorithm to detect your conscious state '
...
Spark Watch can be pre-ordered from Kickstarter from $ 49 -LRB- # 29 -RRB-