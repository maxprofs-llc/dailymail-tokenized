...
Ancestry has launched its AncestryDNA service in the UK . It is the latest in home testing kits that unlock the secrets of a person 's genetic ethnicity . It follows a rising trend in home testing kits , but Ancestry 's service sets itself apart from others because results can be cross-checked with family trees -LRB- process pictured -RRB-
...
The test uses microarray-based autosomal DNA testing , which looks at person 's entire genome at more than 700,000 locations via a sample of saliva . Analysis of the DNA data provides a prediction of the locations of ancestors from 26 separate populations -LRB- pictured -RRB-

AncestryDNA can also help people identify relationships with unknown relatives through a list of possible DNA member matches -LRB- example pictured -RRB- . These results can then be combined with Ancestry 's existing database of 15 billion records and 60 million family trees to trace more lineages
...
Other tests include discovering the genetics of a person 's eye colour , and whether a person carries a red-head variant gene -- even if they do n't have red hair .
...
The tests cost # 99 -LRB- $ 99 -RRB- , plus shipping , and results take up to eight weeks to be delivered .

Another service that offers DNA testing is Britain 's DNA .

Another service that offers DNA testing is Britain 's DNA . It offers a range of options , including tests that look at a person 's fatherline , or traces a person 's mitochondrial DNA from their mother . Results show which population a person is closest to , genetically -LRB- pictured -RRB- , for example
