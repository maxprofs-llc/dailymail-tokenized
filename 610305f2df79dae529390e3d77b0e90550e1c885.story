...
` The
dental treatment , filling a large inter-proximal cavity -LSB- a cavity
between two teeth -RSB- with a protective , likely medicine-laden , barrier is a
...
is n't known , as his body was not seen again until 1859 when James
Ferrier , a businessman and politician , brought the mummified body -LRB- the
whereabouts of the coffin is unknown -RRB- to Montreal , where today it lies
...
CT slices showing the wear of the left first -LRB- left -RRB- and second right -LRB- right -RRB- incisors of the mummy
