...
06:14 EST , 18 January 2013

Urgency : David Cameron called off a long awaited speech on Europe
...
MPs are also insisting a referendum pledge must be a ` red line ' in any future coalition negotiation with the Lib Dems , warning it can not simply be ditched if Mr Cameron fails to win an outright majority and seeks a new power-sharing deal with Nick Clegg .

Scroll down for video

Eurosceptics : Liam Fox , left , and Iain Duncan Smith , right , are content with David Cameron 's European stance

Warning : Mr Cameron was to warn that the UK could exit the EU if powers do not ` flow in both directions ' between member states and Brussels
...
` There are always voices saying , `` Do n't ask the difficult questions '' . But it 's essential for Europe -- and for Britain -- that we do because there are three major challenges confronting us today .
...
Under siege : The gas field in Amenas , Algeria where militants held a number of workers including some Britons hostage . The situation has forced Mr Cameron to abandon his speech in the Netherlands
...
Provocative : MEP Graham Watson 's Tweet
...
David Cameron was to warn that Britain could exit the EU
