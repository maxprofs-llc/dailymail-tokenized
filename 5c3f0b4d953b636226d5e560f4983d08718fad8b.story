Google is n't the only firm looking to create phones that can be upgraded , rather than replaced .
...
The Puzzlephone -LRB- pictured -RRB- from Finnish-based Circular Devices lets owners swap parts in and out of the handset either when they break , or when a better version of that particular module is released
...
phones currently on the market , from compacts to phablets .
...
Puzzlephone is similar to the modular phone being built by Google 's Project Ara . Dubbed Spiral 1 , the device -LRB- pictured -RRB- is demonstrated during a video filmed at NK Labs in Boston . Individual modules are shown being added to , and removed , from the handset including the battery , processor , speaker , and a USB port
...
In the video , an engineer is also shown turning on the device -LRB- pictured -RRB- , unlocking it and launching an app . According to the developer kit files released in April , Ara phones will be able run on multiple batteries - when one battery dies , it can be detached and replaced with a full battery module
...
In the Spiral 1 prototype , -LRB- platform concept pictured -RRB- 50 per cent of the phone is taken up by the modules , but Toshiba has made custom chips for Spiral 2 , which the company said will increase the amount of space on the device . Spiral 2 will be demonstrated at a developer 's conference on 14 January

Each phone will have a central ` spine ' and an endoskeleton that individual modules will clip on to . There will be three different sized endos - mini , medium and large -LRB- pictured -RRB-
