...
For example , the Dutchman defeats the Frenchman in both total score and defence score for the 2013/14 season . These scores are produced by an advanced algorithm that evaluates the outcome of every recorded on-ball action , such as passing , tackling , and chances created -LRB- as detailed by Opta -RRB- .
...
Debuchy shaded tackles per game -LRB- 2.45 to 2.20 -RRB- and was a clear winner in interceptions per game -LRB- 2.38 to 1.47 -RRB- but committed more fouls -LRB- 1.41 to 0.83 -RRB- .
