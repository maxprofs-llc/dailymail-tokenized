...
the cancer risk was ` close to zero ' but , under Brussels legislation , the
three-year trial period has elapsed and it has decided not to
` prioritise ' them for permanent use across the continent .

Airport bosses who were waiting for
the green light on the machines now say they have been left with no
...
Manchester airport , which is the last
in Britain to be still using ` naked ' scanners , said it will now have to
spend # 1.1 million to replace them with the new devices .

It will also have to hire dozens of extra security staff to frisk passengers manually .

The airport 's chief operating officer
Andrew Harrison said : ` We 're baffled by this situation because health
experts say they are safe , plus the overwhelming majority of our
passengers and security staff prefer body scanners to frisking .
...
that more than 600 Advanced Imaging Technology units , using X-ray
technology , have been installed at 140 airports across the U.S. .
