...
By using an included app , the user is told how much gel to release each time based on their activity levels , ensuring they do n't get too much or too little .
...
The app tells you just the right amount of deodorant to apply -LRB- shown -RRB- . This is also apparently the first refillable deodorant applicator

The gadget will then determine how much deodorant to apply when the button is pressed , which can be altered with an adjustable slide buttom . It costs # 16 -LRB- $ 26 -RRB- and will be released in May next year .
...
The team expects to start delivering # 16 -LRB- $ 26 -RRB- ClickSticks to backers next May .
...
It claims to be the first refillable deodorant applicator and costs # 16 -LRB- $ 26 -RRB-