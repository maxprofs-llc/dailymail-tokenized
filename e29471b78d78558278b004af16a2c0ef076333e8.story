...
Game on : Mathematicians have found that most players use a strategy for Rock Paper Scissors that appears random , but consists of predictable patterns -LRB- pictured -RRB- that an opponent could exploit to win the game . This diagram explains that people often rotate from rock to paper to scissors when they are on a losing streak
...
In the earliest version , a frog which is represented by the thumb , battles a slug -LRB- little finger -RRB- and a snake -LRB- index finger -RRB- although different animals have been used .
...
A first : Mathematicians identified a feature of game theory called ` conditional response ' and it has never been detected before in Rock-Paper-Scissors -LRB- pictured -RRB- . The pattern could be used by canny players to boost their chances of winning
...
` This game exhibits collective cyclic motions which can not be understood by the Nash Equilibrium concept but are successfully explained by the empirical data-inspired conditional response mechanism , ' he said .
