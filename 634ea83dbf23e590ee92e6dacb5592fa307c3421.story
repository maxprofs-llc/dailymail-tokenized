...
` Following NSC -LSB- National Security Council meeting -RSB- on Tuesday and discussions with the French , we have now decided to deploy Sentinel , a surveillance capability that has proved its worth in Libya and on an ongoing basis for counter-insurgency operations in Afghanistan . '
