...
Intelligence obtained via torture was reportedly used in a ` Jack Bauer real-time operation ' to foil an al-Qaeda plot to bring down two planes and intercept a bomb at East Midlands Airport -LRB- pictured -RRB-
...
A group called Al-Qaeda in the Arabian Peninsula -LRB- AQAP -RRB- later took responsibility for the plot .
...
A source close to the operation said there was ` no way ' that the information which led to the plot being exposed ` was n't procured under duress ' , but that the British officials would have ensured they were not present .

He added : ` Of course we use intelligence from torture . We take it from wherever we can get it , but we are never , ever going to say `` we do n't want that '' . Or ask too many questions about where it has come from . It is the difference between intelligence and evidence . '
...
` If you decide in 2015 that it does n't work at all then that would be to misunderstand the problem . '
