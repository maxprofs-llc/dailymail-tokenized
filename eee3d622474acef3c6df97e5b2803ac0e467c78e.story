...
Emu -LRB- pictured -RRB- is similar to Google Now because it predicts what users want to do next , and offers relevant help , but it goes one step further . The firm claims the Emu app uses artificial intelligence to learn behaviours and fine tune suggestions in real time , using contextual information .
...
` It will no longer be available in the App Store , and existing users wo n't be able to send , receive , or download messages . We know it 's an inconvenience , and we regret that .
...
This is n't Google 's first foray into artificial intelligence .
