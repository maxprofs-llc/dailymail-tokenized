...
` Even if the Lib Dems can not be persuaded to move further , a limit on child-related benefits could be implemented if Labour is really ready to support it . ' Mr Osborne is prepared to consider cutting the overall # 500-a-week cap on benefits ` based on evidence , not politics ' , a source confirmed .
