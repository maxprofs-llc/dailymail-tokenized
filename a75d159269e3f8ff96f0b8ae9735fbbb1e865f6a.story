Albert Einstein writes an equation : His famous Theory of Special Relativity has been shown to be compatible with travel at faster-than-light speeds
...
How is it possible ? This 3D graph shows the relationship between
three different velocities : v , u and U , where v is the velocity of a
second observer measured by a first observer , u is the velocity of a
moving particle measured by the second observer , and U is the relative
velocity of the particle to the first observer

` About this time last year ,
experiments at CERN , the European centre for particle physics in
Switzerland , suggested that perhaps neutrinos could be accelerated just a
very small amount faster than the speed of light .
...
published in 1905 and explains how motion and speed is always relative
to the observer 's frame of reference .

The
theory connects measurements of the same physical incident viewed from
these different points in a way that depends on the relative velocity of
observers .

As well as this ,
relativity introduced the concept of time dilation , which suggests that
the faster you travel , the more time seems to slow .

However ,
special relativity breaks down if two observers relative velocity - the
difference between their respective speeds - approaches the speed of
light .

` Questions
have since been raised over the experimental results but we were
already well on our way to successfully formulating a theory of special
relativity , applicable to relative velocities in excess of the speed of
light .

` Our approach is a
natural and logical extension of the Einstein Theory of Special
Relativity , and produces anticipated formulae without the need for
imaginary numbers or complicated physics . '
...
` Our paper does n't try and explain how this could be achieved , just how equations of motion might operate in such regimes . '
