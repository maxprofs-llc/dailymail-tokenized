From a human ear , to perfectly functioning valves , 3D printers are already being used in medicine , but now scientists in the U.S. are attempting to build a whole human heart using the versatile piece of kit .
...
Learning by heart : Scientists could create a new heart for a patient using a 3D printer and their own cells . The organ could be created in just three to five years time and be transplanted in a human within the next decade . The printing of ` ventricle cyclinders ' is pictured

The ultimate goal is to create a new heart for a patient using their own cells that could be transplanted .
...
A tricky operation : An organ built from a patient 's cells could solve the rejection problem some patients have with donor organs .
If everything goes according to plan , Professor Williams says the heart might be tested in humans in less than a decade . An image of open heart surgery is pictured
...
The 3D printer uses a mixture of a gel and living cells to gradually build the shape of a blood vessel -- and one day a heart . The idea is that eventually , the cells would grow together to form the tissue .
...
Mending hearts : Professor Williams said that the heart -LRB- a model is pictured -RRB- is the easiest organ to print because it is made up of so few cells and only has one major function - to contract or beat
...
Scientists from the Cardiovascular Innovation Institute in Louisville , Kentucky , are able to print parts of hearts including blood vessels
