...
The standard advice for people with nut allergies is to avoid the food all together , but this new method could put nuts back on the menu and mean that allergy sufferers wo n't have to check food labels any more .

Speaking at the 248th National Meeting of the American Chemical Society -LRB- ACS -RRB- in San Francisco , Dr Chris Mattison said : ` Clinical trials to test immunotherapy are underway , but we 're approaching it from an agricultural perspective rather than medical .
...
Proteins in nuts trigger a response in allergy sufferers that range from itching to life-threatening anaphylaxis which requires an EpiPen -LRB- pictured -RRB-

The response is launched by antibodies called immunoglobulin E -LRB- IgE -RRB- , which recognise and latch onto the proteins .
...
While past research in this area has used harsh chemicals , Dr Mattison sought to achieve results using compounds that are generally regarded as safe -LRB- Gras -RRB- .
...
Using compounds that are generally regarded as safe -LRB- Gras -RRB- , the researchers found that the Gras compound sodium sulphite can disrupt the structure of some cashew allergens .
