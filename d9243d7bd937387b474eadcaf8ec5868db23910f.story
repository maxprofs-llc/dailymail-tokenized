...
A nurse listened for fetal heartbeats but did n't hear any so the ER doctor John Pelner decided against a Cesarean section . Eventually all three were pronounced dead .
...
They are arguing that a fetus is not a person and ` unborn persons ' can not be the subject of a wrongful death case because they do not have the same rights as those born alive .

One of the defense attorneys , Jason Langley , argued in documents filed with the Colorado Supreme Court that the judge ` should not overturn the long-standing rule in Colorado that the term `` person , '' as is used in the Wrongful Death Act , encompasses only individuals born alive . Colorado state courts define `` person '' under the Act to include only those born alive . Therefore Plaintiffs can not maintain wrongful death claims based on two unborn fetuses . '
