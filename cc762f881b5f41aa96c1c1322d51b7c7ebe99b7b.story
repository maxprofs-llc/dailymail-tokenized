...
The Lights themselves can only be seen between September and March each year . They are notoriously unpredictable and can not be forecast in advance .
...
` Photography for me is when my soul tries to reach something so beautiful that you ca n't describe it with words , but can you capture it , and then share it .
...
` Of course no camera is supposed to work for four , five or six hours at temperatures like -50 C and below , so I have to invent some tricks .
