...
Exploration : Using an Orion space capsule , pictured , a crew of about four astronauts would nuzzle up next to the rock in 2021 for spacewalking exploration
...
Projected to cost $ 2.65 billion in
total and last ten years , the project has found favor with the Obama administration , which has already announced a goal of sending
astronauts to a near-Earth asteroid by 2025 .

Researchers from CalTech 's Keck Institute for Space Studies -LRB- KISS -RRB- detailed the plan in a paper published last spring .
...
Institute for Space Studies -LRB- KISS -RRB- detailed the plan in a paper
published last spring , but Nasa is now reportedly seeking funding to
execute it

It adds : ` Placing an NEA -LSB- Near Earth
Asteroid -RSB- in lunar orbit would provide a new capability for human
...
The report outlines an entirely robotic mission to locate and capture a Near Earth Asteroid -LRB- NEA -RRB- , with a diameter of about seven meters and a mass of around 500,000 kg .
...
Once there , the spacecraft would deploy a massive inflatable bag to envelop the asteroid - maneuvering to stabilize against any tumble or rotation - then ` multiple `` draw strings '' would cinch-close the opening of the bag and also cinch-tight against the bulk material , ' the report says .
...
Ion thrusters use beams of ions
-LRB- electrically charged atoms or molecules -RRB- to create thrust in accordance
with momentum conservation .

They create very small levels of
thrust compared to conventional chemical rockets but achieve very high
specific impulse , or propellant mass efficiencies , by accelerating their
exhausts to very high speed .

However , ion thrusters carry a
fundamental price : the power imparted to the exhaust increases with the
square of its velocity while the thrust increases only linearly .

Normal chemical rockets , on the
other hand , can provide very high thrust but are limited in total
impulse by the small amount of energy that can be stored chemically in
the propellants .

Due to their relatively high power
needs and the requirement of an environment void of other ionized
particles ion thrust propulsion is currently only practical in space .
...
Would help NASA develop the capability to nudge away a dangerous asteroid if one headed to Earth
