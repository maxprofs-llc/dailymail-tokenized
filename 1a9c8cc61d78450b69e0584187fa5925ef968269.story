...
Information Centre -LRB- HSCIC -RRB- .

The Summary Hospital-level Mortality Indicator -LRB- SHMI -RRB- compares the number of patients who die following hospitalisation at a trust with the number who would be expected to die .
...
While the majority of trusts -LRB- 115 -RRB- fell into the ` as expected ' category , 16 trusts had lower than expected mortality rates in the same time frame .
...
` This data alone can not be used to judge the quality of care . However , the CQC examines mortality data and a range of other information to target their inspections and to ensure trusts take appropriate action where there are problems .
...
Tariq Mahmood , medical director at Tameside Hospital NHS Foundation Trust , said that another mortality indicator - the Hospital Standardised Mortality Ratio -LRB- HSMR -RRB- - showed that the trust had a `` normal '' death rate .
...
Death rates at Essex County Hospital -LRB- pictured -RRB- and Colchester General Hospital have been higher than expected since 2010 , although numbers have been dropping year-on-year
