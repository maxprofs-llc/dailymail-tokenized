...
` Any diet which restricts calories will normally result in weight loss , and this is yet another diet based on fasting for short periods , resulting in a reduced energy -LRB- calories -RRB- intake over a period of time .
...
` Overall , this is another `` diet '' designed to catch the attention of the public , written in a way that suggest a scientific basis which does n't truly exist and basically boiling down to a short fast plus a -LRB- hopefully healthy -RRB- weight loss diet based on reducing calorie intake . '
