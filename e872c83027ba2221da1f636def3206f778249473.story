...
The smallest are starters , which extend up to a altitude of 12 to 19 miles -LRB- 20 to 30km -RRB- .

Next are jets , which extend 25 to 31 miles -LRB- 40 to 50km -RRB- , and the last are gigantic jets , which reach 44 to 56 miles -LRB- 70 to 90km -RRB- .
...
Upwards lightning is very rare - estimates suggest less than one per cent of lightning travels in an ` upwards ' direction - and it is typically classified into three groups , based on peak altitude . The smallest are starters , which extend up to a maximum altitude of 12 to 19 miles -LRB- 20 to 30km -RRB- .

Next are jets , which extend 25 to 31 miles -LRB- 40 to 50km -RRB- , and the last are gigantic jets , which reach 44 to 56 miles -LRB- 70 to 90km -RRB- .

Lightning is caused by a build up of electrostatic charges . As they develop , air acts as an insulator between the positive and negative charges in the cloud , and between the cloud and the ground . If this build up reaches a certain level , the insulating capacity of the air breaks . The negative charge ` leaps ' from the cloud either onto another another cloud - known as sheet lightning - or to the ground -LRB- pictured -RRB-

When a so-called ` streamer ' of negative charges leaps from the bottom of the cloud , it is attracted to the ground , which in turn emits a streamer of positive charges from the ground up . In particular , the negative ` stepped leaders ' fork downwards looking for the best conductive path to Earth , with the least resistance . This is why these stepped leaders typically travel straight down from the cloud -LRB- pictured -RRB-

However , the upward movement of the lightning in Mr Murray 's image does n't appear to extend as high as other forms of upward lightning , and storm chaser Dan Robinson suggests an alternative .
...
Upward lightning is typically classified into three groups . Starters extend up to an altitude of 19 miles -LRB- 30km -RRB- , jets extend to 31 miles -LRB- 50km -RRB- , and the gigantic jets reach up to 56 miles -LRB- 90km -RRB- . The upward movement in Mr Murray 's image does n't appear to extend this high , however , and storm chaser Dan Robinson said if part of a bolt is coming straight at you , it will appear to loop back on itself even when it 's not
