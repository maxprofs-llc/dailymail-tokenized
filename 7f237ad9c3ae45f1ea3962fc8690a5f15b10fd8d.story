...
This will allow data transmission speeds of up to 575 megabytes -LRB- MB -RRB- per second -- enough to transfer a 1GB movie between devices in less than three seconds .

Scroll down for video

Samsung has developed a 60 GHz WiFi technology that it claims can send data five times faster than other electronics devices . This will allow data transmission speeds of up to 575 megabytes -LRB- MB -RRB- per second -- enough to transfer a 1GB movie between devices in less than three seconds
...
` Unlike the existing 2.4 GHz and 5 GHz Wi-Fi technologies , Samsung 's 802.11 ad standard 60 GHz Wi-Fi technology maintains maximum speed by eliminating co-channel interference , regardless of the number of devices using the same network , ' according to Samsung 's announcement .
...
It also announced a 15.6 trillion won -LRB- $ 14.5 billion or # 9 billion -RRB- investment to build a plant in South Korea that would produce semiconductor chips .
