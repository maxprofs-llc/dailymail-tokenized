...
There is n't a search function , but users can navigate by zooming in and out of the map , and dragging the view around the screen using the mouse .
...
Google Naps does n't have a search function , but users can navigate by zooming in and out of the map , and dragging the view around the screen using the mouse . Naps have been plotted across the world , and even in the Atlantic Ocean , but the majority are based in the developer 's home region of The Netherlands , pictured
...
It was set up as a joke , and the developers have written an open letter to Google 's founders Sergey Brin and Larry Page that reads : ` Hello , please do n't be mad this is just a joke , a parody .

` We do n't mean to damage your brand or anything , we just want to bring a smile on the faces of Google fans .
...
` So please do n't take this to court , we only have a few hundred Euros in the bank . And we also do n't want to go to jail because we 're too busy with other things at the moment .

` But whenever you are in the Netherlands you can have a nap on our couch if you want . We can also make coffee and bake eggs if you like that -LRB- for a small price -RRB- . '
