...
ThreatExchange -LRB- pictured -RRB- builds on Facebook 's existing ThreatData tools currently used to discover and tackle scams and cybercrime . Partners will use it to share clues about malware and phishing scams . Early participants include Bitly , Dropbox , Pinterest , Tumblr , Twitter , and Yahoo
...
Facebook said threats like malware and phishing -LRB- example of a tagging scam is pictured -RRB- typically go after multiple targets , and a successful attack at one place makes it easier to take over systems elsewhere . ` We share in each other 's fate . When one company gets stronger , so do the rest of us ' explained the site
