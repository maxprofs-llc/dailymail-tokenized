...
Internet search engine Google , for example , has been told by the European Union to make changes to its new privacy policy , which pools data collected on individual users across its services including YouTube , gmail and social network Google + , and from which users can not opt out .
...
Schrems said the case could cost the group around 100,000 euros -LRB- $ 130,000 -RRB- , which it hoped to raise via crowd-funding - money provided by a collection of individuals - on the Internet .
...
Lawyers for
the plaintiffs were n't immediately available for comment Monday evening .
