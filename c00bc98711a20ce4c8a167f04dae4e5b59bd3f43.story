...
Mimicking nature : Robots like Jules -LRB- above -RRB- are covered in a synthetic skin to give a life-like appearance and can respond to humans with facial expressions much like our own

Blending in : Like Jules -LRB- left -RRB- , Eve -LRB- right -RRB- is given a life-like face and hair to make them as authentic as possible
...
Ingenious : Nao , a programmable humanoid robot built by French company Aldebaran Robotics -LRB- left -RRB- , and BERT2 -LRB- right -RRB- , which could eventually carry out surgical operations while being controlled anywhere in the world

Going swimmingly : The Robotic Fish -LRB- above -RRB- can operate autonomously and is designed to monitor water pollution and detect leaks from ships in harbour
...
Life-savers : Robots like Shrewbot -LRB- above -RRB- have sensitive ` whiskers ' which could be used to search pitch-black caves for rescue missions
...
I wan na be like you : A humanoid robot , featured with simple sensors and servomotors
...
Defeat the World Chess Champion -LRB- achieved -RRB-

Beat the world champions at TV general knowledge quiz show Jeopardy -LRB- achieved -RRB-
