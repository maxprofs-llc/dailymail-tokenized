...
The announcement came in new long-awaited draft guidelines released by the Centers for Disease Control and Prevention -LRB- CDC -RRB- .
...
Professor Jeremy Turk , Consultant Child & Adolescent Psychiatrist at Southwark Child & Adolescent Mental Health Neurodevelopmental Service , said : ` The findings of this research , while interesting , need to be considered carefully - one can not draw very strong conclusions from the data .
...
` The study is purely based on register data and takes a registered autism diagnosis at face value , without considering cultural or social factors affecting the likelihood of an -LRB- early -RRB- autism diagnosis .
...
` Even in a high income country like Denmark not all children with autism are detected and given a suitable autism diagnosis at an early age -LRB- the age under study in this paper -RRB- .
...
` In other words : the detection rate of autism -LRB- rather than the risk of autism per se -RRB- may be higher in boys seeing a medical professional for circumcision .
...
Applied statistician Professor Kevin McConway , from the Open University , said : ` This study raises an interesting question , but one that can not be fully answered with these data . '
