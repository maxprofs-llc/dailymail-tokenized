...
However , all exploring must be done in daylight hours with all Pikmin returning to their ` Onion ' -LRB- their home -RRB- , before dark lest the wild beasts catch them . Yet as each day passes more food is consumed by the characters so constant exploration to find food is key during daylight hours .

Pikmin are controlled using the Wii U gamepad , which is where one of problems lies . It simply is n't ideal controlling a crosshair with the Wii U gamepad to whistle commands , throw Pikmin and navigate obstacles . The cursor movement just does n't quite lend itself to the game .

Charming : despite some control issues , there 's plenty here to sink your teeth into

Use a standard Wiimote though and the game plays perfectly , yet as you ca n't do this for off-TV play it 's an exercise in futility .
