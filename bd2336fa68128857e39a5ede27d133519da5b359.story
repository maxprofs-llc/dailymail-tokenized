...
The website claims the spray destroys the DNA and RNA which does n't allow the pathogen to reproduce or replicate . This also significantly reduces the risk of cross contamination .
...
` Suffice to say I do n't doubt that the product would work , but needless to say that the take-home message is that any disinfectant shown to work against envelope viruses will be effective .

` Ebolavirus is n't particularly hardy out in the environment - in fact sunlight is likely to rapidly kill it . '

The chemical can be used in both cleaning products and disinfectants to stop Ebola -LRB- pictured -RRB- and is already being used by Heathrow Airport , the company says
...
Claims the product destroys the DNA and RNA which does n't allow the pathogen to reproduce or replicate . Also reduces cross contamination risk
