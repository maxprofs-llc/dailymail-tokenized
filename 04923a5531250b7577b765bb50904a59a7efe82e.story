...
Obama campaigned on the issue of net neutrality . He said in a statement Monday that the FCC 's new rules should explicitly ban any paid
prioritization deals .

` Simply put : No service should be stuck in a ` slow lane '
because it does not pay a fee , ' Obama said . ` That kind of gatekeeping would
undermine the level playing field essential to the Internet 's
growth . '

' I believe the FCC should create a new set of rules
...
He also said the FCC should apply its new rules equally to
mobile and wired ISPs .
...
In taking a position in favor of net neutrality , Obama is siding with liberal activist groups that want the FCC to put ISPs in a new category so that they can be
...
' `` Net neutrality '' has been built into the fabric of the Internet since its creation -- but it is also a principle that we can not take for granted . We can not allow Internet service providers -LRB- ISPs -RRB- to restrict the best access or to pick winners and losers in the online marketplace for services and ideas . That is why today , I am asking the Federal Communications Commission -LRB- FCC -RRB- to answer the call of almost 4 million public comments , and implement the strongest possible rules to protect net neutrality .
...
Cruz : ` The Internet should not operate at the speed of government . '
