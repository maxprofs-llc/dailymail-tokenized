...
Nanorobots -LRB- pictured -RRB- which are made from a DNA ` cage ' and hold a payload of drugs , could be used to treat a person who is seriously ill with leukaemia . The lead researcher behind the innovation hopes that the patient could be cured within a month , based upon successful tests in animals
...
Speaking in December , he said : ` Judging from what we saw -LSB- in tests -RSB- , within a month that person is going to recover .
...
The double helixes stay closed until specific molecules or proteins on the surface of cancer cells act like a ` key ' to open the ` barrel ' so the payload can be deployed . This diagram shows the nanorobot being ` unlocked ' so the drugs -LRB- shown in purple -RRB- are released
...
The team has tested its technique in animals as well as cell cultures and said the ` nanorobot attacked these -LSB- targets -RSB- with almost zero collateral damage . '
...
In the future , Dr Bachelet said people could be injected with nanorobots at an annual doctor 's check-up -LRB- illustrated with a stock image -RRB- . The nanorobots would screen ` every cell ' in the body for cancerous or abnormal cells and destroy them before they spread
