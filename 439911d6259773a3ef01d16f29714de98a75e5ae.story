...
By arranging certain materials ,
including copper and fibreglass but also gold , in a particular shape and
pattern , the properties of those materials can combine to become an
almost ` super ' material .

Duke University 's David Smith
explained : ` Imagine a fabric woven of thread . In this fabric , light is
only allowed to flow over the threads .

` If you punch a hole in the fabric
with a pin , light will go around the hole and resume its original course
of travel , since light can only travel over the thread . `

He continued that because light waves can only travel in this way , the hole is practically ` invisible ' .

Metamaterial arrays work in the same
way to control how waves move around the structure , making it possible
to capture and harvest them , and their energy .
