...
` When we first started using mobiles 25 years or so ago , it was a luxury . But today , the idea that you ca n't use a mobile to have a conversation wherever you are in the UK is not part of the modern world .
...
` In the UK , at a national level , we do n't have roaming . So a French person coming to Wales gets a better signal that someone does as a local . It is such a big problem that something needs to be done . '
...
` Obviously , they have to go through the planning process , but we are talking about hundreds of masts and we want to get moving quickly . Unless we get the hardware up , we wo n't see any improvement .

` The second issue is partial not-spots , where one provider might provide a signal , but others do n't . You might be able to make a call if you 're on O2 but someone on EE ca n't .
...
` It 's a software change , not a hardware change . Obviously the mobile phone companies already implement a system of roaming for international customers . The concept is n't new . '
...
` From a commercial point of view , this would n't be the first choice of the operators , but Ofcom is telling me that it can be made to work , ' he added .
