...
` The report implied that because Weapon 2 landed in a free-fall , without the parachute operating , the timer did not initiate the bomb 's high voltage battery -LRB- ` trajectory arming ' -RRB- , a step in the arming sequence , ' wrote Bill Burr of the National Security Archives .
...
Despite blasting Dr Lapp 's report for lacking ` objectivity and accuracy , ' a Sandia national laboratories engineer -LRB- according to the Guardian -RRB- agreed with the main point .
