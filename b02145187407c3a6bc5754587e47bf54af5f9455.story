...
According to research from The Global Language Monitor -LRB- GLM -RRB- , the most commonly used word across the whole of the web in 2013 was 404 , which refers to an online technical error code .
...
It can appear when a story is taken down , for example , or if a page ca n't load . This was often used in conjunction with second-place word ` fail ' .
...
Pope Francis , pictured left , was the most commonly used name across the web in the past year . The Duchess of Cambridge Kate Middleton , pictured right , was the highest scoring British person to make the names list
...
News about the National Security Agency -LRB- NSA -RRB- accessing people 's personal records and intelligence , leaked by former NSA contractor and CIA employee Edward Snowden meant that ` NSA ' and ` Ed Snowden ' made the top five names list .
