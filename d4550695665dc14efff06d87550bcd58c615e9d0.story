...
The identities of the websites that were broken into have n't been revealed yet .

Concerns : Besides filching 1.2 billion online passwords , the hackers also have amassed 500 million email addresses that could help them engineer other crimes
...
Candid Wueest , Principal Threat Researcher from Symantec Security Response , said that despite the huge volume of data stolen by the Russians , there 's no cause for panic .

He told MailOnline : ` There 's no need to run around and panic . It 's not the first or last data breach - just a very large one . Plus , there 's still speculation about just how old this data is . '

Mr Wueest explained that using robust passwords is the key to keeping personal details safe from intruders .

He said : ` Use strong passwords , it 's a no brainer . We 've been teaching that for 10 to 20 years - and some people still use ' 12345 ' as a password . Having said that , it does n't have to be really cryptic . For example , you could go for ` ireadthedailymailonceaday ' . And make sure you use different passwords for every service , so that losing one password does n't compromise too many accounts . It 's fine to use the same one if it 's not linked to something sensitive .

` If you ca n't remember your passwords , use an app like ` password manager ' . This means you just need to remember one master password that unlocks all of them . '

Gary Newe , Senior Systems Engineering Manager for F5 Networks , said : ` It is worth noting that these hackers , unless they are specifically interested in a specific company for espionage , will move onto a new target if their chosen one is too difficult to compromise . So in terms of protecting yourself , you only have to make your apps more difficult to compromise than your neighbours and you will be in a better position than you are today . '

He added : ` As we have seen in the news , especially with the European Central Bank Hacking , these types of attacks and the market for this information is growing and is almost becoming legitimised in some circles . '

The news follows claims by a Berlin-based hacker that he 's found a way to infiltrate communication systems on planes through Wi-Fi and inflight entertainment systems .
...
Details are still sketchy about how the plane hack was done .
