...
` The design begins with a 3D Computer-Aided Design -LRB- CAD -RRB- model using SolidWorks software . Then comes extensive design reviews . Finally , the whole project ends with the complete manufacturing of the vehicles done entirely on the Cal Poly campus by students . '
