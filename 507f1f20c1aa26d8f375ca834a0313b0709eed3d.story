...
Researchers from Georgia Institute of Technology have developed an app that tricks Apple into accepting it on the App Store , pictured , by convincing reviewers its safe . Once the app has been accepted , the designers can tweak its code to make it malicious and carry out attacks to steal people 's data , for example

The findings were published in the paper , Jekyll on iOS : When Benign Apps Become Evil .

Researchers Tielei Wang , Kangjie Lu , Long Lu , Simon Chung , and Wenke Lee said : ` The key idea is to make the apps remotely exploitable and subsequently introduce malicious control ﬂows byrearranging signed code .
...
The app was dubbed Jekyll after the character in Robert Louis Stevenson 's famous book from 1886 . In the book Dr Jekyll has an evil alter ego called Mr Hyde
...
Apple spokesman Tom Neumayr told MIT Review that
developers have made changes to the iOS in response to the Institute 's
research although it 's not known if the flaw has been completely fixed .

Apple has a strict policy on which apps are accepted onto its App Store .

It does n't allow malicious or dangerous apps or apps that contain adult content , but it will also reject apps that do n't appear to have a set use or function .
...
This is supposed to mean that if one app becomes infected , it ca n't hijack the others , yet the Georgia Institute of Technology 's research even managed to bypass this feature .

@highlight

When the app is submitted for review to Apple it appears to be safe
