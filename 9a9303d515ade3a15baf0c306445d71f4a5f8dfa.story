...
The Membrane Optical Imager for Real-Time Exploitation -LRB- MOIRE -RRB- will be capable of capturing 40percent of the surface of the Earth at once . It will be able to beam back real-time high-resolution video and images from anywhere in the world at any time .
...
This is an artist 's rending of the Membrane Optical Imager for Real-Time Exploitation -LRB- MOIRE -RRB- satellite that the Pentagon hopes to launch to spy on the earth
...
Massive : This drawing shows how much bigger MOIRE is designed to be -LRB- 68 feet -RRB- compared to the Hubble Space Telescope , the W.M. Keck Observatory telescope - which is one of the largest ground-based instruments in the world - and the James Webb Space Telescope , a device planned for launch in 2018
...
The MOIRE satellite will be both cheaper to produce and cheaper to deploy , if the design works out because it does n't require the high-quality glass .
...
Membrane Optical Imager for Real-Time Exploitation -LRB- MOIRE -RRB- uses a massive web of thin membranes instead of heavy lenses
