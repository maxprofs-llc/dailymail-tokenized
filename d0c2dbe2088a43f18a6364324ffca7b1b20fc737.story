...
` We do n't feel we have a whole lot of other choices because we 're certainly not getting any answers without -LRB- legal action -RRB- , ' Sarah Bajc told CNN .
...
` If we do n't have the `` black box '' with all the critical information on it , or we do n't have any part of the wreckage , it would be very hard to maintain a claim against Boeing in any court in the United States , ' Daniel Rose , an aviation attorney from Kreindler & Kreindler , told CNN .
...
` We ca n't focus on one place too long as the ocean is very big , although the search team has been following the leads received and analysed .

` It is by luck if we find the wreckage using the Bluefin-21 -LRB- the US-owned underwater search vehicle -RRB- .
...
` The data involved would be official information , so the -LRB- foreign -RRB- country can not simply give it to us on paper or in soft copy - they will select only the ones that can be revealed . '
...
` We ca n't be forcing them to show us the data , as they had already said there was nothing , ' one source said .
