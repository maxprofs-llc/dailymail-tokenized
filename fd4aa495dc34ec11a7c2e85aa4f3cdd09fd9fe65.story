...
Nearly 2,000 people have already signed a petition calling for planners to reject the scheme to save the endangered species - specimens of which measure just 2.5 mm in length . The nocturnal spider was first recorded in in 1989 and then again in 1995 , and has not been seen since .
...
` It can happen either because the species ca n't reach other locations or because the conditions are favourable where they live , ' she said . ` This means that over time species can become localised , such as with the Horrid Ground Weaver , and because it has lived and adapted there , it now does n't exist anywhere else .

` It 's very unique , and we need to look after it and make sure we do n't drive the species to extinction when we really do n't need to . It might have lived in other locations , in other quarries for example , which have been built on , but it has never been recorded anywhere other than Plymouth .

` We believe that it is probably just clinging on at the last few sites .

` It must just like the weather on the south coast . We think it lives underground , or in cracks in stones , but in truth we do n't know much about them because they are so rare . '
