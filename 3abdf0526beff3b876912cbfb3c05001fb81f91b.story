...
Scientists estimate that a holographic monitor using the technology could be built for less than # 320 -LRB- $ 500USD -RRB- , excluding light sources .
...
` It is now possible ... to make holographic video monitors with full-colour , standard video resolution and a 30Hz -LRB- hertz -RRB- refresh rate . '
