...
A thin gold antenna is sandwiched between two layers of plastic , one with protective rubber cushioning -LRB- pictured -RRB- . The metal shows through the outer plastic layer to make a pattern . The combined antenna system creates superior signal reception , which enables the device to work more efficiently , the company claims
...
The case costs $ 60 -LRB- # 40 -RRB- for an iPhone 6 and $ 70 -LRB- # 46 -RRB- for an iPhone 6 Plus . More colours and cases for other models are planned to launch
...
It also claims that because the smartphone does n't have to work as hard to maintain signal , its battery will last longer .

The case , which weighs 1.27 ounces -LRB- 36g -RRB- is made from thin plastic with a rubbery cushion around its edges and claims to offer protection against drops up to 6.6 ft -LRB- two metres -RRB- . Cut-way sections expose the gold antenna which is sandwiched between the plastic layers .

The case is currently only available for the iPhone 6 and iPhone 6 Plus and costs $ 60 -LRB- # 40 -RRB- and $ 70 -LRB- # 46 -RRB- respectively . It comes in black , but more colours will be added this spring as well as cases for other handsets .
...
Case is available for the iPhone 6 and iPhone 6 Plus , from $ 60 -LRB- # 40 -RRB-