...
Neither the Dubai carrier nor Abu Dhabi-based Etihad Airways would say how close the two planes came to each other . However a Resolution Advisory -LRB- RA -RRB- was given to both planes , which means the distance between the two aircraft could have resulted in a collision within 25 seconds .
...
A Traffic Advisory -LRB- TA -RRB- is sounded to an aircraft when they are within 40 seconds of traffic in a particular airspace .
...
The Seychelles News Agency confirmed both planes received a ` Resolution Advisory ' or RA , from the on-board Traffic Collision Avoidance System -LRB- TCAS -RRB- .
...
` The traffic collision avoidance system -LRB- TCAS -RRB- , which is fitted on all aircraft , ensured that safe vertical separation of both aircraft was maintained at all times .
...
A statement released by Emirates to the Times of India read : 'Em irates can confirm that flight EK 706 on March 29 from Seychelles to Dubai was involved in an air traffic control incident in Mumbai airspace . At no point was the aircraft , passengers or crew at risk .
