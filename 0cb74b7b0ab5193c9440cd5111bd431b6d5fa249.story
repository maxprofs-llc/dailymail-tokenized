...
According to Rt.com it is not known if the shield works or not , but the premise is simple enough : if the drone ca n't detect fighters , it ca n't kill them .
...
A spokesman for US Central Command , which runs military operations on the Arabian Peninsula , has reportedly refused to comment on the ` effectiveness or ineffectiveness of specific enemy -LSB- tactics -RSB- . '
