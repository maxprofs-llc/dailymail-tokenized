...
But now a collaboration between two Seattle-based firms has created a bike that 's handlebars can be used as a bike lock -- so cyclists do n't have to lug a heavy lock around with them .
...
The Denny bike -LRB- pictured -RRB- not only features handlebars that can be used as a removeable lock , but also has an automatic gear shifter , built-in lights and has a motor to help cyclists up hills
...
They were inspired to create the bike to suit a life in Seattle so riders ` do n't have to worry about the hills , rain or an impromptu farmer 's market trip . '

A collaboration between two Seattle-based firms has created the award-winning bike that 's handlebars can be used as a bike lock -LRB- pictured -RRB- -- so cyclists do n't have to lug a heavy lock around with them
...
The lights are automatically on so that people do n't forget to turn them on when it grows dark and the rear light becomes stronger when a cyclist brakes .
...
It 's the brainchild of two Seattle-based firms who want to make cycling carefree so cyclists do n't have to haul around a lot of kit with them
