...
A patent rewarded to Google suggests its headset could teach wearers how dance to any kind of music . ` Shazam-like ' technology would recognise a tune , and suggested dance moves would be shown on the heads up display that a user could copy -LRB- illustrated in this image from the patent -RRB-
...
The patent suggests that a wearer of the smart spectacles -LRB- stock image -RRB- could watch a video of other people dancing in order to understand how the moves should look , before following the instructions themselves

Google 's chairman , Eric Schmidt , said that the company has n't stopped working on Google Glass .
...
` The wearable computing system may determine dance steps corresponding to the content of the media sample and may generate a display of the dance steps on the HMD -LSB- head mounted display -RSB- . '
...
As with all patents , there is no guarantee Google will develop the idea further - although Eric Schmidt has recently said that the tech giant has n't given up on Glass .
...
The system could risk giving users some embarrassingly outlandish movements to use on a dance floor , but seeing as it 's designed to help those with two left feet -LRB- stock image -RRB- , the instructions may still be an improvement overall
...
` We ended the Explorer program and the press conflated this into us cancelling the whole project , which is n't true .
