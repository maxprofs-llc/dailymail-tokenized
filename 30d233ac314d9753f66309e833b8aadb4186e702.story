...
The
layers and structure of the algorithm were based on the Hebbian
principle , for example , which describes how neurons adapt in the brain
as we learn .

It also features scale invariance , which states that objects do n't change even if they 're multiplied by a common factor .

For
example , at its most basic , making an image of an object larger or
smaller does n't change the object , its shape or proportions .

This
helps the software learn the shape and size of different objects , no
matter how small , and be able to recognise them in the future .
...
In this year 's challenge , team GoogLeNet doubled the quality of last year 's results . The technology built upon image recognition research carried out by Alex Krizhevsky from the University of Toronto , which was able to teach computers to divide images into objects -LRB- pictured -RRB-

For example , at its most basic , making an image of an object larger or smaller does n't change the object , its shape or proportions .
...
A team of Google researchers and students has developed GoogLeNet
