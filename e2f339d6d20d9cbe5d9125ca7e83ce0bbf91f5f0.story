...
He wrote presciently of ` an inhaler or non-combustible cigarette , looking much like the real thing , but ... delivering a metered dose of nicotine vapour . -LRB- The new habit , if it catches on , would be known as vaping -RRB- ' .
...
budtender -LRB- noun -RRB- : A person whose job is to serve customers in a cannabis dispensary or shop . This word has come to the fore following moves to legalise the drug for medical use in some US states . It combines bud - slang for marijuana - and tender - as in bartender .

normcore -LRB- noun -RRB- : A trend in which ordinary , unfashionable clothing is worn as a deliberate fashion statement . Oxford Dictionaries said use of the word peaked in 2014 and remains ` very much alive ' despite predictions from fashion pundits that the trend is over .

contactless -LRB- adjective -RRB- : Relating to or involving technologies that allow a smart card or mobile phone to contact wirelessly to an electronic reader , typically in order to make a payment . Usage peaked in September , when the technology was rolled out across London 's transport network .

slacktivism -LRB- noun -RRB- : Actions performed via the Internet in support of a political or social cause but regarded as requiring little time or involvement , for example signing an online petition or joining a campaign group on a social media website . Oxford Dictionaries cited the Ice Bucket Challenge and the No Makeup Selfie as examples .
