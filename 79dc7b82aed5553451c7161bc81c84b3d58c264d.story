...
The # 100 -LRB- $ 160 -RRB- Pikon is able to produce images with a quality equal to telescopes that cost ten times as much , according to its designers .

And with plans available to download online , anyone can create the telescope themselves -- as long as they own a 3D printer which costs at least # 400 -LRB- $ 650 -RRB- .
...
Pikon uses a # 25 -LRB- $ 40 -RRB- Raspberry Pi camera module and is based on Isaac Newton 's reflecting telescope design .
...
# 100 -LRB- $ 160 -RRB- Pikon is able to produce images with a quality equal to telescopes that cost ten times as much
...
The telescope uses a # 25 -LRB- $ 40 -RRB- Raspberry Pi camera module and is based on Isaac Newton 's reflecting telescope design . The physicists unveiled the project , called Disruptive Technology Astronomy , as part of the University of Sheffield 's Festival of the Mind
