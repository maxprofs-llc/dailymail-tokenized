...
To be clear , Facebook ca n't track the
exact keys pressed , and it does n't monitor keystrokes . This means the
code does n't reveal what is being typed .
...
Data scientists can determine that a status or comment has been typed by tracking the HTML form element of each page . This element is made up of HTML code that controls the boxes Facebook users type in to , including the status update box , pictured . Facebook ca n't see the exact characters being typed , just the amount
...
` The remaining 29 per cent of users in our sample likely did n't have a chance to self-censor over the short duration of the study , ' said the researchers .
