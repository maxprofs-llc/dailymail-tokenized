...
` From the few Lerner documents we have received , we know that Washington , DC orchestrated the targeting of groups applying for tax-exempt status , surveillance of existing tax-exempt groups and formed the proposed 501 -LRB- c -RRB- -LRB- 4 -RRB- rules designed to push conservative groups out of the public forum . '

Camp warned the IRS in a February 24 letter that he would start issuing subpoenas if the agency did n't turn over the documents he wanted .
...
` We expect the IRS will also be delivering a copy -LSB- of the complete Lerner files -RSB- to the Oversight Committee . '
