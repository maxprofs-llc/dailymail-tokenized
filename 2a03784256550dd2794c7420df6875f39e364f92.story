...
Multiple sclerosis -LRB- MS -RRB- may be triggered by a toxin produced by common bacteria found in food , according to a new study .
...
Multiple sclerosis - the inflammatory disease of the central nervous system - is thought to be triggered in a genetically susceptible individual by a combination of one or more environmental factors , one of which could be a bacteria found in food . A scan is pictured

MS is known as an autoimmune condition .

This is where something goes wrong with the immune system - the body 's defence against infection - and it mistakenly attacks healthy body tissue -- in this case , the myelin covering of nerves .
...
` We also show that epsilon toxin targets other cells types associated with MS inflammation such as the retinal vascular and meningeal cells , ' -LRB- cells of the membranes that envelop the central nervous system -RRB- , she said .

` Epsilon toxin may be responsible for triggering MS. '

Epsilon toxin is produced by certain strains of Clostridium perfringens , which is a spore-forming bacterium that is one of the most common causes of foodborne illness .

Epsilon toxin is produced by certain strains of Clostridium perfringens -LRB- pictured -RRB- which is a spore-forming bacterium that is one of the most common causes of foodborne illness

Previous studies have suggested that C. perfringens , and in particular , epsilon toxin , may play a role in triggering MS.
...
To further test their hypothesis Dr Linden and her team studied the behaviour of the toxin in mice focusing on which cells it targeted .

They discovered that the toxin did target the brain cells associated with MS pathology , but that was not all they found .

Dr Linden said : ` Originally , we only thought that epsilon toxin would target the brain endothelium cells and oligodendrocytes ; we just happened to notice that it also bound to and killed meningeal cells -LRB- of neurons -RRB- . '
...
Of the 37 food samples , 13.5 per cent were positive for bacteria and almost three per cent were positive for the epsilon toxin gene .
