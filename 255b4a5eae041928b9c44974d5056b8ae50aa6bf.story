...
Researchers have released an amazing image of Abell 2566 . In the annotated image -LRB- move the slider to see the markings -RRB- , the point sources -LRB- examples in red -RRB- are galaxies like ours . Blue objects are radio galaxies with streams of plasma , and in green is the ` Large Relic ' , which could be a shockwave as the clusters collide .

Researchers at the National Radio Astronomy Observatory -LRB- NRAO -RRB- made the image using the Karl G. Jansky Very Large Array -LRB- VLA -RRB- in New Mexico .
...
` We do n't yet understand just why each of those sources have the shapes they have - we 're still working on that .
...
Resarchers at the National Radio Astronomy Observatory -LRB- NRAO -RRB- made the image using the Karl G. Jansky Very Large Array -LRB- VLA -RRB- in New Mexico , shown here . The VLA is at an altitude of 6970ft -LRB- 2125 metres -RRB- and consists of 27 independent antennae
