...
Private care : NHS Wirral have struck a deal for maternity care with One to One -LRB- file picture -RRB-
...
` NHS Wirral continues to contract with local hospital-based maternity services providers -LRB- Wirral Hospital 's Trust , Liverpool Women 's Hospital , Countess of Chester Hospital -RRB- .
