...
Cubli uses two manoeuvres to jump from its resting position to one of its edges and then balance on one of its corners . The mechanical device can detect disturbances to adjust its position while balancing on its corner -LRB- illustrated -RRB- and also rotate
