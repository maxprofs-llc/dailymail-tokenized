...
' -LSB- We -RSB- have revealed how the long-term , error-free storage of information can be achieved , potentially for more than a million years . '
...
For the recent breakthrough , the researchers took inspiration from fossilised bones -LRB- stock image -RRB- . Despite being thousands of years old , it is possible to obtain genetic material because the DNA is protected inside the bones . The experts designed a similar ` fossil shell ' to protect the information-bearing DNA in the same way

In order to simulate the degradation of DNA over a long period of time , researchers stored it at a temperature of between 60 °C -LRB- 140 °F -RRB- and 70 °C -LRB- 158 °F -RRB- for up to a month .
...
In 2013 , researchers from Cambridgeshire ` downloaded ' all 154 of Shakespeare 's sonnets on to strands of synthetic DNA -LRB- illustrated -RRB-
...
Scientists used an ` error correction ' similar to those found in laptops -LRB- stock image -RRB- . This involved adding data to each fragment to create back ups

As the researchers pointed out , this is not the first time DNA has been used to store information and digital data .

In 2013 , researchers from the European Bioinformatics Institute -LRB- EBI -RRB- at the Wellcome Trust Genome Campus in Hinxton , Cambridgeshire ` downloaded ' all 154 of Shakespeare 's sonnets on to strands of synthetic DNA .
...
Theoretically , 100 million hours of high definition video could be stored in a cupful of DNA - equivalent to every film and TV show ever created . A DNA archive also requires no constant supply of electric power like hard drives and data centres -LRB- example pictured -RRB- do

Currently the technology is restricted by the length of time it takes to sequence DNA and its high cost - around # 8,000 -LRB- $ 12,300 -RRB- per megabyte of stored material .
