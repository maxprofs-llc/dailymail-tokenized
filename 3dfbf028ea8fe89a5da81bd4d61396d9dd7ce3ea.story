...
This is true in Montreal , Toronto and Vancouver . In the former the correlation between young people -LRB- aged 25 to 34 -RRB- and density - where -1 indicates a total negative correlation , 0 no correlation at all and +1 a total positive correlation - grew from .22 in 1981 to .66 by 2011 .

In Toronto , it went from .36 to .62 and in Vancouver it increased from .49 to .68 .

The associations between density and older age groups -LRB- 44-54 and 55-64 years old -RRB- have generally moved in the other direction , indicating these individuals are moving toward the lower-density suburbs .
