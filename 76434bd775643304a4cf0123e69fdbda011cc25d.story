...
Jiahao Sha , who led the Chinese team , said that CRISPR-Cas9 could be used to create monkeys that carry genetic faults that lead to diseases in humans for animal testing .

The technology can also be used to grow human organs in the lab , and used to test drugs , or to monitor how serious diseases can affect the body .

Precise changes in DNA are also being investigated as a way to make people resistant to HIV .

Scientists believe CRISPR-Cas9 has the potential to overcome many of the limitations of currently available gene-silencing techniques .

` We can now use this technology on a genome-wide scale , giving us the ability to interrogate any gene we want , ' said Feng Zhang , a member of the Broad Institute and assistant professor at MIT .
...
When cellular machinery repairs the DNA break , it removes a small snip of DNA , making a gene non-functional . In this way , researchers can precisely turn off specific genes in the genome .

The CRISPR-Cas9 procedure has been welcomed by geneticists in labs around the world because of its huge potential .

But this recent breakthrough has created opposition by some groups opposed to animal testing .

` Our study shows that the CRISPR/Cas9 system enables simultaneous disruption of two target genes in one step without producing off-target mutations , said study author Jiahao Sha of Nanjing Medical University .
...
CRISPR-Cas9 technique can be used to create monkeys with genetic faults
