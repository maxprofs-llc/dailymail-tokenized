...
Researchers have succeeded in making one of the key components of cameras , the charge-coupled device -LRB- CCD -RRB- , just one atom thick .

And they say it could be employed in ultra-thin two-dimensional imaging devices in the future .

Scroll down for video

Graduate student Sidong Lei displays a three-pixel prototype made with atomically thin layers of copper indium selenide -LRB- CIS -RRB- . The new material developed at Rice shows promise for two-dimensional electronics , possibly paving the way to extremely thin cameras in the future
...
And its composition , namely copper indium selenide -LRB- CIS -RRB- , apparently shows extraordinary promise for light detection .
...
Many modern digital cameras used an image sensor called a charge-coupled device -LRB- CCD -RRB- .
...
Called copper indium selenide -LRB- CIS -RRB- it is just one atom thick
