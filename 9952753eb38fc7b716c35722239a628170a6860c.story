...
Autocomplete predictions are algorithmically determined based on a number of factors -LRB- including popularity of search terms -RRB- without any human intervention .
...
The higher amounts of negative questions -LRB- both in terms of proportion and frequency -RRB- for black and gay social groups are thus a cause for particular concern . '
...
For example , in the video-sharing website YouTube -LRB- owned and operated by Google -RRB- , people can comment on videos , and then readers can mark those comments with ` agree ' or ` disagree ' .
