...
` Warped ' : ChildLine founder Esther Rantzen -LRB- pictured -RRB- says many teenagers are copying behaviour which is ` quite unacceptable and frankly disturbing , even dangerous '
...
` And whilst filters and blocks are n't the only solution , they are a big step in the right direction and an opt-in system can only be a positive thing . '
