...
` The day-to-day processing is performed by ULA , ' said Merri Anne Stowe of Nasa 's Fleet Systems Integration Branch of the Launch Services Program -LRB- LSP -RRB- . ` Nasa 's role is to keep a watchful eye on everything and be there to help if any issues come up . '
...
United Launch Alliance technicians prepare the second stage of a Delta IV Heavy rocket for mating to the central core booster of the three booster stages for the unpiloted Exploration Flight Test-1 .
...
The same upper stage will be used on the block 1 version of NASA 's new heavy-lift rocket , the Space Launch System -LRB- SLS -RRB- . More powerful than any rocket ever built , SLS will be capable of sending humans aboard Orion to deep-space destinations such as an asteroid and Mars .

` The hardware for Exploration Flight Test-1 is coming together well , ' Stowe said . ` We have n't had to deal with any serious problems . All of the advance planning appears to be paying off . '
...
The second Orion flight wo n't occur until around 2018 when another unmanned capsule soars atop NASA 's new megarocket , still under development , called SLS for Space Launch System .

A test version of NASA 's Orion capsule is shown after being recovered by the USS Anchorage off the coast of California in September
...
For its first flight test , SLS will be configured for a 70-metric-ton -LRB- 77-ton -RRB- lift capacity and carry an uncrewed Orion spacecraft beyond low-Earth orbit .

In its most powerful configuration , SLS will provide an unprecedented lift capability of 130 metric tons -LRB- 143 tons -RRB- , which will enable missions even farther into our solar system , including such destinations as an asteroid and Mars .
