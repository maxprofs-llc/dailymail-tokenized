...
Bright idea : Inventors in Tel Aviv , Israel , have come up with a smart light bulb adapter called Vocca -LRB- pictured -RRB- that can be controlled with simple voice commands , saving people precious time and energy
...
Cost : From $ 39 -LRB- # 23 -RRB- plus shipping
...
The adapter is designed to fit different light bulbs and fittings . Consumers can still use a regular light switch with the device if a voice command is n't convenient .
...
Customisable : A ` Pro ' version of the adapter is also available to pre-order , which will allow people to create their own triggers to turn their light on and off . Using an accompanying iPhone app , -LRB- pictured -RRB- they will also be able to set the gadget to automatically switch on at a certain time
...
The device is available to pre-order on Kickstarter for $ 39 -LRB- # 23 -RRB- plus $ 12 -LRB- # 7 -RRB- shipping outside US , while a Pro version costs $ 49 -LRB- # 29 -RRB- plus shipping per device .

The company is half way to raising the $ 40,000 -LRB- # 24,000 -RRB- it needs to manufacture the device , which is expected to ship in December .
...
Device costs from $ 39 -LRB- # 23 -RRB- plus shipping and is set to launch in December