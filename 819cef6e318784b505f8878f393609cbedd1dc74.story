...
The WiFlux device uses an inductive coil in charging circuitry that fits into packaging that is 72mm x 55mm x 5.5 mm . To power your phone , you simply stick a charged WiFlux device to the back of it
...
The WiFlux device uses an inductive coil in charging circuitry that fits into packaging that is 72mm x 55mm x 5.5 mm .
...
The receiver is shown on the left and wireless charger on the right . It wo n't provide a complete charge , as with cable-based systems , but it buys you some time before plugging your smartphone into the mains

The device wo n't provide a complete charge , as with cable-based systems , but it buys you some time before plugging your smartphone into the mains .
...
` The circuitry for the mobile charging portion has been challenging to design , as we are trying to deliver 0.25 W from the receiving coil to the charging input . '
...
When placed near each other , the charger will wireless supply the receiver with power . At present , the prototype runs off a 9V battery , and provides 5V from the receiver . The goal is to reduce this to 3.7 V on the charger and up the voltage to 5V from the receiver while maintaining a slim profile

@highlight

Device charges using inductive coil in packaging that is just 5.5 mm thick
