...
Transmission Control Protocol/Internet Protocol -LRB- TCP/IP -RRB- - TCP/IP are the protocols used with packet-switching technologies on the modern-day internet . They format the packets - depending on
...
At this time the word ` network ' meant what is now referred to as a local area network -LRB- LAN -RRB- .
...
Arpanet became the first to adopt Transmission Control Protocol/Internet Protocol -LRB- TCP/IP -RRB- , which later became part of the framework for the modern-day internet .
...
The world 's first operational packet-switching network was Arpanet . This map details the processes early versions of the network used . Arpanet was the first to implement TCP/IP which is still used in the modern-day internet . Catenet did n't adopt these protocols and became obsolete
