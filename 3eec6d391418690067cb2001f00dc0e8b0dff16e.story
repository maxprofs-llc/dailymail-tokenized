...
Papers from Nasa HQ in Washington DC have revealed how the agency intends to capture an asteroid by the end of this decade . And they also explain how astronauts will visit the asteroid -LRB- illustrated -RRB- in the 2020s

The six papers are available from the agency at the Asteroid Initiative Related Documents page .

Nasa 's ultimate goal is to send humans to Mars , and they say the Asteroid Redirect Mission -LRB- Arm -RRB- will be an important stepping stone towards getting there .
...
Astronauts aboard Nasa 's Orion spacecraft , launched from the upcoming Space Launch System -LRB- SLS -RRB- rocket , will then explore the asteroid in the mid-2020s at the furthest point in its controlled orbit around the moon .
...
This includes advanced Solar Electric Propulsion -LRB- SEP -RRB- - one of the critical technologies needed to send larger payloads into deep space and to the Mars system .

SEP - or ion propulsion - creates thrust powered by solar arrays , which transforms sunlight into electromagnetic fields that accelerate and expel charged atoms -LRB- ions -RRB- .
...
The agency is considering two options for the Asteroid Redirect Mission . One involves picking up a boulder from a large asteroid -LRB- shown -RRB- and taking it to lunar orbit , where it would be studied by astronauts

The other method would grab an asteroid in an inflatable bag -LRB- illustrated -RRB- . Both mission concepts would bring their respective asteroids back to lunar orbit . Here they would be visited by astronauts aboard the Orion spacecraft . The astronauts would study the asteroid and collect samples before returning to Earth
...
Nasa is currently developing the huge Space Launch System -LRB- SLS -RRB- rocket , illustration shown , which will be the largest rocket ever when it flies later this decade . SLS is seen as a vital component for a future mission to Mars as a large lifting capability will needed to take all the equipment required for such a mission

Nasa says this the Asteroid Redirect Mission is an important way to test new technologies that will be needed for an eventual mission to Mars -LRB- illustrated -RRB- . It could also help us test the methods that would be needed to redirect a planet-destroying asteroid if one was heading towards Earth
...
The Asteroid Redirect Mission will provide humans with the first chance to study asteroids in situ space . After the mission is completed the astronauts will return safely to Earth -LRB- illustrated -RRB-
