...
They demonstrated that a hacker could use it to collect data from devices protected by an air-gap in a paper , which they presented at the IEEE 9th International Conference on Malicious and Unwanted Software -LRB- Malcon -RRB- .
...
Commentators said the AirHopper technique is a refinement of methods used by intelligence agencies since the mid 1980s to bypass machines protected with passwords -LRB- stock image -RRB- and other measures
...
But the method is still slow , transferring less than 60 bytes a second and only at a distance of between 3ft -LRB- one metre -RRB- and 22ft -LRB- seven metres -RRB- .
