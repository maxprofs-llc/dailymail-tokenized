A high-end dental brand has launched a # 3,000 -LRB- $ 4,620 -RRB- bespoke botanical toothpaste service , which includes a chauffeur-driven car to the consultation and allows the customer to choose any flavour from an unlimited menu of options .
...
The VIP treatment does n't end there either .
...
In addition to the initial # 3,000 fee , which includes the first two tubes of toothpaste - one for the day and one for the night - customers are then required to fork over an additional # 120 -LRB- $ 185 -RRB- every two months in order to re-stock their supplies .
