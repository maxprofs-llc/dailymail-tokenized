...
` Probably anything that was n't too rotten was fair game . '
...
Dr Pobiner found that modern predators leave large amounts of meat on their kills -LRB- as shown above -RRB- and believes that prehistoric carnivores could have left even more to be picked clean by early humans
...
Dr Briana Pobiner -LRB- above -RRB- claims to have found evidence that humans butchered carcasses after large predators had eaten meat from the bones first
...
` Where the difference comes in is with the three species -LRB- three genera , actually -RRB- of sabertoothed cats that were around when hominins first started eating meat .
