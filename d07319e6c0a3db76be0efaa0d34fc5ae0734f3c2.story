...
` Why else bother to write the guide if you do n't have the weapons ? If AQIM not only has the MANPADS , but also fighters who know how to use them effectively , then the impact is significant , not only on the current conflict , but on security throughout North and West Africa , and possibly beyond . '
...
They are using more fighter jets rather than helicopters to fly above its range of 1.4 miles -LRB- 2.3 km -RRB- from the ground , even though that makes it harder to attack the jihadists .
...
Concerns : The knowledge that the terrorists have the weapon has already changed the way the French -LRB- above -RRB- are carrying out their five-month-old offensive in Mali
...
It 's located less than three miles -LRB- 5 km -RRB- from the Ministry of Finance 's Budget Division building where the manual was found .
...
so far to hit a plane could mean that they can not position themselves
...
` They just could n't destroy everything , ' said neighbor Mohamed Alassane . ` They appeared to be in a panic when the French came . They left in a state of disorder . '
...
Terror expert : ` Why bother to write guide if you do n't have the weapons ? '
