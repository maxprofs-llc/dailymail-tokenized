...
The technology is being developed by the Massachusetts Institute of Technology -LRB- MIT -RRB- as part of the ` Cord UIs ' project .
...
The first of the prototypes was a lamp with the dimmer knob replaced by a knot on the cord -LRB- top -RRB- . In another prototype , a clip clamping on the Macbook charger wire was able to control a computer 's power function -LRB- bottom left -RRB- . Another cable -LRB- bottom right -RRB- allowed the user to pinch headphone to control the play function
...
After the initial run of cables are shipped , they will retail for $ 36 -LRB- # 24 -RRB- . They are expected to be available sometime next month .
...
Pinching the cord triggers the pause functionality of the iPhone 's 3.5 mm jack .
