...
Facebook has launched a new app called Hello -LRB- pictured -RRB- designed to give you more control over who can call you and how their details appear - even if their number is n't stored in your contacts book . It pulls in any publicly-shared data from a user 's Facebook profile and lets you easily block unwanted callers
...
` This balance is different for everyone -LSB- and -RSB- as more people and pages are sharing more content , we need to keep improving News Feed to get this balance right . '
...
When a user receives a call , Hello shows them info about who 's calling , even if they do n't have that number saved .
...
When a user receives a call Hello shows them info about who 's calling , even if they do n't have that number saved -LRB- pictured left -RRB- . Hello also makes it easier to block unwanted calls and see which numbers have been blocked from other users -LRB- pictured right -RRB- in the app 's settings menu
