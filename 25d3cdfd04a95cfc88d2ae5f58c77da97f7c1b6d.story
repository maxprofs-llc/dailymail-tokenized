Oscar Wilde may have said ` I can resist everything except temptation , ' but he did n't have a smart safe to help him .
...
No more temptation : The cylindrical device , called kSafe , locks up a form of temptation - whether it is fattening cookies , cigarettes or a time-consuming games controller -LRB- pictured -RRB-
...
Strict : The only way to unlock the kSafe is to reach pre-determined fitness goals , such as walking a set number of steps in a day , which can be set and tracked on an app -LRB- pictured left and right -RRB-
...
It uses pre-commitment , an example of which is moving an alarm clock out of reach so the user ca n't reach the snooze button , to make people commit to a smart choice , knowing that they 'll probably be tempted later .
...
Motivational : Users will be able to view their progress in meeting their goal on the light-up ` button dial ' on the top of the kSafe -LRB- pictured -RRB- or via the app
...
The company said : ` kSafe wo n't open until you 've reached your goal . No overrides ! '
...
But it wo n't let users get away with making their challenge easier .

The device is available in three colours : black , white and transparent , and can be pre-ordered via Kickstarter for $ 89 -LRB- # 60 -RRB- with an estimated delivery date of November .
...
Device can be pre-ordered on Kickstarter for $ 89 -LRB- # 60 -RRB-