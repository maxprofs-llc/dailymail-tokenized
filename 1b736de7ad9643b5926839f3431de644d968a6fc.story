...
Taking 16 years to create , the colourful map describes the geography of Mars as it is today while also shedding light on the red planet 's past . The map was created by the U.S. Geological Survey -LRB- USGS -RRB- in Virginia using data from four separate orbiting spacecraft

The map was created by the U.S. Geological Survey -LRB- USGS -RRB- in Virginia using data from four separate orbiting spacecraft .
