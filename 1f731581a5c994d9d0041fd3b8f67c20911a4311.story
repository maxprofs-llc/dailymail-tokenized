...
The sensor , which will cost # 30 -LRB- $ 50 -RRB- , plugs into the On-Board Diagnosticics-II -LRB- OBD-II -RRB- port , which almost all modern cars have .
...
When attached the sensor is powered by the car , meaning it does n't need a battery .
...
The app includes features such as telling you the status of your airbags -LRB- left -RRB- and whether the car needs an oil change . A multi-vehicle feature -LRB- right -RRB- also lets a user keep track of multiple cars at once

The # 30 -LRB- $ 50 -RRB- sensor will be available later this year , while the app will be available for Android in October and for iPhone in May 2015 , with various features to be rolled out over the next year
