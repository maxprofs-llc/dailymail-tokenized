...
` Second , it provides just a tiny taste of the excellence and challenges ahead , to turn Gaia data into human understanding of the Milky Way 's origins .

` One substantial step for astronomy , one huge leap still to come . '

Gaia 's goal is to create the most accurate map yet of the Milky Way .

Artist 's impression of Gaia , an ambitious mission to chart a three-dimensional map of our Galaxy , the Milky Way
...
Liftoff ! Soyuz VS06 , with Gaia space observatory , lifted off from Europe 's Spaceport , French Guiana , on 19 December 2013 .
...
As a result , Gaia 's final catalogue will not be released until three years after the end of the nominal five-year mission .

Intermediate data releases will be made , however , and if rapidly changing objects such as supernovae are detected , alerts will be released within hours of data processing , its operators say .

Eventually , the Gaia data archive will exceed a million Gigabytes , equivalent to about 200 000 DVDs of data .

@highlight

Space telescope will create the most accurate map yet of the Milky Way
