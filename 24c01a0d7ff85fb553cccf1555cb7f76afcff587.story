...
` To move only one , -LRB- or even two or four -RRB- out of 5 fixtures would seem to be leaving our game wide open to unsavoury accusations .
...
` To date , we have had no request from Hibernian FC to move its fixture to the Sunday at the time of writing -LRB- 8.45 pm , Wednesday 15 April -RRB- .
...
` But we 've told by the TV , I believe , that it may be the case that the other games are moved to the Sunday . I honestly do n't know . It 's nothing to do with us . We 've not asked for that , but if I was in Hibs ' position then , yes , I would be annoyed as well . Of course .
