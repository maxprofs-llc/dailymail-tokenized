NBC has announced plans to introduce Matrix-style replays into its coverage of pro football .

They will use freeD ™ system by Replay Technologies that have been used in PGA golf shows .

This comes after Japanese television network NHK announced last month that they will use a robotic rig to shoot footage in 360 degrees and slow motion .

Scroll down for video

Saturday Night Football will use the 360 degree technology to capture the action in both end zones

The move will give fans a complete view of the events , reported Peta Pixel .

Sunday Night Football , the most watched show on television , will use one 24-camera bullet time rig at each end zone .

The technology will be installed by the first game in September between the Giants and Cowboys in Dallas .

It will ensure that there is a back-up in case a referee makes a controversial or incorrect decision .

NBC announced that they will use the technology from September

NBC 's Cris Collinsworth : ` We 're trying to be a show that really appeals to everybody .

` We 're trying to -LSB- show -RSB- human beings behind the facemasks . '

NHK last month said they would use a robotic multi-camera system that has been developed in Japan and can record a single scene simultaneously from multiple angles .

A computer can then stitch the
individual images together to create a video clip of that scene , which
can sped up or slowed down .

The
effect the system creates is called ` bullet time ' and is the same
effect used in 1999 film The Matrix in which the main character Neo is
shown dodging bullets in slow motion as a camera virtually moves the
audience 360-degrees around the shot .
...
Japanese broadcaster NHK 's system uses eight cameras , each one used
for various pans , tilts and zooms . These eight cameras move in tandem
...
This is n't possible with traditional cameras because the cameras would have move round a scene at the same speed at which the event is taking place .
...
NHK 's system is similar to the set-up used by
the Wachowski brothers during the filming of their 1999 film The Matrix
...
NBC will use Matrix-style 360 technology to film pro football
