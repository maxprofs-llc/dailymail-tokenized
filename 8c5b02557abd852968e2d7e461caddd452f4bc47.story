...
David Cameron will claim that there is a ` welfare gap ' in Britain , where those on the dole have a financial incentive to breed while those in work are forced to stop having children because they simply can not afford to .
...
` Yes , this is difficult territory . But at a time when so many people are struggling , is n't it right that we ask whether those in the welfare system are faced with the same kinds of decisions that working people have to wrestle with when they have a child ? '
...
In 2010 , Culture Secretary Jeremy Hunt provoked a row when he suggested that the workshy should stop having children if they can not afford them , saying the number of children is a ` choice ' .
...
He added : ` He 's -LRB- David Cameron -RRB- looking , quite rightly , at the balance between those families that work and try and do the right things against those families that are n't necessarily working and have understood how to work the system .
...
He said : ` We just are n't prepared to put up with second-rate standards in state schools . ` Michael has the courage to deliver it and I back him all the way . '
