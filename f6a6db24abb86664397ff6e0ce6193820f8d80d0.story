...
Like a modern car , the Footloose has an Electronic Control Unit -LRB- ECU -RRB- which works with sensors to monitor terrain and an automatic gear changer to adjust the motor 's output to suit .

This ECU also monitors the contraption to identify any problems , which it then displays by means of a handlebar mounted HMI -LRB- Human Machine Interface -RRB- .
