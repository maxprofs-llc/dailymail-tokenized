...
Samsung devices are at risk of attack due to a vulnerability in its Find My Mobile service -LRB- pictured -RRB- . Security experts have discovered a way to hack into the service and remotely unlock handsets from a PC . Once a hacker has access to a device , they can also change the PIN code rendering it useless to the owner
...
The flaw has also been reported by the National Institute of Standards and Technology -LRB- NIST -RRB- in the US on its National Vulnerability Database -LRB- NVD -RRB- .

The security researchers have given it a high-severity rating of 7.8 , with an ` exploitability sub-score ' of 10.0 .

This means it is a relatively easy hack and does n't require authentication .
...
' -LSB- This -RSB- makes it easier for remote attackers to cause a denial of service - screen locking with an arbitrary code - by triggering unexpected Find My Mobile network traffic . '

Egyptian researcher Mohamad Baset has posted a proof-of-concept video -LRB- screengrab pictured -RRB- that shows him hacking a device , unlocking it , changing the greeting message and remotely calling it . The flaw has also been reported by the National Institute of Standards and Technology -LRB- NIST -RRB-

The flaw affects any Samsung device with Find My Mobile enabled -LRB- Galaxy S5 pictured -RRB-
