...
The Free Speech Coalition -LRB- FSC -RRB- ended the five-day production hold Monday , saying in a statement that testing has been completed and ` the performer pool has not been compromised . '
...
The group said in the statement ' A production hold was called when it was determined that a performer in the PASS -LSB- Performer Availability Screening Services -RSB- database might have been exposed to HIV in late September , after off-set contact with a performer from an out-of-state set that was not observing PASS protocols .
...
Protected : The organization did n't name the state where the film set was located
