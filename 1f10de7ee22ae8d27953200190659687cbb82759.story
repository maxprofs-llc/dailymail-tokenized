...
Party pooch : A coat encrusted with LEDs that can flash different colours and display scrolling messages -LRB- pictured -RRB- aims to turn any mutt into a party pooch .

A start-up firm called Party NYC , based in New York and Tokyo , is in the process of creating the final version of the vest , which has 256 LEDs on the outside , as well as a concealed microcontroller , a Bluetooth low energy chip and a 3.7 V lithium ion battery .
...
An accompanying app -LRB- pictured -RRB- can be used to program the design on the vest and control the LEDs from a distance . There are controls for brightness and colour , including ` two-colour gradients that flow across the vest ' as well as room to type words -LRB- right -RRB- and even a lost dog mode
...
They can be pre-ordered for $ 300 -LRB- # 203 -RRB- for the smallest and $ 400 -LRB- # 271 -RRB- for large .
