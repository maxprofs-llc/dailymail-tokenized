...
` It is a substrate-independent mind -LRB- SIM -RRB- by being able to function in different operating substrates .

The popular term ` mind uploading ' can refer to the process of transfer , moving a specific substrate-independent mind from one operating substrate -LRB- e.g. , the biological brain -RRB- to another .
...
` Or perhaps bodies that are n't built to survive in this environment , but somewhere else , like space . '

He has set up an organisation , carboncopies to work on the technical and ethical issues around the project .

` We support practical approaches toward what we descriptively term `` advanced substrate-independent minds -LRB- ASIM -RRB- , i.e. transferring mind functions from the biological substrate to another substrate on which those functions can be performed , ' it says .
