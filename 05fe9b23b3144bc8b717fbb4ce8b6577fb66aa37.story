...
` This -LSB- atmospheric -RSB- wave is dragged by the winds of Venus , so if they are constant the wave should round the planet without getting deformed , right ? ' Dr Javier Peralta , the IAA-CSIC researcher in charge of this study , told MailOnline .

` But we must consider that these waves propagate over a `` sphere '' , and `` circles '' completed both at the equator and at 40ºN have a different radius -LRB- the higher latitude , the smaller the parallels or circles are -RRB- .
