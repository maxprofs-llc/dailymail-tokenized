...
enrichment material -LRB- e.g. straw -RRB- , providing more space per pig , and
...
` The Assured Food Standards -LRB- AFS -RRB-
...
ensure compliance with minimum legislative requirements -LRB- the
interpretation of which is considered inadequate in some cases -RRB- . '
...
Under scrutiny : The report also tested labels such as -LRB- l-r -RRB- Lion Mark , RSPCA Freedom and Soil Association - the latter scored extremely highly and achieved a gold standard
