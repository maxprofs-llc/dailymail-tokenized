...
` These transactions represented purchases of gym memberships , food -LSB- and -RSB- hotel space , ' according to the report . And many purchases were ` split ' among two or more transactions in order to avoid spending more than $ 3,000 at a time -- an amount that should trigger more extensive scrutiny .
...
EPA Administrator Gina McCarthy -LRB- C -RRB- has her hands full trying to persuade the coal industry that it 's not headed for extinction -- and now this ...
