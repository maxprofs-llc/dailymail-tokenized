...
It 's designed to fit a Dell Venue 8 Pro tablet , which retails for around $ 320 -LRB- # 200 -RRB- , but versions for Android devices and iOS devices are in the works .
...
Uni case is designed to fit a Dell Venue 8 Pro tablet -LRB- both pictured -RRB- which retails for around $ 320 -LRB- # 200 -RRB- , but versions for Android devices and iOS devices are in the works . The case uses Leap Motion technology togethr with a camera to sense hands and fingers
...
Its American Sign Language -LRB- ASL -RRB- recognition software interprets signs and matches them with a database of signs to translate them into the correct word .
...
It 's available to pre-order on Indiegogo for $ 198 -LRB- # 124 -RRB- plus a monthly subscription and is expected to ship in September 2015 .

Uni uses Leap Motion 's motion-sensing technology , which enables a camera to sense hand movements up to one foot away .

The entrepreneurs ' American Sign Language -LRB- ASL -RRB- recognition software interprets signs and matches them with a database of signs to translate them into the correct word .
...
Uni is available to pre-order for $ 198 -LRB- # 124 -RRB- . It 's expected to ship in September 2015 . A $ 20-a-month subscription is needed for software updates and crowd signing functions .

The case 's American Sign Language -LRB- ASL -RRB- recognition software interprets signs in real-time , showing what the camera sees on screen -LRB- pictured -RRB- . It matches them with a database of signs to translate them into the correct word , which is displayed on the tablet
...
Uni is available to pre-order on Indiegogo for $ 198 -LRB- # 124 -RRB-