...
Cern has launched its Open Data Portal , which lets members of the public pore through collision data from the Large Hadron Collider -LRB- LHC -RRB- .

It is the first time data has been made openly available for research and educational purposes .

Scroll down for video

Cern in Geneva has begun releasing collision data from the LHC on their Open Data Portal website -LRB- screenshot shown -RRB- . The public are invited to use the information for research and education . Data will come from various experiments at the particle accelerator
...
Yesterday scientists at the Large Hadron Collider -LRB- LHC -RRB- in Cern , Geneva said they had discovered two new subatomic particles by smashing protons together .
...
The first data to be released on the Open Data Portal will be from the LHC 's Compact Muon Solenoid -LRB- CMS -RRB- experiment , first recorded back in 2010 .
...
The first data to be released on the Open Data Portal will be from the LHC 's Compact Muon Solenoid -LRB- CMS -RRB- experiment , pictured here . The CMS team will release data three years after it has been collected , to give those on the team time to analyse the data before others get their hands on it
