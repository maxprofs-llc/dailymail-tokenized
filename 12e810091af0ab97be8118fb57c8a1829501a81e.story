...
According to notes from inside an HHS ` war room ' set up to troubleshoot the website in its calamitous first days , stakeholders were told on October 11 that ' -LSB- t -RSB- he paper applications allow people to feel like they are moving forward in the process and provides another option ; at the end of the day , we are all stuck in the same queue . '
...
Contractors for the Centers for Medicare and Medicaid Services have to manually enter data from paper applications into the same website that consumers use -- the hapless and error-prone site that has been down nearly as much as it 's been up since its October 1 launch .
...
` The same portal is used to determine eligibility -LSB- for government subsidies -RSB- no matter how the application is submitted -LRB- paper , online -RRB- , ' reads another section of the war room notes .
...
On Oct. 15 the war room heard that ' -LSB- n -RSB- avigators are seeing people very frustrated and walking away , so they are turning to paper applications to protect their reputations as people in the communities who can help , even though paper applications will not have a quicker result necessarily . '
...
' -LSB- W -RSB- e are to instruct Navigators to use paper applications rather than go through the call center , ' that day 's notes read .
...
The documents were released by the House Oversight Committee , which had to go to a contractor to obtain the documents since HHS is n't talking