...
In fact , Neil Cybart claims Apple makes an extra $ 3 billion -LRB- # 1.9 billion -RRB- each year by not doubling the amount of minimum storage every time a new model is released .
