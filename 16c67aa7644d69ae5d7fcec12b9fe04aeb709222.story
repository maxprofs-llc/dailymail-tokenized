...
Take note ! A notebook -LRB- pictured -RRB- allows people to write in it with a pen , then digitise the notes and save them to the cloud , using just a smartphone app
...
Organised : There are seven icons on each page , described as the ` magic buttons ' used to organise notes in the cloud . ` You assign each icon to the place of your choice , any folder inside Dropbox , Evernote , Google Docs -LRB- illustrated -RRB- or your email address , ' the company said , so they can easily be found in the cloud

Write on ! When the Rocketbook is full of ideas -LRB- pictured -RRB- , users will be able to heat in a microwave to clean the pages . People will be able to use the accompanying free app to ` accurately and quickly ' convert handwritten notes and drawings into digital images
...
The book can be pre-ordered via Indiegogo from $ 25 plus $ 15 international shipping -LRB- # 27 for those living in the UK -RRB- and each one comes with one black FriXion pen , with others colours on sale too .
...
Notebook can be pre-ordered on Indiegogo for $ 25 -LRB- # 17 plus shipping -RRB-