...
Users can call the police , fire service , report a car crash or seek medical help at the press of a button - and it works even if you do n't have signal .

Developers in Boston have worked with global emergency response teams to create its One-Touch-911 app -LRB- pictured -RRB- . Users can call the police , fire service , report a car crash or seek medical help at the press of a single button - and it works even if the user does n't have signal
...
If the user does n't have signal on their network , the app lets them ` roam ' onto another network to connect the call . This is a feature built into most phones already .
...
Each call is placed with the phone 's GPS location , user details and any pre-entered medical information attached -LRB- shown -RRB- . If the user does n't have signal on their network , the app lets them ` roam ' onto another network to connect the call . Calls can also be routed through a Wi-Fi network
...
The app can be used in 135 countries , and is compatible with any three-digit emergency number in these regions -LRB- pictured -RRB- . RapidSOS will begin testing the software in Texas next month and has launched a Kickstarter campaign to launch the app globally
