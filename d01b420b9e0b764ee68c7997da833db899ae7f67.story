...
Dim light : Figures in the report state that out of 1,514 perpetrators identified , some 415 were Asian -LRB- file photo -RRB-
...
` On the face of it , this is an issue for all ethnicities , but there is a specific problem in certain Asian communities -- specifically the Pakistani community -- in too many cities to ignore the phenomenon . Unless we recognise the problem , we wo n't be able to devise a strategy for tackling it '

Tory MP Margot James

A Whitehall source said last week : ` It 's important we do n't take a politically correct approach and pretend there is not a real problem here .

` Obviously abuse has been carried out by men from all sorts of ethnic background . But that does n't mean we can not say there is an issue about groups of Pakistani men systematically targeting young white girls . '
...
` Unless we recognise the problem , we wo n't be able to devise a strategy for tackling it .
...
Said figures on Asian gangs were n't enough to conclude particular issue
