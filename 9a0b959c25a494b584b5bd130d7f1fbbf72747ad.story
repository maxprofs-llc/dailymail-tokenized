...
French website iGen.fr has been told by a ` reliable source ' that the stainless steel model of Apple 's Watch will be available from $ 500 , while the gold version -LRB- pictured -RRB- will set customers back between $ 4,000 and $ 5,000
...
When state tax for California is added - a state with one of the highest taxes in the country at an average of 9 per cent - the price increases to $ 2,727.91 .

In addition to this , California laws state that a recycle fee must be added of $ 4 .

This brings the total cost of the order to $ 2727.91 , which converts to # 1,704 .

By comparison , the total price for the iMac in the UK is # 1,999 with VAT of # 333.17 already included .

This is a difference of # 295 .
...
This converts to # 2,510 and # 3,130 , but conversions ca n't be used to determine global prices because Apple typically sets prices on a region-by-region basis .
...
He did n't announce exactly when the watch would be available , but said it would go on sale ` early next year . '

A ` source close to Apple ' told The Information last month that the firm ` would be lucky to ship -LSB- the watch -RSB- before Valentine 's Day ' .
...
The source also revealed Apple is on track to release its first wearable around Valentine 's Day , as per previous rumours - dismissing more recent claims of a spring release . Apple 's Watch will be available in a Sport model , stainless steel and gold . Within the gold range , users will choose from rose gold -LRB- pictured -RRB- and yellow gold

Despite reports claiming the watch -LRB- pictured with boss Tim Cook -RRB- would launch in February , a statement recently suggested it has been delayed until ` spring . ' Angela Ahrendts , Apple 's senior vice president of retail and online stores said : ` We 'll go into Chinese New Year , and then we 've got a new watch launch coming '

Apple is said to be unhappy with the watch 's battery life , and the long lead time before the $ 349 -LRB- # 216 -RRB- product ships could mean the device will be more functional once it 's released early next year .
...
Apple 's chief executive Tim Cook -LRB- pictured -RRB- unveiled the watch at a launch event in September . Although he did n't reveal battery life details , Mr Cook did spend some time talking about the Watch 's charging system , which combines Apple 's MagSafe technology with inductive charging

The watch has a completely new user interface -LRB- left -RRB- , different from the iPhone , and the ` crown ' on the Apple Watch is a dial called the ` digital crown ' -LRB- right -RRB- presented by chief executive Tim Cook

The company 's chief executive added the Apple Watch ` can be worn all day , for any occasion , ' but hourly figures were notably absent . The long lead time before the $ 349 -LRB- # 216 -RRB- product ships could mean the device will be more functional once it 's released early next year
...
Like many of Apple 's other products , the Apple Watch appears to have a sealed back , which means the battery can not be replaced .

This suggests that the entire $ 349 -LRB- # 216 -RRB- device will have to be replaced , once the battery eventually deteriorates from constant charging and use .
...
Initial reports claimed the gadget would n't launch until February 2015
