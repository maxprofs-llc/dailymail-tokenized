...
The inflatable LED lighting called BLOW appears to float , can be made up to 33ft -LRB- 10 metres -RRB- long and is able to be folded so it is easily stored .
...
The inflatable LED lighting called BLOW -LRB- pictured -RRB- appears to float , can be made up to 33ft -LRB- 10metres -RRB- long and folded up so it is easily stored
...
The tubes are made from sheets of aluminium-coated polyethylene and are ` welded ' together using magnets and electrical current . They appear to float when attached to a simple metal stand -LRB- pictured -RRB-

A flexible LED stripe fits into a thin
tunnel on the translucent bottom foil of the lamp to avoid trouble with safety
certificates . The system can be used to create different shapes and sizes of lights such as a vertical strip -LRB- pictured left -RRB- and a square design -LRB- right -RRB-
...
He has now created tubes in different lengths with some measuring four metres , which weigh just 1.3 lbs -LRB- 600 grams -RRB- each .
...
When the novelty of the inflatable lighting has worn off , the lights can be deflated by inserting a straw into the valve and can be folded up and stored in a small space -LRB- pictured -RRB-
