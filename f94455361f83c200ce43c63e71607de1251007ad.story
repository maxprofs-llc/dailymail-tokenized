...
An experiment run by Esa on the ISS using a ` dummy ' human -LRB- shown -RRB- has found radiation levels for astronauts in space are less than thought . The findings suggest deep space travel for humans could be safe . Here the dummy is shown being put in a casing to simulate the spacesuit of an astronaut
...
Known as Matroshka , the legless torso consists of 33 slices of ` human matter ' each one inch -LRB- 2.5 cm -RRB- in thickness .
...
Back in October a study claimed sending people to Mars may be impossible due to an increased radiation risk from cosmic rays when the sun is less active during the solar minimum .

It 's thought that a predicted decrease in solar activity , which occurs every 11 years , will raise the levels of radiation astronauts are subjected to from cosmic rays on a deep space mission .
...
The research , published in the journal Space Weather and led by Dr Nathan Schwadron of the University of New Hampshire , found that a 30-year-old astronaut can spend about one year in space before cosmic rays raises the radiation-risk beyond safe exposure limits .

However , this new research by Esa could suggest the levels are safer than expected .
...
` One may say that we found open space to be a bit less hostile to humans than expected , ' said Dr Paweł Bilski , an Associate Professor at the Institute of Nuclear Physics of the Polish Academy of Sciences -LRB- IFJ PAN -RRB- in Kraków , Poland .
...
The mannequin on board of the International Space Station -LRB- ISS -RRB- , with thermoluminescent and plastic detectors inside its ` body ' , was also dressed in a ` poncho ' with additional detectors , simulating the personal dosimeters worn by astronauts .
...
The detectors were then returned to Earth to be analysed to make the findings , which could make the possibility of a manned mission to Mars more likely .
