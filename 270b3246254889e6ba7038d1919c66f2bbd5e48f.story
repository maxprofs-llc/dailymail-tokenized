...
` This -LSB- also -RSB- makes the water stronger -LSB- so it does -RSB- not break up as easily which gives you better shapes . Every day is different . When you start , you first have to get the initial impact .
...
Deep impact : As the droplet splashes into the water -LRB- pictred left and right -RRB- a pellet cuts through the artificially coloured liquid , which has fabric softener added to it
