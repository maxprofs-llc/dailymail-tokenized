...
Among the participants , 72 were using condoms , 57 were using an intrauterine device -LRB- IUD -RRB- , and 35 were using the ` rhythm method ' , in which a couple abstains from sex on the days pregnancy is mostly likely .
...
Lactobacillus -LRB- pictured -RRB- produce lactic acid and hydrogen peroxide , help the vagina maintain an average pH of 4.5 , comparable to the acidity of beer or tomato juice
...
Sexual activity can disrupt the balance of the vagina 's ecosystem , especially when semen -LRB- which has a pH of 7.0 to 8.0 -RRB- enters the mix , the researchers said .
