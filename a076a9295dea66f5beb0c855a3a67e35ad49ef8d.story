Microsoft is considering releasing a free version of its Windows 8.1 software in a bid to persuade customers to upgrade to the latest versions .

Reports claim a new version , called Windows with Bing , could be given away .
...
According to reports at The Verge , ` Microsoft is currently experimenting with a free version of Windows 8.1 that could boost the number of people using the operating system .

` Sources familiar with Microsoft 's plans tell The Verge that the company is building ` Windows 8.1 with Bing , ' a version that will bundle key Microsoft apps and services , ' the site claims .

The firm has already made major changes to Windows 8 in a bid to make it more appealing to consumers .

It is also believed to be planning to abandon its controversial 'til e ' start screen and reverting to the classic windows desktop every time a user switches on their PC , it has been claimed .
...
According to Russian developer known only as Wzor , the latest version now starts in the desktop rather than Microsoft 's tile system , called Metro .
...
Free version to be called ` Windows with Bing '
