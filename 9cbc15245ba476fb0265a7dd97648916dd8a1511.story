...
` Ultimately , these methods suggest that we can use `` big data '' from social media for remote monitoring and surveillance of HIV risk behaviours and potential outbreaks , ' said Sean Young , co-director of the Centre for Digital Behaviour at the University of California , Los Angeles -LRB- UCLA -RRB- .
...
less likely to use condoms , Centres for Disease Control and Prevention -LRB- CDC -RRB- said .
...
The study is the first to suggest that Twitter -LRB- pictured -RRB- can be used to predict people 's health-related behaviours and as a method for monitoring HIV risk behaviours and drug use , the researchers said
