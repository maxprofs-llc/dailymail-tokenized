...
The private company which turned failing Hinchingbrooke Hospital -LRB- pictured -RRB- in Huntingdon , Cambridgeshire , into an award-winner is set to pull out of running services , blaming soaring costs and funding cuts
...
It also said it was facing an imminent report from the Care Quality Commission -LRB- CQC -RRB- which it expected to be ` unbalanced ' .
...
` It has entered into discussions with the NHS Trust Development Authority -LRB- TDA -RRB- with the view to ensuring an orderly withdrawal from the current contract . '
...
Circle defended its running of the Cambridgeshire hospital -LRB- pictured -RRB- , saying that it had been transformed since the 2012 takeover when it was described as a ` basket case ' facing closure
...
2013 : Circle reduced the annual # 10million deficit to # 3.5 million in its first year , and made up the deficit with its own money
