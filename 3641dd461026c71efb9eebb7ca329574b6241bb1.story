...
However , this can continue even when a number is switched to an Android phone , without access to the service , meaning if anyone sends an iMessage to that number it does n't get converted to a text , and ultimately ends up lost in the ether .
