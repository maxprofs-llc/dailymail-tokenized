It does n't matter how many times Facebook updates its privacy and security features , the tools are still criticised for being too complicated to use .
...
Facebook knows that many people struggle with managing their privacy settings , and recently introduced a privacy checkup tool -LRB- pictured -RRB- to make the process more transparent . The system uses a blue dinosaur which guides Facebook users through three steps to navigate its maze of privacy settings
