...
Wakie -LRB- pictured -RRB- was created Armenian developer Hrachik Adjamian . To use Wakie , an alarm is set via the app for 7am for example , and at 7am , the user who set the alarm will receive a phone call from another member . This member can be from anywhere in the world
...
Each call is carried out over the internet , which means if a user is connected to Wi-Fi or a mobile network , they wo n't be charged for the call .
...
The app states this means there are ` no awkward goodbyes , no long conversations -LSB- and -RSB- calls are quick and casual . '
