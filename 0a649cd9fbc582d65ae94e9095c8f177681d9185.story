...
Individual licences for the RenderMan software typically cost $ 500 -LRB- # 300 -RRB- but from August , amateur animators can get hold of the non-commercial version of the program for free .

Anyone interested in downloading the software can register their interest via Pixar 's RenderMan site .

Scroll down for videos

The RenderMan software typically costs $ 495 -LRB- # 295 -RRB- and has been used by Pixar to render animations in Toy Story 3 -LRB- pictured -RRB- , Wreck It Ralph and Star Wars . From August , amateur animators can get hold of the non-commercial version of the program for free
...
Students , freelancers and developers can register their interest to receive the software via Pixar 's RenderMan site . RenderMan -LRB- pictured -RRB- is a visual effects program used to create 3D animations and graphics . As well as Pixar 's own releases , the technology has been used to create effects in Thor , Jurassic Park and SkyFall

Pixar is expected to release the latest version of RenderMan , used to create the aliens in Toy Story -LRB- pictured -RRB- at a computer graphics show in August
...
This means any renderings made using the software can be published , but ca n't be used for profit .
...
Pixar typically charges $ 500 -LRB- # 300 -RRB- for individual licences , but is making the non-commercial version for free from August