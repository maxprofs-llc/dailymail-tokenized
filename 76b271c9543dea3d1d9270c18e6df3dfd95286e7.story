...
Blippar does n't produce the content , it
...
Blippar does n't produce the content , it is the software that recognises the images and links that with a pre-programmed video , for example .
...
Google has banned facial recognition with its Glass product and MailOnline asked Mitra how he will guarantee users wo n't abuse the app to bypass these restrictions .

` Blippar is capable of facial recognition but we disable it by default , ' said Mitra .

` Brands ca n't turn pictures of people into Blippable images , for example , with the existing app and this will continue with Google Glass . '
...
The concept is similar to the technology seen in the film Minority Report -LRB- a still , pictured -RRB- . In a recent report , Juniper Research announced that the number of people using augmented reality globally is predicted to rise from 60 million , at the end of 2013 , to over 200 million by 2018

This is n't just a technology that companies can use to advertise their products , either . The Blipp Builder can be used by anyone on a web browser to turn a photo of anything , other than faces , into a Blippable image .
...
CEO assured MailOnline the technology can not be used to scan faces