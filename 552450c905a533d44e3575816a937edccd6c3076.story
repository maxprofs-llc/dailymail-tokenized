...
Earlier this year Terry Myerson , Microsoft 's Windows chief , explained how the new software will work on everything from a desktop computer to a smartphone - and even the firm 's XBox One games console
...
` It would n't be right to call it Windows 9 . '
...
The new software will also allow users on hybrid devices like the Surface Pro tablet will be able to jump between and keyboard and touchscreen modes , with Microsoft demonstrating how the interface will change as you do .
...
The firm announced the latest version of its Windows operating system , called Windows 10 , at an event in San Francisco . It will run on tablets , phones , desktop computers and even the firm 's Xbox games console .
...
Industry experts have been having their say on Microsoft 's latest operating system , Windows 10 , which has been announced at an event in California .
...
The new software is designed to bring together all of Microsoft 's different hardware , such as a the surface tablet -LRB- left -RRB- and the Xbox One -LRB- right -RRB- under the same software .
...
` They do n't have to learn any new way to drive . '
...
Although the new software wo n't be formally released until next year , analysts already consider its success crucial for Microsoft and new CEO Satya Nadella .
