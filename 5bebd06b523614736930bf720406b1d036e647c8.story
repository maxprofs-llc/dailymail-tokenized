...
Its makers stress that the app does n't offer a full diagnosis , and should n't replace medical advice , but it can identify skin lesions as high risk if they show signs associated with the disease .

Scroll down for video

SkinVision uses an algorithm that was developed using 4,000 images from 500 live dermatological evaluations - and has an accuracy of up to 90 % , compared to official medical results for the same lesions . Its makers stress it does n't offer a diagnosis , but can identify lesions as high risk if they show signs of disease
...
` Skin conditions , in general and skin cancer -LRB- melanoma in particular -RRB- , almost always have a cause related to lifestyle , ' said the firm .

The app costs # 2.99 in the UK and $ 4.99 in the US , plus a monthly subscription starting at # 2.99 -LRB- $ 4.99 -RRB- for one month , up to # 17.49 -LRB- $ 28 -RRB- for a year

` -LSB- Our -RSB- goal is to help change those lifestyles so that more people stay healthy and the ones that need treatment receive it in time . '
...
The # 2.99 -LRB- $ 4.99 -RRB- app was designed with dermatologists , but the firm stressed it should not replace medical advice from a doctor