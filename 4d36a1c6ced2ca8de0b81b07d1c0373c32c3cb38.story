...
The TorrX electric pump will work on the same principle as a pump used to inflate car tyres so users can set the desired PSI -LRB- pounds per square inch -RRB- , in order to keep balls at a specific hardness .
...
The TorrX electric pump will work on the same principle as a pump used to inflate car tyres so users can set the desired PSI -LRB- pounds per square inch -RRB- , in order to keep balls at a specific hardness . The device shows the pressure of a ball and buttons can be used to manually increase or decrease the PSI -LRB- pictured -RRB-
...
The pump is available to pre-order on Kickstarter from # 32 -LRB- $ 49 -RRB- , while the planned RRP will be # 52 -LRB- $ 80 -RRB- .
...
The 2014 World Cup in Brazil was the most scientific and technologically advanced football tournament ever seen , and included products from smart clothing that kept players cool to advanced boots that enhanced speed and skill -LRB- as illustrated in this graphic -RRB-
...
Used in every stadium , the system was able to tell the referee if a goal was scored within a second to an accuracy of 0.2 inches -LRB- 0.5 centimetres -RRB- , with the word ` GOAL ' transmitted to a watch on the referee 's wrist if the ball had crossed the line .
...
It is available to pre-order on Kickstarter from # 32 -LRB- $ 49 -RRB-