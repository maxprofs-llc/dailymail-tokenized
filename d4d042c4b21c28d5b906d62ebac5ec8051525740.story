...
The device , which costs $ 229 -LRB- # 144 -RRB- , claims to be the first Wi-Fi voice-activated assistant for the home , which helps individuals manage and control their devices , as well as set reminders .
...
The device , which costs $ 229 -LRB- # 144 -RRB- claims to be the first Wi-Fi voice-activated assistant for the home , which helps individuals manage and control their devices

Ivee 's Sleek is much like the HAL 9000 -LRB- pictured -RRB- computer imagined by Arthur C Clarke in his Space Odyssey series
...
A person might want to set a reminder and they can talk to the device , which will send a text message with the contents of their memo -LRB- pictured -RRB-

To give the hub a command , a user must first say ` hello Ivee ' and the device will then listen for clues when a person starts to talk . If they ask the machine to ` clean up , ' it can contact a smart vacuum cleaner to carry out the desired action -LRB- pictured -RRB-
...
The device is connected to a home Wi-Fi network and users can add gadgets connected to the internet , via a web dashboard -LRB- pictured -RRB-

The hub is designed to be placed near a bed as it also functions as an alarm clock and displays live content , such as the weather -LRB- pictured -RRB- stocks and news
...
The Californian engineers behind the device , which costs $ 229 -LRB- # 144 -RRB- claim it is the first Wi-Fi voice-activated assistant for the home
