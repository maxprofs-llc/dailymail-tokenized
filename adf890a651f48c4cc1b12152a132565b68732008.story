...
` I do n't generally comment on the
pros or cons of policy , but that just does n't make sense , ' Foster said
...
` These changes do n't take effect until 2014 , so we have time to review all possible cases to ensure Medicaid meets its mission of serving only the neediest Americans , ' said Erin Shields .

But Republicans already see a problem .

Former Utah governor Mike Leavitt said adding early retirees will ` just add fuel to the fire , ' bolstering the argument from Republican governors that some of Washington 's rules do n't make sense .
