...
MacWeb v2 .0 browser -LRB- 1994 -RRB-

This means it did n't have a web browser , could n't read web addresses and did n't even have an Ethernet port in order to connect it to Keacher 's router .
...
To connect to his home network , Keacher had to wire up his computer to a Raspberry Pi , pictured , and then connect the Pi to his router . This was necessary because the Mac Plus is so old it does n't have an Ethernet port , so could n't connect to the router directly

MacWeb 2.0 is not capable of reading web addresses and serving links and pages in the same way as modern-day browsers because it does n't recognise computer languages such as Javascript or CSS .
...
A Wikipedia page viewed through the MacWeb 2.0 browser . MacWeb 2.0 is n't capable of reading web pages because it does n't recognise computer languages such as Javascript of CSS . Instead , Keacher used a program that stripped the sites of this computer language and turned them into basic text versions
