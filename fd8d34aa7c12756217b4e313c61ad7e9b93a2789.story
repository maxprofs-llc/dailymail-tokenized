...
` We have rejected a # 600,000 bid , ' Kindberg told Sportsmail . ` We put Modou in the price range of # 1.5 m but it depends on the structure and sell-on clause . We also want to look after the player .
...
` We had a very encouraging report from -LRB- Bolton boss -RRB- Dougie Freedman about the player . We also have interest from Celtic , Middlesbrough and Swansea .
...
Barrow 's side Osterlunds value pacy Gambian striker at # 1.5 million
