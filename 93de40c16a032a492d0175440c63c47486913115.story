...
When the flat frog screen is n't being used as a touchscreen device or beaming images , it can be used with specially-created beer glasses , pictured , that have chips built into the bottom . These chips connect to the screen , which can then tell when the glass needs to be refilled
...
` We have n't been affected that much , ' he said . ` There is a lot of Chinese and Russian money about and you only need to drive through London to see the amount of scaffolding around houses . It 's these homes that tend to want new technology in some form or other . '
