...
Costs are : printing - 2.5 p per page ; ring binder - 75p .
...
-LRB- Spell the missing word in the sentence , heard through headphones -RRB-

Nadine was --------- that she had passed her geography examination .

Proposed maths paper :

-LRB- No calculator allowed -RRB-

The cost , # C , of advertising in a newspaper is worked out using the formula : C = 0.4 n + 0.75 where n is the number of words in the advertisement .

a -RRB- The cost of an advertisement is # 11.55 . How many words are in the advertisement ?

b -RRB- If I have only # 9.00 , how many words can I afford ?
