...
The coalition has sought to undermine Mr Balls 's pledge to raise # 2.5 bn for the NHS through a combination of the mansion tax , a a levy on tobacco firms and reducing tax avoidance by hedge funds by announcing its own # 3bn boost at the autumn statement . Critics also pointed out that revenues from these measures were unlikely to start flowing in until the middle of the next Parliament .
...
To raise the # 1.2 bn a year Labour predicts , experts say an average charge of # 11,000 a year will need to be levied .
