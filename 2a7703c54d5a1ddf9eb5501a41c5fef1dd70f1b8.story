...
The device uses a brainwave quantifying algorithm to monitor the wearer 's level of interest through a special headband the phone is attached to . It judges what the person if interested in on a scale of 1-100 and records a 5-second video clip if the user scores over 60 -LRB- pictured -RRB-

Neurowear is thinking of adding an extra ` effect function ' to its device -LRB- pictured -RRB- , which would automatically overlay filters and visual effects on video clips based on emotions
