...
Hello , I have a question regarding the mandatory USSID 18 training . The training states the following : -- -LRB- U -RRB- The Hierarchy of Governing Authorities and Documents is displayed from the highest authority to the lowest authority as follows : U.S. ConstitutionFederal Statutes/Presidential Executive Orders -LRB- EO -RRB- Department of Defense -LRB- DoD -RRB- and Office of the Director of National Intelligence -LRB- ODNI -RRB- RegulationsNSA/CSS Directives and Policies USSIDs SID Management Directives and Policies Office Policies -- I 'm not entirely certain , but this does not seem correct , as it seems to imply Executive Orders have the same precedence as law . My understanding is that EOs may be superceded by federal statute , but EOs may not override statute . Am I incorrect in this ? Between EOs and laws , which have precedence?Similarly , between DOD and ODNI regulations , which has greater precedence ? Could you please clarify?Thank you very much , Ed

Official response , sender 's name redacted , sent on Monday April 8 , 2013Hello Ed , Executive Orders -LRB- E.O.s -RRB- have the `` force and effect of law . '' That said , you are correct that E.O.s can not override a statute.In general , DOD and ODNI regulations are afforded similar precedence though subject matter or date could result in one having precedence over another . Please give me a call if you would like to discuss further . Regards , -LSB- name redacted -RSB- Office of General Counsel
