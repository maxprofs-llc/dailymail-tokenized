...
Carried by MP Margot James , who sits on a policy advisory board which is drawing up proposals for Prime Minister David Cameron , it reads : ` Apply conditions for parents on benefits -LRB- training or parenting classes -RRB- ' .
...
Ministers argue there is a problem with the enforcement of the current rules . Currently , # 1.3 million a year is raised from truancy fines . But almost half the total issued since 2004 went unpaid .
