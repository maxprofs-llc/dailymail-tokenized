...
First , that His Royal Highness knows one end of a snorkel from the other , and second , that he has n't done anything about his rapid hair loss .

In common with around three in ten men of his age , 32-year-old William suffers from male pattern baldness -LRB- MPB -RRB- and those pictures of him emerging from a swimming pool with the little hair he has left plastered to his head served to highlight the problem .
...
It happens when dihydrotestosterone -LRB- DHT -RRB- -- a hormone formed when the body metabolises testerosterone -- causes hair follicles at the front and top of the head to shrink , producing finer hairs and , eventually , no hair at all .
...
Hopefully , he wo n't be tempted to use Prince Charles 's solution -- the comb-over . Not only does it fail to disguise the royal bald spot , it has a habit of blowing around in high winds to create an alarming spiky halo .
...
In fact , minoxidil was first developed as a medication for high blood pressure , until researchers noticed it also thickened the hair . ` However , ' continues Jonny Harris , ` just because one vasodilator works with male pattern baldness does n't mean they all do . So no , these techniques wo n't work . '
...
The verdict : Dr Reddy explains that while Propecia -LRB- in use since the late Nineties -RRB- is roughly twice as effective at halting male pattern baldness , it can also -LRB- in around two per cent of men -RRB- cause side-effects , which include loss of libido , anxiety and depression .
...
The exact mechanism by which it works is n't fully understood , but it does help retain hair and slow the thinning process .

It can not be used on areas that are completely bald .
...
Whether you opt for the space-age iGrow helmet -LRB- # 665 -RRB- or a slightly less futuristic ` laser comb ' -LRB- around # 300 -RRB- , the principle is the same . Manufacturers claim these low - level laser therapies -LRB- LLLT -RRB- will re-energise and strengthen cells in the hair follicles , combating hair loss . Both are suitable for use at home .

Hitting the market in 2013 , the iGrow is a helmet -LRB- which even plays music while you use it -RRB- filled with red laser and LED light diodes . According to a study published by the American Society For Laser Medicine And Surgery , when used every other day for about four months , the treatment will increase hair growth by up to 40 per cent .
...
The verdict : Dr Reddy -LRB- along with most leading experts -RRB- is very sceptical that this approach will work without one of the proven anti-hair loss medications being used at the same time .
...
The verdict : Leading hair transplant surgeon Dr Bessam Farjo explains : ` One method is to take a thin block of skin from the back of the head -LRB- which contains many hair roots -RRB- and then have a team of technicians present in the theatre to isolate individual hair roots -LRB- surrounded by a small bit of skin -- referred to as a graft -RRB- which the surgeon implants into the bald area one at a time . This is Follicular Unit Transplantation , or FUT .
...
FUT can be performed in a day , but will leave a scar at the back of the head -LRB- which may prevent the patient shaving his head in the future -RRB- while FUE leaves no scars , but takes longer -LRB- around two days -RRB- and involves shaving the back of the head initially -LRB- in other words it wo n't work for a high-flying executive who has to be back in the office the next day -RRB- .
...
Dr Farjo and Dr Reddy agree that not everyone is a suitable candidate for transplant . Neither surgeon will accept men below 30 because hair loss patterns are unpredictable and expectations often unrealistic . They are also reluctant to work on the very elderly as hair thins naturally , regardless of MPB , and if there is n't enough hair at the back of the head to get good quality grafts .

Clinical trials are already underway . The dream is that scientists could use stem cells to generate new hair follicles in the laboratory . They 'd still have to be implanted , but they would n't have to be removed from another part of the scalp .

However , there are still multiple problems to be overcome . Follicles are complicated to generate -LRB- hence expensive -RRB- and the body is prone to reject large numbers of them .

The verdict : Dr Reddy says that , at the moment , rejection of cloned hair grafts is a major problem , which can be solved only with anti-rejection drugs -LRB- of the type used in organ transplants -RRB- .
