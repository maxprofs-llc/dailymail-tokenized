...
A standard tri-bar test pattern off the runway
at Walker Field , Maryland : These mysterious QR code-like patterns
painted across dozens of locations in the U.S. are used to calibrate
airborne and satellite cameras
...
A tri-bar test pattern on the Photo Resolution
Range at Edwards Airforce Base in California : California 's Mojave desert
is a resolution test target hot spot and is where many of the U.S. 's surveillance planes are tested

An expanded tri-bar array at Fort Huachuca ,
Arizona : The targets function like an optician 's eye chart , with the
smallest group of bars discernable marking the limit of the resolution
for the camera being tested
...
A tri-bar array at Eglin Air Force Base ,
Florida : The total number of the sites across the U.S. is unknown , but
it is thought they have been rendered obsolete by the emergence of digital systems

The report goes on to detail several other military bases and Nasa sites with testing grids of different styles and sizes , although it adds that the total number across the U.S. is unknown .

Despite their ubiquity , it seems that the tri-bar photo targets are increasingly becoming obselete thanks to the emergence of high-precision digital systems .

` The arrangement and spacing of the lines is not well suited for computer analysis -LRB- it 's not a continuous single row , but two or three rows of pairs -RRB- , and it has other frequency and modulation issues that make determining sharpness by digital means inaccurate , ' says the CLUI

` The Air Force officially cancelled MIL-STD-150A for photographic lenses in 2006 , without replacement . '
