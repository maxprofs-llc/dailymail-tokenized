...
MRI -LRB- magnetic resonance imaging -RRB- uses magnetism to build a picture of inside the body , while CT -LRB- computed tomography -RRB- uses radiation .
...
Roger Goss , of Patient Concern , said : ` It 's not surprising we ca n't afford modern equipment , after we negotiated a contract that enhanced doctors ' pay to such a degree all funds go on staff costs . '

The OECD figures come in its Health At A Glance 2013 report , which warned : ` If there are too few -LSB- MRI and CT -RSB- units , this may lead to access problems in terms of geographic proximity or waiting times . '
