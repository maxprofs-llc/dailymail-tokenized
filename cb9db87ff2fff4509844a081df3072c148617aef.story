...
The American Hospitality & Lodging Association and Marriott International asked the FCC to declare that a hotel operator can use equipment to manage its network even if it ` may result in ` interference with or cause interference ' to a -LSB- wireless device -RSB- being used by a guest on the operator 's property . '
...
` Any access point can be used to launch an attack against 's an operators network or threaten its guest 's privacy -LRB- for example by attempting to obtain guest 's credit card details or other personal information -RRB- .
