...
Researchers at at the Massachusetts Institute of Technology -LRB- MIT -RRB- Computer Science and Artificial Intelligence Laboratory -LRB- CSAIL -RRB- said their modular robots can adapt to different tasks and terrains .

The M-Blocks are cubes with no external moving parts , but are able to climb over and around aone another , leap through the air , roll across the ground , and even move while suspended upside down from metallic surfaces .
...
Each edge has two cylindrical magnets that are mounted like rolling pins so that when two cubes approach each other , the magnets naturally rotate so that north poles align with south -LRB- and vice versa -RRB- allowing any cube to attach to any other .
...
systems , an individual module can not move on its own . If you drop one of
...
The researchers -LRB- pictured -RRB- believe that ` armies ' of mobile cubes could temporarily repair bridges or buildings during emergencies , or raise and reconfigure scaffolding for building projects
...
They were developed by researchers at at MIT 's Computer Science and Artificial Intelligence Laboratory -LRB- CSAIL -RRB-
