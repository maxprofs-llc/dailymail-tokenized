...
CaseCam was created by Seattle-based Garett Ochs , who is currently working on a new design that will allow the mirror to be stowed facing inwards , so that it does n't get scratched .

The device is currently only compatible with the iPhone 5 and 5S .

If the Kickstarter campaign is successful , the case will sell for around # 25 -LRB- $ 40 -RRB- , but early-bird backers can get their hands on one for # 15 -LRB- $ 25 -RRB- .
