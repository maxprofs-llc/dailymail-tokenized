...
Her appearance was brief and it was clear that she was n't entirely comfortable being followed by the camera from KNSD-TV . However , she did offer thanks to her supporters when asked
...
var nbcLP ={ -RCB- ; nbcLP.aRandomNumber = Math.floor -LRB- Math.random -LRB- -RRB- * 10000 -RRB- ; nbcLP.currentPageLoc = encodeURIComponent -LRB- window.location.href -RRB- ; nbcLP.currentSiteLoc = encodeURIComponent -LRB- window.location.host -RRB- ; nbcLP.defaultWidth = 652 ; nbcLP.defaultHeight = 367 ; nbcLP.cmsID = `` 220059881 '' ; nbcLP.vidPid = `` n85_bUOjlAkt '' ; nbcLP.vidSec = `` TK '' ; nbcLP.vidSubSec = `` TK '' ; nbcLP.vidFrame = document.getElementById -LRB- `` nbcLP220059881 '' -RRB- ; nbcLP.vidFrame.style.border = `` none '' ; nbcLP.vidFrame.width = nbcLP.defaultWidth ; nbcLP.vidFrame.height = nbcLP.defaultHeight ; nbcLP.vidFrame.scrolling = `` no '' ; nbcLP.vidFrame.src = `` http://www.nbcsandiego.com/templates/nbc_partner_player?cmsID= '' + nbcLP.cmsID + '' & videoID = '' + nbcLP.vidPid + '' & width = '' + nbcLP.defaultWidth + '' & height = '' + nbcLP.defaultHeight + '' & sec = '' + nbcLP.vidSec + '' & subsec = '' + nbcLP.vidSubSec + '' & turl = '' + nbcLP.currentSiteLoc + '' & ourl = '' + nbcLP.currentPageLoc + '' & rand = '' + nbcLP.aRandomNumber ;
...
San Diego County Sheriff Bill Gore has been adamant that Hannah was an unwilling victim from start to finish . `` I ca n't make it any clearer , '' he said at a news conference Monday .
...
What remained : Firefighters found the bodies of Christina and Ethan Anderson covered with tarp , showing that they were killed before the fire that burnt down Jim DiMaggio 's Boulevard cabin -LRB- pictured -RRB-
