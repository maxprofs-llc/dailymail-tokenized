...
Called Word Map , the interactive guide -LRB- pictured -RRB- was created by Easyway Language Centre in Brazil . To use the map , type any word in any language into the search box and press Map It . As the words are mapped globally , the map reads each translation out loud . Coloured lines also connect countries with a common language

Called Word Map , the interactive guide was created by Easyway Language Centre in Brazil . If the tool above does n't work in your browser , use the original version .
...
` Taxi ' is ` taxi ' in many languages -LRB- Spanish highlighted . -RRB- It is shortened from ` taximeter ' , a tool used to measure distances and fares , and ` cabriolet ' that refers to a horse-drawn carriage . Taximeter comes from Latin for ` taxa ' , meaning ` tax '

The Word Map plots the official languages in each country , and does n't necessarily reflect the dominance of other languages in that region .
...
The map also reveals that despite its vast size , the official language of the US , as well as Hawaii , is English , or American English . It is n't until Mexico -LRB- shown -RRB- that the word for ` science ' , used as an example , changes into Spanish and ` ciencia '
...
On the map , Australia is listed as having no official language -LRB- pictured -RRB- , although English is considered the as the national language of the country
...
As a result , the word has n't been translated globally , and as the map shows , is written as ` internet ' in the various scripts .
...
The word ` internet ' is a portmanteau of English words ` inter ' , for reciprocal or mutual , and ` net ' for network . Considered a proper noun by many , the word is often capitalised , but the term has become so widespread - and is often used interchangeably with the word web - that many people use it as a noun instead . As a result , the word has n't been translated globally , and as shown , is written as ` internet ' in various scripts
