...
But , if the magnetic field reversal does n't happen in the next year or two as expected , that is confirmation that Voyager 1 has already passed into interstellar space .
...
` It is a signature that ca n't be missed . ` Ed Stone of the California Institute of Technology in Pasadena and NASA 's Voyager Project Scientist said ` It is the nature of the scientific process that alternative theories are developed in order to account for new observations .
...
Researchers say they have developed a test that could end the debate
