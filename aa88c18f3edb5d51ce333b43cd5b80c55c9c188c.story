...
A ghostly portrait of Schrödinger 's cat has revealed one of physics ' most bizarre theories : quantum entanglement .
...
Schrödinger 's cat is a thought experiment created by Austrian physicist Erwin Schrödinger in 1935 -LRB- left -RRB- . The latest experiment has allowed scientists at the Austrian Academy of Sciences have found a way to observe the cat without ever having to ` look ' at it using photons of light -LRB- right -RRB-
...
` How , in an entangled state , -LSB- this information -RSB- can be accessed by one photon . '
