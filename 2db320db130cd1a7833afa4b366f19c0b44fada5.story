...
Avoiding the area : A map from airline tracker FlightRadar24 , shows that a large number of planes -LRB- highlighted in yellow -RRB- have been diverted away from Ukrainian airspace
...
A spokesman for the UK Civil Aviation Authority said : ` The Ukrainian authorities are responsible for managing their airspace and the UK or other countries can not enforce airspace restrictions in the area .

` However , the CAA has previously issued advice to UK airlines on operating in this area and following this incident , Eurocontrol -LRB- the European air traffic control body -RRB- has issued advice to airlines to plan routes that avoid the area . '
