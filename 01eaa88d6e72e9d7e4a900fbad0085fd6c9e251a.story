...
The creators of inFORM -LRB- pictured -RRB- envision their innovation could be used to replicate objects remotely and even reproduce city maps , using 3D data . Here , a researcher show how he can move a ball on the table using his hands , which are read by nearby sensors
...
The machine is composed of sensors -LRB- from Microsoft 's Kinect -RRB- , a projector , the ` shape display ' bars in the table , pins and linkages , actuators -LRB- pictured -RRB- and a hefty computer
