...
Signal developed by San Francisco-based Open WhisperSystem uses a person 's existing number and contacts -LRB- pictured left -RRB- . The first time the app is used , a caller verifies their device using a one-time SMS code . During a call Signal then displays two random words on the screen of both users -LRB- right -RRB- to verify caller identities
...
These are used to verify who the two callers are , and to make sure people ca n't join the call in what 's known as a ` man-in-the-middle ' attack .
...
Signal is the first free voice call encryption app to launch on iOS . There are other apps available , namely Silent Circle 's Silent Phone and Silent Text -LRB- pictured -RRB- , but these services start at $ 12.95 -LRB- # 7.70 -RRB- per month

San Francisco-based Open WhisperSystems already makes RedPhone , which encrypts calls on Android devices -LRB- pictured -RRB-
...
It is also open source , and the firm encourages developers to audit the code and suggest improvements to make sure the code has n't been compromised or hacked by cybercriminals or organisations .

There are other apps available , namely Silent Circle 's Silent Phone and Silent Text , but these services start at $ 12.95 -LRB- # 7.70 -RRB- per month .
