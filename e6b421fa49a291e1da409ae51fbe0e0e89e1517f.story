...
The XAgent malware will run on Apple devices like the new iPhone 6 -LRB- above -RRB- even if they are not jailbroken
...
` Installing the malware into an iOS 8 device yields different results . The icon is not hidden and it also can not restart automatically .
