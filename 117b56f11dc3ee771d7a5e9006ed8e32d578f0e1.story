...
Probe : Jaganmohan Reddy -LRB- left -RRB- and his father Y.S. Rajasekhara Reddy , the late CM of Andhra Pradesh
...
The CBI pointed out that APIIC chief general manager -LRB- projects -RRB- T.L. Ramachandran had rejected the file sent by Acharya recommending the allotment of land , stating that the deal could not be struck at just ` 7 lakh per acre . Yet Acharya had ordered that the corporation give the ` inprinciple letter of allocation ' to the two companies at the same rate citing an approval from YSR .
