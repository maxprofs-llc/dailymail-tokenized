...
The report read : ` The -LRB- initial -RRB- incident was incorrectly graded and not `` tagged '' as domestic abuse : urgent grading would have been appropriate in this case .

` Attempts should have been made to contact Victim A -LSB- Ms Wightman -RSB- directly to check on her welfare when the address was visited in the early hours of that morning and there is no reference as to whether Victim A may have required medical attention . '

Ms Wightman reported Kemp 's violence to police in 2008 but authorities underestimated the risk he posed

It added : ` Officers -LSB- must be -RSB- reminded that when attending a domestic incident involving cross allegations they should fully investigate each allegation , examine whether justifiable force has been used in self-defence and evaluate each party 's complaint separately . '
...
Superintendent Helen Chamberlain , head of public protection for the police , said of the recommendations : ` The force has already implemented and resolved all but one , and the final one -LSB- relating to a database review -RSB- is currently undergoing development . '
