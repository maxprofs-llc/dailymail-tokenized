...
That Musk says in his tweet -LRB- shown -RRB- this is a software update seemingly rules out one theory , namely more of Tesla 's ` supercharger ' stations being added . However , the fact that it affects the entire Model S fleet may also pour cold water on the ` turn by turn navigation ' theory - as not all the cars have this ability
...
But aside from speculation , there is n't much that can be done except wait to see what exactly Musk will reveal on Friday .

Software updates to the Model S are n't unprecedented - in January , an update increased the speed of the top-of-the-line P85D via use of ` insane mode ' - enabling the car to go 0 to 60mph -LRB- 97km/h -RRB- in 3.2 seconds , compared to the usual 5.9 seconds . Shown is a still from a video where people tested out the feature
