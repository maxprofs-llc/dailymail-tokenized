...
If you do n't , Twitter is hoping to make things a little clearer with a new feature that has been spotted on its iOS app .
...
According to screengrabs taken by Wall Street Journal , select hashtags now reveal the full term underneath . For example , #OITNB is labelled ` Orange Is The New Black ' -LRB- pictured left -RRB- in reference to the Netflix show . Shortened terms , such as #manutd , which stands for Manchester United , are labelled too
...
This also includes common acronyms used regularly across social networks , such as #tbt for Throwback Thursday - referring to the day of the week users post old photos or make references to past event -LRB- pictured -RRB-

Although hashtags are used across social networks , they are synonymous with Twitter and have been criticised for being difficult to use . Twitter even has a support page -LRB- pictured -RRB- that explains what hashtags are , and how best to use them

Not all hashtags are decoded , and terms such as #MH17 -LRB- pictured -RRB- appear without explanation
...
Twitter , and other sites , often test features that are n't implemented .
