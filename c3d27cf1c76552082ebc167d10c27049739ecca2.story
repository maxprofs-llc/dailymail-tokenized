...
What Project X could look like : an early prototype of the interconnected maps that future cyber-warriors will use to prevent cyberattacks . This is n't exactly what the prototype looks like because Darpa is keeping the design a secret for security reasons . The prototype includes red ` target ' nodes as well as ` weapon packages ' and ` battle unit ' nodes
...
` You do n't necessarily know what spells were used to create that sword , right ?

` You just know it has these attributes and it helps you in this way .

` It 's the same type of concept . You do n't need the technical details . '
