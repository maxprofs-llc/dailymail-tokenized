...
An app called LookFor flashes a rainbow of colours to attract the attention of friends -LRB- illustrated -RRB-

The self-titled ` world 's dumbest app ' costs 78p -LRB- 99 cents -RRB- on iTunes and Google Play , where comments include : ` How has no one thought about this before ?! ' and ` So simple , so effective . '
...
Users simply pick a colour -LRB- pictured left -RRB- then send their missing friend a message , saying ` look for a blue flashing light , ' -LRB- illustrated right -RRB- if they have chosen blue as the colour of their digital beacon
...
It claims the app is the only friend finder that does n't rely on GPS , a data connection or any wireless signal , meaning it can be used anywhere , including in underground venues .

The app is fully functional , but having raised over $ 1,500 -LRB- # 1,000 -RRB- on the crowd funding site in May last year , Retroproof had vowed to add ` location-based push notifications , iBeacons and a slew of other great technologies ' .
...
Users then simply wave their phone , the screen of which has been turned into a flashing coloured light , -LRB- illustated left -RRB- until they attract a friend 's attention -LRB- right -RRB-
