...
The University of Southern California -LRB- USC -RRB- study , which was published in the International Journal of Geoinformatics used a custom-built app to examine how many people willingly and accidentally publicise their presence on Twitter .

Lead author Chris Weidemann , a graduate
student in the Geographic Information Science and Technology -LRB- GIST -RRB-
...
The data , generated by Twitter users and publicly available through Twitter 's application programming interface -LRB- API -RRB- and Google 's Geocoding API , was then processed by a software program , which mapped and analysed the data , searching for trends .
...
An increasing number of social media platforms -LRB- pictured -RRB- allow users to share their location . During the one-week sampling period of the study , roughly 20 per cent of the tweets collected showed the user 's location to an accuracy of street level or better
