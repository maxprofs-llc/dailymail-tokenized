...
The mail service 's 275million users were ` surprised ' on October 8 with the redesign and tens of thousands have complained about glitches and reduced functionality . Many simply do n't like the look and feel of the new product .
...
One user wrote : ` The only reason I use yahoo is for the tabs . If tabs are gone , then I will be gone . '

Another complaint : In their haste to create a streamlined interface for their email service , Yahoo designers somehow forgot to add a ` print ' button for users who need paper copies of their emails .
...
Users also complained that they can no longer sort their email by sender . One person says : ` That 's IMPORTANT functionality . I ca n't believe that such a feature was overlooked ! '
