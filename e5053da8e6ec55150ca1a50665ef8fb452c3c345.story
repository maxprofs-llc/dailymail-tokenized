...
The two drones , one a quadcopter -LRB- four blades -RRB- and the other a hexacopter -LRB- six blades -RRB- , work in tandem to move a target . The first sprays it with foam -LRB- pictured -RRB- , and the second then sticks to it before flying away
...
` We do n't copy nature , we use the same principles and implement them using the best of robotic engineering . '
