...
The trend does n't indicate that every name will be left or right-keyboard oriented , but that a general trend can be noticed .

The team computed the so-called ` right side advantage ' -LRB- RSA -RRB- for every name given to more than 100 babies from 1960 to 2012 according to the US Social Security Administration .
...
In the research the team computed the so-called ` right side advantage ' -LRB- RSA -RRB- for every name given to more than 100 babies from 1960 to 2012 according to the US Social Security Administration . The increase in the number of right-hand-key letters can be seen in this graph from the researchers
...
As most people are right handed , they pick names from the right hand keys of a keyboard according to the study -LRB- stock image shown -RRB- / And the researchers say the trend can be spotted in baby names picked from 1960 to 2012 , with the year 1990 starting the beginning of the ` Qwerty era '
