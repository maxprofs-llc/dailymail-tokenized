...
' I am directing ICE , ' Johnson wrote , ` to replace requests for detention -LRB- i.e. , requests that an agency hold an individual beyond the point at which they would otherwise be released -RRB- with requests for notification -LRB- i.e. , requests that state or local law enforcement notify ICE of a pending release during the time that person is otherwise in custody under state or local authority -RRB- . '
...
2014-Nov DOJ Memos Ending Secure Communities Program uploaded by MailOnline
