...
French pen maker BIC analysed 868,496 characters from handwriting from 112 countries to create an average typeface alphabet -LRB- pictured -RRB- . The alphabet can be explored by gender , age , country and handedness
...
Although the writing style between the UK and U.S , for example , is very similar across the entire alphabet , there are dramatic differences between Angola and American Samoa . In the latter -LRB- pictured left -RRB- the line through the letter ` F ' is wavy , while the style of the Angolan ` F ' -LRB- pictured right -RRB- is more fluid and curved

People in the education industry -LRB- pictured left -RRB- tend to write their letter ` G 's more neatly than service people -LRB- pictured centre -RRB- , while people in the traffic industry -LRB- pictured right -RRB- write more curved Gs
...
Hovering over each letter in the categories reveals the different shapes that contributed to the average letter -LRB- pictured left -RRB- . On the site 's homepage , these letters also show the name and location , where available -LRB- right -RRB-
