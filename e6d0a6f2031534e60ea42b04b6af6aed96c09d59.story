...
However , these findings were not confirmed by the ` gold-standard ' in evidence-based medicine , randomised controlled trials -LRB- RCTs -RRB- .
...
` Supplementation by exogenous anti-oxidants may well be a two-edged sword , ' the scientists wrote . ` These compounds could , in vivo -LRB- outside the laboratory -RRB- , serve as pro-oxidants or interfere with any number of protective processes such as apoptosis induction . '
