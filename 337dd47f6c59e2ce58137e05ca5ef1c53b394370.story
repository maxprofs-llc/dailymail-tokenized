...
The AdvicyDrive sensor monitors your heart rate while driving to determine how awake you are . If it detects a drop in heart rate , which suggests you 're dozing off , it sounds an alarm on a smartphone -LRB- illustrated -RRB-

When a person falls to sleep their heart rate drops by up around 10 to 30 beats per minute on average .

To detect the most subtle of these changes , AdvicyDrive uses digital photoplethysmography -LRB- PPG -RRB- - an imaging test used to detect changes in blood flow at the microvascular level on the skin .
...
To detect the most subtle of changes , AdvicyDrive uses digital photoplethysmography -LRB- PPG -RRB- - an imaging test used to detect changes in blood flow at the microvascular level on the skin . It shines a green LED onto the skin , and based on the variations in colour that are reflected back , the sensor can detect the heartbeat

The clip -LRB- pictured -RRB- can be fitted to a wristband but will also clip to a person 's underwear or clothes . It will work as long as its in contact with the skin . The sensor is currently under development , so these claims have not been put to the test , and the firm has launched a campaign on Kickstarter to fund the project

Last year , researchers from the Biomechanics Institute in Valencia , Spain unveiled the Harken system .

It measures the driver 's heart rate and breathing via a sensor system knitted into the seatbelt and seat cover . If the rates drop too much , a warning alarm goes off .

AdvicyDrive uses a traffic-light system to monitor the wearer 's heart rate . The app will ring an alarm when the rate reaches the ` red ' zone ' -LRB- shown -RRB-
...
It uses digital photoplethysmography -LRB- PPG -RRB- to track changes in blood flow
