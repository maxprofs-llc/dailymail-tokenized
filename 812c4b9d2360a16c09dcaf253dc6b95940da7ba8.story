...
Now two mathematicians claim to have ` proved ' that it did n't - it might not have an end , but the universe definitely had a beginning .
...
The universe IS expanding - so it ca n't simply have ` sat still ' forever . But some mathematicians thought it perhaps worked on a ` cycle '
...
This is measurable from Earth - and so the universe ca n't simply have ` sat still ' since the beginning of time .

However , three theories allow the universe to expand without requiring a ` beginning ' .

` There are , however , three popular scenarios which circumvent these theorems : eternal inflation , a cyclic universe , and an 'em ergent ' universe which exists for eternity as a static seed before expanding , ' say Mithani and Vilenkin .

The pair mathemtacially analysed the three scenarios and found that eternity can not exist in our expanding universe . There WAS a beginning , whether or not it was the Big Bang .
...
Put simply , the future could be eternal , but the past can not .

Albert Einstein : He was right about the expansion of the universe

Of the three ` theories ' of an eternal universe , the mathematicians say , ` Two of these scenarios are geodesically incomplete to the past , and thus can not describe a universe without a beginning . The third , although it is stable with respect to classical perturbations , can collapse quantum mechanically , and therefore can not have an eternal past . '

` Mithani and Vilenkin point to a proof dating from 2003 that these kind of past trajectories can not be infinite if they are part of a universe that expands in a specific way . They go on to show that cyclical universes and universes of eternal inflation both expand in this way . So they can not be eternal in the past and must therefore have had a beginning , ' says MIT 's Technological Review , which reported the research .
...
pressure-driven acoustic -LRB- sound -RRB- waves that passed through the early
universe .
