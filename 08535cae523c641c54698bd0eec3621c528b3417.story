...
The Cockpit Door Locking System -LRB- CDLS -RRB- according to the flight manual ` provides a means of electrically locking and unlocking the cockpit door ' .
...
According to the flight manual there are ` routine ' and 'em ergency ' access requests .
...
Unlocking the door i , in case of cockpit decompression -LRB- the door then opens towards the cockpit under differential pressure -RRB-
...
Lock : Once the button has been moved to this position , the door is locked ; emergency access , the buzzer , and the keypayd are inhibited for a preselected time -LRB- 5 to 20 min -RRB-