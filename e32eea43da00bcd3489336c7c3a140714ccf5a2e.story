...
In May last year , a committee was set up by Prime Minister David Cameron to examine privacy and free speech after
the controversy .

Details of an injunction brought out by Ryan Giggs , pictured here with his wife Stacey Cooke , was spread over the internet despite the court order banning the use of his name

Imogen Thomas outside the High Court in December , when Ryan Giggs accepted that there was no basis to accuse the reality star of blackmail
...
It added : ` Google and other search engines should
take steps to ensure that their websites are not used as vehicles to
breach the law and should actively develop and use such technology .

` We recommend that if legislation is necessary to
require them to do so it should be introduced . '
...
The committee heard from former Formula 1 boss Max Mosley , centre , who claimed he has spent # 500,000 trying to remove a video from the internet
...
The nature of the story can not be disclosed , but Mr Justice Lindblom said it contained ` sensitive personal information ' regarding which the boy was entitled to privacy .
...
It also urged the Attorney General to be
more willing to launch contempt of court claims against internet users
if they are suspected of breaching privacy injunctions online .
...
In a series of recommendations on the
future of press regulation , the committee said a reformed Press
Complaints Commission should have the power to fine newspapers and
determine the prominence of printed apologies .

It
urged advertisers to withdraw funding from newspapers and major blogs
that opt out of the reconstituted regulator , and threatened ` statutory
oversight ' from a body such as Ofcom if the industry can not agree a
credible package of reforms .

John
Whittingdale MP , chair of the committee , said : ` The committee spent
some time debating whether additional laws to clarify the right to
privacy were necessary or desirable .

` However ,
we concluded that the existing position , where each case is judged by
the courts on an individual basis , is now working reasonably well .

` We
are concerned that individuals with grievances about invasion of
privacy should have an alternative to costly legal action available to
them .

` It is clear that
media self-regulation under the PCC did not work . We therefore wish to
see a stronger self-regulatory system that is seen to be effective and
commands the confidence of the public . '

A
Google spokesman said : ` Requiring search engines to screen the content
of their web pages would be like asking phone companies to listen in on
every call made across their networks for potentially suspicious
activity . '
