...
Lost and found : With the Tile App , you can attach this matchbook-sized square any item , and track its whereabouts with Bluetooth via a smartphone app
...
It allows you to share your access to
Tiles with friends , and to log into your Tile app from anyone else 's
smartphone , and locate the Tile from there .
...
And if your lost object - a wandering
dog , for example , or a stolen bike - goes out of your own phone 's
150-foot Bluetooth range , you can set it as a ` lost item ' .
...
And even though the app uses the Cloud to alert you if your Tile is detected by other smartphones , this does n't give other people access to your account .
...
The Tile App links up your smartphone with a matchbook-sized square that can be attached to any object
