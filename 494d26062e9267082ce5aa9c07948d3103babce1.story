...
That is the view of the number-crunchers at The Economist , who have calculated the worth of each player 's goals , based on how crucial the goal was to the match result -LRB- and the subsequent gains from that result -RRB- , as well as the importance of the game .

Lionel Messi -LRB- left -RRB- and Cristiano Ronaldo -LRB- right -RRB- in action during last Sunday 's El Clasico duel
...
But the key facts are these . Messi 's -LRB- still fantastic -RRB- total of 86 goals over the period does not compare with Ronaldo 's superhuman 105 .
...
And if that sounds like gobbledegook , essentially this can be explained in simple terms : a goal in a match where the score is tied 1-1 in the final minutes yields more points -LRB- or aggregate value in cup ties -RRB- to his team than a goal scored in a match where the player 's team is already winning 3-1 .
