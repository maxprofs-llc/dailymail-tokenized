...
A designer recently created a $ 10 -LRB- # 6 -RRB- DIY microscope using wood , glass and a smartphone .
...
Once folded , there is room to place a sample slide , before these built-in stages are used to illuminate and magnify objects up to 2,000 x .

It can accommodate standard glass slides , 3-inches -LRB- 75mm -RRB- long , by 1 inch -LRB- 25mm -RRB- wide , but Prakash said the kits come with plastic slides to improve safety .

There are three stages in the paper - the optical stage , the illumination stage and the mask holding stage . Once folded , there is room to place a standard glass sample slide before these built-in stages are used to illuminate and magnify objects up to 2,000 x

These are a selection of images captured by the Foldscope including -LRB- pictured left to right -RRB- Plasmodium falciparum , Trypanosoma cruzi , Giardia lamblia , Leishmania donovani and E. Coli and Bacillus . The Foldscope can accommodate standard glass slides , but also come with plastic slides

The paper the Foldscope is built into does n't feature instructions ; instead it has a colour-coded key that helps anyone , speaking any language to build the Foldscope .
...
This diagram explains how Prakash Lab was able to make the Foldscope so affordable . Each of the parts , listed in the table in the top left-hand corner , costs less than $ 50 -LRB- 30p -RRB- . This image also reveals how the different components fit within the paper
...
It can provide more than 2,000 x magnification and weighs less than 8.8 g
