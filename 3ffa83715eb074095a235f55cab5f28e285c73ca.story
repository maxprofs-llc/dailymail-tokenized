...
Israel Institute of Technology researchers studied human retinas -LRB- image of an eye interior shown -RRB- . They looked at why cells in our retinas are wired the wrong way round . Light travels through a mass of neurons before it reaches the ` back ' . The research suggests the structure appears to enhance our vision

About a century ago , the fine structure of the retina was discovered . The retina is the light-sensitive part of the eye , lining the inside of the eyeball .

The back of the retina contains cones to sense the colours red , green and blue . Spread among the cones are rods , which are much more light-sensitive than cones , but which are colour-blind .
...
Researchers in Leipzig found that glial cells , which also span the retinal depth and connect to the cones , have an interesting attribute .

These cells are essential for metabolism , but they are also denser than other cells in the retina . In the transparent retina , this higher density -LRB- and corresponding refractive index -RRB- means that glial cells can guide light , just like fibre-optic cables .
...
This surprising result of the simulation now needed an experimental proof . With colleagues at the Technion Medical School , we tested how light crosses guinea pig retinas .

The back of the retina contains cones to sense the colours red , green and blue . Spread among the cones are rods , which are much more light-sensitive than cones , but which are colour-blind . Before arriving at the cones and rods , light must traverse the full thickness of the retina , with its layers of neurons and cell nuclei

Like humans , these animals are active during the day and their retinal structure has been well-characterised , which allowed us to simulate their eyes just as we had done for humans .

Then we passed light through their retinas and , at the same time , scanned them with a microscope in three dimensions . This we did for 27 colours in the visible spectrum .

The result was easy to notice : in each layer of the retina we saw that the light was not scattered evenly , but concentrated in a few spots .

These spots were continued from layer to layer , thus creating elongated columns of light leading from the entrance of the retina down to the cones at the detection layer .

Light was concentrated in these columns up to ten times , compared to the average intensity .
...
The cones are not as sensitive as the rods , so this additional light allowed them to function better -- even under lower light levels . Meanwhile , the bluer light , that was not well-captured in the glial cells , was scattered onto the rods in its vicinity .

These results mean that the retina of the eye has been optimised so that the sizes and densities of glial cells match the colours to which the eye is sensitive -LRB- which is in itself an optimisation process suited to our needs -RRB- .

This optimisation is such that colour vision during the day is enhanced , while night-time vision suffers very little .

The effect also works best when the pupils are contracted at high illumination , further adding to the clarity of our colour vision .



@highlight

Israel Institute of Technology researchers studied human retinas
