...
Now a new method has been uncovered which uses malware infected adverts on Yahoo to make computers into Bitcoin slaves .
...
Yahoo has confirmed that the breach took place last week and experts believe there were around 27,000 infections every hour the malware was live on the site
...
In this recent attack , the hackers used malware to exploit something known as ` Bitcoin mining ' . The mining process works on the premise that there are 21 million Bitcoins hidden across an internet-based network , which are expected to all be found by 2040
...
Experts estimate that these criminal networks could be generating as much as $ 100,000 -LRB- # 60,000 -RRB- each day .

The value of Bitcoin rose to over $ 1000 -LRB- # 613 -RRB- last year but is currently worth around $ 850 -LRB- # 520 -RRB- .
...
Users in North America , Asia Pacific and Latin America , as well as those using Apple Macs and mobiles , were n't affected , the group said .
...
` However , I do n't trust Java , so unless you absolutely need it , my advice is to uninstall it from your system . It seems like I see more zero-day attacks aimed at Java than anything else , the risk is n't worth it for me . '
