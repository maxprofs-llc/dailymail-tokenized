Angry birds game , which counts David Cameron and Dick Cheney as fans , worth # 1.2 billion
...
Game : Angry Birds is now on offer on Google + , if you 've have n't got an iPhone
...
Dveloped by Rovio , there are rumours that companies want to invest in the game which would make it worth an estimated # 1.2 billion .
...
` Games in Google + are there when you want them and gone when you do n't . '
...
If the person shows no interest in certain types of games , Facebook wo n't serve them updates in the newsfeed .
