...
VetiGel - a new plant-based haemophilic polymer -LRB- pictured -RRB- under development can stop the flow of profuse bleeding almost immediately . This could save the lives of people who would otherwise bleed to death
...
To make the gel , cell walls are extracted from a plant polymer and used like Lego Bricks . When the ` bricks ' are applied to a wound they reassemble to form a clot -LRB- illustrated -RRB- . It changes shape and colour when it interacts with the tissue
...
` You apply this -LSB- VetiGel -RSB- and not only will the bleeding stop within 15 seconds , it will stay stopped thanks to its high clot strength . '
