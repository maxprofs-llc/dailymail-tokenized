...
Researchers say that the huge discrepancy is due to problems with the Body Mass Index -LRB- BMI -RRB- , which does not distinguish between different body shapes .
...
` Global and Australian estimates of obesity have been based on Body Mass Index . Yet , as a measure of body weight for height , this technique does n't account for different body types .

` It does n't distinguish between fat , muscle or bone , which contribute to body weight differently for men and women , and for different age groups . '
...
` It means that an alarming number of young men are exhibiting the physical characteristics of older men , where muscle mass has been replaced by fat , ' she said .
