...
` This is a markedly different pattern of use compared to their peers in the continental U.S. , where teen e-cigarette use is less than half that rate and e-cigarette users are mainly also cigarette smokers -LRB- dual-users -RRB- , ' reported the team .
...
The investigators assessed risk status for three groups -LRB- non-users , e-cigarette-only users , and dual-users -RRB- on variables that predict future use of cigarettes , and found the e-cigarette-only users to have risk that was in between the never-smokers and dual-users .
