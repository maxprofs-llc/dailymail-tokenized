...
The images look similar to scans of a human brain
...
Astrophysicists at the University of California , Santa Cruz -LRB- UCSC -RRB- and the University of Minnesota came to this conclusion after running a number of supercomputer simulations at the Department of Energy 's -LRB- DOE 's -RRB- National Energy Research Scientific Computing Center -LRB- NERSC -RRB- and Minnesota Supercomputing Institute at the University of Minnesota .

They relied extensively on CASTRO , a compressible astrophysics code developed at DOE 's Lawrence Berkeley National Laboratory 's -LRB- Berkeley Lab 's -RRB- Computational Research Division -LRB- CRD -RRB- . Their findings were recently published in Astrophysical Journal -LRB- ApJ -RRB- .
...
And relevant for massive stars , photo-disintegration of elements , electron-positron pair productionand special relativistic effects .
...
The researchers say that this mixing should create a distinct observational signature that could be detected by upcoming near-infrared experiments such as the European Space Agency 's Euclid and NASA 's Wide-Field Infrared Survey Telescope .
...
` My work involves studying the supernovae of very massive stars with new physical processes beyond hydrodynamics , so I 've collaborated with Ann Almgren to adapt CASTRO for many different projects over the years , ' says Chen .

` Before I run my simulations , I typically think about the physics I need to solve a particular problem .

I then work with Ann to develop some code and incorporate it into CASTRO .

It is a very efficient system . '

To visualize his data , Chen used an open source tool called VisIt , which was architected by Hank Childs , formerly a staff scientist at Berkeley Lab .

` Most of the time I did my own visualizations , but when there were things that I needed to modify or customize I would shoot Hank an email and that was very helpful . '
...
Primordial stars between 55,000 and 56,000 times the mass of our Sun died unusually
