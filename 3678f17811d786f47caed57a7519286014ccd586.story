...
Researchers at Barcelona 's Institute for Advanced Architecture of Catalunya have designed a prototype structure that can change shape -LRB- shown -RRB- . When it is heated above 60 °C it expands and grows into a new form and holds its shape when it cools

The project is the work of students Ece Tankal , Efilena Baseta and Ramin Shambayati from Barcelona 's Institute for Advanced Architecture of Catalunya -LRB- IAAC -RRB- .

Their supervisors are Areti Markopoulou , Alexandre Dubor and Moritz Begle .

Called Translated Geometries , the project makes use of something called Shape Memory Polymers -LRB- SMP -RRB- to create the responsive architecture .
...
When the temperature is raised to 60 to 70 °C -LRB- 140 to 158 °F -RRB- , the prototype undergoes geometric deformations in an origami-like process .
...
While this means it only moves when it is heated , the team says it is an important goal towards architecture that can respond to its environment . The prototype -LRB- shown -RRB- is made of plywood , with embedded wires heating the various triangulated segments

Drones and gravity -LRB- shown -RRB- can also be used to pull it into different arrangements . When it cools it solidifies in the new position and flattens when heated again . While only a prototype for now the researchers say it could one day lead to houses that change with temperature

In addition they show how , when heated , the prototype does n't just expand - it can actually be moulded as well .
