...
Plants use a newly discovered ` language ' to ` speak ' to each other , research has revealed . They studied the molecular communication between a parasitic plant called dodder , and two host plants , Arabidopsis -LRB- pictured left -RRB- and tomatoes -LRB- pictured right -RRB-
...
The research could give scientists new insights into how to fight parasitic weeds that devastate food crops in some of the poorest parts of the world and in extreme cases lead to famine -LRB- illustrated with a stock image -RRB-

Ribonucleic acid -LRB- RNA -RRB- is a family of large biological molecules that code and decode information passed down from its DNA .
...
Professor Westwood has previously discovered that during this parasitic interaction , there is a transport of RNA -LRB- illustrated -RRB- between two species .
