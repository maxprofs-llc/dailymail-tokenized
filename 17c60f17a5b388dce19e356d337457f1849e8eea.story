...
Starting from the walls of the burial chamber , the Egyptians could then build ramps using the lighter , smaller rocks in zigzags -LRB- pictured above left -RRB- around the structure , placing these rocks on top of each other as they went in order to build the pyramid up in layers .
...
He suggested the ramps would have been built in the centre of the pyramid , or in a spiral 30 to 50ft beneath the outer skin -LRB- pictured centre and right -RRB- .
...
` Really these pyramids show a lot of innovation of how -LSB- the Egyptians -RSB- overcame problems , and how they resolved them in the next pyramid . '
...
` Some locals claim that these stones were stolen , but I ca n't see anyone wanting to climb that high to do that , ' said Peter James .
...
` When limestone heats up , it expands and it never goes back to where it starts . This would have caused the casing and the structure to warp and bend meaning the problem was all over the pyramid , so it could n't be foundations .
...
` Some locals claim that these stones were stolen , but I ca n't see anyone wanting to climb that high to do that , ' continued James .
