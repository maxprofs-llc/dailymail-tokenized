...
Currently codenamed Threshold , it is expected to include a ` mini ' Smart Menu and separate Windows for its controversial Metro-style 'til e ' applications .

Earlier this year Microsoft was forced to bring back its Start menu after users complained they were confused by its Windows 8 'til e ' interface .
...
It will have separate windows for Metro-style 'til e ' applications running on the desktop
