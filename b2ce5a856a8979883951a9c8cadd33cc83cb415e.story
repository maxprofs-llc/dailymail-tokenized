...
If the score reaches the minimum security threshold , the phone is unlocked . If it does n't the user is denied access and has to try again .
...
' -LSB- The device -RSB- may detect facial gestures associated
with various facial features .

Examples include one or both eyes -LRB- e.g. ,
for blinks , winks , etc. -RRB- , the mouth area -LRB- e.g. , for gestures including
smiling , frowning , displaying a user 's teeth , extending a user 's tongue ,
etc. -RRB- , the nose -LRB- e.g. , for a nose wrinkle gesture , etc. -RRB- , the forehead
-LRB- e.g. , for a forehead wrinkle gesture , etc. -RRB- , one or both eyebrows -LRB- for
eyebrow raise and compression gestures , etc. -RRB- , and various others . '
...
display pixel transitions -LRB- e.g. , contrasting colors -RRB- with respect to two
...
display pixel transitions only at its upper bound -LRB- relative to the
eyebrow -RRB- and lower bound -LRB- relative to the eyelash -RRB- . '
...
If it does n't the user is denied access and has to try again .

The patent does n't explain how many times a user can try to access the device before it is permanently locked , not does it say if there is a failsafe technique if the user ca n't get in .
...
A similar idea teased by Motorola during talk last year was a swallowable pill -LRB- picutred -RRB- . It contains a computer chip powered like a battery using the acid in the wearer 's stomach . Once swallowed the ` vitamin authentication pill ' creates an 18-bit ECG-like signal that can be picked up by mobile devices
