...
The company website states the ` LED luminaire -LRB- lighting -RRB- saves more than 50 % in energy while the addition of the Intellistreets PTM -LRB- Post Top Module -RRB- further enables a 25 % reduction in energy and an additional 3 year life extension of the light engine . '
...
` If -LRB- hacking -RRB- ever happened , the systems sends a warning and shuts down , ' Harwood said .
