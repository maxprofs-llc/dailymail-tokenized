...
Rare , vintage bottles of whiskey can cost anywhere up to $ 1.4 million -LRB- # 874,150 -RRB- and can be aged in oak barrels stored in cellars for years .
...
` And then it hit us . If the goal is for the whiskey to filter in and out of the wood to remove toxins , get infused with flavour , and pull out those rich colours , what if the barrel is n't the best design to achieve this process ? , ' they wrote .

Tony Peniche explained that wood barrels are used for containing whiskey because the wood is cut vertically so that capillaries are not exposed to the liquid , meaning that it does n't slowly seep out of the sides of the wood .

The sticks -LRB- pictured -RRB- have lots of grooves cut in them to increase the overall-surface area touching the liquid.They are intended to be placed in a bottle or decanter of cheap whiskey to replicate the taste of a more expensive bottle . The oak is cut horizontally to allow ` accelerated transpiration through capillary action '
...
Each stick can only be used once for maximum effectiveness and a two-pack is available to pre-order for $ 12 -LRB- # 7.50 -RRB- plus shipping .
...
Oak sticks are available to pre-order on Kickstarter from $ 12 -LRB- # 7.50 -RRB- for two