...
At present , men are given the prostate-specific antigen -LRB- PSA -RRB- test . It measures levels of a different type of protein , which are normally raised if a tumour is present .
...
` I hope that this research brings forward the day when I can say to patients , `` We know that your cancer does n't need treatment '' -- a crucial development that could spare thousands of patients from enduring arduous treatment with unpleasant side effects .
