...
The first gadgets : A -RRB- bone point from the
Middle Stone Age levels at Peers Cave . B-g -RRB- bone tools from the Still Bay levels at Blombos Cave ; b-e are bone awls ;
f-g are bone points . H-i -RRB- engraved lines on tools c and g. J -RRB- engraved bone
fragment
...
These were periods of many innovations including , for example , the first abstract art -LRB- engraved ochre and engraved ostrich eggshell -RRB- ; the first jewellery -LRB- shell beads -RRB- ; the first bone tools ; and the earliest use of the pressure flaking technique , that was used in combination with heating to make stone spear points and the first probable use of stone tipped arrows .

Engraved ochres from the Still Bay M1 phase at
Blombos Cave : A -RRB- Two groups of incisions , one on the centre and one
...
these lines . B -RRB- Two lines that cross perpendicularly on the top right
margin ; converging lines produced with a single lithic point . C -RRB- this
...
that cross them . D -RRB- three distinct sets of lines engraved on a natural
surface ; piece was then knapped and a part of the engraving removed . E -RRB- a
group of sinuous lines engraved on one face ; the opposite face is
highly scraped and engraved with a cross-hatched pattern . F -RRB-
...
` When Africans left Africa and entered Neanderthal territory they had projectiles with greater killing reach , and these early moderns probably also had higher levels of pro-social -LRB- hyper-cooperative -RRB- behaviour , ' said Curtis Marean , project director and Arizona State University professor in the Institute of Human Origins .
