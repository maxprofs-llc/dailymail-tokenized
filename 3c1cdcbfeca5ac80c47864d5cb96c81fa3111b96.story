...
Game on : Computers are teaching each other to play Pac-Man -LRB- pictured -RRB- which sees a player trying to gobble up pellets while avoiding four colourful enemies , thanks to clever algorithms developed by researchers at Washington State University
...
Pay attention : In the study , the scientists programmed their teacher agent to focus on action advice -LRB- shown in the text on the right of the screen -RRB- as well as giving it no advice so it could learn for itself

` As robots become more common , we want them to be able to learn quickly and any time one robot learns something we want to make sure that it can teach that information to another robot , because we do n't want this information to be lost , ' Professor Taylor said .
...
They said : ` As anyone with teenagers knows , the trick is in knowing when the robot should give advice . If it gives no advice , the robot is not teaching . But if it always gives advice , the student gets annoyed and does n't learn to outperform the teacher . '
...
Must try harder : The team , which was led by Matthew Taylor , Washington State University 's Allred Distinguished Professor in Artificial Intelligence , used virtual robots called agents to simulate the teacher and student relationship -LRB- illustrated -RRB-
...
Problems occur , though , when hardware and software do n't work in the new model and this approach can not be used in one of robotics long-term aims , which is to use robots to teach skills to humans , as we can not simply insert their hard drives .

Robots will be smarter than the most intelligent humans within the next 15 years , Google 's engineering head has predicted .

Computers will soon be able to learn from experience , tell jokes and even flirt , according to Ray Kurzweil , the company 's artificial intelligence -LRB- AI -RRB- expert .
...
Prophet ? Ray Kurzweil -LRB- pictured -RRB- predicts that the ` Turing test ' moment - when computers become cleverer than us - will be passed in 2029
...
` We want -LSB- computers -RSB- to read everything on the web and every page of every book , then be able to engage in intelligent dialogue with the user to be able to answer their questions . '
