...
However , the app adds a novel twist , as users can not see a friend 's picture until they send one back .

Scroll down for video

Facebook 's Slingshot app has begun rolling out internationally from today . It allows people to send messages to friends -LRB- pictured left -RRB- , but they can only view them if they send a message back . The app also allows people to react to an image -LRB- right -RRB-
...
sender . The recipient does n't have to send back a message to
view the response .

Slingshot works with both Apple and Android devices - on iOS 7 and Android Jelly Bean and KitKat .

A Facebook account is n't required to use the new app .

` Photos and videos that do n't stick around forever allow for sharing that 's more expressive , raw and spontaneous , ' said Facebook .

The app shows a pixelated preview -LRB- left -RRB- until a ` sling ' message is sent , at which point it is unlocked -LRB- right -RRB-
...
Users can not see their friends ' pictures until they send one back
