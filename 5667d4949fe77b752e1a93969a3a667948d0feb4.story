...
` However , we were conscious that to do justice to these well-loved tales would be an incredible challenge . It 's only now that our tools and technology have advanced sufficiently to enable us to create a LEGO Middle-earth that meets everyone 's expectations -LRB- including ours -RRB- . '
...
` As such the team are able to squeeze every last drop of processing power to ensure that the lighting , environments , audio -LRB- to name just a few -RRB- are as stunning as you 've already noted . '
