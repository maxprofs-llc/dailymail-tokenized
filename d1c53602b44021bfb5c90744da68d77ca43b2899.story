...
` Safety Car restarts will now be a standing start from the grid , ' it said . ` Standing starts will not be carried out if the safety car is used within two laps of the start -LRB- or restart -RRB- of a race or if there are less than five laps of the race remaining . '
...
Wind tunnel testing will be limited to 65 hours a week , from 80 , and Computational Fluid Dynamics -LRB- CFD -RRB- usage reduced .
