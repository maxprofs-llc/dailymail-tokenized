...
Researchers have studied the practicality of using free-form gestures -LRB- pictured -RRB- for access authentication on smart phones and tablets . With the ability to create any shape in any size and location on the screen , the gestures had an inherent appeal as passwords and were harder to copy by hackers
...
Most passwords today are in the form of text or a pin -LRB- stock image shown -RRB- , but future authentication for machines may be more possible with free-form gestures . Some modern devices like Android smartphones already employ a grid-based password system , while Microsoft 's Windows 8 has a ` picture password ' method
