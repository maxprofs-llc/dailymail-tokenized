...
A serum from the equine blood is injected into Zoe because it contains antithymocyte globulin -LRB- ATG -RRB- - an antibody which doctors hope will kick-start her immune system .
...
If it does n't work , her only option will be finding a suitable bone marrow donor to come forward and save her life .
...
` A transplant would secure Zoe 's life . Even if we do n't find a match , donors could save other people 's lives . '
...
The horse therapy reduces the number of white blood cells circulating in the bloodstream using drugs such as antilymphocyte globulin -LRB- ATG -RRB- and ciclosporin , which stimulate the bone marrow to restart blood cell production .
...
` If , as in this case , we can not find a match we use horse ATG , which has an 85 per cent survival rate . '
...
` It is a pretty intensive treatment and can result in serum sickness , but we can only carry out marrow transplants if we have a perfect match - it is essential for this condition , otherwise it wo n't work .
