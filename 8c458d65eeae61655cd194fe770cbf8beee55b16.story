...
` I 'm convinced that if we do n't regulate it properly - ie the technological ability to use millions of images we capture - there will be a huge public backlash .
...
He told the Independent : ` I do n't want the state to carry on and start pushing the boundaries . Let 's have a debate - if the public support it , then fine . `

` If the public do n't support it , and we need to increase the regulation , then that 's what we need to do . '
