...
The RSA delivers # 8.7 m a year to the regions for Welsh qualified players and the WRU has allocated # 2m of that to be spent on national dual contracts with an additional # 1.3 m coming from the regions .
