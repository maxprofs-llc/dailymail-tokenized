...
Scientists completed the largest whole genome study of a single class of animals to date by mapping the tree of life for birds . Avian genetic samples from Louisiana State University 's Museum of Natural Science , which has one of the largest vertebrate tissue collections in the world -LRB- shown -RRB- , were used for this study

The study also suggests that the earliest common ancestor of land birds , which include parrots and songbirds as well as hawks and eagles -LRB- stock image -RRB- , was a scaled predator
...
` What we 've learned from doing this whole-genome approach is that we can infer a somewhat different phylogeny -LSB- family tree -RSB- than what has been proposed in the past .
...
Frozen samples of muscle tissue from bird species -LRB- pictured -RRB- collected by the Smithsonian Institution were the source of DNA extracted in Duke University labs . The DNA was then sent to BGI in China for full genome sequencing

One report by Dr Ed Green , of University of California , and colleagues describes the sequencing of three crocodilian genomes - the American alligator 's , the saltwater crocodile 's -LRB- pictured -RRB- , and the Indian gharial 's - which represent birds ' closest living relatives
