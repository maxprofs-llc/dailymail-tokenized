...
` It can not be assumed that all existing arrangements between the Scottish NHS and the NHS in other parts of the UK would necessarily continue in their current form - for example , those whereby NHS Blood and Transplant allocates organs for transplant on a UK-wide basis . '
