...
A piece of music is composed based on the density , speed and shape of the clouds and is then played on a grand piano which has been modified with mechanical parts -LRB- pictured -RRB- hooked up to a computer
...
An art installation called Cloud Piano uses a camera -LRB- pictured -RRB- to take pictures of the sky . From this information , a discordant melody is created
...
The images are cut into 88 segments -LRB- pictured -RRB- by a computer programme called Max/MSP , which analyses the appearance of the clouds pictured in each of the pieces of the sky . They correspond to keys on the piano

Information about the cloud 's appearance is sent to a robotic device -LRB- pictured -RRB- that presses keys on the grand piano ` based on the movements and shapes of the clouds ' . This means that dense clouds are played loudly and light clouds are quiet
