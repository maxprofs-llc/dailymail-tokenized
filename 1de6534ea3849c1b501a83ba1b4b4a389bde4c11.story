...
Researchers from the University of Warwick found methylglyoxal -LRB- MG -RRB- , which is formed from glucose in the body , damages ` good ' High Density Lipoprotein -LRB- HDL -RRB- cholesterol , which removes excess levels of ` bad ' cholesterol from the body .
...
Researchers say that drugs and food supplements could be developed to control the damage to ` good ' HDL cholesterol by Methyglyoxal -LRB- MG -RRB- , formed from glucose in the body , which leads to an increased risk of heart disease
...
Supported by funding from the British Heart Foundation -LRB- BHF -RRB- , the researchers discovered that MG destabilises ` good ' HDL cholesterol and causes it to lose the properties which protect against heart disease .
...
Methyglyoxal -LRB- MG -RRB- is formed from glucose in the body , but is 40,000 times more reactive than glucose
