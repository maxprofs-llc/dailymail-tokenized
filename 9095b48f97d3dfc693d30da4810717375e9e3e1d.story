...
Cyborg Unplug can be operated in two modes The recommended mode is Territory Mode , disconnecting target devices , such as drones -LRB- stock image pictured -RRB- from selected networks owned and operated by the user . All Out Mode disconnects detected devices from any network they are associated with
...
The router also lets owners block specific devices , while allowing others . For example , during set up phase , owners can choose to allow smartphones to access the network , but not Google Glass devices -LRB- pictured -RRB-

Cyborg Unplug is n't a ` jammer ' . A jammer disrupts all signals within a given distance , while Cyborg Unplug detects and targets a specific device and only disconnects that specific gadget .

The firm said Cyborg Unplug is n't designed for use in cases where there is already strict control over who uses the local wireless network , in a home , for example .
...
Two models will be initially available , later this year , priced between $ 50 -LRB- # 30 -RRB- and $ 100 -LRB- # 60 -RRB-
...
Two models will be available , later this year , priced $ 50 -LRB- # 30 -RRB- and $ 100 -LRB- # 60 -RRB-
