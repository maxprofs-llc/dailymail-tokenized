...
Visitors to www.spacewarps.org are
given examples of what space warps look like and are shown how to mark
potential candidates on each image .

After identifying possible
candidates in images , participants can discuss them via an
online forum with other volunteers and experts , and create computer
models of their discoveries .

The final collection of space-warp
candidates will be published for both amateur and expert astronomers to
investigate further .

Anyone can participate in Space Warps project at the www.spacewarps.org site .
...
The first set of sky images to be inspected in the project is from the CFHT -LRB- Canada-France-Hawaii Telescope -RRB- legacy survey .
...
` Realistically simulated space warps are dropped into some images to train volunteers to spot them and reassure people that they are on the right track , ' said Dr. Anupreeta More , co-leader of the project at the Kavli Institute for the Physics and Mathematics of the universe -LRB- Kavli IPMU -RRB- , the University of Tokyo .
...
This is a bright blue ` quasi-stellar object ' behind a massive galaxy : it has been lensed into two images , one on either side of the lens galaxy

The image configuration in this case is a quad , with two images very close together
