...
Structural remnants : Two beams from the towers -LRB- left -RRB- and the ` survivors staircase ' -LRB- right -RRB- that helped hundreds out of the burning buildings shows the scale
...
Center is on display along with his mugshot -LRB- left -RRB- as is a window from
...
that became an emblem of remembrance . -LRB- An atheists ' group has sued , so
far unsuccessfully , seeking to stop the display of the cross -RRB- .
...
Interactive : An animation at left shows the path that the terrorists took on that fateful morning , while pieces of steel from the impact floors on the 96th to 99th floor -LRB- right -RRB- are shown directly above the visitors ' heads
...
Iconic images : The clouds of smoke -LRB- seen in a photograph at left -RRB- and the parallel bars of the building frame -LRB- at right -RRB- were among the most iconic references to the tragedy
...
Personal efforts : Quilts -LRB- pictured -RRB- and other objects made as memorials by New Yorkers are included in the exhibit , which will cost $ 24 for members of the public to visit
...
Pricey : The Museum -LRB- left -RRB- was built and funded entirely separately from the Freedom Tower . The museum and the memorial plaza above it cost a total of $ 700million to build
