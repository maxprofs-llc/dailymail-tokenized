...
It involved dropping the temperature of strontium monofluoride with lasers in a process known as magneto-optical trapping -LRB- MOT -RRB- .

At almost absolute zero -LRB- -273.15 °C or -459.67 ° -RRB- they are the coldest molecules ever achieved through direct cooling , representing a physics milestone .
...
The results could prompt new research into areas such as quantum chemistry . Magneto-optical trapping has become very popular with atomic physicists in the past generation - but only at the single-atom level . This marks the coldest recorded temperature for molecules -LRB- illustration shown -RRB- , groups of two or more atoms

Magneto-optical trapping involves holding molecules in place with lasers . In so doing the physicists were able to cool the molecules to a fraction of a degree above aboslute zero -LRB- artist 's illustration shown -RRB-
...
Pulses
of strontium monofluoride -LRB- SrF -RRB- were shot out from a cryogenic chamber
to form a beam of molecules , which is slowed by pushing on it with a
laser .
...
The
slowed molecules enter a specially-shaped magnetic field , where
opposing laser beams pass through the center of the field , along three
perpendicular axes .

This is where the molecules become trapped and subsequently cooled .

` Quantum
mechanics allows us to both cool things down and apply force that
leaves the molecules levitating in an almost perfect vacuum , ' Dr DeMille
added .
...
` We thought it would be best to start applying this technique with a simple diatomic molecule -LSB- those composed of only two atoms -RSB- , ' Dr DeMille said .
