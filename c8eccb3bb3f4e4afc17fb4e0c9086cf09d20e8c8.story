...
Realistic : A 3D model of a cancerous tumour has been created using a 3D printer . The model , which consists of a scaffold of fibrous proteins coated in cervical cancer cells , has provided a realistic 3D representation of a tumour 's environment . 3D printed HeLa cells in tumour-like configurations are pictured
...
Grid with great potential : A group of researchers created a model of a grid structure that measures 1cm squared and is made from gelatin , alginate and fibrin -LRB- pictured -RRB- to recreate the fibrous proteins that make up the extracellular matrix of a tumour . The grid structure is coated in Hela cells - a unique , ` immortal ' cell line
...
Learning by heart : Earlier this week scientists announced they hope to create a new heart for a patient using a 3D printer and their own cells . The organ could be created in just three to five years time and be transplanted in a human within the next decade . The printing of ` ventricle cylinders ' is pictured

The results also showed that the 3D model had more similar characteristics to a tumour compared to 2D models and in the 3D model the cancer cells showed a higher proliferation rate -LRB- the time between cell divisions -RRB- and higher resistance to anti-cancer drugs .
