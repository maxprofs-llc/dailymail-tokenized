...
It 's the first time that Google Now has been available on smartphones and tablet computers that are n't running on the latest version of Google 's Android software .
...
Like Siri , Google Now also is equipped with voice technology that allows it to respond to questions and interact with users , though it has n't shown the wit that amuses some of Siri 's users .

The Google Now app for iOS is n't as comprehensive as the Android app , which only works on devices running on the latest version of Android - known as ` Jelly Bean . '
