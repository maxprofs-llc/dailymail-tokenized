...
In this instance , # 58.6 m will go directly to the German state , with the remainder to a German charity that looks after terminally-ill children .
...
Settlement : Ecclestone paid # 60m to end the case , with # 68.6 m going directly to the German state and the remainder to a German charity that looks after terminally ill children
...
Ecclestone added : ` In the end what has happened today is good and bad - the good is the judge more or less said I was acquitted , and they -LRB- the prosecution -RRB- really did n't have a case .

` So I was a bit of an idiot to do what I did to settle because it was n't with the judge , it was with the prosecutors .
...
# 58.6 m of payment will go directly to German state , remainder to charity
