...
And with 4G technology built in , the concept car does n't need a phone to get online so can double up as a Wi-Fi hotspot for all passengers .

The Maserati -LRB- pictured -RRB- is on display at this year 's Mobile World Congress in Barcelona and uses Qualcomm technology to power its sensors , camera and on-board modems . It has 4G technology built in , so does n't need a phone to get online , and this means it can double up as a Wi-Fi hotspot for all passengers
...
Although the system can sync with smartphones and tablets - and uses a screen mirroring technology called MirrorLink - it is more advanced than Apple and Google 's systems because it does n't need one to work . Instead it comes with built-in apps and 4G .
...
The Maserati -LRB- pictured -RRB- is a concept but Qualcomm 's vice president for product management Nakul Duggal said it showcases the potential for connected cars and believes these kinds of systems will be in cars soon

The concept has a display that can be used with voice control , touch and hand gestures . By default , the screen displays map info , car controls -LRB- left -RRB- , music playback , and recent calls . The system syncs with phones using screen mirroring technology called MirrorLink -LRB- right -RRB- but also comes with its own mobile network

The Maserati is also kitted out cameras that provide an almost 360-degree view of the car and warn of impending collisions , obstacles and more . The rear-view camera can additionally be used for parking assist features -LRB- pictured -RRB- . This technology runs on BlackBerry 's QNX car platform
...
These include a light detection and ranging -LRB- Lidar -RRB- sensor that shows a forward-facing collision warnings up to 164ft -LRB- 50 metres -RRB- .
...
A set of ultrasonic and optical sensors near each wing mirror -LRB- pictured -RRB- spot pedestrians , cyclists , and obstacles in the blind spots , helping the driver make safer lane changes and turns

A ` digital instrument cluster ' - or screen behind the wheel - shows the driver information from all the car 's systems at a glance plus navigation details -LRB- pictured -RRB- . These details are updated in real-time and advanced map data plots the road ahead - even if it is beyond the view of the driver

The mirrors show real-time video footage to offer a wide field of view , plus a warning bar that goes from green -LRB- shown -RRB- to red when an obstacle approaches
...
This means , for example , that if a driver starts indicating right but it is n't safe to move over - if a cyclist is approaching for example , or they 're too close to a car - the strip will glow red .
...
Apple firm first toyed with an in-car system at its Worldwide Developer Conference in June 2013 . At that point it was known as ` iOS in the Car ' but following changes in the design team the system was unveiled at last year 's Geneva Motor Show , under the moniker CarPlay -LRB- Apple Maps on CarPlay pictured -RRB-

Elsewhere Google used its annual developer I/O in June to unveil Android Auto , a key feature of its latest operating system Android Lollipop . Android Auto works with any Android phone to show a user 's information on the dashboard -LRB- Google Maps on Android Auto pictured -RRB-
...
Lidar provides collision warnings up to 164ft -LRB- 50 metres -RRB- ahead
