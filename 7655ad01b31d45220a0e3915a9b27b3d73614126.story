...
A paper called ` Our high-energy planet ' says that decoupling our planet from the environment means we can consume more and more energy without damaging the environment . As we move to more cleaner forms of energy such as solar -LRB- shown -RRB- , we are beginning to decouple ourselves from environmental impact
...
Innovation is the key to reducing emissions while expanding energy access , the experts claim . For instance , in order to reduce energy poverty within their borders , China and India are pioneering the use of advanced nuclear generation -LRB- pictured -RRB- and carbon capture and storage -LRB- CCS -RRB-
...
generation and carbon capture and storage -LRB- CCS -RRB- .
...
The advancement of clean and low-carbon technology means we do n't to be so energy-conscious , say the researchers
