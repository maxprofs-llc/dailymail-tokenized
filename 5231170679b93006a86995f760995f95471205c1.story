...
Anki Drive is available now for # 179.99 -LRB- $ 199.95 -RRB- and comes with two cars , while each additional car costs an extra # 49.99 -LRB- $ 69.95 -RRB- .
...
According to chief executive and co-founder Boris Stofman , ` if you scaled it up to real-world size it would be equivalent to driving down a highway at 250 miles -LRB- 400 kilometres -RRB- per hour with a concrete wall a tenth of an inch from your windows , and staying within that wall . '
...
Up to four players can race around the track using one of several uniquely programmed cars -LRB- pictured -RRB- . Each of the cars have different attributes ; some are faster and more agile , while others have access to better virtual weapons that could be used to disable the cars of other players
...
Scalextrix -LRB- stock image shown -RRB- is a slot-car toy racing game created by Minimodels and now owned by Hornby . It was released back in 1957 and sees players use a controller with a throttle to alter the speed of cars on track as they followed rails around and race each other
...
` So we started with a game where we wanted to bridge the worlds of toys and video games . 'S ofman explains how the game , while simple at its heart , can be mastered by more experienced players to give entirely new experiences .
