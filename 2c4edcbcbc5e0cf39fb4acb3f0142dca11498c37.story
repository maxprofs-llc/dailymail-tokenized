...
Although video games spending is expected to grow by 10 per cent this year , only $ 4 -LRB- # 2 -RRB- in every $ 10 -LRB- # 6 -RRB- in the industry is set to come from disc-based games played on consoles and PCs .
...
Experts predict only $ 4 -LRB- # 2 -RRB- in every $ 10 -LRB- # 6 -RRB- in 2014 will come from console games . Disc-based games will account for just 41 % of all video games revenue , down from 68 % in 2009 , while online games will jump to 31 % and mobile will account for 28 % of games
...
` Disc-based games have suffered from the emergence of digital gaming and wo n't ever recapture the peak years of the PS2 and Wii generations , ' said Eric Smith , analyst at Strategy Analytics ' Digital Consumer Practice .
...
expected to grow by 10 per cent this year , only $ 4 -LRB- # 2 -RRB- in every $ 10
-LRB- # 6 -RRB- is set to come from disc-based games , played on consoles and PCs .
...
Mobile gaming is popular because the devices are portable and the games are cheap -- usually selling for less than # 3 -LRB- $ 5 -RRB- , or are free , but funded by in-app purchases .
...
` It 's important to note that the console manufacturers also considered going ` disc-less ' for this generation but determined the market was n't ready yet - so the removal of the disc drive is not necessarily indicative of a decline in the console market but rather a likely inevitable transition down the road , ' Inoyue continued .

` When you factor in download speeds , data caps , and limited storage space , the timing was n't right for disc-less gaming on a wholesale level .
...
` Thirdly , the companies are deeply committed to investing in the perpetuation of the console model . Aside from games , it 's a key -LSB- strategy -RSB- into the connected living room for Microsoft , Sony , Nintendo and perhaps others in future such as Amazon and Apple . '
