...
` It is n't your home , but because
...
` Landslides are naturally occurring events , we ca n't stop them happening but we can lessen the impact and we have been making improvements , not only to our processes but also through engineering . There are no overnight solutions to the issue but we are committed to a programme of on-going works to remedy the situation .

` We have invested # 3.7 m in mitigation measures on the A83 including protective netting , a new culvert and drainage system at the site of a previous landslide and geotechnical monitoring equipment .
