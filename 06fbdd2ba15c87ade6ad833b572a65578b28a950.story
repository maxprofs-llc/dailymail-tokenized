...
In truth , no body really knows , but the work conducted by scientists at the Laboratory of Molecular Biology in Cambridge can provide some clues .

They were able to create sequences of XNA that they could use to hold genetic information , copy it into strands of DNA and then copy back to a new XNA .

This is very similar to the behaviour of viruses , which transfer genetic information into cells , hijack the host DNA and then create more copies of themselves .

However , if life on other planets used this approach , it would still require DNA to help them replicate .

But the molecular machinery needed to do this would look unlike anything here on Earth . The researchers had to create a specially engineered enzyme to get this reaction to occur - one that does not occur anywhere in nature , on Earth at least .

Yet the scientists have also created XNA molecules that can assemble and fold themselves up spontaneously - much like naturally occurring DNA .

Their most recent work shows XNA can also behave like enzymes to trigger biochemical reactions .

This raises the prospect that XNA could also begin to replicate itself , a crucial step in creating organisms .

XNA has been shown to be far stronger and stable than DNA and so could result in life that is much more robust than here on Earth .

However , the tiny errors and mutations that occur when DNA is damaged are also essential for driving evolution .

This would mean that in an XNA-world , life would evolve far slower than on Earth and could still be fairly basic .
...
Two of the XNA enzymes created by the scientists at the Laboratory of Molecular Biology in Cambridge , which were able to join two strands of XNA together -LRB- left -RRB- and cut up strands of RNA -LRB- right -RRB-
