...
New mothers are up to five times more likely to have the condition than other women -LRB- posed by model -RRB-
...
` There is some debate as to whether post-partum -LRB- post-natal -RRB- depression is simply a major depressive episode that happens after birth , or its own disease with its own features , ' said co-author Dr Emily Miller , also from Northwestern University .
