...
The not for dividend company , which has ` members ' instead of shareholders receives # 3.5 billion taxpayer subsidy a year , which represents just over half its total income , with the rest from fare-payers or borrowings .
