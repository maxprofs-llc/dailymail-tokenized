...
O'Leary added : ` If we are going to put aircraft in Cyprus , we would need to have a Cypriot air operator 's certificate -LRB- AOC -RRB- so we could go from Cyprus into some of the Middle Eastern destinations .
