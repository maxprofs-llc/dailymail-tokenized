...
It can be used to film full-HD video but it is only able to create video footage from a 1920 x 1080 array meaning that it only has one photosite per output pixel so can not offer the same colour resolution as Canon 's EOS C200 professional video camera .
...
However , it is only able to create video footage from a 1920 x 1080 array meaning that it only has one photosite per output pixel so can not offer the same colour resolution of the EOS C200 .
