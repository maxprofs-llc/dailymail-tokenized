...
But this is n't a human testing out the security capabilities of homes ; rather , it 's a cat fitted with a gadget around its neck to see if pets could hack into Wi-Fi networks .
...
Gene Bransfield in Virginia used a siamese cat -LRB- stock image shown -RRB- called Coco to hack into his neighbours ' networks . The pet was fitted with a device around its collar to seek out vulnerable Wi-Fi . The device included a GPS device and hacking tools and cost less than # 60 -LRB- $ 100 -RRB-
...
The device strapped around the cat 's neck cost less than # 60 -LRB- $ 100 -RRB- and looked for an older form of wireless encryption that can be easily broken , known as WEP .
