...
Handball ! A team of five humanoid ` Drake ' robots -LRB- pictured -RRB- will compete as a team at Robocup 2014 , which will kick off in Joal Pessao on 21 July

Hi-tech : The robots -LRB- pictured -RRB- have all-player tracking , a new inertial motion unit , new gait design and can communicate with each other during games using Wi-Fi
...
Team spirit : The team from Plymouth University -LRB- pictured -RRB- is one of three to compete from the UK and the students ' humanoid robots are using some cutting-edge technology

A right character : While the team might not look exactly human , they do come with their own looks , with one flamboyant player sporting a monocle , top hat and moustache -LRB- pictured -RRB-
