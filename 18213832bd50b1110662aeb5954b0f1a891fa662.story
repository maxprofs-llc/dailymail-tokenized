...
Users effectively load money on to the band from their own debit or credit card via the bPay website and then make purchases up to a value of # 20 -LRB- $ 32 -RRB- on a single item .

They can top it up themselves online or arrange for cash to be automatically loaded if it falls below a set trigger point of , for example , # 5 -LRB- $ 8 -RRB- .
...
Barclaycard is issuing the 10,000 wristbands to mark the start of a new system of contactless payments on London 's public transport system . The bands are one of a number of new ways to pay , which include smart tags that can be stuck on the back of a mobile phone -LRB- pictured -RRB-
...
So-called contactless payment is n't new . Starbucks , McDonald 's , PayPal , Google and Square offer their own services , but only a small portion of customers use them .
...
` It 's a time that is n't quite here yet , but it 's not far away . Innovations like bPay band are bringing it closer every day . '
...
The bPay band can be linked to any UK Visa or MasterCard debit or credit card and used to ` touch and pay ' for transactions with a value of up to # 20 -LRB- $ 32 -RRB- wherever contactless payments are accepted .
...
They can be used for purchases of up to # 20 -LRB- $ 32 -RRB- for a single item