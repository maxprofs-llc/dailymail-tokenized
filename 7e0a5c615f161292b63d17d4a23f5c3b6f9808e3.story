...
The store 's e-commerce business has also picked up on the practice . Online ` details ' indicate when items will be delivered with a B-tag attached . ` Please note that this dress will be delivered with a black B-tag attached , with instructions for removal included . If the B-tag is removed , the dress can not be returned , ' reads an online description for a French Connection ` opal sequin ' dress .

The SoHo store associate told MailOnline that , for now , dresses are the only item at Bloomingdale 's to receive the B-tag . Bloomberg says that the retailer is ` using the tactic to combat a practice known as `` wardrobing '' -- buying clothes and using them once -- a form of return fraud . ' They say that the ` National Retail Federation estimates -LSB- `` wardrobing '' -RSB- cost the industry $ 8.8 billion last year . '
