...
Samsung showed off its curved screens -LRB- pictured -RRB- at the Consumer Electronics Show in January . Here you can see how the curved edge of the display is being used for buttons and a rolling message to maximise space
...
The new curved display is likely to feature on Samsung 's S or Note luxury handsets , or could be the first of a new line of smartphones , according to rumours . It is predicted the device will use an updated version of the company 's Youm technology , which is used for the Galaxy Round handset -LRB- pictured -RRB- launched last month

There are a number of companies working on curved screens . The Semiconductor Energy Laboratory has made a lightweight C-Axis Aligned Crystal -LRB- CAAC -RRB- material for this prototype smartphone , which has icons down its sides and allows images to ` spill ' round its corners . It also allows for rolling text down its sides

Samsung will hope to repeat the success of its Galaxy S4 handset released in April -LRB- pictured -RRB- which is responsible for more than 60 percent of its third quarter profit
