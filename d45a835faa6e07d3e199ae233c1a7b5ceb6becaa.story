...
To check , users can visit www.dns-ok.us . If you see a red background , your machine has been
infected , and while green signals good news , you could still be at risk .

You can also go to www.dcwg.org , run by the DNS Changer Working Group , a
collection of experts the FBI recruited to help with the problem .

The site includes links to
commercial sites that will run a quick check on the computer , and it
also lays out detailed instructions if users want to actually check the
computer themselves .

Once there , click on ` Detect ' and
scroll to ` Manually Checking if your DNS server have been Changed ' .
Click on the option for your system and follow the step-by-step guide .
