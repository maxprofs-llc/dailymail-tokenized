...
Geologists have come out in defence of carbon capture and storage -LRB- CCS -RRB- following concerns raised by leading climate scientists over its safety .
...
` That has n't happened with carbon dioxide disposal , but it has happened with dams on a tiny scale . '
...
` The IPCC report also does n't really cover the last three or four years of research , and with a new field such as CCS , that is crucial . '
...
Carbon capture and storage -LRB- CCS -RRB- has not yet been applied to scale and many barriers remain . Pictured is a Vattenfall employee at the carbon dioxide capture and storage facility in Schwarze Pumpe , Brandenburg , Germany
...
` Storing carbon dioxide underground is new and leaks are certainly possible -- we will need to put careful monitoring in place to make sure they are n't happening , ' said Jane Burston , Head of the Centre for Carbon Measurement .

` Most of the UK 's potential storage is under the sea though , so leaks are less a safety issue and more about ensuring our captured carbon is n't lost .
