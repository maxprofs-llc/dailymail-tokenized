...
Livr is a social network that is only available through an app , and users can only access that app when they 're drunk . It works with a breathalyzer , pictured , that plugs into the charging port of an iOS or Android device . To open the app , users blow on the breathalyzer to get a blood alcohol content -LRB- BAC -RRB- reading
...
' -LSB- We -RSB- think everyone is trying to put their best face forward and showing themselves as this perfect person - but no-one is perfect .
...
The Livr app is n't available for download yet , and the website claims it will be available from ` spring . '
