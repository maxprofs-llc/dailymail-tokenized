...
Now you see it : The lensless camera -LRB- left -RRB- is tiny compared to a traditional smartphone camera -LRB- middle -RRB- and pales in comparison to the size of a coin

It works by using a
tiny chip known as a CMOS -LRB- complementary metal-oxide-semiconductor -RRB-
...
This lensless camera works by using a tiny chip known as a CMOS -LRB- complementary metal-oxide-semiconductor -RRB- embedded in a paper-thin piece of glass .

As light hits the glass , the imager processes the light into an algorithm .

A traditional camera -LRB- top -RRB- relies on a multitude of equipment to take a picture , but the lensless camera -LRB- bottom -RRB- can create the same image with a paper-thin chip
...
` These sensors are so small they should find use in endoscopy , medical sensing , machine inspection -LSB- and -RSB- surveillance , ' Stork and Gill write in their research paper on the device .
