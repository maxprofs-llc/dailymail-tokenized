...
A Spanish study has shown that the light emitted by LED bulbs can damage the cells in the retina . Some experts are now calling for a filter to be fitted in the bulbs -LRB- file picture -RRB-
...
Incandescent bulbs -LRB- left -RRB- are being phased out in favour of low-energy alternatives such as CFLs -LRB- right -RRB- , but there are concerns about the safety of the new generation of so-called ` environmentally friendly ' lighting
