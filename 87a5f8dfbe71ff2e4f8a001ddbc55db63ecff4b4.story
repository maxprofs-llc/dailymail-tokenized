...
The effect can not be seen with the naked eye , so anyone who wants to try it at home will have to first get their hands on a camera capable of shooting at exactly 24 frames per second .
...
Optical illusion : The effect can not be seen with the naked eye , so anyone who wants to try it at home will have to first get their hands on a camera capable of shooting at exactly 24 frames per second

` The goal is to make sure the hose is touching the actual speaker so that when the speaker produces sound -LRB- vibrates -RRB- it will vibrate the hose , ' brusspup explains .
...
One of the top rated comments on the video 's YouTube page explains how it works . User necraduq explains : ` When the frequency of the speaker is the same with the frequency of the video frames -LRB- frames/sec -RRB- the camera actually captures the same frame everytime and thus the same water shape .

` You can see the change 1hz makes when filming -LRB- if filming is kept at the same rate 24fps -RRB- as this translates into a `` forward movement '' .
