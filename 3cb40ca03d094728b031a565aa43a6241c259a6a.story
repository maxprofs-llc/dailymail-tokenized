...
During research , 162 students drove in simulators and around a neighbourhood while using different voice-activated integration systems . Many of the test subjects found that the systems were unable to understand their requests . Apple 's Siri -LRB- stock image shown -RRB- was rated the most distracting
...
The voice-activated systems -LRB- shown being tested -RRB- were graded on a distraction scale of 1 to 5 , with 1 representing no distraction , and 5 comparable to doing complex math problems and word tasks . Chevrolet 's MyLink received the worst rating , 3.7 , among the infotainment systems
...
` The good news is that really well-designed systems offer us the possibility to interact in ways that are n't so distracting , ' Professor Strayer said .
...
Apple noted in a statement that researchers did n't use the company 's CarPlay or Siri Eyes Free , which are designed for use in cars .
...
Apple noted in a statement that researchers did n't use the company 's CarPlay -LRB- stock image shown -RRB- or Siri Eyes Free , which are designed for use in cars . However , Professor Strayer said researchers consulted with Apple before beginning the study and used a tweaked version of iOS 7
