...
The main waste products include a residual solid called draff , and a yeast-based liquid known as pot ale . Celtic Renewables has taken an industrial process developed to turn molasses and other sugars into chemicals , and fine-tuned it to convert these products -LRB- pictured -RRB- into acetone , biobutanol and ethanol

Following the successful fermentation of the draff and pot ale -LRB- distillery pictured -RRB- to create biobutanol , the solid residue left is separated to produce animal feed . Celtic Renewables said the feed has a high protein and is ` ideal for the cattle and dairy cow feed markets '
