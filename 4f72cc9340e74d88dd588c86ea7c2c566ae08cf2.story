...
Suing : Paris mayor Anne Hidalgo -LRB- above -RRB- announced in an interview on Tuesday that the city would be suing FOX News
...
Emerson then took the idea a step further by stating ; ` And they 're places where the governments , like France , Britain , Sweden , Germany -- they do n't exercise any sovereignty so you basically have zones where Sharia courts are set up , where Muslim density is very intense , where police do n't go in . '

Finally , Emerson wrapped the segment up by making the claim that Birmingham , England was an example of one of these zones , and that ` non-Muslims just simply do n't go in . '

FOX News ultimately issued corrections for these statements , as well as an apology .

Muslim myth : This in response to the network 's claim that Europe was filled with ` no go zones ' where non-Muslims were not allowed , which was first introduced by Sean Hannity -LRB- above -RRB-

Too far : A guest of Jeanine Pirro 's -LRB- above -RRB- show , Steve Emerson , even claimed that Birmingham , England was an example of a ` no go zone '
