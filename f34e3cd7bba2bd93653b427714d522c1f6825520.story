...
He told MailOnline : ` The study in question poses some interesting `` what if '' questions for researchers to ponder , and we should n't get carried away .
...
A new test that can diagnose Ebola in just 15 minutes has been approved by the World Health Organisation -LRB- WHO -RRB- .
...
The new method is less accurate than the Nucleic acid tests -LRB- NATs -RRB- that have previously been used but offers a far quicker way of identifying the disease .
...
` The new test is n't about saving the lives of infected people , but it can help in the long run by making it easier and quicker to detect Ebola outbreaks . '
...
But , they add , ` with phenotypic changes -LRB- physical or biochemical characteristics of the organism -RRB- in the virus , aerosol transmission ... involving droplets of various sizes from cases in relatively close proximity to uninfected persons remains plausible ' .
