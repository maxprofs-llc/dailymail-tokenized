...
Miss Dineage 's spokesman said she sent the cards for ` consolation or condolence ' when a ` formal letter would n't be appropriate ' .
...
` There needs to be something in Caroline 's capacity as an MP -LSB- for when -RSB- a formal letter would n't be quite right .

` Over the past couple of years we have had constituents that have passed away -- if someone has raised this with Caroline when Caroline is corresponding with them then when a formal letter would n't be quite right it 's a card to send instead .

` It is sort of in her formal capacity as MP . It 's when something that needs to be done , it is n't just a note of sympathy -- it wo n't just be a personal note . There will be something in her role as an MP , some information , some correspondence in there that is n't the card . '
