...
Ford 's European Research and Innovation Centre in Aachen , Germany is working on a car seat that can detect heart attacks -LRB- shown -RRB- . The device uses six embedded sensors to monitor heart activity . It can then work out through clothing if someone is having a heart attack

The project is being undertaken by Ford 's European Research and Innovation Centre in Aachen , Germany and Rheinisch-Westfälische Technische Hochschule -LRB- RWTH -RRB- Aachen University .
...
Used in medicine for more than a century , the Electrocardiograph -LRB- ECG -RRB- is a method for monitoring the activity of the heart through sensors that detect its electrical impulses .
