...
Last month , Texas-based internet cartographer and computer scientist John Matherly used software to ` ping ' every web device on the globe , and used the signals to create a map -LRB- pictured -RRB- demonstrating the technology 's global reach

Last year , Dr Graham and Mr De Sabbata used data from analytics firm Alexa to map the largest websites around the world -LRB- pictured -RRB- . Google topped the list , in 62 countries , Facebook was the second most visited site globally , in 50 countries , while third place , China 's Baidu search engine , was popular in just two countries
