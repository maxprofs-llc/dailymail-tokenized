...
Cognitive scientists from Indiana University taught a robot -LRB- pictured -RRB- to associate the name of an object with its location , while sat with a certain posture . When the target and another object were placed in the location , and the robot was positioned in a different way , it failed to recognise the object
...
This experiment was replicated using children aged 12 to 18 months -LRB- stock image -RRB- and the researchers noticed only ` slight differences in the results . ' Like with the robot , the infants failed to recognise objects if their position and posture changed , or the object was moved
...
` This study shows the body plays a role in early object name learning , ' lead author Professor Linda Smith said . ` The creation of a robot model for infant learning -LRB- iCub pictured -RRB- -RRB- has far-reaching implications for how the brains of young people work '
...
A video shows iCub playing a game of paddle war -LRB- pictured -RRB- -- a game where two players each hold a paddle and try to score goals using a digital ball , while stopping their rival from scoring
