...
HideMyPhone ! -LRB- HMP -RRB- lets people use their current phone as if it had a different number , manage as many numbers as they want and remove all traces of call and message history at the press of a button .

The app can also be password protected to keep others from seeing what 's been said .

HideMyPhone ! -LRB- HMP -RRB- can be used on multiple devices and there is also no limit to the amount of numbers -LRB- selection pictured right -RRB- a user can rent . An average 30-day package costs # 2.29 in the UK and $ 2.99 in the US , and numbers can be bought from Brazil to Japan , across Europe and New Zealand among others -LRB- left -RRB-

It was developed by London-based virtual private network -LRB- VPN -RRB- provider HideMyAss !
...
When abroad , this could end up costing a substantial amount of money in data . Although the firm said people can choose to forward calls to a landline and this does n't require a web connection .
...
Numbers can be renewed but if a user does n't renew a number they lose it .
...
The firm imagines the service being used when giving numbers out at a bar or when travelling abroad -LRB- illustrated -RRB- Private numbers could also be used to give to companies to avoid being bombarded by sales calls . Numbers are rented in the same way that phone providers acquire lists of numbers for their customers
...
HMP ! -LRB- pictured -RRB- also comes with a free anonymous Instant Messenger service , a PIN protection service and a self-destruct button for call history
...
Although the firm said people can choose to forward calls to a landline and this does n't require a web connection .

The service does have the potential for abuse and could be used to carry out illegal activity .

But HMA told MailOnline : ` Hide My Phone ! has been created to keep its users private and secure - it does n't enable illegal activity any more than the abuse of pay-as-you-go handset might do .
...
The app is free , but the service is n't and numbers start at # 2.29 -LRB- $ 2.99 -RRB- in the US -RRB- plus individual costs for calls and text messages