...
Security researchers have uncovered a major flaw that affects Android 's KeyStore - part of the system responsible for encrypted data and cryptographic keys . Google has patched the issue in Android KitKat 4.4 -LRB- pictured left -RRB- , but vulnerability still affects older software releases , including Android Froyo 2.2 -LRB- pictured right -RRB-
...
Google has designed Android so that any installed apps need to be ` digitally signed ' with a certificate -LRB- pictured -RRB- . This certificate has a private key that is stored by the app 's developer . The flaw in this system means attackers can execute code to apps and steal keys on banking , and other , sensitive apps
...
In theory , because banking apps ask for passwords every time they are used , and have added security measures , they are more secure than other apps , for example . But , this does n't mean they are impenetrable .
