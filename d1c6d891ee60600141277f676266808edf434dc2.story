...
Apple 's proposed system tracks the movement of the phone to determine whether it is being used , or is placed flat on a table -LRB- flow chart shown -RRB- . The screen would n't need to be enabled . Instead , once the phone is moved and positioned in front of the face the camera would begin scanning for a face

Android Lollipop users already have an almost identical feature known as ` Trusted face ' -LRB- left -RRB- in the Smart Lock menu . Once the screen is enabled and the camera is held in front of the face , the screen automatically unlocks . The face icon between the Whatsapp and Chrome logo -LRB- right -RRB- shows the feature is enabled
...
` Trusted face ' and Smart Lock are extensions of the Face Unlock feature that was launched on Android Ice Cream Sandwich -LRB- pictured -RRB- . This relies on the user pressing the power button to enable the screen
...
Phone makers are looking for alternative ways to secure devices while making them faster and more convenient to open . For example , Fujitsu recently demonstrated its iris scanning prototype that lets people access phones , apps and online accounts by staring at an infrared sensor -LRB- illustrated -RRB-
