...
The company recommends a towing speed around 2-4 knots , -LRB- 2.3 mph to 4.6 mph -RRB- which can be achieved by a boat with a small motor .
...
By holding onto these wings the user is pulled along at anything from two to four knots , -LRB- 2.3 mph to 4.6 mph with a scuba mask being the only other piece of gear required to create a sense of underwater flying .
...
The Subwing -LRB- pictured -RRB- has two wings and is connected by a flexible component that allows the device to be twisted so that users can steer and perform tricks
...
Simon Sivertsen -LRB- pictured -RRB- has created a clever device with two wings that is towed along by a boat to enable a person to be pulled along underwater while twisting , turning and performing acrobatics
...
The device -LRB- pictured -RRB- is attached to a boat by Dyneema rope - the world 's strongest rope - and features two wings which can be rotated individually to control movement . By twisting them in certain ways , users can perform acrobatics , including spinning

The 20-year-old came up with the idea for Subwing -LRB- pictured -RRB- in 2010 during a sailing trip to the Mediterranean
...
Beginners will typically spend between 10 and 15 seconds underwater at a time , diving to around three metres - but with more training and practice users can go much deeper and for longer -LRB- pictured -RRB-
...
Device costs from # 296 -LRB- $ 490 -RRB- and users can select lighting and video camera accessories
