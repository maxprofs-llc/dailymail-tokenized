...
pre-orders by phone only , for up to two weeks in advance . -LRB- For
...
Long lines : Instead of waiting in the long lines that start outside the bakery as early as two hours prior to opening -LRB- pictured -RRB- , Ms Klum was lucky enough to secure a spot on the pre-order list
