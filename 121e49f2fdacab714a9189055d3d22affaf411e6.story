...
Following powerful volcanic eruptions , large amounts of sulfur dioxide deposit themselves in ice cores buried deep within the Antarctic .
...
Although the study plots earlier events , the researchers do n't know exactly what these explosions were .

Researchers studied records of global ice core sulfate data collected from Antarctica . In total , the study looked at 26 ice core records collected in an array of 19 sites from across Antarctica . Samalas was the most explosive eruption , and it took place in 1257 in Indonesia 's Mount Rinjani 's -LRB- pictured -RRB-

The scientists , led by Michael Sigl and Joe McConnell of Nevada 's Desert Research Institute -LRB- DRI -RRB- , studied 26 ice core records from 19 sites across Antarctica .
...
Powerful volcanic eruptions are one of
the most significant causes of climate variability in the past due to the large amounts of sulfur dioxide they emit .

This leads to the formation
of microscopic particles known as volcanic sulfate aerosols .

These
aerosols reflect more of the sun 's radiation back to space and ultimately cool the
Earth 's temperature .
...
Based
on the timeline , however , it 's possible to estimate what these events
may have been .

For example , the fourth most powerful eruption took place
in around 674 AD , which could have been the Pago event in Bismarck or
the eastern Alaskan eruption in Mount Churchill believed to have take place around 700 AD .
...
Based
on the 450 AD date of the eighth place event suggests it was Ilopango
in Central America , ninth appears to have been the Grímsvötn and Laki eruptions in Iceland around 1785 .

While tenth place happened shortly before Samalas and
could have been an earlier eruption of Mount Rinjani , Indonesia .

Past volcanic events are measured using sulfate deposition
records found in ice cores , and have been linked to short-term global and
regional cooling .

The latest research brought together an array of ice core sulfate
data in the world , including the West Antarctic Ice Sheet -LRB- WAIS -RRB- Divide
ice core - said to be the most detailed record of volcanic sulfate in the
Southern Hemisphere .
...
A Desert Research Institute scientist examines a freshly drilled ice core in the field before ice cores are analysed in DRI 's ultra-trace ice core analytical laboratory -LRB- left -RRB- . Locations of Antarctic ice core sites used for volcanic sulfate aerosol deposition reconstruction are pictured right

Topping the list was the eruption at Samalas , Indonesia in 1257 , followed by the Kuwae event of 1452 , and Tambora in 1815 .

Most notably , the research found that the
two largest volcanic eruptions in recent Earth history deposited 30 to 35 percent less sulfate in
Antarctica , suggesting that these events had a weaker cooling effect on
global climate than previously thought .
...
Such
model simulations underpin environmental policy decisions including
those aimed at regulating greenhouse gas and aerosol emissions to curb
...
An ice core section -LRB- picutred -RRB- is simultaneously analysed for a variety of elements and chemical species in DRI 's ultra-trace ice core laboratory while slowly melting the ice on a heated melter plate
...
This new record also builds on DRI 's previous work as part of the international Past Global Changes -LRB- PAGES -RRB- effort to help reconstruct an accurate 2,000-year-long global temperature for individual continents .

Simulations of volcanic sulfate transport performed with a coupled aerosol-climate model were compared to the ice core observations and used to investigate spatial patterns of sulfate deposition to Antarctica . The third most explosive event took place at Tombora in Indonesia -LRB- pictured -RRB- in 1815
