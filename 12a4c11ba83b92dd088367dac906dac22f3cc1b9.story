Apple has confirmed a bug in its new iOS 8 has meant users can not automatically sync their health data to the firm 's new Health app .
...
The new Health app on iOS 8 features a dashboard -LRB- pictured -RRB- showing all the user 's health and ﬁtness data . However , the firm was today forced to delay apps using the service from being distributed .
...
Developer Brian Mueller of Carrot Fit said via Twitter that his app had been removed from the App Store because HealthKit was n't ready for launch .

Later he said the service would n't be ready for the rest of this week .
...
HealthKit feature designed to allow users to easily see in one place all their health related data , and to share it with doctors

@highlight

Health app is still in iOS 8 - but can not sync with apps to get data
