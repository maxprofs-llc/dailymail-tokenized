...
` Defendants -LSB- the State of Connecticut -RSB- had a duty to use reasonable care to keep its property in a condition that did not endanger motorists like the Stavola family , ' it continues .

` As part of that duty , -LSB- they -RSB- also had a duty to inspect and/or ensure that the trees on its property were maintained in a reasonably safe condition . '
...
` -LSB- This -RSB- could and should have been avoided , if the Department of Transportation had simply done its job , ' the family 's lawyer wrote to the claims commissioner . ` It did n't and two people are dead . '
