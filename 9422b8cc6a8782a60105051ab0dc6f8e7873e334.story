Monkeys in the wild not only love watching videos , but they also tend to copy the behaviour seen on screen , according to a new study .
...
When scientists showed marmosets footage of a monkey opening a box to get a banana , they were able to replicate what they saw and open the box themselves , according to a new study
...
Monkeys can use symbols to add , researchers have found .

Experts say the discovery could give new insight into the evolutionary origins of our ability to count .

The found rhesus monkeys can not only differentiate between symbols but also add the values of two symbols at a time with 90 % accuracy .

Margaret Livingstone , a neuroscientist at Harvard University Medical School , led the study in the journal PNAS .

The team developed a series of tests for rhesus monkeys , which diverged from humans roughly 25 million years ago .

Given the choice of two different symbols , the monkeys chose the symbol that represented the larger reward with up to 90 % accuracy , suggesting that the monkeys had learned to assign specific values to the 26 distinct abstract symbols .

` The monkeys demonstrated the ability to not only differentiate between the symbols but also to add the values of two symbols at a time , ' the researchers wrote .
...
The study was undertaken in the jungles of Pernambuco in Brazil
