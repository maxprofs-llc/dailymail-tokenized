...
Most websites that use voice recognition also use HTTPS secure servers , -LRB- a server room is pictured -RRB- which means that Google Chrome does not have to ask permission every time it wants to run voice-recognition software . This means that cunning criminals could potentially tap into the feature to invade peoples ' privacy
