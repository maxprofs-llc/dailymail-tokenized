...
While a fix for computers and websites was readily available after news of Heartbleed sent internet users into a panic last week , the same can not be said for Android .
...
A spokesman said : ` It 's good practice to use strong passwords that are unique to each of your accounts , but we do n't think our users need to change their Google Account passwords because of this bug . '
...
A spokesman said : ` We added protections for Facebook 's implementations of OpenSSL before this issue was publicly disclosed , and we have n't detected any signs of suspicious activity on people 's accounts .
...
Researchers now say the ` exception ' covers millions of devices that still run the old software and a solution wo n't come easily