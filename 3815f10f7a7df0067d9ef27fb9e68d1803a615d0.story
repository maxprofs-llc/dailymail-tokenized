...
In the early stages , aim to establish fixed times of day for the following - it may help to write this on a board that 's kept next to a calendar -LRB- cross it off to show what day it is -RRB- and a clock , so that they know what to expect when .

In the middle stages of dementia , routines may still be useful but patients can be more prone to mood changes , so be flexible . Encourage but do n't coerce .
...
Wandering about the house at night can arise from a need to go to the loo . Ensure they do n't have too much fluid before bed and install night-lights to help prevent falls . Painting the walls and doors a matching colour makes it less likely that the person with dementia will find their way out .
