...
The text , which referred to an error-strewn blog written by Mr Rippon to explain why Newsnight had axed its Savile investigation , said : ` Thought of the hour : PR -LRB- Peter Rippon -RRB- changes blog and accepts he was wrong and goes , giving Panorama a scalp .

` GE -LRB- George Entwistle -RRB- then goes into Select -LRB- committee -RRB- saying he backed his editor as you would expect .
...
` The decision by their editor -LRB- Peter Rippon -RRB- to drop the original investigation was
...
' I
have a personal interest here : my first job was on a JS -LRB- Jimmy Savile -RRB-
...
gather we did n't prepare the obit because of the darker side of the
story . So something celebrating a particular part of his TV career is
probably better than the -LRB- life -RRB- story as there are aspects of this which
are hard to tell . '
...
BBC director general George Entwistle -LRB- left -RRB- was
...
Editorial Standards Committee -LRB- ESC -RRB- found .
...
The text said :
` Thought of the hour : PR -LRB- Peter Rippon -RRB- changes blog and accepts he was
