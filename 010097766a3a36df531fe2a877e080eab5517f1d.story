...
This is n't the first time the lock screen security on iOS has been compromised , but this particular hack does require specific settings in order to work .
...
The method does n't allow full access to an iOS 7 device , but depending on the app running , different levels of privacy can be breached .
