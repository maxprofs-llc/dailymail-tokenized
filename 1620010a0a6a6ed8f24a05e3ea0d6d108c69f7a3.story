...
Soon smart labels could grace the sides of Johnnie Walker whisky bottles , which would send advertising messages to consumers who scan them with their phones -LRB- illustrated -RRB- . A prototype bottle has gone on show at Mobile World Congress in Barcelona
...
It uses a smartphone 's near field communication -LRB- NFC -RRB- capabilities so that a handset can be hovered over the label to unlock its digital secrets .

The bottle has sensor tags using ThinFilm 's OpenSense technology on its label that allows the transmission of adverts either when consumers are looking to buy whisky , or afterwards . It also tells a user that the bottle was properly sealed and when it is open -LRB- illustrated by the prototype -RRB-
...
This is because unlike static QR codes , which are easy to copy and do n't include sensors , the new labels will be permanently encoded in the factory do they ca n't be copied or electronically modified .

Scanning the label -LRB- pictured -RRB- with a phone could , for example , give consumers special offers , cocktail recipes or film content . The technology could also be useful for the London-based drinks firm in tracking the movement of drinks from shops to homes
...
Rare , vintage bottles of whisky can cost anywhere up to $ 1.4 million -LRB- # 874,150 -RRB- and can be aged in oak barrels stored in cellars for years .
...
Whiskey Element claims to make cheap alcohol taste like expensive whiskey by infusing it with a woody flavour when placed in a decanter -LRB- pictured -RRB-
...
Tony Peniche explained that wood barrels are used for containing whisky because the wood is cut vertically so that capillaries are not exposed to the liquid , meaning that it does n't slowly seep out of the sides of the wood .
...
A two pack of the sticks cost $ 12 -LRB- # 7.50 -RRB- .
