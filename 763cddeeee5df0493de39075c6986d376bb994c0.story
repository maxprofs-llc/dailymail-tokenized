...
It takes advantage of a feature that launched in Apple 's iOS 7 called Multipeer Connectivity Framework -LRB- MCF -RRB- . Android has a similar feature that works over Bluetooth .
...
Apple added to Multipeer Connectivity framework -LRB- MCF -RRB- to iOS 7 .

It creates what 's called a wireless mesh network that connects phones to each other .

Instead of sending messages using mobile or data signal , the features lets users send messages to people in close proximity that are in Bluetooth or Wi-Fi Direct range - up to around 30 feet -LRB- 9 metres -RRB- .
...
However , there are limits to how far a message can travel in this way - at around 200ft -LRB- 61 metres -RRB- - and Greenstone has been designed to solve this .
...
These messages are sent securely , so the individual nodes ca n't read them .
...
Elsewhere , because the feature does n't use an internet connection , it ca n't be infiltrated by hackers .
...
In FireChat -LRB- left -RRB- there are ` chatrooms ' called Everyone and Nearby . The former searches for all users , while the latter applies to people within Bluetooth and Wi-Fi range . It takes advantage of a tool used by Apple for AirDrop -LRB- right -RRB- . This creates a network in which phones become nodes , and data is passed between nodes
...
FireChat -LRB- pictured -RRB- has been downloaded more than five million times and is particularly useful when on a plane , or the underground
...
However , there are limits to how far a message can travel in this way - at around 200ft -LRB- 61 metres -RRB- - and Greenstone has been designed to plus these gaps .

Christophe Daligault , chief marketing officer at Open Garden told Daily Dot : ` The combination between -LSB- Greenstone -RSB- and the smartphones will enable a community , or a neighbourhood , or a hospital , or any other situation where they want resilient communication , even in the case of not having any connectivity . '
...
Greenstone is still under development and only currently works with FireChat at a range of around 20ft -LRB- 6 metres -RRB- .
...
Both use an iOS feature called Multipeer Connectivity Framework -LRB- MCF -RRB-
