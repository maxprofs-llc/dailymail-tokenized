A team of scientists who were given the go-ahead by Nasa to crowd-fund the revival of a seemingly ` dead ' spacecraft have announced their mission was successful .

Contact was last made with the spacecraft , called ISEE-3 -LRB- International Sun-Earth Explorer -RRB- , in the late 90s .

As it approached our planet , scientists had a brief chance to communicate with the 36-year-old probe in an
attempt to bring it back to life - which they have now managed to do .
...
In April the ISEE-3 Reboot Project team - made up of the groups Space College , Skycorp , and SpaceRef - undertook a successful crowd funding project to raise # 74,000 -LRB- $ 125,000 -RRB- to rescue the probe .
...
` We contacted the spacecraft after recreating hardware that was discarded by NASA decades ago using command language that was recreated from old documents that were sitting in former employees ' basements , ' Cowan tells MailOnline .

` Now that we have taken command of the spacecraft we will study its current condition and then prepare to fire its engines .

` We need to fire the engines soon - within the month of June - to put ISEE-3 into an orbit close to Earth .

` If we manage to accomplish all of this then we intend to use the spacecraft for science again - and to involve citizens in its operation in a way not yet attempted . '
...
extending its mission of discovery to study two comets , ' said Nasa
astronaut John Grunsfeld last week .
...
The goal of the ISEE-3 Reboot Project is to put the spacecraft into an orbit at a gravitationally stable point between Earth and the sun known as Lagrangian 1 -LRB- L1 -RRB- .
...
The mission 's original communication hardware no longer exists , so controlling the spacecraft required the amateur group to create virtual software versions of the original hardware . Once proving this was possible , the project is now using the Arecibo Radio Observatory -LRB- pictured -RRB- in Puerto Rico to send commands to ISEE-3
