...
Officers ordered that the entire flock at the farm in Upham , Hampshire , be culled , and they imposed a 1km -LRB- 0.6 miles -RRB- exclusion zone around the site after the chickens tested positive for the strain of avian influenza .

It is understood that three people , including an official from the Department for Environment , Food and Rural Affairs -LRB- Defra -RRB- , were tested for the disease after showing symptoms but were proved to be negative .
...
Officers have imposed a 1km -LRB- 0.6 miles -RRB- exclusion zone around the site after the chickens tested positive for the strain of avian influenza
...
The outbreak is the second of the disease to hit the UK in four months , following the outbreak at a Yorkshire duck farm last November -LRB- pictured -RRB- . Officials have insisted that the most recent case is ` much less severe '
...
` On the basis of current scientific evidence , Food Standards Agency advice is that avian -LRB- bird -RRB- flu does not pose a food safety risk for UK consumers , ' a spokesman said .
...
` Low pathogenic avian flu viruses naturally infect wild birds . These wild birds get several influenza infections a year , often with different subtypes of influenza , and usually these wild birds do n't appear sick .

` These wild birds also migrate and can carry their influenza viruses among geographic regions .

` The investigating scientists will be able to compare the virus genetic material from this outbreak to influenza viruses in both wild and domestic birds , from both within and outside the UK to try to work out where it might have come from . In the meantime , the control measures taken on the farm by the UK authorities will ensure that the virus does n't mutate into something more severe and so safeguard human health . '
...
` H5N8 is relatively new , and is a hybrid -LRB- `` re-assortant '' is the technical term -RRB- between the old H5N1 highly pathogenic strain and an unknown other strain .
