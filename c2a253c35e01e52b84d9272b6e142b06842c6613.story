The implantation of memories is a common feature in sci-fi films , such as Inception and Total Recall .
...
For the first time , conscious memories have been implanted into the minds of mice while the sleep . The technique could one day be used to change human memories , such in in films like Total Recall and Inception -LRB- a still from the film is shown -RRB-
...
Experts have found that when this replay process is disrupted in rodents , so too is their ability to remember what they learned -- for example , a new area that they explored -- the previous day , New Scientist reported .
...
The brain typically replays the day 's activities when people or animals sleep , which allows it to reinforce and learn a new activity , for example . Scientists used this replay process to create new memories in the brains of mice , while they slept - and say it could one day be used in humans while they sleep -LRB- stock image -RRB-

In the same way that humans sometimes remember things that did n't actually occur , researchers have found that bees also misremember .

It 's the first time that false memories have been observed in non-human animals .

Researchers from Queen Mary University of London -LRB- QMUL -RRB- tested to see if bumblebees would confuse merged versions of patterns that had previously rewarded them with food , with the ones they had actually seen .
...
While this is the first time a conscious memory has been implanted during sleep , experts have already managed to create subconscious associations in the minds of sleeping people -- so that smokers associate cigarettes with the smell of rotten eggs , for example .
...
` The mouse develops a goal-directed behaviour to go towards the place , ' Dr Benchenane said .

` It proves that it 's not an automatic behaviour . What we create is an association between a particular place and a reward that can be consciously accessed by the mouse . '

He thinks it could take years for the technique to be adapted to implant different kinds of memories such as skills , for example , but hopes that it could be developed to alter traumatic memories in people .

He believes that positive thoughts could be attached to negative memories to stop people having nightmares or dwelling on upsetting events .

` If you can identify where in the brain a person is reactivating a phobia-associated experience , you might be able to create a positive association , ' he said .
