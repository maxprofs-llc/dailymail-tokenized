Like many of us as we get older , the long-serving Mars rover Opportunity is having trouble storing its memory .
...
Volatile memory , meanwhile , is similar to RAM -LRB- Random Access Memory -RRB- found in computers . When the rover turns off , any data stored within the volatile memory is wiped .
...
The rover is currently at ` Solander Point ' at the rim of Endeavour Crater on Mars . The rover has n't moved in over a month as it waits for better weather on the red planet .
...
Currently the rover is just 2,100 ft -LRB- 650 metres -RRB- away from Marathon Valley , which looks like ancient clay beds that would have been created when the planet was moist .

` So now we 're having these events we call ` amnesia , ' Mr Callas told Ian O'Neill at Discovery News .

` Which is the rover trying to use the flash memory , but it was n't able to , so instead it uses the RAM . '
...
` It stores telemetry data in that volatile memory , but when the rover goes to sleep and wakes up again , all -LSB- the data -RSB- is gone , ' added Mr Callas .
...
Six-wheeled vehicle has been roaming Mars for more than a decade
