...
` Compelling evidence from basic science , population studies , and clinical trials implicates sugars , and particularly the monosaccharide fructose , as playing a major role in the development of hypertension -LRB- high blood pressure -RRB- .
...
` Added sugar intake is derived mainly from sugar-sweetened beverages , confectionery , cereal products -LRB- cakes and biscuits -RRB- .
