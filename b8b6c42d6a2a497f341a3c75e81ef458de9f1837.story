...
Chef Daniel Smalley told the Daily Mail : ` The secret to getting it right , is to make sure that the batter -LRB- flour , bicarbonate of soda , soda water , salt and a small amount of food colouring -RRB- is kept very cold .
...
` And , no , we do n't use the same fryer that we use to cook our fish . '
...
` Just make sure you do n't eat anything else for the rest of the week . '
