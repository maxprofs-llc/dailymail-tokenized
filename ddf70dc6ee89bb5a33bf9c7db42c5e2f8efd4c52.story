...
Nasa has revealed 12 concepts for future space travel and cosmic science as part of its Nasa Innovative Advanced Concepts -LRB- NIAC -RRB- programme . This includes a proposal to snag an asteroid with a net to prep it for further study -LRB- illustration shown -RRB-
...
NIAC Phase I awards are approximately # 60,000 -LRB- $ 100,000 -RRB- , providing awardees the funding needed to conduct a nine-month initial definition and analysis study of their concepts .

If the basic feasibility studies are successful , proposers can apply for Phase II awards , which provide up to # 300,000 -LRB- $ 500,000 -RRB- for two more years of concept development .

Titan Submarine : Exploring the Depths of KrakenA
proposal for a submarine to explore Titan 's largest northern sea ,
Kraken Mare . The craft would autonomously carry out detailed scientific
investigations under the surface of the methane sea .

Heliopause Electrostatic Rapid Transit System -LRB- Herts -RRB- A propellant-less propulsion concept for deep space
missions . Herts is like an electric solar sail - it is an array of
wires extending out up to 20 miles -LRB- 30km -RRB- from a rotating
spacecraft that would gather energy from the sun . It would be capable of
reaching speeds more than 430 miles -LRB- 700km -RRB- per second - and at top speed could
travel from the sun to Neptune in a year .

Swarm Flyby GravimetryA method for working out the gravity and mass of small solar system bodies -LRB- such as asteroids and comets -RRB- using a swarm of small , low-cost probes -LRB- illustration below -RRB- .
...
Europa to perform science at reduced time and risk -LRB- illustration to the right -RRB- .
...
Wrangler : Capture and De-Spin of Asteroids and Space DebrisThis nanosatellite-scale sub-satellite , called the Weightless Rendezvous And Net Grapple to Limit Excess Rotation -LRB- Wrangler -RRB- System , will capture and de-spin a space object such as an asteroid using a large ` net ' , in tandem with a tether deployer and winch mechanism .

Titan Aerial Daughtercraft A small rotorcraft weighing under 10kg -LRB- 22lbs -RRB- , not too dissimilar to small portable quadracopter drones on Earth , that would be deployed on Titan by a balloon to acquire close-up , high resolution imagery and mapping data of the surface .

Using the Hottest Particles in the Universe to Probe Icy Solar System WorldsA method to measure the ice depth on outer planet moons such as Europa , Ganymede and Enceladus using experimental techniques adapted from high-energy physics -LRB- illustration below -RRB- .
...
Comet Hitchhiker : Harvesting Kinetic Energy from Small Bodies to Enable Fast and Low-Cost Deep Space ExplorationA tethered spacecraft that hitches rides on comets to tour the solar system . This would be done by firing a ` harpoon ' with a tether attached that would reel the spacecraft in , like a sort of cosmic fishing rod -LRB- illustration below -RRB- .

One of the most interesting proposals is the Heliopause Electrostatic Rapid Transit System -LRB- Herts -RRB- , illustrated here . This would use electrically biased wires to harness the energy of the sun and accelerate to speeds of more than 430 miles -LRB- 700 kilometres -RRB- a second , enough to travel from the sun to neptune in just a year
...
` So we considered various kinds of potential benefit and risk , and developed this portfolio to really push boundaries and explore new approaches , which is what makes NIAC unique . '

The visionary , long-term concepts for technological advancements were assessed based on their potential value to future agency space missions and operational needs .

The projects are chosen through a peer-review process that evaluates their potential , technical approach , as well as benefits , for study in a timely manner .

But although many of the concepts are promising they are only that , concepts , and are still many years from implementation .

Robotic drones might be gaining popularity on Earth , but one proposal suggests we could also deploy them on Titan . These could be used to cover vast expanses of the surface and return a lot of useful science , including not only images of the surface but also mapping data for future missions
