...
KPMG accountants calculate that the boost to Birmingham 's economy will be equivalent to between 2.1 per cent to 4.2 per cent of the city region 's economic output -LRB- Gross domestic product or GDP -RRB- .
...
` And that is an upper limit with a # 14.4 billion contingency in reserve which we are determined to bear down on . '
