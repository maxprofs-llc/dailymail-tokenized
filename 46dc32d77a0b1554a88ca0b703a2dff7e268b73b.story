...
Engineers at Brigham Young University in Utah have created a giant virtual reality screen -LRB- shown -RRB- that allows users to view an area over a particular time period , letting them see changes in the environment otherwise invisible to the human eye . It uses lidar -LRB- laser radar -RRB- data to track changes in a particular locale

The VR system was created by engineers at Brigham Young University in Utah , led by civil engineering professor Dan Ames .

On the giant display , which measures 108ft -LRB- 33 metres -RRB- across when the 12 screens are combined , images are controlled by a Wii remote that interacts with a Kinect-like Bluetooth device called SmartTrack .
...
The VuePod creates images using point data from aircraft equipped with lidar -LRB- laser-based radar -RRB- .
...
The VuePod creates images using point data from aircraft equipped with lidar -LRB- laser-based radar -RRB- . It could reveal the more ` invisible ' effects of natural disasters like earthquakes . Pictured is a collapsed freeway in Oakland , California after the 1989 Loma Prieta earthquake

On the massive screen , which measures 108ft -LRB- 33 metres -RRB- with the 12 screens combined , images are controlled by a Wii remote that interacts with a Kinect-like Bluetooth device called SmartTrack . 3D glasses worn by the user -LRB- shown -RRB- create dizzying added dimensions
...
Some systems cost as much as # 6.5 million -LRB- $ 10 million -RRB- to build and maintain , while BYU 's VuePod just barely topped the # 19,000 -LRB- $ 30,000 -RRB- mark .
...
The Lidar scans the landscape and records millions of data points that are then viewed as an image on the VuePod -LRB- shown -RRB- . Point data can also be created from stitched-together photographs taken from low-cost drones . One set of data currently available for study in the VuePod captured a canyon area
...
And it uses lidar -LRB- laser radar -RRB- data to track changes in these regions
