...
He told Radio 4 's Today programme : ` Within the letter there is an explicit paragraph that says British values are Muslim values . You ca n't be more explicit than that . '

He added : ` Perhaps he was n't clear in what the letter said but if you have seen a copy of the letter ... it has been pretty explicit that we want to work together with the Muslim community .
...
The letter slams far-right groups like the English Defence League -LRB- pictured -RRB- , but some Muslims say ministers appear to use the same language as such groups by suggesting British and Muslim identity is distinct
...
Let us assure you that the Government will do all we can to defeat the voices of division , but ultimately the challenges of integration and radicalisation can not be solved from Whitehall alone . Strong community-based leadership at a local level is needed .
...
Letter says radicalisation ` can not be solved from Whitehall alone '
