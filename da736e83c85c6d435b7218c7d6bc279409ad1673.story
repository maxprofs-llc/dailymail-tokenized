...
` For instance , the Kallash group are an isolated population in Pakistan . They are believed to be descendants of Alexander the Great 's invading army , and our map does n't dispute that fact . '
...
Many Kalash people -LRB- left -RRB- believe they are descended from the army of Alexander the Great -LRB- right -RRB- . The date shown in the interactive map does not rule this out but the date range also allows for many other possibilities
...
Researchers identified distinct events happening at different times among groups sampled within Pakistan -LRB- pictured -RRB- , with some inheriting DNA from sub-Saharan Africa
...
Though we ca n't directly sample DNA from the groups that mixed in the past , we can capture much of the DNA of these original groups as persisting , within a mixed palette of modern-day groups , ' said Dr Falush . ` This is a very exciting development . '
