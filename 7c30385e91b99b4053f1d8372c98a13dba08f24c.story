...
Like millions of tech fans around the world President Obama would reportedly love to get his hands on a shiny new iPhone 5 for Christmas , but sadly for him his security advisers wo n't allow it .
...
month . He will be using the trusty device for some time to come after being told he can not have an iPhone for security reasons
...
that may have allowed the National Security Agency -LRB- NSA -RRB- direct access
...
` There are two main vectors of risk ; one is the software insecurities and vulnerabilities , that could be used by attackers to gain access to the device -LRB- e.g. in order to steal data , install spyware application , etc. -RRB- ; the second is the possibility of hardware backdoors or suspicious firmware changes , that could have been made to the device at the factory level .
...
Nevertheless , the White House 's movement does n't necessarily mean that there is a serious security issue with iPhone in general . '
