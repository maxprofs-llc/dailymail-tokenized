...
Gothic cathedrals , such as the Ulm Minster in Germany , pictured , with soaring spires are built with a low centre of gravity to keep them upright

Gothic cathedrals , with their soaring spires and structural beauty , were once pioneering architectural wonders - appearing to defy the laws of gravity .

And now the principles of these awe-inspiring buildings could help build a stairway to the skies .

Engineer Peter Debney has proposed a theory that borrows the methods by which cathedrals control their centre of gravity - by tapering at the top - and applied it to the concept of an elevator that take humans into space .

The space elevator concept was first suggested by Russian scientist Konstantin Tsiolkovsky in 1895 .

In principle it sounds simple - extend a tether from the surface of Earth into space and travel along it .

In practice , however , it 's difficult to construct .

There are few materials strong enough , or that can be manufactured in sufficient quantities , to create a cable long enough to reach .

Secondly , the tether would need to be anchored at a geostationary station , as well as attached to a counterweight further out into space , to ensure it does n't break and keep the system balanced .
...
In humans , for example , the centre of gravity is around the stomach . The higher this centre is above the ground , the harder it is balance .

However , if the centre of gravity is lowered , it becomes easier to balance and maintain a sturdy footing .

Engineer Peter Debney proposes a system that uses these principles to create a space elevator .
Firms could lower a cable from a satellite in geostationary orbit . A counterweight would balance the system , pictured . The cable would taper , to adjust the centre of mass and it would sit on the Equator , to minimise the gravitational pull
...
Structural engineer Peter Debney , from Arup explained to the MailOnline : ` The gravity we experience here on the Earth 's surface is the result of two components .
...
Engineer Peter Debney proposes a system that uses the principles from gothic cathedral and skyscraper architecture to create a space elevator .

He claims firms could lower a cable from a satellite that is say in geostationary orbit above the Earth .

A counterweight , such as a suitably-sized asteroid , would be used at the other end of the cable to balance the system .

The cable would need to be made of graphene , or carbon nanotubes , because these materials are capable of holding heavier loads and bearing their own weight more effectively .

By anchoring the cable at the Equator , the gravitational acceleration on the system would be at a minimum .

The elevator itself would then extend from low to high Earth orbit , and would be kept taught by tidal forces .

The cable would taper , to adjust the centre of mass , but from the top down , rather than the bottom up , as seen in pyramids and spires .
...
The cable would also need to made of a material that can hold its own weight at such heavy loads , such as graphene or carbon nanotubes .

In 2012 , Tokyo-based company Obayashi Corporation announced plans to build an operational space elevator by 2050 , concept image pictured . It uses similar technology proposed by Debney , and seen in supertall buildings
...
In 2012 , Tokyo-based company Obayashi Corporation announced plans to build an operational space elevator by 2050 .

@highlight

Cathedrals and skyscrapers stay upright by lowering their centre of gravity
