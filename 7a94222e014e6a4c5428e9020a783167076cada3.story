Apple has n't had the best track record in terms of security on iCloud recently - and now the tech giant is suggesting storing fingerprints on the online service .
...
The patent -LRB- pictured -RRB- was filed by the Californian tech giant in July 2013 and awarded yesterday . The files detail a system that would let users store their fingerprints on iCloud , which could then be downloaded and used when touching a biometric sensor on another device

The benefit of doing this would mean people would n't have to record their fingerprints across multiple devices , which Apple described in the patent as ` cumbersome . '
...
Last year , Apple 's iCloud fell victim to hackers who stole photos from a number of its celebrity users including Jennifer Lawrence -LRB- pictured -RRB-
...
Starbug , whose real name is Jan Krissler , told attendees of the Chaos Computer Club 's -LRB- CCC -RRB- 31st annual congress in Hamburg , Germany , how he achieved the hack .
...
` Unfortunately , I 'm unable to change my biometric data . So if such data is n't stored securely - and there 's no such thing as 100 per cent security - the risks could be far greater than the theft of a single password . '
