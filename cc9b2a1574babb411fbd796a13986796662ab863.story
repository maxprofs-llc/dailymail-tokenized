...
` Yet current diagnostic methods can take up to two days , so an accurate diagnostic test that can be carried out at the patient 's bedside is urgently needed . We have for the first time identified a group of biomarkers -LSB- molecules -RSB- in the blood that are good indicators of sepsis .
...
The research , published in the journal Public Library of Science ONE , took blood from individuals with sepsis , those with systemic inflammatory response syndrome -LRB- SIRS -RRB- -- a similar condition that does not respond to antibiotics -- and healthy patients .
