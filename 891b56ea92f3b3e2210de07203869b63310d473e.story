` Ginger gene ' : Couples attending an exhibition are expected to be keen to discover if they could produce red-headed children -LRB- file picture -RRB-
...
When counting the entire world population only just over 0.5 per cent -LRB- one in 200 -RRB- have red hair , which is nearly 40million people .

Identifying carriers : Couples can get DNA tests to see if they are carrying the ` ginger gene ' -LRB- file picture -RRB-
