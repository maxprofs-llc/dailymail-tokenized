...
12:01 EST , 14 June 2012

Scientists have discovered that planets do not need stars similar to our sun in order to form - implying that Earth-like planets are much more abundant than first thought .
...
However , new ground-based observations , combined with data collected by NASA 's Kepler space telescope , shows small planets form around stars with a wide range of heavy element content - and suggests they may be widespread in our galaxy .
...
Buchhave said : ' I wanted to investigate whether small planets needed a special environment in order to form , like the giant gas planets , which we know preferentially develop in environments with a high content of heavy elements .
...
Kepler scientist Batalha said ` nature is opportunistic - finding pathways we might otherwise have thought difficult
...
` The data suggest that small planets may form around stars with a wide range of metallicities - that nature is opportunistic and prolific , finding pathways we might otherwise have thought difficult . '
...
Planets up to four times the size of Earth can form around stars with a wide range of heavy elements
...
history . ` You do n't need many earlier generations of stars . ` Their discovery supports the ` core
