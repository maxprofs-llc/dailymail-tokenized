...
Lawrenceville Plasma Physics claim to be close to cracking the ` holy grail ' of energy generation with their Focus Fusion project -LRB- illustration shown -RRB- . They have already successfully heated fusion fuel 200 times hotter than the centre of the sun , and now plan to increase the density with sufficient funding

The project is being run by Lawrenceville Plasma Physics -LRB- LPP -RRB- by chief scientist Eric Lerner .
...
` Some 20 per centof the global population is without electricity , while almost half of the world lives on less than $ 2.50 -LSB- # 1.50 -RSB- per day .
...
LPP Fusion claim that theres there innovation will provider cheaper and cleaner energy for all , doing away with nuclear waste -LRB- nuclear plant pictured -RRB- and other pollutants that contribute to climate change and cause other problems . They also say their system could allow for smaller power stations that are decentralised
...
` Second , it does n't always take billions to get earth-shaking inventions .

` The first airplane cost $ 30,000 -LSB- # 17,900 -RSB- in today 's dollars , and the first transistor was built by a team of three who only spent two years working on it .
...
Fusion power is seen as being very appealing as it mimics the huge energy-generating process that takes place in the centre of stars -LRB- illustration shown -RRB- . Many experts say that if true nuclear fusion can be achieved , it will provide us with a much cleaner and greener source of energy than anything currently available
