...
The 12-minute clip , in which Mr Snowden has used software to distort his voiceover , explains how to use free software to scramble messages using a technique called Public Key Encryption -LRB- PKE -RRB- .
...
Viewers may find the video difficult to follow . Mr Greenwald himself admitted he was n't able to finish it . It took him seven weeks and help from experts to finally gather the expertise to get back to Snowden .
...
` Any router you cross could be monitored by an intelligence agency or other adversary -LSB- such as -RSB- a random hacker . So could any end points on the way there , a mail server or a service provider such as Gmail .
...
` But public key encryption such as GPG allows the journalist to publish a key that anyone can have based on the design of the algorithm , and it does n't provide any advantage to the adversary . '
...
Javier
Ruiz , director of policy at the Open Rights Group , said : 'Em ails are
