...
It has been revealed that the Transportation Security Administration uses a behavioral checklist , nicknamed SPOT , to help identify potential terrorists among airport travelers -LRB- file photo -RRB-
...
` Suspicious ' items range from blueprints to liquids ` in excess of 3.4 oz ' .
...
SPOT breaks down body language the TSA believes indicates ` stress ' or ` deception ' , including sweaty palms , a strong body odor , widely opened eyes or a bobbing Adam 's apple -LRB- file photo -RRB-
