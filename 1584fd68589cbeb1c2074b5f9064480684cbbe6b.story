...
called thiazolidinedione -LRB- TZD -RRB- -- used to treat type 2 diabetes -- which
lowers glucose levels - but at the cost of some patients gaining weight .

The findings could have implications for people with diabetes.The scientists think that people treated with the thiazolidinedione drugs such as Pioglitazone -LRB- illustrated -RRB- gain weight as a side effect , but that future medication could solve this problem
...
` Therefore , targeting peripheral PPARgamma to treat type 2 diabetes should be done by developing TZD compounds that ca n't penetrate the brain . '
