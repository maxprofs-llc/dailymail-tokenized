...
12:30 EST , 12 December 2012

Cyber crime : Facebook helped the FBI bust an international hacking ring that infected 11million computers and stole over # 525million from users
...
` Security systems ' : Facebook 's security team helped the FBI after the so-called ` Yahos ' malware targeted its users between 2010 and October 2012 , the FBI said in a statement

A botnet is a collection of internet-connected computers over which a hacker has seized control .

Each compromised machine - known as a ` bot ' - is created when a computer is infected with malicious software -LRB- malware -RRB- which allows the hacker to direct its activities remotely .
...
It estimated the total losses from their activities at more than $ 850m -LRB- # 525m -RRB- , without elaborating .
...
Hackers distributed malware which stole credit card numbers and bank details , agency says
