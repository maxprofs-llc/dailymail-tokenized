...
Tesla CEO Elon Musk -LRB- pictured -RRB- believes humans will be banned from driving in years to come and cars will , instead , be controlled by robots . The inventor and entrepreneur claims that computers will do a much better job of driving and that human drivers are simply ` too dangerous
...
Musk said that the obvious answer to keeping humans safe on the road is to ban us from driving , because ` it 's too dangerous ... you ca n't have a two-ton death machine , ' The Verge reported .
...
Tesla 's Model S features an ` autopilot ' mode , which uses sensors to stop drivers drifting accidently between motorway lanes , as well as moderate speed and brake when necessary .

Tesla 's Model S -LRB- pictured -RRB- will feature an ` autopilot ' mode , which uses sensors to stop drivers drifting accidently between motorway lanes , as well as moderate speed and brake when necessary

A recent study by eBay Motors revealed that 84 per cent of Americans want to continue driving their own cars and not rely on autonomous technology .
...
It 's releasing a $ 10,000 -LRB- # 6,815 -RRB- developers kit so people can hone the technology for car manufacturers .
...
Days ago , a nondescript garage -LRB- pictured -RRB- in Sunnyvale , California , was pinpointed as being where Apple is believed to be building its self-driving ` Titan ' cars
...
He told Paul Goldberger : ` Steve Jobs was gon na design an iCar . I think cars have an extraordinary opportunity for cool design . '
...
Elon Musk tweeted that he will reveal a way to cure drivers of Tesla 's Model S ' range anxiety .

While no further details are known , it seems the smart money may be on either navigation software that shows the best route to a charging station or an update that boosts the car 's battery power .
...
Elon Musk tweeted that he will reveal a way to cure drivers of Tesla 's Model S ' range anxiety . A promotional shot of the car is pictured
...
The official range of the Model S at the moment is up to 310 miles -LRB- 500km -RRB- , which is apparently not enough to quell range anxiety for some drivers .

Musk said that all Model S cars will get the update - if so , that points to battery optimisations , a power-saving mode or smarter navigation , ' Engadget reported .

Software updates to the Model S are n't unprecedented , either ; in January , an update increased the speed of the top-of-the-line P85D via use of ` insane mode ' - enabling the car to go 0 to 60mph -LRB- 97km/h -RRB- in 3.2 seconds , compared to the usual 5.9 seconds .
...
Tesla CEO claims computers will be better drivers than humans
