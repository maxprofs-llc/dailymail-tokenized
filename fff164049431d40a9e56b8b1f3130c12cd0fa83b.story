...
Their catalyst , placed on an electrode used in the production of hydrogen , is much more efficient - and although Dr Hintermair did n't have an exact figure , he said the energy loss using it is ` almost non-existent ' .
...
` We can make electricity out of sunlight and wind , low carbon renewable sources , but we ca n't store it very well , ' Dr Hintermair continued .

` We can put it in a battery but you ca n't , for example , fly an airplane on a battery yet .
...
Solar power is thought to be able to provide up to four per cent of the UK 's electricity by the end of the decade -LRB- Wymeswold Solar Farm in Leicestershire , UK shown -RRB- , but storing it is difficult . This new technology could store energy as hydrogen , which can then be used on demand
...
' -LSB- Dr Hintermair 's -RSB- results are extremely exciting because of their potential for practical application . '
