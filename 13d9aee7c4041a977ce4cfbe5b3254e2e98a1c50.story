...
` The presence of perchlorates is n't good news for some of the techniques we 're currently using with Curiosity , ' said Mr Glavin .

` This may change the way we search for organics in the future on Mars . '

The Curiosity rover 's Sample Analysis on Mars -LRB- SAM -RRB- system tests soil by heating them in an instrument , called a pyrolysis gas chromatograph mass spectrometer .
...
Perchlorates are the salts derived from perchloric acid -LRB- pictured -RRB- . Hydrogen atom are shown in white , oxygen in red and chlorine in green
...
The rover already carries an apparatus capable of that , which it has n't yet used .
