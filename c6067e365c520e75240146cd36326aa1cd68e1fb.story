...
Fan site AppleInsider has spotted nine job listings on Apple 's official recruitment site in the past month that relate to batteries . These include one for an iOS battery life software engineer -LRB- pictured left -RRB- and another for iOS software power systems engineer -LRB- pictured right -RRB-
...
Earlier this week Atmel released its latest microcontrollers -LRB- MCUs -RRB- for a variety of gadgets that are so low power they can harvest energy from a person 's body .
...
Earlier this week Atmel released its latest microcontrollers -LRB- MCUs -RRB- for a variety of gadgets that are so low power they can even harvest energy from a person 's body . Atmel said its MCUs extend ` battery life from years to decades , reducing the number of times batteries need to be changed in devices '
