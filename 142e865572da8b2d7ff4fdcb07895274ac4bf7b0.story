...
` Yes things like Chinese manufactured goods are so cheap because of cheap labour and cheaper overheads and they were as cheap as chips when we were above parity -LRB- dollar to dollar -RRB- but now it 's not we face a double whammy - the Aussie is presenting about 20 per cent less value .

` But the good news is that hiring intentions have picked up , businesses can help by giving consumers a job .

'Em ployment which has been weak in the past year or so -- not catastrophic but weak , so if we are getting a turning point on employment that would be significant .
...
` Yes things like Chinese manufactured goods are so cheap because of cheap labour and cheaper overheads and they were as cheap as chips when we were above parity -LRB- dollar to dollar -RRB- but now it 's not we face a double whammy - the Aussie is presenting about 20 per cent less value , ' said Mr Koukoulas

The D&B survey reveals the significance of the falling dollar on businesses , with 21 per cent listing it as the issue that will influence their operations the most , with ` cash flow ' the only more pressing concern -LRB- 26 per cent -RRB- for their operations in the first quarter of 2015 .
