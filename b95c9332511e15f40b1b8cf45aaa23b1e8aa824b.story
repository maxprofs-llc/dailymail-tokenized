...
The director at the Office for Security and Counter Terrorism -LRB- OSCT -RRB- said the release of information from the Snowden documents had given extremists ` full sight ' of tools and techniques used by the British listening station GCHQ , which had had a ` severe ' effect on spying operations .
...
` Basically you see people using less of the methods that he -LRB- Snowden -RRB- described the Government uses to track terrorism and as a natural consequence terrorists are trying to use other methods . We have to be more agile , ' he said .
