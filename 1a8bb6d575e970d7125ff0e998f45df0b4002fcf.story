...
Scientists used a robot to find the ` fittest ' droplets in experiments by selecting desirable properties like division -LRB- b -RRB- , vibration -LRB- e -RRB- and movement -LRB- f -RRB- that over time led to the droplets becoming more stable
...
The scientists adapted a 3D printer to create a robot that was able to mix and tweak the oil compounds before using a camera to select those that performed best in a series of tests in a Petri dish -LRB- Evo arena -RRB- full of water
...
Four droplets of each mixture were deposited by the robot -LRB- top left -RRB- into a Petri dish -LRB- bottom left -RRB- and then monitored for stability in the water and to see whether they divided -LRB- bottom right -RRB- , moved or vibrated
