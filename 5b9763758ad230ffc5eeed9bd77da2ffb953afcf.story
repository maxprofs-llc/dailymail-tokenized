...
Castillo cave proved to date back to at least 40,800 years . This makes
...
form of perforated beads , engraved egg shells and pigments in Africa
70,000 to 100,000 years ago , but it appears that the earliest cave
paintings are in Europe .

` One argument for its development
here is that competition for resources with Neanderthals provoked
increased cultural innovation from the earliest groups of modern humans
in order to survive .

` Alternatively , cave painting started before the arrival of modern humans , and was done by Neanderthals .

` That would be a fantastic find as it
would mean the hand stencils on the walls of the caves are outlines of
Neanderthals ' hands , but we will need to date more examples to see if
this is the case . '
...
The scientists were forced to use the
uranium method as the paintings lacked organic pigments or binders
suitable for radiocarbon dating .

And even if there was organic material
- such as charcoal pigments - only small samples can be used for dating
to minimise damage .

This can cause contamination , leading to an inaccurate result .

Instead , the international team
measured uranium isotypes in the thin calcite flowstone growths which
had formed on the surfaces of the paintings to date the art .

The method , known as uranium-series disequilibrium , is used in Earth Sciences to accurately date ancient objects .

Dr Dirk Hoffmann , of the National
Centre for the Investigation of Human Evolution in Burgos , Spain , said :
` The key development was our method to date tiny tiny calcium carbonate
deposits similar to stalactites .

` We can now date samples of just ten
milligrams - about as small as a grain of rice . This has allowed us to
find samples that had formed directly on top of hundreds of paintings ,
whereas the larger stalactites were much less frequent . '

Cave art specialist Dr Paul Pettitt ,
of the University of Sheffield , said : ` Until now our understanding of
the age of cave art was sketchy at best ; now we have firmly extended the
earliest age of European cave art back by several thousand years , to
the time of the last Neanderthals and earliest Homo sapiens .

` These earliest images do not
represent animals , and suggest that the earliest art was non-figurative ,
which may have significant implications for how art evolved . '
