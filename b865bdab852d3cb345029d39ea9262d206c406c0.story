...
The 0.9 lb -LRB- 0.4 kg -RRB- has two arms fitted with tools to hold , cauterise and suture tissue , while its head is a small video camera.The camera feed is sent to a control station , where a human surgeon operates it using joysticks .
...
To upgrade the existing content , the Virtual Space Station system has been delivered for testing at the Hi-Seas -LRB- Hawaii Space Exploration Analog and Simulation -RRB- Mission 3 which is starting today in Hawaii .
...
The program is designed for astronauts on missions to places such as Mars -LRB- artist 's impression pictured -RRB- , but it could also be adapted to treat people on Earth
