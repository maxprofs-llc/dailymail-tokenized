...
The mission , known as the Mars Plant Experiment -LRB- MPX -RRB- , aims to create a small Martian greenhouse which , if successful , could pave the way for humans living on the planet .

Nasa is planning to send seeds on its next Mars rover , which is scheduled to launch in mid-2020 and land on the red planet in 2021 . The mission , known as the Mars Plant Experiment -LRB- MPX -RRB- , aims to create a small Martian greenhouse which , if successful , could pave the way for humans living on the planet
...
Nasa
claims that after extensive testing on plants on Earth , it does n't
...
MPX would use a CubeSat which would be attached to the outer body of the 2020 rover . This box would hold Earth air and about 200 seeds of Arabidopsis -LRB- right -RRB- , a small flowering plant that is widely used as a model organism in plant biology . The mission could lead to larger greenhouses on Mars -LRB- left -RRB- in the future
