...
Although the signal does n't meet strict scientific standards for a ` full scientific discovery ' , it 's still enough for researchers at CERN 'S Large Hadron Collider -LRB- LHC -RRB- to predict a discovery next year .
...
A typical ` candidate event ' for the Higgs boson , including two high-energy photons whose energy -LRB- depicted by red towers -RRB- is measured by CMS . The yellow lines are the measured tracks of other particles produced in the collision
...
Professor Stefan Soldner-Rembold , a particle physicist from the University of Manchester , told MailOnline : ` ATLAS and CMS -LSB- the two detectors in the hunt for Higgs -RSB- have presented an important milestone in their search for the Higgs particle , but it is not yet sufficient for a proper discovery given the amount of data recorded so far .

` Still , I am very excited about it , since the quality of the LHC results is exceptional . '

CERN was cautious : ` The main conclusion is that the Standard Model Higgs boson , if it exists , is most likely to have a mass constrained to the range 116-130 GeV -LSB- a unit of energy equal to billion electron volts -RSB- by the ATLAS experiment , and 115-127 GeV by CMS .
