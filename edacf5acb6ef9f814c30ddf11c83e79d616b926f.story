...
LiFx lights -LRB- x10 -RRB- = # 530 -LRB- $ 890 -RRB-

August smart lock = # 119 -LRB- $ 199 -RRB- -- available from Spring

Elertus sensor = # 119 -LRB- $ 199 -RRB-

Canary smart alarm = # 119 -LRB- $ 199 -RRB- -- available from July

Nest smoke alarm = # 77 -LRB- $ 129 -RRB-

Smart TV = from around # 329 -LRB- $ 548 -RRB-

Teddy The Guardian = # 139 -LRB- $ 232 -RRB-

Jalousier smart blinds = # 77 -LRB- $ 129 -RRB-

Total = # 1,509 -LRB- $ 2,519 -RRB-
...
The
August smart lock -LRB- pictured -RRB- secures Qualcomm 's smart house . Fitted to the existing door lock , the battery-powered
...
To open the lock -LRB- pictured left -RRB- , anyone with a code can
approach the door , enable their phone 's Bluetooth and press the relevant
address from the app -LRB- pictured right -RRB-
...
A smart security alarm , such as Canary -LRB- pictured -RRB- can be connected to smart lights from LiFx

Here , LiFx lights flash to silently alert homeowners to the fact there is
an intruder in their home

When someone enters or leaves the house a notification is sent to the owner and the lock automatically closes after 10 seconds to secure the door . The August device will be available from Spring for # 119 -LRB- $ 199 -RRB- .
...
Elsewhere , a smart security alarm , such as Canary , can be connected to smart lights from LiFx . The lights could then flash in the bedroom , for example , to silently alert homeowners to the fact there is an intruder downstairs . Canary will be available from July and costs # 119 -LRB- $ 199 -RRB- . The system can also be used for people with poor hearing .

The smart LiFx lights in Qualcomm 's
demonstration -LRB- pictured left -RRB- were funded by a Kickstarter campaign . They start at $ 89
-LRB- # 53 -RRB- each and an individual light can be customised to be any colour on
the spectrum using an app -LRB- right -RRB-
...
The smart LiFx lights in Qualcomm 's demonstration were funded by a Kickstarter campaign . They start at $ 89 -LRB- # 53 -RRB- each and an individual light can be customised to be any colour on the spectrum .
...
For example , in the kitchen of Qualcomm 's Connected Home the LiFx lights were linked to a smart wine cooler fitted with an Elertus sensor , starting at # 119 -LRB- $ 199 -RRB- .

Elertus sensors can be fitted to almost
any item in the house to detect changes in movement or temperature , for
example . A home owner can keep tabs on alerts using an app -LRB- left -RRB- . In the Wine Protection System -LRB- right -RRB- the sensor recognises when the
...
The teddy used in the home was a concept device -LRB- pictured -RRB- that can speak to children to wake them up , yet similar smart teddies are already on sale , such as Teddy the Guardian from London-based IDX Labs
