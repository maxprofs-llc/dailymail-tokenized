...
NB : The shopping bills for each supermarket are not identical as the weights and varieties are not always the same . If an exact product comparison was n't available , Lovemoney.com used the closest match .

Turkey : Whole basted British frozen turkey , 3.6 -- 4.8 kg , # 10
...
Price per head -LRB- 8 people -RRB- = # 2.88
