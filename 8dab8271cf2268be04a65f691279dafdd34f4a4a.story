Nine rail workers were just seconds from death in Lancashire after being given no warning that an 80mph passenger train was bearing down on them , rail accident investigators have said .
...
The workers received no advance warning that an Edinburgh to Manchester Airport train was approaching

The Rail Accident Investigation Branch -LRB- RAIB -RRB- said : ` They were forced to take immediate evasive action when the train first became visible , approximately four seconds before it reached the site of work .
...
The RAIB said the track workers comprised contract staff and a controller of site safety employed by Network Rail -LRB- NR -RRB- .

They were packing ballast under sleepers on the up -LRB- towards London -RRB- main line on a small bridge .

A lookout-operated warning system -LRB- LOWS -RRB- was being used to give warning of approaching trains because of the gang 's restricted view . This system is designed to allow lookouts to signal the approach of a train by operating two toggle switches on an LOWS lookout unit . This then transmits a radio signal to a LOWS static unit which then gives both visual and audible warnings .

The investigation will focus on why the workers were not warned of an approaching train -LRB- File photo -RRB-
...
Mick Cash , general secretary of the Rail , Maritime and Transport -LRB- RMT -RRB- union , said : ` This incident once again illustrates the dangers that confront track workers on Britain 's railways on a daily basis .
...
Shocking incident took place between Carnforth and Lancaster
