...
The Aerial Bold project was set up by German designer Benedikt Groß and geographer Joey Lee . Their tool lets people scour Mapbox images to find letters , numbers and characters in the landscape -LRB- pictured -RRB-
...
They raised $ 11,492 -LRB- # 7,630 -RRB- and have since set up the Aerial Bold crowdsourcing tool .
...
Users begin with a grid divided into 21 rectangles . The exact location of the satellite imagery is n't revealed .
...
To add a new letter that the software has n't suggested , click ` Add New ' , type the letter and reposition the box .

Users begin with a grid divided into 21 rectangles . The software will suggest letters , numbers or characters in each rectangle and this will be displayed by a number . These suggestions can then be placed over the relevant part of the map -LRB- pictured -RRB- . Once Update Geometry is clicked , the letters are added to a database
...
People can search for letters -LRB- examples shown -RRB- either anonymously or by adding a credit name to the discoveries . They are then added to a leaderboard as soon as they find more than ten letters . The top ` hunter ' is currently Marco Berends with 365 , and more than 500 shapes in total have been spotted .
...
They raised $ 11,492 -LRB- # 7,630 -RRB- and have since set up a crowdsourcing tool
