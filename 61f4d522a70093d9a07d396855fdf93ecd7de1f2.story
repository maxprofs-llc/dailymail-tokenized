...
The annual levy on banks , which was introduced in 2010 , currently brings in around # 2.5 billion a year . Mr Alexander 's proposals are expected to take that up to # 3.5 billion a year .

A ` mansion tax ' on homes worth over # 2million will raise an extra # 1.5 billion , and a crackdown on tax avoidance could save # 6billion , the Lib Dems claim .
...
The Tories and Lib Dems are committed eliminating the deficit in the public finances by 2017/18 . But the Lib Dems want to raise at least # 8 billion through extra taxes , while George Osborne -LRB- pictured -RRB- insists it can be achieved through spending cuts alone
