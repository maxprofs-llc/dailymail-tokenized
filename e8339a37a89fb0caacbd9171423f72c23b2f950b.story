...
Professor John Goodenough -LRB- pictured above left -RRB- has received honors including the National Medal of Technology and Innovation from Barack Obama , for his role in the invention of the lithium ion battery
...
Currently , sources such as wind turbines must be ` switched off ' during periods of low demand as the energy they produce can not be stored .
...
Professor Goodenough wants to create batteries that contain pure metal anodes made from lithium -LRB- above -RRB-
...
` There are a lot of people working , and none of them is stupid . I do n't say I 'm the only one who can solve the problem . '
