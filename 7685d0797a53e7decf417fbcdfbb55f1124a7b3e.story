...
Strapped to the outside of the International space stations , residents must deal with temperatures ranging from -12 C to 40C several times a day - as well as huge amounts of radiation .
...
Some samples of each biomolecule or organism are embedded in a simulant Mars soil -LRB- ranging from just a single layer of soil to multiple layers -RRB- , and other samples are left on their own to face the space environment without protection .
