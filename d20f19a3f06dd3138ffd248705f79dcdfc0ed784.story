...
Snapchat rival Taptalk -LRB- pictured -RRB- was developed by Berlin-based Onno Faber . Pictures and videos are shared with friends using a tap of the screen , and each file is sent with the user 's location . Captions can also be added , and the photos and videos self-destruct after they 've been viewed
...
Ashton Kutcher tweeted support for the app to his 16 million followers on Sunday -LRB- pictured -RRB- , but it is unknown whether he has invested in the German firm or not . Other rumours state Facebook is looking to copy Taptalk 's features on its own Slingshot app

Taptalk -LRB- pictured left -RRB- has a photo and video viewer at the top of the screen , and a grid of friends below . Tapping a friend 's face takes a photo with either the front , or rear-facing camera . The image is then sent to the selected friend automatically . Messages can only be sent to individuals , and not groups - like on Snapchat -LRB- right -RRB-
