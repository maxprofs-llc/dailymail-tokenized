...
Windows 8 features blocks or 'til es ' that can be moved around the screen or tapped to go straight into an application . The tiles update in real time , so you can see if you have emails , voice messages or Facebook notifications at a glance
...
Fewer windows - instead of ` stacks ' of windows , as in previous versions , the OS is built around clean 'til es ' that deliver information to the home screen .
...
Apps shared with phones - apps in Windows 8 will be built to work smoothly with phones -LRB- such as Nokia 's -RRB- running Microsoft 's Windows Phone OS .
...
Tech site Mashable was impressed , but overwhelmed by the sheer number of ways to control the new software , ` In the end , Microsoft is n't just asking you to get used to a different interface for Windows . It 's asking you to get used to multiple within the same OS . I 'm not sure how many people have the patience for that . Still , Metro is gorgeous enough to keep me looking forward to Windows 8 ′ s final act . '
...
It features blocks or 'til es ' that can be moved around the screen or tapped to go straight into an application .
...
defined by the iPad and the -LRB- Amazon -RRB- Kindle , if they come out with a
buggy first version , they wo n't get a second chance , ' said Michael
Cherry , a former Microsoft engineer who now works at independent
research firm Directions on Microsoft . ` They ca n't afford to disappoint
customers . '
...
Intel chips . But they wo n't get to try out Windows 8 on an ARM tablet
...
The 'til e ' interface , where a set of panels bring up ` live ' information - showing , for instance , whether there are emails to read , or bring up Facebook posts - is similar to the one found in Windows Phone , and apps will work smoothly across the two
...
The test version was downloaded by people from more than 70 countries as Microsoft gave its presentation about Windows 8 , but the company did n't immediately disclose the number of downloads .
