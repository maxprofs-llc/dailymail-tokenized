A screenshot -LRB- pictured -RRB- posted to Reddit is the first to show how Whatsapp 's Calls feature will look
...
In December , Dutch site AndroidWorld uncovered clues about the feature while studying the app 's test code . It then extracted layout files from the raw code to create mock-up screenshots -LRB- pictured -RRB- . The new tool is only available to select users , but if someone with the feature calls someone without it , it forces the update

Other messaging apps , including Viber -LRB- pictured -RRB- , already offer free voice and video calls to users
...
The beta version of its live translation tool lets people speak to others in another language - even if they do n't know what they 're saying .
...
To use the new Whatsapp tool , users open the Calls tab , select a contact and make a voice call using an internet connection . This is similar to how Skype -LRB- pictured -RRB- , for example , connects web-based calls , using a service called ` voice over internet protocol ' or VoIP

Voice over Internet Protocol -LRB- VoIP -RRB- lets people make free , or low cost , telephone calls over the web .
...
Last year , Whatsapp updated its service to make it harder to avoid messages . A single grey tick on a message means it has been sent , a double grey tick means it has been delivered , and two blue ticks mean it has been read -LRB- pictured -RRB- . The update is available across all mobile platforms
