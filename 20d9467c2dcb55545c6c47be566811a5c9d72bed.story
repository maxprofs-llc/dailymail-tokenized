...
Doctor Mole is n't the first tool to help smartphone users check for signs of skin cancer . Other apps guide users through self exams , and the German-made ` Handyscope ' converts an iPhone into a dermatoscope , which doctors use to look for melanoma .
...
` There are a lot of factors that can influence the image processing , such as shadows , poor lighting and poor camera quality , so I do n't think any app could claim that they can spot a cancer 100 % .
