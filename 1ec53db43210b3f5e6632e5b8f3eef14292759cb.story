...
Black holes that fit this description are called active galactic nuclei -LRB- AGN -RRB- , and their intense radiation output also generates powerful winds that force material away from the centre of a galaxy .
...
The team analysed data collected in 2013 by Suzaku , an X-ray satellite operated by the Japan Aerospace Exploration Agency -LRB- Jaxa -RRB- and Nasa , as well as data from Esa 's Herschel Space Observatory .
...
Star formation alone ca n't explain this intense concentration of energy , leading the researchers to conclude that the AGN winds must be the primary driver .

The outflows could also remove huge quantities of star-making gas , dictating the size and shape of galaxies . This artist 's impression shows the outflow of molecular gas -LRB- red -RRB- in a galaxy hosting a supermassive black hole at its core . The study is based on data from the Herschel and Suzaku space observatories

This is a red-filter image of IRAS F11119 +3257 -LRB- inset -RRB- from a telescope at the University of Hawaii 's , showing faint features that may be tidal debris , a sign of a galaxy merger . The background is a wider view of the region from the Sloan Digital Sky Survey

` The temptation is to ignore the supermassive black hole when studying galactic dynamics and evolution , but our study shows that you ca n't because it influences galaxies on the larger scale , ' added co-author Dr Marcio Meléndez .
