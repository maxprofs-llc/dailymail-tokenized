...
Payments via mobile systems such as NFC -LRB- near field communications -RRB- chips will overtake both cash AND cards by 2020 , claims a new report
...
authentication -LRB- secret number + physical device -RRB- is better than
...
Based on a technology known as near-field communication -LRB- NFC -RRB- , Google Wallet allows users to store payment information in the cloud and pay for goods at participating retailers by tapping their phone at the point of purchase
...
The research found that the change is already happening - particularly in America , where phones using Google Wallet -LRB- a mobile payment system -RRB- and NFC payment chips are more common .
...
Users will pay via NFC -LRB- ` near field ' -RRB- chips where they ` bump ' mobiles on tills to pay
