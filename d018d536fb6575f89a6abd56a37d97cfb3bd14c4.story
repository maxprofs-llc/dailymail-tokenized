...
` There 's an average of about 23 parts-per-million-by-weight -LRB- ppmw -RRB- more hydrogen on Pole-Facing Slopes -LRB- PFS -RRB- than on Equator-Facing Slopes -LRB- EFS -RRB- , ' said Nasa scientist , Timothy McClanahan .

This is the first time a widespread difference in the spread of hydrogen on the moon has been detected .

Using data from the Lunar Reconnaisance Orbiter 's Lend tool -LRB- artist 's impression pictured -RRB- , Nasa scientists have been mapping the hydrogen levels across the moon 's surface
...
` We think a similar phenomenon is happening with the volatiles on the moon -- PFS do n't get as much sunlight as EFS , so this easily vapourised material stays longer and possibly accumulates to a greater extent on PFS . '
