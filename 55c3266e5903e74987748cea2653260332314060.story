...
Facebook has been experimenting with this tool for a while . Currently , when statuses , photos and videos are uploaded , the app shows what was similarly posted on this day a year ago , for example . The new official tool -LRB- pictured -RRB- is rolling out to users in stages , so not everyone will be able to see it yet

On This Day is similar to the Timehop app that can be installed to Facebook 's web and mobile site -LRB- examples shown -RRB- . A major difference between the Timehop app and Facebook 's tool , though , is that Timehop also collates posts made on Twitter , Instagram , Flickr and Foursquare in addition to Facebook
