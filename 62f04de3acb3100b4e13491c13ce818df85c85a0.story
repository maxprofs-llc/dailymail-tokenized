...
` As an explanation for the Black Death in its own right , -LSB- bubonic
plague is -RSB- simply not good enough .
...
` It
can not spread fast enough from one household to the next to cause the
