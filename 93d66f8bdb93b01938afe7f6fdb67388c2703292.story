...
Ibrutinib is one of only a handful of new medicines to be made available via the Cancer Drugs Fund after two trials in 28 British hospitals showed it to be extremely effective in treating both mantle cell lymphoma -LRB- MCL -RRB- and chronic lymphocytic leukaemia -LRB- CLL -RRB- .
...
` As this drug is targeted at the B-cells , the side effects are minor . In addition , patients do n't have to go into hospital to have it administered . '
...
For now , ibrutinib -LRB- which costs up to # 74,000 a year -RRB- will be prescribed only to patients whose disease does n't respond to chemotherapy