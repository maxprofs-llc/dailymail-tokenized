...
of time - from one minute up to 10 days - and ca n't be opened until the timer runs down .
...
The plastic box will then only open when the countdown has ended - even removing the batteries wo n't release the lid .
...
They 've thought of everything : The Kitchen Safe , left , can not be opened before a set time without actually breaking it . However , if you set the timer wrong you get five seconds to cancel it before it locks . Other items including keys and gadgets can be locked away from children , for example , right
...
` You hear about bank safes which ca n't open until a certain hour so I thought of that concept .
...
` The Kitchen Safe physically can not be opened when the lid is shut .
...
The ` Kitchen Safe ' locks tempting foods away so you ca n't eat them
...
It ca n't be opened before the timer is up - even by removing the batteries