...
Professor Sir Colin Blakemore -LRB- pictured -RRB- claimed there is a ceiling on how long humans can live and believes 120 years ` might be a real absolute limit to human lifespan ' . This is because living for longer is ` so rarely exceeded ' that even with medical advances , it is unlikely this upper threshold will be raised
...
The research , reported in the journal Cell Reports , involved blocking key molecules that affect the action of insulin and a nutrient signalling pathway called Target of Rapamycin -LRB- TOR -RRB- .
