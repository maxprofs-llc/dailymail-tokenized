If you 've used Gmail recently you might want to check you did n't send confidential or potentially embarrassing messages to the wrong people .

A bug in the email provider 's autocomplete tool has resulted in random addresses being added to emails .

And if the sender did n't spot the mistake before hitting send , private information could have been shared with the wrong person .

When a user type an address in Gmail Google suggests addresses from their Contacts list -LRB- pictured -RRB- . Gmail is supposed to prioritise addresses the user sends mail to most often , but the bug means random and less frequent addresses are being placed at the top of the list . Emails are then sent without being checked

Twitter users began complaining about the bug at the weekend and more reports emerged yesterday .

One wrote : ` For a company as awesome as Google , Gmail is making me -LSB- miss -RSB- the old days of Outlook ... Takes forever to load , freezes , autocomplete bugs etc. '
...
If Gmail does n't suggest the address the user wants they can continue typing .
...
If the sender does n't spot the mistake emails are sent to the wrong people
