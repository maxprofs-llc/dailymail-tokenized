...
` Acts that are widely considered dangerous -LRB- due to the intense physical contact between horse and tamer -RRB- become safety techniques and methods by which the horses quickly lose the fear -LRB- spooking/sensibility -RRB- which renders them so unpredictable .

` The removal of fear -LRB- spooking/sensibility -RRB- using the Scarpati method guarantees a loyal relationship with an untamed horse . '
