...
The device is an improved version of MRI -LRB- magnetic resonance imaging -RRB- which is currently used by doctors to pick up tumours , multiple sclerosis , heart disease and other illnesses .

At present the amount of detail that can be probed is limited but MRF -LRB- magnetic resonance fingerprinting -RRB- can collect a vast amount of information in one measurement .
...
Information : According to the scientists , the amount of detail which can be probed from an MRI scan -LRB- pictured -RRB- is limited , but MRF can collect a vast amount of inforamtion in one measurement
...
For example an MRI would show swelling as a bright area in an image . But brightness does n't necessarily equate with severity or cause .
