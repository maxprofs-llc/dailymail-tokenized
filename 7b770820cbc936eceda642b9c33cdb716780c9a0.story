...
Dung beetles travel in straight lines by taking cues from the sun , during the day , and the moon at night . Yet the winners of the Ig Nobel biology and astronomy award found that the beetles also use light from stars on nights when the moon is n't visible
...
into a package and then dropping the packaged hijacker -LRB- with a
parachute -RRB- to the ground where police will be waiting . Winner : Gustano
Pizzo
...
cow stands up , you can not easily predict how soon that cow will lie
...
Yet the insects ' ability to stay on course overnight when the moon was n't visible led the researchers to discover the beetles can also use the location and light from stars in the Milky Way as a guide .
...
would dissolve in the human digestive system and which would n't .
...
The dung beetle one and the physics one are awesome ! Both are actually really contributions to science -LRB- and no , I 'm not being sarcastic -RRB- . Love this sort of thing : knowledge for its own sake rather than trying to make everything ` vocational ' and linked to the quest for the almighty dollar -LRB- or pound -RRB- .
...
Would n't it have made more sense if the picture to illustrate the beer-goggles had shown an ugly couple looking at each other admiringly ?
