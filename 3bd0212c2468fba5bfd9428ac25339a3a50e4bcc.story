...
If they only take visible matter into account , their equations do n't add up ; the elements that can be observed are not sufficient to explain the rotation of objects and the existing gravitational forces . There is something missing .
...
The team used the European Southern Observatory 's -LRB- ESO -RRB- Very Large Telescope -LRB- VLT -RRB- in Chile , along with images from Hubble , to view Abell 3827 .
...
Although dark matter can not be seen , the team could deduce its location using a technique called gravitational lensing .
...
The team used the European Southern Observatory 's -LRB- ESO -RRB- Very Large Telescope -LRB- VLT -RRB- in Chile , pictured , along with images from the Hubble Space Telescope , to make the discovery
