...
Georgia Institute of Technology researchers have revealed a new hacking method . They say hackers can ` listen in ' to signals emitted by laptops and phones -LRB- stock image shown -RRB- . This means , even when offline , they could find out what you are doing . It is very hard to track because the spying is ` silent '
...
Worryingly , the signals do n't even require your computer to be online - simply being active is enough for a hacker to listen in to what you are up to .
...
One way in which such hackers - as well as some intelligence agencies - get access to such information is by using International Mobile Subscriber Identity -LRB- IMSI -RRB- catchers , or ` stingrays ' .
...
Because the spying is passive and emits no signals itself , users of computers and smartphones would n't know they 're being watched .
...
The signals are produced from the hardware of the computer -LRB- shown -RRB- when it performs a task . Currently , there has been no mention in open literature of hackers using side-channel attacks , but the researchers believe it 's only a matter of time before that happens
...
People in coffee shops could be at particularly risk -LRB- stock image shown -RRB- , as in a public space hackers could more easily listen in to the signals from their laptop . ` If somebody is putting strange objects near your computer , you certainly should beware , ' said Dr Zajic
...
To measure the vulnerability , Dr Zajic , Dr Prvulovic and graduate student Robert Callen developed a metric known as ` signal available to attacker ' -LRB- Savat -RRB- , which is a measure of the strength of the signal emitted .
