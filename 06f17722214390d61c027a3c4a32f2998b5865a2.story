...
` The real issue with cats with TB is
that unless they are feral , they tend to have close contact with
humans , ' Carl Padgett , former president of the British Veterinary
Association , told the Sunday Telegraph .

` That is
where you ramp up a degree of the public health risk through direct
contact with cats that have TB and that is where I see the importance
rather than driving the outbreak among cattle . '
...
Professor Danielle Gunn-Moore , who led the study , told the newspaper : ` You need to be aware that cats are acting as
sentinels for other small furries that are infected .

` You might clear the
cattle , but if you do n't clear the cats as well , you could potentially
get reinfection . '
...
Chief veterinary officer Nigel
Gibbens told BBC Radio 4 's Farming Today : ' -LSB- Cats -RSB- roam and do explore
and could get into fights with feral cats and badgers themselves .
...
` There
is a threat to humans . If an animal has an unresolving bite wound or a
respiratory problem that wo n't go away , they should talk to their vets ,
and vets need to bear this in mind .

` Transmission to people is possible
and has happened but the number of cases in pets is low and so the
possibility of this is low . '
