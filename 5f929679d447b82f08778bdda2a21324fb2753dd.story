...
Officials were due to spend # 1.2 million of public money transforming an existing illegal camp into fifteen state-of-the-art eco plots .
...
Changes : A # 1.2 m plan to transform this illegal travellers site at Haldon Hill near Exeter has been scrapped because residents have refused to pay council tax

The council had secured a massive # 1.2 million grant from the Homes and Communities Agency -LRB- HCA -RRB- to pay for the camp , described as the first of its type in the country .
...
But if the council take the grant , build the site but then no-one moves in - the authority may be forced to pay back the # 1.2 million .

And they say the only way to make that back would be to increase council tax on local residents by 0.7 per cent a year .

A council spokesman said : ` The HCA have advised the council that should the site cease to operate they are entitled to require repayment in full of the # 1.12 m grant .

` Assurances have been sought from the HCA that they would not do so but these have not been given .

` Should the site cease to operate , the land value is likely to be a very small fraction of the grant value , leaving the council at risk of having to repay most if not all of the # 1.12 m back to the agency . '
...
It means that if the # 1.2 m revamp is axed the council must pay back the cash