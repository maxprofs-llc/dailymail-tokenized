...
The platform , called Assistive Context Aware Toolkit -LRB- ACAT -RRB- uses Professor Hawking 's existing cheek sensor , which is detected by an infrared switch mounted onto his glasses .
...
This echoes claims he made earlier in the year when he said AI ` would be the biggest event in human history , -LSB- but -RSB- unfortunately , it might also be the last . ' He argues developments in personal assistants Siri -LRB- pictured -RRB- and Cortana are symptoms of an IT arms race that ` pale against what the coming decades will bring '

Professor Hawking made today 's claims at an event in London , during which he unveiled a new communications platform -LRB- pictured -RRB- that replaces his current system . The platform called Assistive Context Aware Toolkit -LRB- ACAT -RRB- uses Professor Hawking 's existing cheek sensor to help double his typing speed

Professor Hawking has a Motor Neurone Disease related to amyotrophic lateral sclerosis -LRB- ALS -RRB- - a condition that has progressed over the years . This leaves him almost entirely paralysed .
