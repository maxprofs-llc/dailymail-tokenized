...
Grill master : The barbeque connects to an online database to find the optimal grilling time and technique for the food -LRB- pictured -RRB- and tells the chef where on the grill to place each item to ensure the best result . This also means that all the food will be ready at the same time
...
There 's an app for that : Hungry grillers will be able to keep tabs on the progress of their dinner using the app -LRB- illustrated -RRB- or receiving text messages . They could also choose voice prompts if they are nearby , freeing them up to mix with guests if they are having a party
