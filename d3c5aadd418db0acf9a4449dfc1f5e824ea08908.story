...
Internet companies have a threshold for releasing information on their users and only do so if there is a direct threat to life ; many criminals the GCHQ track cause significant damage to communities but do n't pose a direct threat to life , so their private information remains a secret
