...
Supported languages include Russian , Spanish , French , Italian , German and Portuguese - and for a limited time , the app and $ 10 -LRB- # 6 -RRB- language packs are free .

Word Lens uses augmented reality to translate text including road signs -LRB- pictured -RRB- , menus , newspapers , and more by pointing a phone 's camera towards it . Supported languages include Russian , Spanish , French , Italian , German and Portuguese and for a limited time , the app and $ 10 -LRB- # 6 -RRB- language packs are free
...
The app is available on iOS , Android -LRB- pictured -RRB- and Google Glass . To use the translation tool , users select which languages they want to translate to and from before holding the camera up to the text . Once a language pack has been downloaded , the user does n't need a network connection to use the app
...
Once a language pack has been downloaded , the user does n't need a network connection .

Developers Quest Visual announced Google 's acquisition last month , but did n't disclose how much the deal was worth . The app was recently showcased by Apple in one of its TV adverts -LRB- pictured bottom right -RRB-
...
Once a language pack is downloaded , it does n't need a web connection

@highlight

For a limited time , the Android , iOS and Google Glass app , as well as the $ 10 -LRB- # 6 -RRB- language packs , are free