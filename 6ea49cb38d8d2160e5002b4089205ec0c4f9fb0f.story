...
A good hacker can get full access to Nasdaq.com in a couple of days with the ability to do almost whatever he wants , such as push an announcement that Facebook shares have dropped 90 % -LSB- which -RSB- could cause havoc on the stock exchange , ' Mr Kolochenko told the Daily News .
...
All it was took was inputting random HTML code into the site 's script to see if it would be detected before displaying on the site , he further explained . Once it was n't , the security expert knew he had found a problem .
