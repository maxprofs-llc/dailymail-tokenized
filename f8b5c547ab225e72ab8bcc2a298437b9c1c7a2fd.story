...
However , at an altitude of 16,400 ft , roughly half the cruising height of a jumbo jet and almost four times the height of Ben Nevis , they did admit to some problems - having to carry oxygen to work , for example .

Scroll down for video

The view from the Office : The ALMA telescope is located deep in the Chilean desert , in one of the driest places on Earth - at an altitude of 16,400 ft , roughly half the cruising height of a jumbo jet and almost four times the height of Ben Nevis

A panoramic view of Llano de Chajnantors spacious grounds where the 66 antennas of the Atacama Large Millimetre/Submillimetre Array -LRB- ALMA -RRB- will be switched on today
...
places on Earth , ALMA is at an altitude of 16,400 ft -- roughly half the
...
Built deep in the Chilean desert , in one of the driest places on Earth , ALMA is at an altitude of 16,400 ft ¿ roughly half the cruising height of a jumbo jet and almost four times the height of Ben Nevis
...
Babak Tafreshi , one of the ESO Photo Ambassadors , has captured the antennas of the Atacama Large Millimeter/submillimeter Array -LRB- ALMA -RRB- under the southern sky in another breathtaking image

Under test : A spectacular sunset view of three prototypes of ALMA antennas , developed by Japan , North America and Europe , respectively , at the ALMA Test Facility -LRB- ATF -RRB- in Socorro , New Mexico , USA
...
Radio telescope antennas of the ALMA -LRB- Atacama Large Millimeter/submillimeter Array -RRB- project , in the Atacama desert , some 1500 km north of Santiago , on March 12,2013

The secret to the # 1 billion facility 's incredible resolution comes from two factors : height and distance .

ALMA 's highest receivers sit on a plateau some 16,500 feet -LRB- 5,000 meters -RRB- above sea level .

This is far above most of Earth 's atmosphere and water vapor , which obscures observations .

Astronomers working in ALMA 's facility at 9,500 feet -LRB- 2,900 meters -RRB- must use supplemental oxygen for extended stays .

The system currently comprises about 50 functional antennas .

When the array is finished , there will be 66 of these receivers that can be moved as far as 9.9 miles -LRB- 16 kilometers -RRB- apart .
...
ALMA is situated in the Chile desert at 16,400 ft -- roughly half the
