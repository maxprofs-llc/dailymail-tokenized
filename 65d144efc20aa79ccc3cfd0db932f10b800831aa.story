...
Black line : Observed global average changes . Green area : model simulations using only changes in natural factors -LRB- solar and volcanic -RRB- . Blue area : model simulations with the addition of human-induced emissions .

Climate changes since 1950 can not be explained by natural factors or variability , and can only be explained by human factors , the report says .

However , if the nation and the world do n't change the way they use energy , ` we 're still on the pathway to more damage and danger of the type that are described in great detail in the rest of this report , ' said study co-author Henry Jacoby , co-director of the Joint Program on the Science and Policy of Global Change at the Massachusetts Institute of Technology .
...
The map on the left shows a projected change in average annual temperature over the period 2071-2099 -LRB- compared to the period 1970-1999 -RRB- under a scenario that assumes rapid reductions in emissions and concentrations of heat-trapping gases -LRB- RCP 2.6 -RRB- . The map on the right assumes continued increases in emissions -LRB- RCP 8.5 -RRB- .

The colors on the map show temperature changes throughout the past 22 years -LRB- 1991-2012 -RRB- compared to the 1901-1960 average , and compared to the 1951-1980 average for Alaska and Hawaii . The bars on the graphs show the average temperature changes by decade for 1901-2012 -LRB- relative to the 1901-1960 average -RRB- for each region . The far right bar in each graph -LRB- 2000s decade -RRB- includes 2011 and 2012 . The period from 2001 to 2012 was warmer than any previous decade in every region .

The map on the left shows the projected change in average temperature under a scenario that assumes substantial reductions in heat trapping gases -LRB- B11 -RRB- . The map on the right assumes continued increases in global emissions -LRB- A2 -RRB-
...
percent in the Northeast . Experts expect the number of times it rains to go down , but the intensity of downpours to go up . Especially at risk in this region are the approximately 1.6 million people who live within the Federal Emergency Management Agency 's -LRB- FEMA -RRB- 100-year coastal flood zone , the majority of whom live in New York and New Jersey .
...
-LRB- twice , setting records for April and May last year -RRB- , Georgia , Michigan ,
