...
The Murata Cheerleaders -LRB- pictured -RRB- were built by Japanese-based Murata Manufacturing . Each robot balances - similar to Weebles - and perform high-precision routines thanks to real-time position measurement technology
...
Instead of wheels , the cheerleading robots -LRB- pictured -RRB- balance on a removable ball , which rolls in its housing to help the machines dance and move . They remain upright due to three advanced gyro sensors , which incorporate inverted-pendulum control technology , to detect tilt angles
