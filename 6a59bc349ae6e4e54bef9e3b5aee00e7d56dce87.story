...
Scientists have developed interactive semi-transparent mirrors that allow people to ` touch ' exhibits in museums that are behind glass , using the reflection of their fingers , to reveal information and manipulate inaccessible objects -LRB- pictured -RRB-
...
To create the technology -LRB- pictured -RRB- computer scientists from the University of Bristol created a setup that involved sensors , projectors and semi-transparent mirrors placed in front of a pane of glass



In a museum , people in front of a cabinet would see the reflection of their fingers inside the glass overlapping the same point behind it , allowing them to seemingly reach around objects . They could also access extra information and even 3D models -LRB- pictured -RRB- by pointing at a chosen artefact
...
One example is when people ca n't access a shop because it 's closed .
...
The researchers have also demonstrated how their technology can be used by musicians . They recorded loops in digital mixers , which appeared as floating images above it -LRB- pictured -RRB- . Musicians could grab the representations to play or edit them using different musical effects
