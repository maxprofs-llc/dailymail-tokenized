...
This ultrasharp image uses a new method to simultaneously resolve microtubules -LRB- green -RRB- , mitochondria -LRB- purple -RRB- , Golgi apparatus -LRB- red -RRB- , and peroxisomes -LRB- yellow -RRB- from a single human cell . Each of these components works together to make the cell function
...
When two objects are closer than about 200 nanometres apart - about one five-hundredth the width of a human hair - they can not be distinguished using a traditional light microscope .
...
This is the first time researchers have been able to develop an imaging system that can capture structures less than 10 nanometres apart -LRB- about the size of an antibody -RRB- . One nanometre is a millionth of a millimetre or around the size of a glucose molecule
