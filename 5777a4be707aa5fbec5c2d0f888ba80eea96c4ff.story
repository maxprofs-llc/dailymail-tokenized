...
Researchers from Scotland have translated the key gestures used by chimps . From 4,351 gestures , experts were able to identify 66 that were used for 19 specific message meanings , including hugging the air to ask for an embrace -LRB- stock image pictured -RRB- , and slapping objects together to ask another chimp to follow them
...
Recordings taken from 2007 to 2009 in Uganda found that nibbling on a leaf -LRB- stock image pictured -RRB- signals intent that a chimp is ready to mate
...
` -LSB- Recent -RSB- findings about great ape
...
The researchers were able to narrow down these 66 gestures to 36 that are used intentionally to achieve 15 purposes , other than in play . For example , when a mother shows their chimp the bottom of their foot -LRB- stock image pictured -RRB- , it tells the child they are allowed to climb on their parent 's back

In a separate study , primatologists from Switzerland 's University of Neuchâtel wanted to translate a specific gesture used by bonobos . Stretching an arm towards another bonobo , sweeping it inwards , then finishing with a wrist-twirl that turns a downward-facing palm upwards -LRB- pictured -RRB- is used to initiate sex
...
When the gestures resulted in sex , the initiator approached from a distance of around 3ft -LRB- 1 metre -RRB- with their back in a concave position .
