A mother was hit with a staggering # 1,200 in phone bills after texting hundreds of smiley face emoticon symbols that were n't included in her ` unlimited ' # 31-a-month contract .
...
Not happy : Paula Cochrane has been hit with a staggering # 1,200 phone bill after texting hundreds of smiley face emoticon symbols that were n't included in her ` unlimited ' # 31-a-month contract
...
Picture messages , or MMS -LRB- multi-media service -RRB- messages cost far more than standard texts - meaning users can be hit by huge bills if they send dozens of the symbols every day .
...
If you own one of the Samsung handsets affected , you can stop this from happening by taking the following steps -LRB- instructions may vary depending on what handset you use -RRB- :
...
4 . Select UniCode instead of automatic OR Select GSM alphabet -LRB- depending on handset -RRB-
...
In some cases , especially on older handsets , the emoticons are converted into MMS -LRB- multi-media service -RRB- messages , which can cost up to 40p each depending on what network you 're on .
...
Speaking on the issue an Ofcom spokesperson told the Daily Express : ` We are aware that in some circumstances SMS may be transferred into MMS -LRB- for example , where one text is sent to multiple recipients or where an emoticon or emoji is used -RRB- .
...
` It can also happen when the message contains icons , emoticons and symbols or an email address . And some apps -LRB- such as Facebook -RRB- that integrate with a customer 's contact list in their smartphone may result in an MMS charge too .

` To stop this happening , customers should make sure they do n't include symbols , icons or emoticons and also disable the integration between their contact list and apps like Facebook .
