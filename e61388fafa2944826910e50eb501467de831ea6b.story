...
` The new resonance discovered by the ATLAS and CMS experiments at the CERNLarge Hadron Collider -LRB- LHC -RRB- could be the long-sought Higgs boson of the Standard Model , ' say the scientists .
...
the Large Hadron Collider -LRB- LHC -RRB- - the ` Big Bang ' particle accelerator
