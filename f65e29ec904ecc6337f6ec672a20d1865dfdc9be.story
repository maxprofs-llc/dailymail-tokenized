...
AGP - Malaga Airport did n't want to take its first three letters from the city name as mal means bad in Spanish . So instead it is AGP , taking ` AG ' from the middle of the word and filling with the letter ` P ' .
...
LOL - in the spirit of unusual acronyms , the term usually use din text messages to signify ` laugh out loud ' is actually Derby Field airport in Nevada , serving Lovelock City -LRB- hence the code -RRB- .
...
The codes are known as IATA location identifiers , and are set by the International Air Transport Association -LRB- IATA -RRB- .
...
` It 's especially surprising -LRB- and interesting -RRB- when the code comes from very early or even unofficial designations . '
