...
So it 's timely that SRD Wireless has announced the launch of PQChat - an app for iOS devices based on the company 's own ` Never-The-Same ' -LRB- NTS -RRB- encryption .
...
SRD Wireless has unveiled their PQChat app , which they claim is the world 's first ` quantum-proof ' messenger . Users are in complete control of their messages and can apparently delete them remotely if necessary -LRB- left -RRB- , while only messages can only be read by approved contacts -LRB- right -RRB-
...
` Modern communication tools simply are n't built with this as a priority and so make compromises in order to allow communication .
...
PQChat only stores a one-way encrypted value of the user 's phone number , which can not be reconstructed , plus an encrypted user-supplied nickname and pseudo ID image .
...
To ensure a message recipient is who they claim to be , PQChat uses SRD 's patented Man At The End -LRB- MATE -RRB- authentication .

By providing a video and audio authentication message , users can be certain of each others ' identity .

Locker

To guarantee important information is n't lost , PQChat includes a secure locker where users can store information that they want to guarantee is kept safe and private .
...
' A quite frankly terrifying amount of information is out there on you for anyone who wants to grab it ; and apps like WhatsApp and Snapchat do n't help by hoovering up your contact details and passwords to store , ' said the design team .

` PQChat stores nothing on you - not even your phone number , messages or password - meaning it could n't share the details around even if it wanted to . '
...
Within the app users can set messages to ` self-destruct ' -LRB- left -RRB- so they delete themselves after a certain amount of time , while a variety of symbols -LRB- right -RRB- tell you the status of your message . Like other apps users can also embed videos , videos and voice
...
` Quite simply , if we can not guarantee this trust between us and our users , then all of our claims about the security of PQChat itself are worthless . '
