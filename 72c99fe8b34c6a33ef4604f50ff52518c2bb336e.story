...
A Birmingham University project has created a robot that can grab plates and cups . It can work out how to pick up different objects placed in front of it . Called ` Boris ' -LRB- shown -RRB- it is controlled by three separate computers
...
Boris has thick multi-jointed arms that enable it to pick up objects . The robot can learn various grips and costs # 350,000 -LRB- $ 570,000 -RRB- to build
...
` The system we have developed allows the robot to assess the object and generate hundreds of different grasp options . That means the robot is able to make choices about the best grasp for the object it has been told to pick up , and it does n't have to be re-trained each time the object changes . '
