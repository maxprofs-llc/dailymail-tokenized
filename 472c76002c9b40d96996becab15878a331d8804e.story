...
Is the future supersonic ? Hopes for super speedy journeys by air have been rekindled as a number of companies , including Boeing -LRB- pictured -RRB- have unveiled concepts for supersonic jets of the future , and Nasa has begun tests to work out a way of creating an aircraft that is not as noisy as Concorde was
...
Aeronautics engineers at Nasa are working to define a new standard for low sonic booms . They have flown F/A -18 mission support aircraft -LRB- pictured -RRB- to create low-intensity sonic booms in a bid to gauge the public 's tolerance to noise at the agency 's Armstrong Flight Research Centre in Edwards , California
...
It 's more than a decade since Concorde -LRB- pictured -RRB- was retired from service . No company will build a supersonic passenger plane unless it is allowed to fly supersonically over land - something that was off-limits for Concorde
...
Sonic boom noise is measured in perceived decibel level -LRB- PLdB -RRB- .
...
Boston-based Spike Aerospace has designed a supersonic jet called the Spike S-512 that it claims could carry 12 to 18 passengers at 1,100 mph -LRB- 1,700 km/h -RRB- , or Mach 1.6 .
...
successor , dubbed the SR-72 -LRB- pictured above -RRB- .
