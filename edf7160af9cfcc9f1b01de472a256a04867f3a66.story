...
Computer software in the system not only recognises the driver and learns their habits , it can then predict their routine and changing preferences . It will even check a calendar in advance and remind owners to take their child 's sports kit to sports day , or make an important phone call -LRB- pictured -RRB-
...
Jaguar also unveiled its virtual windscreen that uses the entire screen as a display so the driver 's eyes need never leave the road . Drivers on a racetrack could have ` ghost cars ' projected onto the screen which they could then race -LRB- pictured -RRB- , said Jaguar
...
This is based on touchscreens that detect the proximity of a user 's finger from around 6 inches -LRB- 15cm -RRB- , which means the system can be used to accurately track a user 's hand and any gestures it makes inside the car .
