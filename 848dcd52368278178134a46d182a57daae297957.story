...
` For example , the gossip websites listed -LRB- see image below -RRB- mostly have high PageRank scores , but would not generally be considered reliable .
...
` Informally , we define the trustworthiness or accuracy of a web source as the probability that it contains the correct value for a fact -LRB- such as Barack Obama 's nationality -RRB- , assuming that it mentions any value for that fact . '
...
He said : ` This was research - we do n't have any specific plans to implement it in our products . We publish hundreds of research papers every year . '
