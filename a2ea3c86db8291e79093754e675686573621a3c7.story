...
A search for ` Marie Curie ' brings up this kind of search box , with suggested follow-up searches suggested in blue

Searching ` Taj Mahal ' brings up a map of the Taj Mahal , while also offering other alternatives which the user may be looking for
...
Amit Singhal , Google 's senior vice president of engineering , said : ` Search is a lot about discovery - the basic human need to learn and broaden your horizons .
...
The redesign , which for now affects only U.S.-based English language users , is gradually being rolled starting Wednesday on desktop , mobile and tablet platforms .

Google plans to eventually expand the new search features outside the U.S. - and many UK users have reported seeing the feature in the last few days .

Many of the results will carry more graphical elements , compared to standard lists of search results , such as maps and pictures of related results .
...
Google is by far the leader in search , with 66 percent of the U.S. market , according to comScore .

But it sees other sites such as Facebook as competition , as users there can poll their friends and acquaintances for information on various topics without leaving the Facebook ecosystem .

Under the new system , many users will end their Internet search without leaving Google 's pages , when in the past they might have continued to a site such as Wikipedia , which is collaborating with Google on the new search features .

Google said it could actually drive more traffic to Wikipedia , which will be prominently linked to in the summary boxes .
...
He said : ` We are not magicians - we are just computer science geeks . '

Similarly , Google yesterday revealed the ` Research Pane ' , which provides a similar service while writing in Google Documents

Explaining the concept , Singhal said : ` Take a query like -LSB- taj mahal -RSB- . For more than four decades , search has essentially been about matching keywords to queries . To a search engine the words -LSB- taj mahal -RSB- have been just that - two words .

` But we all know that -LSB- taj mahal -RSB- has a much richer meaning . You might think of one of the world 's most beautiful monuments , or a Grammy Award-winning musician , or possibly even a casino in Atlantic City , NJ . Or , depending on when you last ate , the nearest Indian restaurant .
...
He continued : ` Google 's Knowledge Graph is n't just rooted in public sources such as Freebase , Wikipedia and the CIA World Factbook . It 's also augmented at a much larger scale - because we 're focused on comprehensive breadth and depth .

` It currently contains more than 500million objects , as well as more than 3.5 billion facts about and relationships between these different objects . And it 's tuned based on what people search for , and what we find out on the web .
...
Search engine has 3.5 billion facts ready to weave into search results
