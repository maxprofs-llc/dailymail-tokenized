...
Next time you hold a secret conversation in a secure room , you might want to make sure there are n't any crisp packets or plants in the line of sight of a window .
...
Research led by the Massachusetts Institute of Technology has shown that sounds can be identified by monitoring tiny vibrations of objects with a high speed camera . In one experiment the researchers identify words being spoken by filming a crisp packet through soundproof glass -LRB- shown -RRB-

The research was carried out at the Massachusetts Institute of Technology -LRB- MIT -RRB- in partnership with Microsoft and Adobe by Abe Davis , Michael Rubinstein , Neal Wadhwa , Gautham Mysore , Fredo Durand and William T. Freeman .
...
For example , in one experiment the scientists were able to recover intelligible speech from the vibrations of a crisp packet filmed from 15 feet -LRB- 4.6 metres -RRB- away through soundproof glass .
...
` People did n't realise that this information was there . '
...
As different edges move in different directions , the algorithm aligns all the measurements so that they do n't cancel each other out .
