...
The disk was developed in four stages : Initially the disk had thirty-two small round gold circles , a large circular plate , and a large crescent-shaped plate attached -LRB- left -RRB- . At some later date , two arcs -LRB- constructed from gold of a different origin , as shown by its chemical impurities -RRB- were added at opposite edges of the disk -LRB- right -RRB- .

To make space for these arcs , one small circle was moved from the left side toward the center of the disk and two of the circles on the right were covered over , so that thirty remain visible -LRB- left -RRB- . The final addition was another arc at the bottom , the ` sun boat ' , again made of gold from a different origin .
