...
This is due to a bug in the streaming box 's screensaver feature that means picture files are n't being cached correctly .
...
Amazon Fire TV users have complained that the streaming box is draining their internet data . Amazon said this is due to a bug in the streaming box 's screensaver feature -LRB- pictured -RRB- that means
image files are n't being cached properly . It is working on fixing the problem and has advised users to disable the feature temporarily
...
Hayes initially blamed Amazon Fire TV 's Advanced Streaming and Prediction -LRB- ASAP -RRB- feature for draining his data .
...
This tool ca n't be switched off .
...
The fault was initially blamed on Amazon Fire TV 's Advanced Streaming and Prediction -LRB- ASAP -RRB- feature . ASAP learns what movies and shows users like , -LRB- pictured -RRB- and gets them ready to watch . This is designed to remove buffering , but means data is used in the background
