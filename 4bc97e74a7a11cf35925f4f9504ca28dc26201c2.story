...
The proposed new policy calls for adhering to a 40-year life span for each reactor and for building no more new reactors .

It leaves open the possibility of restarting reactors before they are eventually phased out , but only if they have passed strict safety tests and won approval by a newly formed regulatory commission .
...
Before the Fukushima disaster , Japan relied on nuclear power for one-third of its energy

Following Japan 's 2011 Fukushima disaster , Germany decided to speed up phasing out its nuclear power plants , shutting them down within a decade and betting on renewable energies instead .

Nuclear power had accounted for a little more than 20 percent of Germany 's needs but has since fallen well below that level .

Energy experts note that relying more on renewable energy is easier for European countries that can draw on surplus power from neighboring countries when volatile wind and solar power fall short .

As an island nation Japan lacks that option .
...
Japanese cabinet has agreed to changes as it overhauls energy policy
