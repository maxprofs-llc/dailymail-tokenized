...
Indecisive : A textile designer in Budapest has created experimental fabric -LRB- pictured -RRB- that can change colour in seconds like a chameleon as it is filled with electronics
...
The fabric , which comprises her Chromosonic research project , consists of ` arduino -LSB- a microcontroller -RSB- with 12V power supply and 20 custom PCBs -LSB- printed circuit boards -RSB- driving and controlling 4 industrial 24V DC power supplies , that heat two handmade textile woven with nichrome wires and screen-printed with thermochromatic dying , revealing the pre-programmed patterns . '

A textile designer in Budapest has taken the first steps to creating clothing that can change colour like a chameleon -LRB- pictured -RRB- . The lizards have specialized cells - chromatophores - which contain pigments in their cytoplasm , in three layers below their transparent outer skin , but the fabric uses electronics to change colour

Making a mark : Patterns on the fabric are generated from sound files and heat . People also can leave traces on the surface by touching it -LRB- pictured -RRB-
...
Chain reaction : Two slow moving textile ` displays ' show the content and react to environmental changes such as heat and pressure by changing the colour and pattern of the fabric -LRB- pictured -RRB-
...
` But it was n't my intention as it is an installation . I think it provides many opportunities for further reflection and it can be a food for thought . '

Would you wear hardware ? Judit Eszter Karpati created the interactive fabric using computer programming , engineering and electronic devices -LRB- pictured -RRB-

Fashion fast forward : Ms Karpati told MailOnline that one day her innovation could be developed to the next level to become wearable , involving more experts from electronics and the IT sector to embed the necessary electronics -LRB- pictured -RRB- into the main body of the fabric
