...
` We do n't want to antagonise the council . It is all above board , we just want to carry on for our members .
...
` It certainly is n't a Naturist club recognised by British Naturism .
...
` We have no problem with the existence of adult/swingers clubs - each to their own , but we can not forgive them muddying the image of Naturism because , time and again , this causes us problems .
