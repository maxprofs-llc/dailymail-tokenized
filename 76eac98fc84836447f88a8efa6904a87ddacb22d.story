...
Scientists have developed a headset that uses electricity to change your mood by using a smartphone -- and it should be on sale next year . The device currently consists of a set of electrodes -LRB- illustrated with a stock picture -RRB- connected to a phone to administer an almost imperceptible shock
...
The device works by using a type of transcranial direct current stimulation -LRB- TDCS -RRB- where a barely imperceptible electrical current is applied when a user presses a button on the smartphone .
...
The experiment was funded by the company , which has recently raised $ 13 million -LRB- # 8.2 million -RRB- in venture capital to bring its products to market .
