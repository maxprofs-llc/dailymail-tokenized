...
On camera : This is the moment that an RAC patrol man was hit by a lorry -LRB- right -RRB- swerving off a motorway

Hit-and-run : Recovery driver Mark Wootton -LRB- left -RRB- is seen securing a vehicle in an emergency refuge area - narrowly avoiding being killed by lorry driver Terence Poolman -LRB- right -RRB-
...
Astonishing : Poolman -LRB- in the yellow vehicle -RRB- veered in an arc , and struck the patrol man before carrying on
