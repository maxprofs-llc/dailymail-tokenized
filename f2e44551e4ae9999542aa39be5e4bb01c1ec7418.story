...
Reaction Engines claims Sabre can be used to help accelerate existing aircraft up to five times the speed of sound and plans to use the technology on a unique 3,500 mph ` spaceplane ' called Skylon -LRB- pictured -RRB-
...
The A2 vehicle , which is designed to be propelled by the Scimitar engine , has exceptional range -LRB- ca. 20,000 km both subsonic and supersonic -RRB- and is therefore able to service a large number of routes whilst simultaneously avoiding supersonic overflight of populated areas and the related sonic booms that can be heard on the ground . Its good subsonic performance enables it to service conventional subsonic overland routes .
...
The A2 vehicle , which is designed to be propelled by the Scimitar engine , has exceptional range -LRB- ca. 20,000 km both subsonic and supersonic -RRB- and is ` able to service a large number of routes whilst simultaneously avoiding supersonic overflight of populated areas and the related sonic booms that can be heard on the ground , ' the firm says .
...
The Sabre engine has taken part in 100 successful test runs and its design was recently validated by the European Space Agency to validate the design . Modern-day traditional aviation engines have to carry tanks of liquid oxygen when travelling at more than 1,900 mph because they ca n't ` breathe ' oxygen . Oxygen helps an engine to burn the fuel needed to power its propulsion . Reaction Engine 's Sabre design uses a system of pipes , filled with helium . The air passes through these pipes and the helium helps remove any heat . Once in space , the engine is capable of switching into rocket mode .
