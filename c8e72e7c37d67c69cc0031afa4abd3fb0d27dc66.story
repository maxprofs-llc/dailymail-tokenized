...
The company behind the system , Videalert , uses advanced camera technology known as ANPR -LRB- automatic number plate recognition -RRB- to capture drivers breaching traffic laws .
...
The system has been installed using a ` capital expenditure neutral ' model , which sees all costs recovered through the issuing of penalty charge notices -LRB- PCNs -RRB- .
...
a situation similar to Clapham 's ` money box junction ' -LRB- in south London -RRB-
