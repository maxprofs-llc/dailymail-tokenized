...
It could also decrease the amount of power being used by the central processing unit -LRB- CPU -RRB- , while increasing the amount of energy needed to power the graphical processing unit -LRB- GPU -RRB- specifically needed for the game .
...
If the phone detects that the remaining power capacity wo n't last that long , certain power management actions may be performed .
