...
That 's all set to change later this year , though , as the International Astronomical Union -LRB- IAU -RRB- will allow the public to vote on the names of exoplanets for the first time .
...
The lowercase letter then explains where the planet sits in its system ; b is the innermost planet -LRB- which would be Mercury in our solar system -RRB- , followed by c , d and so on .
...
In September , astronomy clubs and non-profit organisations will be allowed to sign up for the IAU Directory for World Astronomy website -LRB- directory.iau.org -RRB- .

Then in October , of the 305 planets 20 to 30 will be selected for naming .

Only 305 initial planets were selected as more recent discoveries have n't been confirmed , and the IAU did n't want to select planets that might later be proven to not exist .

In December the clubs and organisations will be invited to send proposals for names , subject to the IAU 's naming rules .

These state that a proposed name can not be more than 16 characters , it must be pronounceable , it can not be offensive and the names of living people will not be allowed .
...
More than 800 planets have been found outside the solar system to date , with thousands more waiting to be confirmed . The diversity of these planets has been tremendous , with some found orbiting binary stars -LRB- illustration shown -RRB- and others found in tight orbits - but few have been given ` proper ' names
...
Although the IAU does n't technically ` own ' space , it still maintains the database of named objects in the night sky , making this an ` official ' naming process for exoplanets .

The new ` official ' naming system will allow planets outside the solar system to be named by members of public for the first name . This could give rise to names based on things from popular culture such as Tatooine from Star Wars -LRB- pictured -RRB- , a popular choice for space enthusiasts
