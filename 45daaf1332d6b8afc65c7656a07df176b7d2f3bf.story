...
Danger : Using a mobile while driving is now illegal in the UK -LRB- photo posed by model -RRB-
...
` Our findings suggest that the distracted brain sacrificed areas important for visual attention and alertness to recruit enough brain resources to perform a secondary , cognitive task -LSB- speaking -RSB- , ' the report concluded .
...
Use your head : Brain scans revealed that chatting , whether or not it was on the phone , affected drivers ' abilities to react -LRB- photo posed by model -RRB-
