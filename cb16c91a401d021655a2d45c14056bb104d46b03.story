...
The SiRFusion software , from Cambridge Silicon Radio -LRB- CSR -RRB- , helps app developers map indoor locations . It combines real-time Wi-Fi signals , GPS and sensors in phones to calculate accurate points , which could help people navigate shopping centres , find items in supermarkets and locate people in crowds

It was created by Cambridge Silicon Radio -LRB- CSR -RRB- , and can be added to any Android app .
...
CSR claims the technology is accurate to around 16ft -LRB- five metres -RRB- for a busy location , but this accuracy is improved depending on the number of Wi-Fi signals , for example .
...
CSR claims the technology is accurate to around 16ft -LRB- five metres -RRB- for a busy location , such as a shopping centre , but this accuracy can be improved depending on the number of Wi-Fi signals , for example .
...
The Marauder 's Map -LRB- pictured -RRB- is a fictional map of Hogwarts School of Witchcraft and Wizardry as featured in the Harry Potter franchise . It tracks the location of every person in the grounds , shown as footprints labelled with the person 's name -LRB- pictured -RRB-
...
` It would -LSB- also -RSB- allow the airline to understand where their passengers spend time at the airport or get lost . '
