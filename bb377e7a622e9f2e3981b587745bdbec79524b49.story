...
To get his professional-looking images , Mr Coles takes three separate images using his array of telescopes , sometimes on different nights . He uses filters to select different wavelengths and then layers up his images to make the perfect picture -LRB- shown above -RRB-
...
A supernova -LRB- pictured -RRB- occurs in two different ways when there is a change in the core of a star . The first type happens in binary star systems - two stars that orbit the same point - when one of the stars - a white dwarf - steals matter from its companion . Eventually the white dwarf acquires too much matter and explodes in a supernova
...
Alternatively , an explosion is caused at the end of a star 's lifetime . As it runs out of nuclear fuel , some of its mass flows into its core , which becomes so heavy that it ca n't withstand its own gravitational force . The core collapses , resulting in a supernova .

Supernovae can also be caused at the end of a star 's lifetime . As it runs out of nuclear fuel , some of its mass flows into its core , which becomes so heavy that it ca n't withstand its own gravitational force . The core collapses , resulting in a supernova -LRB- pictured -RRB-

Scientists study supernovae -LRB- pictured -RRB- to learn more about the universe . One kind of supernova has shown scientists that we live in an expanding universe that is growing at an ever increasing rate
