A new collaborative robot -LRB- pictured -RRB- can work alongside human factory workers
...
The robot can lift objects weighing up to 77 lbs -LRB- 35kg -RRB- and could be used in a number of industries , from warehouses to production lines .
...
Robots have been used on production lines for decades . In the car industry for instance , many are automated so that robots perform the bulk of dangerous tasks , such as welding -LRB- pictured -RRB- , away from humans

Some 15,000 robots pick up items ordered by customers in warehouses to save humans walking miles .

The robot can lift up to 77 lbs -LRB- 35kg -RRB- .
...
It has a protective green covering so it does n't ` pinch ' workers .
...
Fanuc 's robot can lift objects weighing up to 77 lbs -LRB- 35kg -RRB- and could be used in a number of industries , from warehouses to production lines . This illustration shows it lifting a wheel into a car -LRB- left -RRB- and it moving a piece to a machine -LRB- pictured right -RRB-
...
Amazon has already introduced robots to it vast warehouses to work along human employees . A Kiva robot is shown moving goods -LRB- left -RRB- and another robot unloading them -LRB- right -RRB- , which is placed in a safety cage
...
Could be used in warehouses to lift heavy items up to 77 lbs -LRB- 35kg -RRB-