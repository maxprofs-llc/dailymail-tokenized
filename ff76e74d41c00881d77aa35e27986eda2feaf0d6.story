...
The experts studied Daubenton 's bats -LRB- pictured -RRB- . They said : ` The bats seem to have adopted a simple trick - once another individual is close enough for your biosonar to pick up its echo -LSB- and -RSB- copy this individual 's flight direction . The discovery could help improve search and rescue missions and surveillance operations
...
The robotic wings are made using carbon fibre and , similar to the wing of a bird , each have a wrist joint custom built using a 3D printer

Inspired by the way bats and birds avoid colliding in mid-air , roboticists have created flying drones with ` morphing wings ' .

The robotic wings are made using carbon fibre and , similar to the wing of a bird , each have a wrist joint custom built using a 3D printer .

These joints are hinged in such a way so that as the rest of the wing flaps , the hand can freely fold and unfold over the arm , much like origami folding , without any actuation .

In particular the pin joint connects the arm wing and the hand wing .

The arm wing attaches to the body of the robot at the shoulder joint , which initiates the flapping .

And the complete wing set has a wingspan of 15.7 inches -LRB- 40cm -RRB- with a length , or chord , of three inches -LRB- 80 mm -RRB- .

In addition to morphing shape to avoid collisions , the mechanism could also allow future flying robots to easily squeeze between obstacles , such as branches of a tree , and fully recover after accidental hard impacts .

The morphing technology was built by experts from Stanford University .



@highlight

Researches studied pairs of Daubenton 's bats in Barrow Gurney , Somerset
