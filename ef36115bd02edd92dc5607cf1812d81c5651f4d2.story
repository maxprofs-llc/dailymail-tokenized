...
Fejes ' final full-size pieces cover 4096 x 4096 pixels . The images pictured are compressed so do n't display all the colours . The view also varies depending on the number of pixels a screen can handle - for example , it will look different on a phone to a laptop to a high-definition TV
...
` At first I did n't really know if it was going to end up looking beautiful or not , it was just an interesting programming challenge for me , ' Fejes told New Scientist . ` I was very surprised at how beautiful it turned out to be . '
...
These images are compressed versions so do n't display all the colours .
...
They could use all the colours from the RGB -LRB- red , green and blue -RRB- system up to 24-bits , a total of 16,777,216 colours
