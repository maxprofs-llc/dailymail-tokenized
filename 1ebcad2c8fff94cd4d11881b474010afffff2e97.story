...
' A sufficiently long power measurement -LRB- several minutes -RRB- enables the learning algorithm to ` see ' through the noise , ' the researchers write .
...
If they do n't know your routine , that accuracy of location drop from 90 per cent to about 60 per cent .
...
` You could install an application like Angry Birds that communicates over the network but does n't ask for any location permissions , ' Yan Michalevski , one of the Stanford researchers told Wired .
