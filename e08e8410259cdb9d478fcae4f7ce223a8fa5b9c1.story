Phones have been blamed for creating a generation of people who can only communicate in so-called ` text speak ' and smiley faces .
...
` Learning new vocabulary can be stressful and challenging , but it does n't have to be , ' explained Sam Mendleson and Allan Zhang .
...
The general meaning of a new word is the same as the word it is replacing , but users can tap it to see a full dictionary definition -LRB- pictured -RRB- . They can also revert it back to the original word , and recipients can press the lightbulb icon to see what the sender initially typed
...
Free Words U was created by developers Sam Mendelson and Allan Zhang
