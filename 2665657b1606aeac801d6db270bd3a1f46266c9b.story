...
The retailer is understood to be aiming to ` undercut rivals ' and ` grab a meaningful market share ' by tempting consumers using iPhones and Galaxy phones - which normally cost about $ 200 -LRB- # 127 -RRB- - to switch to their free version .
...
` Apple 's nightmare ' : If Amazon , which is already behind the popular Kindle e-reader -LRB- right -RRB- can conquer the market with free phones , Apple may be forced to lower the prices on its iPhone -LRB- left -RRB-
...
at the same time . -LRB- Wireless carriers typically discount the price of
devices if customers sign up for a one or two-year wireless contract . -RRB- '

Cost : Smartphones like the Samsung Galaxy typically cost about $ 200 -LRB- # 127 -RRB-
...
Lessin said the free strategy ` is n't set in stone - it depends on a few things that Amazon still needs to work out .

For example , the company will need to figure out the financial arrangements with hardware suppliers who are actually manufacturing the phones - something one of Lessin 's sources is n't entirely sure is feasible .
