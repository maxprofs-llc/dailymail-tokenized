...
The sensor -LRB- pictured -RRB- , mounted below the keyboard , uses two cameras and three infrared LEDs to track the movement of any object . Leap Motion says it hopes the technology will one day find its way into smartphones and even head mounted displays
...
Users can play popular app games such as Fruit Ninja -LRB- pictured -RRB- on the laptop , using the built-in Leap Motion sensor to ` slice ' fruit in mid air
