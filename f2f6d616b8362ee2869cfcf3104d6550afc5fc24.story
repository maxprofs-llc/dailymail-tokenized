...
The 105-ft -LRB- 32-m -RRB- long , 55-ft -LRB- 17-m -RRB- wide , 180-ton -LRB- 163-tonne -RRB- watercraft features two 3,480 hp diesel engines , two 180-kW Caterpillar diesel electric generators , and a top speed of 30 knots -LRB- 56 km/h , or 35 mph -RRB- .
...
` Sea SLICE , designated as a High Speed Vessel -LRB- HSV -RRB- for the exercise , is demonstrating the flexibility achievable by ` modularity ' in a small , fast , highly maneuverable platform , ' the Navy wrote when it first trialled the ship .
...
` The joint high speed vessel -LRB- experimental -RRB- Joint Venture -LRB- HSV-X1 -RRB- has been evaluating the potential of fast , shallow draft , open architecture , multi-mission vessels with large payload fractions in the areas of mine warfare , special operations , ship-to-objective maneuver and medical and non-combatant support operations . '

Some of its weapons tested during FBE-J include the joint Lockheed Martin and Oerlikon Contraves 35mm Millennium Gun and the NetFires System and launcher , intended to launch Loitering Attack Munitions -LRB- LAM -RRB- - although these have now been removed .
