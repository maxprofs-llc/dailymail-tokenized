James Bond may like his Martini shaken , not stirred , but the fictional spy has n't had to contend with zero gravity when sipping his favourite tipple .
...
A Californian company has designed a martini glass -LRB- pictured alongside a cup -RRB- intended for zero gravity that has ridges to ensure liquid stays inside it and can be sipped by an astronaut

A company called Cosmic Lifestyle Corp -LRB- CLC -RRB- in Oakland , California came up with the design - which is a work in progress - to solve the problem of drinking in space .
...
To solve this problem , liquid is typically kept in bags with attachment for straws , but while this is practical , it 's not an elegant solution and means astronauts ca n't smell the liquid , which is naturally less pungent and tasteless in zero gravity .
...
In the 1979 film , Moonraker , James Bond , played by Roger Moore -LRB- a poster is shown -RRB- , has a space adventure but does n't attempt to drink his signature martini in space
...
Because there is already a printer on the International Space Station -LRB- ISS -RRB- , the idea is that glasses could be printed off straight away , without the need to transport the delicate vessels .
...
Researchers at the Maseeh College of Engineering and Computer Science at Portland State University recently unveiled a zero gravity espresso cup -LRB- pictured -RRB- , which has a series of channels to simulate pouring
...
It has created a Kickstarter campaign to continue developing the cup and raise $ 30,000 -LRB- # 20,000 -RRB- to eventually print it on the ISS .
...
The ` glass ' can be pre-ordered from the crowd funding website for $ 400 -LRB- # 263 -RRB- and $ 500 -LRB- # 329 -RRB- for a colourful version , and is due to ship in February next year .
...
While a martini glass may be useful , arguably champagne and carbonated drinks remain the final frontier in space drinks because bubbles are n't buoyant in zero gravity conditions as they are on Earth and so behave in a strange way .
