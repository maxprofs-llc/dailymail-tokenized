...
A single water molecule is made from a large oxygen atom joined to two hydrogen atoms with covalent bonds -LRB- a chemical bond that involves the sharing of two electron pairs between atoms -RRB- .
...
A water molecule is made from an oxygen atom joined to two hydrogen atoms with covalent bonds -LRB- a bond that involves the sharing of two electron pairs -RRB- . When a hydrogen atom drifts close to an oxygen atom , it bonds with it , creating a hydrogen bond . It 's the strange behaviour of these bonds that explains the Mpemba effect

The strange behaviour of hot water freezing more quickly has been noted by great thinkers throughout history , including Aristotle -LRB- pictured -RRB- and Descartes
...
However , some physicists have noted that the explanation can not currently be used to predict new properties of water that could be created by shortening covalent bonds , for example so there is one step to go before the mystery is satisfactorily solved .
