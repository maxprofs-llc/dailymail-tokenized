...
` Anything we can learn about the -LRB- latest -RRB- battery failure would be helpful -LRB- to the ongoing investigation -RRB- , ' Knudson said .
...
` Our 787s are operating normally , and we have n't experienced any issues with the batteries , ' spokeswoman Christen David said .
...
What is n't clear yet is what exactly went wrong to cause the smoking battery in the first place -- the airline is currently investigating the incident , and Boeing says that it is working with Japan Airlines to return the plane to service .
