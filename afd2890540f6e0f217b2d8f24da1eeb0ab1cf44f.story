...
Experts believe hackers used a computer to guess the answers to stars ' secret questions -LRB- below -RRB- using widely-known personal details , then used phishing attacks to get their usernames -LRB- above -RRB-
