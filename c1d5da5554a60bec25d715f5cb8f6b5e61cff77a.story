...
10:33 EST , 12 September 2013

Nasa has narrowed down the hunt for an asteroid that it can capture and put it into orbit around the moon .

The space agency said it has found three suitable asteroids , one of which it hopes it can put into lunar orbit using a robotic space lasso .

Once in orbit , astronauts will be able to visit the space rock using the Orion spacecraft by as early as 2021 .

The space agency said it has identified three asteroids , one of which it hopes it can put into lunar orbit using a robotic space lasso . This artist 's rendering shows what capturing an asteroid could look like

The asteroids are all between seven and 10m in size , but further tests will need to be conducted to determine their suitability , said scientists at a conference in San Diego , California .
...
The mission hopes to gather useful information that will help protect the Earth from a potential hazardous asteroid collision , as well as the technology to enable for future human missions to deep space .
...
Last month , the latest version of the plan was revealed in an animation .

Exact details on how Nasa plans to pluck an asteroid out of its trajectory are not yet known , but the rendering shows it is captured and held inside what looks like a giant plastic bag .
...
Though it bares a striking resemblance to the earlier Apollo Spacecraft , Orion can hold more crew and is far-more advanced , said Nasa .
...
After the mission is complete , Orion returns to Earth on the same path it journeyed out on , loop around the moon included , and splashes down in an ocean -- likely the Pacific -- 10 days later , as seen in the video .
...
` One of the serendipitous results from this -LSB- asteroid-retrieval -RSB- flight we hope will be the demonstration of a capability to move an asteroid , to deflect it ever so slightly . '
...
Nasa plans to send a 7-10m asteroid into lunar orbit within the next decade
