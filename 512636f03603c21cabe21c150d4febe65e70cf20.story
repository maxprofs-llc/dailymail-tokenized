...
Google worked with the U.S. Geological Survey -LRB- USGS -RRB- , Nasa and Time to develop the images , even digitising tapes containing the early data from the satellites .

Google worked with the U.S. Geological Survey -LRB- USGS -RRB- , Nasa and Time to develop the site .
...
` Working with the U.S. Geological Survey -LRB- USGS -RRB- , NASA and TIME , we 're releasing more than a quarter-century of images of Earth taken from space , compiled for the first time into an interactive time-lapse experience .
...
` Using Google Earth Engine technology , we sifted through 2,068,467 images -- a total of 909 terabytes of data -- to find the highest-quality pixels -LRB- e.g. , those without clouds -RRB- , for every year since 1984 and for every spot on Earth .
