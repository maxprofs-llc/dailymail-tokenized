...
The patent is called ` Head-mounted display apparatus for retaining a portable electronic device with display ' and was filed in September 2008 . Its description reads : ` The portable electronic may be physically coupled to the head-mounted device such that -LSB- it -RSB- can be worn on the user 's head '
...
Its description reads : ` The portable electronic may be physically coupled to the head-mounted device such that -LSB- it -RSB- can be worn on the user 's head .
...
The patent does n't use the words ` virtual reality ' , but the headset 's similarity to Samsung 's Gear VR headset and Google 's Cardboard headset suggests that the device would be used in a similar way .
...
If Apple is looking to expand into the virtual reality market , it would follow rivals Google , Samsung and Oculus Rift - despite filing its patent before these firms released their headsets . Google Cardboard -LRB- pictured -RRB- is made from cardboard folded to form an enclosure , in which a phone is then slotted in to act as a display
...
Hints that Apple was looking to expand into virtual reality appeared in December when it was awarded a patent simply called ` Head-mounted display . ' The patent -LRB- pictured -RRB- was filed in May 2007 and details a ` goggle system for providing a personal media viewing experience to a user '

In November rumours surfaced again when the firm posted a job listing for an engineer . ' The post said : ` We are looking for a software engineer to develop UI and applications to create next generation software experiences -LSB- and -RSB- create apps that integrate with virtual reality systems '
