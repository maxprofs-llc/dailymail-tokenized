...
The news came on the same day Uber hinted it was working on its own range of self-driving cars . In a blog post , the taxi app -LRB- pictured -RRB- said it would be partnering with roboticists at Carnegie Mellon University to create a centre devoted to research and development of mapping , car safety , and ` autonomous technology '
...
This range would directly compete with Google 's autonomous vehicles -LRB- pictured with Google Chairman Eric Schmidt -LRB- left -RRB- and US Transportation Secretary Anthony Foxx -LRB- right -RRB- . An unnamed source told Bloomberg that Google is preparing to offer its own service , and it was likely to use its driverless cars
