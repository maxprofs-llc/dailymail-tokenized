...
Another suggests that dark energy comes from the quantum theory of matter . In this theory , 'em pty space ' is full of temporary particles that continually form and then disappear .
...
` However there is growing evidence that this simple model can not explain the full range of astronomical data researchers now have access to .
