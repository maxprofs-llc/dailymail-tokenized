...
Google 's patent explained its wearable -LRB- illustrated -RRB- could target any substances or objects that , when present in the blood , may affect the health of a wearer by transmitting energy into the vessels . This could include infrared signals , a radio-frequency or acoustic pulse , or a magnetic field

' A number of scientific methods have been developed to examine physiological conditions of a person by detecting and measuring one or more analytes -LSB- chemicals -RSB- in a person 's blood , ' explained the Nanoparticle Phoresis patent .
...
In an interview with Bloomberg , Google Ventures ' president Bill Maris recently said he thinks it 's possible to live to 500 years old .
...
Elsewhere he has develop Google 's Calico project .
...
It would scan the blood for so-called analytes , or chemicals , in the blood such as the presence of ` enzymes , hormones , proteins , cells or other substances . ' Google said it could target certain proteins that have been implicated as a partial cause of Parkinson 's disease , for example , or cancer cells

In January , Google 's Life Sciences lab unveiled plans for a wristband which would work with nanoparticles that circulate around the body looking for cells . To assist with their research , the scientists made moulds of human arms using both synthetic and real human skin from donors -LRB- pictured -RRB-
...
After travelling around the body , these nanoparticles would then be collected , using a magnet , to reveal what cells they encountered . The nanoparticles would cause the cancer cells to light up , for example , allowing the wristband to record whether there are dangerous cells in the body
