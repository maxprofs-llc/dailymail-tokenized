...
Bild claims to have obtained a document detailing ` concrete countermeasures ' that the Bundesnachrichtendienst -LRB- BND -RRB- -- Germany 's equivalent of the CIA - plans to implement .
...
The Bundesnachrichtendienst -LRB- pictured -RRB- , Germany ¿ s equivalent of the CIA , has ` concrete ' plans to spy on U.S. for first time since 1945 after ` double agent ' scanda
...
New German counter-espionage measures would almost certainly result in the monitoring of ` listening posts ' , which the National Security Agency -LRB- NSA -RRB- runs from the roof of its Berlin embassy .
