...
Sensys has 250 + customers in 45 US states and 10 countriesImportant US cities have deployments : New York , Washington DC , San Francisco , Los Angeles , Boston , Seattle , etc. 50,000 + devices deployed worldwide -LRB- most of them in the US -RRB- Countries include US , United Kingdom , China , Canada , Australia , France , etc. . For instance , some UK cities with deployments : London , Shropshire , Slough , Bournemouth , Aberdeen , Blackburn with Darwen Borough Council , Belfast , etc. . Australia has a big deployment on one of the most important and modern freeways .
...
` Probably many of you have watched scenes from ` Live Free or Die Hard ' -LRB- Die Hard 4 -RRB- where ` terrorist hackers ' manipulate traffic signals by just hitting Enter or typing a few keys , ' he wrote in a blog post revealing the hack .
...
' I wanted to do that ! I started to look around , and while I could n't exactly do the same thing -LRB- too Hollywood style ! -RRB- , I got pretty close .
...
` After getting the devices , it was n't difficult to find vulnerabilities .
...
` Basically anyone could cause a traffic mess by launching an attack with a simple exploit programmed on cheap hardware -LRB- $ 100 or less -RRB- .
...
` What I would like to mention is that the vendor was contacted a long time ago -LRB- September 2013 -RRB- through ICS-CERT -LRB- the initial report to ICS-CERT was sent on July 31st , 2013 -RRB- . I was told by ICS-CERT that the vendor said that they did n't think the issues were critical nor even important .

` Another excuse the vendor provided is that because the devices do n't control traffic lights , there is no need for security .

` This is crazy , because while the devices do n't directly control traffic control systems , they have a direct influence on the actions and decisions of these systems . '
