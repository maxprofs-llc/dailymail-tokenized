...
` The evidence uncovered during the investigation supports that view . While we can not bring this case to misconduct proceedings , we can publish the evidence and our conclusions , so that the public can judge for themselves .
...
` Such a finding could only follow a formal misconduct hearing in which the evidence would be tested and , as Sir Norman is no longer a police officer , such a hearing can not be held .
...
Sir Norman -LRB- pictured in 2008 -RRB- today questioned the ` fairness ' of the IPCC report
