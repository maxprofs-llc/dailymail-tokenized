...
Nevertheless , the apparent leak comes as the rumours have begun to circulate online that Apple is already about to begin making the successor to its latest smartphone .
...
Virtually identical : From the outside the apparently leaked iPhone 5S case hardly differs from that of the iPhone 5

The Commercial Times estimated that full commercial production of the rumoured iPhone 5S will begin as early as Q1 2013 , with the December run only expected to return between 50,000 and 100,000 units .

` Facing low yield rates in the
production of iPhone 5 , Apple has accelerated the certification
processes for related parts and components for the iPhone 5S , the paper
revealed , according to DigiTimes .

` While
the speculated iPhone 5S is expected to enter volume production in the
first quarter of 2013 , Apple is also likely to release a new version of
iPad a quarter later than the iPhone 5S , since the display resolution of
its latest version of iPad has come out lower than expected , ' the paper
said .
...
French website claims to have found the images published on a forum
