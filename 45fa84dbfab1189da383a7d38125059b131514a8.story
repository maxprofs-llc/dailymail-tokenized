...
Trivia Crack is available for Android , iOS and Windows Phone . Players connect , using Facebook or email , and can compete against a friend or random opponent . Once a match is set , the first player is shown a wheel -LRB- left -RRB- , which they spin to decide which category they 'll play first . Each player is then shown a timed questions -LRB- right -RRB-
...
The categories include science , entertainment , art , geography , sports and history . Each category has a corresponding character -LRB- left -RRB- and the first person who collects all six characters wins the game . Each player also has a profile -LRB- right -RRB- that shows how many games they 've won , and which categories are their strongest
...
Trivia Crack launched in Argentina in 2013 and is developed by Etermax . The English-speaking version launched last summer , and now the app is available in the UK -LRB- example questions are pictured -RRB-
