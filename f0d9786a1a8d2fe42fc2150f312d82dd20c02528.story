...
Even with masses of the latest technology , man still can not deal ` with whatever nature might throw at us , ' it concludes .
...
But at temperatures of minus -7 C and below , the effectiveness of salt decreases .
...
On potholes the report notes : ` RAC patrols expressed concerns about the number of potholes in all types of road , and the observation that these are particularly dangerous when it has snowed . Because they can not be seen . '
