...
The scientists measured the light reflected from the skin of male Iberian emerald lizards -LRB- labelled L -RRB- from different angles and found that birds of prey -LRB- labelled P -RRB- , which normally see the lizards from above , find harder to see than female lizards -LRB- C -RRB- which will tend to be on the same level on the ground with the males
