...
` You can see the sea grass visibly changing and the coral are unable to live in these higher temperatures . They wo n't be able to form coral limestone anymore . You do n't need to be a genius to see that . '
...
And on dry land the challenges come just as frequently . ` My job always come back to the animals - I go where they are , not where they are n't .
...
` The Chinese population has benefited from their ` one child ' policy - they would be in even greater trouble than they are at the moment if they had n't been doing that for the past 20 years .

` But the answer is much greater than that , and actually , the right to have children is a fundamental right as a human being .

` The reality is , if we can not control our yearning to reproduce , eco-tourism might be the only answer we have left in trying to , even partially , arrest this slump in green thinking .
...
` People need n't think eco-tourism means travelling to far-off lands or protecting obscure species we 've never previously heard of .
