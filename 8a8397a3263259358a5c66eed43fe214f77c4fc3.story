...
The artwork -LRB- pictured -RRB- was designed to show some of the smallest structures found inside the human body , including cells , microbes , pathogens and neurons . Although each of the images are based on the human biome , which includes microorganisms that live on humans , they are not designed to be scientifically accurate
...
` They `` see '' microbes through complex experiments using very complex laboratory equipment ; aesthetics do n't really interest them .
...
Images are n't of specific cells , instead they are ` visual representations '