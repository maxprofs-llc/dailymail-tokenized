...
Austrian campaigner Max Schrems is claiming damages of $ 500 -LRB- # 397 -RRB- per supporter for alleged data protection violations .
...
A law student has called on Facebook 's one billion users worldwide to join his Europe versus Facebook -LRB- pictured -RRB- class action against the site over privacy . Austrian campaigner Max Schrems is claiming damages of $ 500 -LRB- # 397 -RRB- per supporter for alleged data protection violations , billed as a ` David and Goliath lawsuit '
...
Therefore , it only applies to users who have a contract with Facebook Ireland .

This means its not available to users in the US and Canada .

Angered users can sign up using an app on fbclaim.com .

The app asks users to sign in using their Facebook account to verify their identity .

They will also need to upload a scan or image of their passport or driving licence .

Supporters have been assured there are no cost risks and all the data is securely encrypted .

` However , if many thousands of people participate we would reach an amount that will have a serious impact on Facebook . '

Angered users are being asked to sign up using an app on fbclaim.com .
...
The class action is open to all registered adult Facebook users outside the US and Canada .
...
Austrian Max Schrems is claiming damages of $ 500 -LRB- # 397 -RRB- per supporter
