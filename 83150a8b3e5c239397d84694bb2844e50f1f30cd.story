...
Investigations carried out security researchers and the BBC discovered that they could retrieve ` deleted ' data from second-hand models of Tesco 's Hudl tablet -LRB- pictured -RRB- . Using free software , a security expert obtained unlock codes , Wi-Fi and site passwords , and browsing history
...
In response to the findings , Google said : ` This research looks to be based on old devices and versions -LRB- pre-Android 3.0 -RRB- and does not reflect the security protections in Android versions that are used by the vast majority of users .
...
Experts typically advise carrying out a factory reset -LRB- stock image pictured -RRB- to remove data from any device , but the BBC investigation has revealed this technique may not always work on the supermarket 's gadget . The vulnerability is caused by a bug in the tablet 's Rockchip processor 's firmware
