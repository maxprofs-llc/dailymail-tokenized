...
A scientist from Michigan Tech University studied faster than light effects . Dr Robert Nemiroff said a laser swept across the moon -LRB- telescope laser shown -RRB- will appear to break light-speed . This is because it will move from one end to the other before light on the surface could make the same journey
...
In air , the speed of light is about 984 million feet -LRB- 300 million metres -RRB- per second .

In water , however , it is less at 738 million feet -LRB- 225 million metres -RRB- per second .
...
The phenomenon is possible only because the spots contain no mass and so can not only move faster than light , but decelerate past the speed of light without violating Einstein 's theory of special relativity .
...
When neutrinos leak out of nuclear reactor , they are travelling above the speed of light in water and briefly break the ` light barrier ' . As they slow , they release something called Cerenkov radiation , which appears as a blue glow . Pictured is the glow from the Idaho National Laboratory 's Advanced Test Reactor -LRB- ATR -RRB- core
