...
In a defeat for the so-called ` right to be forgotten ' privacy principle under debate in Europe , an adviser to the highest European Union court backed the internet search giant 's position that it can not erase legal content from the internet even if it is harmful to an individual .
...
` Search engine service providers are not responsible , on the basis of the -LRB- EU 's -RRB- Data Protection Directive , for personal data appearing on web pages they process . '
...
Backed : An adviser to the highest European Union court backed the internet search giant 's position that it can not erase legal content from the internet even if it is harmful to an individual
