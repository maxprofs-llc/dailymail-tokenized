...
Flow -LRB- pictured -RRB- works alongside a desktop or laptop via a Bluetooth connection , with apps such as Final Cut Pro X , SoundCloud , Spotify and YouTube . For example , a user could programme the device to skip tracks in a Spotify playlist by swiping in mid-air over the device
...
To begin with , the device will support Macs , with iOS devices , Android , Windows and Linux support in the pipeline . It could be used alongside work equipment or in the home -LRB- pictured -RRB- which may mean that smart appliances could one day be controlled using the simple device
...
Size : Almost three inches -LRB- 7cm -RRB- in diameter and half an inch -LRB- 1.5 cm -RRB- high .
...
The team combined three technologies into their small circular device so it can recognise hand gestures , sensitive touch and precise haptics -LRB- such as being tapped -RRB- via sensors .
...
he team combined three technologies into their small circular device -LRB- pictured in a work situation -RRB- so it can recognise hand gestures , sensitive touch and precise haptics via sensors
...
The device works by wirelessly calibrating with the user 's eye as long as they sit or lie between 23 inches -LRB- 60cm -RRB- and 27 inches -LRB- 70cm -RRB- away from the monitor .

Samsung has revealed a next-generation kind of eye tracking mouse , called EyeCan + which allows disabled users such as Hyung-Jin Shin -LRB- pictured -RRB- to browse the internet by blinking and moving his eyes
...
Gadget is available to pre-order via Indiegogo from $ 99 -LRB- # 63 -RRB-