...
United States Patent Application No. 20140168799 , entitled ` Artificial Muscle Camera Lens Actuator ' , describes how the structure will be based on electroactive polymers -LRB- EAP -RRB- .

EAPs , or artificial muscles , are a class of ` smart material ' that deform in the presence of an electric field .

The muscle that Apple has outlined would replace the comparatively large voice coil motor -LRB- VCM -RRB- currently used to focus mobile phones cameras .

While it may sound like science-fiction , the idea to use artificial muscle is n't new . The technology , for instance , is already being used in touch feedback in some video game controllers .
...
Whether Apple will use the EAP technology in the future iPhone 6 -LRB- leaked image pictured -RRB- remains unclear
