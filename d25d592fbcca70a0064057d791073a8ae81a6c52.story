...
This chart shows how the major fast food chains scored , based on the Food Standards Agency hygiene rating . The top half shows the average score -LRB- out of five -RRB- taken from various restaurant ratings across the country . The bottom half shows the lowest score an individual restaurant in a chain received
...
It is then rated from zero to five .
...
The Food Standards Agency -LRB- FSA -RRB- issues guidelines to local authorities with a hygiene rating score out of five .
...
Details obtained from the local authorities found that Chicken Cottage -LRB- stock image of sink used -RRB- received the lowest average score during official hygiene inspections across the UK . The information was collected by a Sussex-based health and safety firm Tutorcare using Freedom of Information requests
