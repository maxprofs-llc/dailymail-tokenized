Google Glass may not have proved as popular as its makers would have liked , but that has n't stopped other firms jumping on the headset bandwagon .

Sony is the latest tech company looking to develop a Glass rival , but this time with a twist .

The Japanese firm 's Single-Lens Display Module -LRB- SLDM -RRB- is a microdisplay that fits onto any type of spectacles - from sunglasses to work goggles - and can be removed when it 's not needed .

The Single-Lens Display Module -LRB- SLDM -RRB- is a microdisplay -LRB- left -RRB- that fits onto any type of spectacles - from sunglasses to work goggles - while also being detachable for when it 's not needed . Sony said that the module also has potential applications in sports -LRB- top right -RRB- or for work , to display useful information
...
Sony said it is hoping to start selling the module ` within the coming year ' , but will be unveiling a concept model at the Consumer Electronics Show -LRB- CES -RRB- in Vegas in January .

SLDM is fitted with a high-resolution , colour microdisplay , a micro-optical unit and a miniature control board -LRB- pictured -RRB-
...
Sony will also make the software development kits -LRB- SDK -RRB- available for developers to create apps , when the module is nearer to completion .
...
Sony said it is hoping to start selling the module -LRB- example uses are pictured -RRB- ` within the coming year ' and will unveil a concept at the Consumer Electronics Show in Vegas in January . Sony will also make the software development kits -LRB- SDK -RRB- available for developers to create apps , when the module is nearer to completion

The display has a resolution of 640x400 pixels and weighs 40g - 22g for the display arm and 18g for the secondary arm . By comparison , Google Glass -LRB- pictured -RRB- weighs 43g , with a 640x360 pixel resolution . There is no mention of a camera on Sony 's module , which would put it at a disadvantage to Google

` For example , when cycling , playing a round of golf , or -LSB- taking part -RSB- in some other outdoor sport , attaching this module to a pair of sports sunglasses and pairing it with a smartphone would enable you to access valuable information such as course maps or distance readings , even when your hands are tied .
