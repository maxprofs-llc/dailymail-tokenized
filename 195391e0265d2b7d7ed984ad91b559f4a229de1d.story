...
Scientists have found that Macaque monkeys show similar signs of depression to humans , such as shying away from a group -LRB- shown in E -RRB- and adopting a hunched posture -LRB- shown at A , B , D and E -RRB- . Image C suggests bullying from dominant monkeys -LRB- marked in the pictures with red arrows -RRB- in the form of a cut to the monkey 's ear . Intimidating behaviour -LRB- B and D -RRB- may explain the monkeys ' depression

Previous studies have used rodents , which ` do not realistically resemble the etiopathological -LSB- causal -RSB- development of depression , which occurs naturally in a social context , ' according to the study , published in Nature .
...
` One to two subjects per stable social colony -LRB- 17 -- 22 subjects -RRB- manifested a depressive phenotype that may be attributed to psychosocial stress , ' the study said .

The authors believe that their monkey model of depression mimics real life and is closer to how depression develops than humans -LRB- illustrated with a stock image -RRB- than rodent models
