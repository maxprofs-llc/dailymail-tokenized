...
Payment : They then pack their items straight into shopping bags as they tour the aisles . Payment is made via a smartphone app linked to the shopper 's bank account or card -LRB- pictured -RRB- , so there is no need to queue at a till
...
It uses short distance radio signals known as Near Field Communication -LRB- NFC -RRB- . Tim Erlin , of the security firm Tripwire , warned : ` -LSB- Apple 's -RSB- entrance into the arena will greatly speed adoption of the technology , and the attention it gets from potential attackers .

` NFC is n't as well-tested as the more common wireless technologies . We may see the rise of the modern-day pickpocket . '

Smart : The Mobile Scan & Go service is the latest example of smartphones being used as electronic wallets

The service -LRB- pictured -RRB- allows customers to scan purchases using the camera on their mobile handsets
