...
Now one Austrian company is hoping to tackle the problem with the introduction of the Johammer J1 - an electric bike that can travel 125 miles -LRB- 200km -RRB- on a single charge .
...
The 11 kilowatt hub-mounted motor provides 14 horsepower and a top speed of 74mph -LRB- 119kph -RRB- .
...
` Perfectly balanced -LRB- at 350mm mass centre height -RRB- the Johammer offers an unmatched and safe driving experience . Steering and footpeg allow for individual adaptation . '

The bike , which can be purchased from the Johammer , currently comes in silver , white , blue , yellow and green options .

The J1 .150 will set you back # 19,000 -LRB- $ 31,600 -RRB- while the J1 .200 will hit your wallet a bit harder at # 20,600 -LRB- $ 34,500 -RRB- in exchange for a bigger battery and longer range .

The bike , which can be purchased from the Johammer , currently comes in silver , white , blue , yellow and green options

To drive the wheel , the motor -LRB- shown on the rear wheel -RRB- contains a coil which generates an electromagnetic field as power flows through it . The field attracts the outer part of the motor , which attempts to follow its direction , and in doing so turns the connected wheel
