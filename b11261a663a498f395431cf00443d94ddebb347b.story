...
The bra is not currently on sale and there is no indication as to whether it will be made , but the prototype has a front clasp with a sensor and light that glows pink -LRB- pictured -RRB- if the wearer is in love with a person nearby
...
While some would-be wearers might worry that any excitement might cause their underwear to ping off , the creators of the bra say that the catch will only be released when a woman is in love so that her Adrenal Medulla -LRB- part of the adrenal gland -RRB- secretes the hormone Catecholamine , which increases her heart rate .

n a promotional video , the sensor monitors the wearer 's heart rate and transmits the data in realtime to an iPhone app using a Bluetooth connection -LRB- pictured -RRB-

The app calculates the ` true love rate , ' -LRB- illustrated -RRB- according to the firm based on the data gleaned from the sensor on the bra , which will only open when a woman is in love so that her Adrenal Medulla -LRB- part of the adrenal gland -RRB- secretes the hormone Catecholamine , which increases her heart rate
...
The bra has been designed to test true love and ward off unsuitable men -LRB- pictured from the demonstration in the video -RRB- . A sex expert in Ravijour 's video , said : ` Until now the bra was a piece of clothing to remove , but now it is an instrument to test true love '

The app processes the data - measuring heart rate elevation using a specially built algorithm as well as pre-set data - and only when a woman 's heart rate is suitably elevated and she is in love will the bra catch open -LRB- illustrated -RRB-
