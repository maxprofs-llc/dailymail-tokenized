...
The pilot project does not store images but uses an algorithm that converts reference points on a fingerprint into an encrypted code that can not reconstruct the original image , Bloomberg reported .
...
It must go through rigorous approval process and Alaska Air must convince the Transportation Security Administration and other aviation authorities that the system can not be defeated and personal information will be kept safe and secure .
...
` Obviously we have to line up a number of partnerships to make that happen . The customer response has been that strong . We do n't want to take our foot off the gas . '
