...
Researchers have turned to the works of Charles Dickens -LRB- illustrated -RRB- to generate secure but memorable passwords according to new research by US-based computer scientists . They used a model from probability theory to examine the occurrence of letters within Mr Dickens ' Tale of Two Cities to generate new passwords
...
` Today , the general assumption - evidenced by the lack of systems using randomly assigned passwords - is that users can not be expected to recall secure passwords
