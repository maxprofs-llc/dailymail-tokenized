...
Researchers from Princeton University in New Jersey and Lund University in Sweden say Gaia -LRB- illustration shown -RRB- could find thousands of planets during its mission . Primary goal of the spacecraft is to map one billion stars in the Milky Way . But a ` by-product ' could also be the discovery of planets
...
One of the main objectives of the Gaia mission is to establish the currently uncertain distance from Earth to various stars , which would allow a much better understanding of the properties of the stars and the planets orbiting them . This image shows the distances from Earth -LRB- centre -RRB- to the stars -LRB- black dots -RRB- of some exoplanets

The kinds of planets that the researchers expect Gaia to detect would include planets with multi-year orbits and others that are more difficult to detect via other methods . This would include Jupiter-sized worlds orbiting dim stars , but is unlikely to include many Earth-like planets -LRB- Earth-like Kepler 186f illustration shown -RRB-
