...
Researchers in Germany have created the first library of drunk speech patterns , which could be used to predict drunkenness in cars -LRB- Illustrated with a stock image -RRB-
...
Scientists have used the library to create an algorithm that can predict if a driver is drunk . The hope is that it could be built into cars to stop people putting their key in the ignition and driving off . The technology would act as a preventative measure , unlike breathalysers -LRB- pictured -RRB- that are used by the police to prove an offence
...
` That means , you want to go and drive your car , one in three times we 're going to say you 're drunk . That 's bad for a product , ' Professor Andrew Rosenberg , of Queens College New York -LRB- CUNY -RRB- said .
