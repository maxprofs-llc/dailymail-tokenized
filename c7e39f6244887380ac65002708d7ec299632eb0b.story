...
A Mexican federal agent crawls through a hidden tunnel , used to transport drugs from Mexico -LRB- file picture -RRB-

Mexican Army soldier standing guard inside tunnel connecting warehouses on California 's border -LRB- file photo -RRB-
...
And the devices can be used in tunnels and pipes where agents ca n't fit .
...
Soldiers guard a tunnel at the border wall in Tijuana , Mexico , -LRB- file photo -RRB-

Entrances : A cross-border tunnel in San Diego -LRB- left -RRB- and an illegal tunnel found underneath a bathroom sink by the Mexican army inside a warehouse in Tijuana , Mexico . Nearly 170 have been found since 1990
...
Soldier climbing up a ladder from a tunnel that passes under the US-Mexico border -LRB- file picture -RRB-
...
Device can be used in places where agents can not reach
