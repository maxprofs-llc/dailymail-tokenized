...
` This type of -LSB- cloud -RSB- iridescence occurs with high level cloud and with diffraction , -LSB- meaning -RSB- that water droplets are gathering light , ' Mr Efron said .

There have been other recent sightings of fallstreak hole clouds , with one forming over Perth in early October .

A spokesman from the Bureau of Meteorology told Perth Now that ` It does n't occur often so it 's no surprise that it 's causing quite a stir ' .
