...
Catapult : A man wearing a white vest and black flat cap -LRB- left -RRB- initiated the mass brawl in Wickham , Hampshire
...
` Esta then extends an asp -LSB- baton -RSB- , and uses it to hit down on James
...
occasioning actually bodily harm -LRB- ABH -RRB- .
