...
A key benefit of using TRAIL is that it uses the immune system , so it is not toxic to the body like chemotherapy or radiotherapy -LRB- pictured -RRB-

This process is lost during cancer
progression , which leads to uncontrolled growth and spread of tumours .

The key benefit of using TRAIL -LRB- tumour-necrosis-factor-related
apoptosis-inducing ligand -RRB- as a way to fight cancer is that it is already part of the immune system so it is not toxic to the body like chemotherapy or radiotherapy .
...
The small size of TIC10 also means it can cross the blood-brain barrier , which many anti-cancer drugs can not do , making it effective at targeting brain cancer cells -LRB- pictured -RRB-
