...
It ca n't track location , however , but it can reveal how many steps a user takes , or establish whether a phone was still being carried around when used with select , third-party apps .
...
processing unit -LRB- CPU -RRB- to help preserve battery and speed up the
processors .
...
It also ca n't be accessed by Apple 's built-in apps - only by apps developed by third parties .
...
Glarznak wrote : ` I frequently use Argus -LSB- fitness app -RSB- to track my steps since it takes advantage of the M7 chip built into the phone .
...
The phone itself ca n't track steps , but apps such as Argus , pictured , use the data collected by the M7 chip
...
It was designed to take this data collection task away from the central processing unit -LRB- CPU -RRB- to help preserve battery , and speed up the processors .
...
This means that although Glarznak 's phone could track his steps , it was n't able to track his location .

All the data the M7 collects is encrypted and removed after seven days . It also ca n't be accessed by Apple 's built-in apps - only by apps developed by third parties .
