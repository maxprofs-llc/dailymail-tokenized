...
Despite the massive bill to taxpayers , the Healthcare.gov still does n't work properly ten days after it was launched - allowing only a handful of Americans to sign up for plans on the insurance exchange market .
...
Failure : This is the error message MailOnline received on Thursday when a reporter tried to sign in to Healthcare.gov . Some content on the site does n't even appear to have been proof-read
