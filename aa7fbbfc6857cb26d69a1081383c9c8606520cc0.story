...
Mr Gardner said : ` We recently examined how the proximity to a tube or railway station impacted property prices in three major cities -LRB- London , Manchester and Glasgow -RRB- after taking account of other property characteristics , such as property type , size and local neighbourhood type .

` Our research suggests that people are willing to pay a significant premium to be close to a station .

` The impact is most marked in London , where being located 500m from a station attracts a 10.5 per cent price premium over an otherwise identical property 1,500 m from a station .

` This is equivalent to approximately # 42,000 based on the value of the typical London home . In Manchester , the premium on a typical property for being 500m from station is 4.6 per cent -LRB- # 12,000 -RRB- , while in Glasgow the premium is 6 per cent -LRB- # 9,400 -RRB- .
...
` London also has the densest network of stations and services , with 94 per cent of properties within 1.5 km of a station , compared with 72 per cent in Greater Glasgow and 69 per cent in Greater Manchester . '
