...
The SolePower Ensoles , which are currently under development and are intended to fit inside everyday shoes -LRB- illustrated -RRB- , claim to provide two-and-a-half hours of phone charge from a one-hour walk
...
The SolePower company is a spin-out from Carnegie Mellon University , Pennsylvania , which received $ 60,000 -LRB- # 38,591 -RRB- of money from a 2013 Kickstarter campaign .

While the insole is still in the design phase , the company intends on launching it ` as soon as possible ' .

The insole connects to a power pack -LRB- pictured -RRB- and collects kinetic energy , with a mechanism that converts linear motion - generated while walking - into rotational motion , which is capable of spinning a generator

The generator allows power to be built up in an external battery pack connected by a cable , called a PowerPac -LRB- shown right -RRB- . This PowerPac is tied onto the laces so it sits on top of a shoe . It contains a USB port , allowing a variety of items to charge off it , including smartphone -LRB- illustrated left -RRB-
...
It is not the first time designers have attempted to harness power produced by walking in order to charge devices . A team of engineers from Rice University -LRB- pictured -RRB- created a shoe with an unusual heel attachment designed to generate electricity needed to charge medical equipment in remote areas
...
The XOO Belt can recharge your smartphone -LRB- pictured -RRB- and other electronic devices while they are still safety hidden away in your pocket , so you never run out of power when you need it
