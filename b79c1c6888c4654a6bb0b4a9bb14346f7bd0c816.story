...
This mosaic was assembled using imagery from Voyagers 1 and 2 and Galileo spacecraft . This mosaic -LRB- right -RRB- served as the base map for the geologic map of Ganymede -LRB- left -RRB- .
...
These studies depict a complex icy world whose surface is characterized by the striking contrast between its two major terrain types : the dark , very old , highly cratered regions ; and the lighter , somewhat younger -LRB- but still ancient -RRB- regions marked with an extensive array of grooves and ridges .

With a diameter of 3,280 miles -LRB- 5,262 kilometers -RRB- , Ganymede is larger than both planet Mercury and dwarf planet Pluto .
