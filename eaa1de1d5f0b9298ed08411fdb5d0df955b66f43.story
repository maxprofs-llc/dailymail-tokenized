...
Sunburn -LRB- stock image -RRB- causes DNA damage that can lead to skin cancer , and new research from Yale University has found this damage can continue for several hours after the sun goes down

The scientists believe that a new type of ` evening after ' sunscreen containing vitamin E could be developed to block this transfer of energy .
...
In tests using mouse and human melanocytes , experts found UV radiation from sunlight causes enzymes in the cells to create two chemicals that react together .
...
People with blonde or red hair , and fair skin tend to have less melanin in their skin and are more vulnerable to skin cancer caused by sunburn .

The Yale study found that DNA damage -LRB- labelled as CPDs in the graph above -RRB- in melanocyte skin cells continued for up to four hours after exposure to ultraviolet light had stopped , increasing the risk of cancer

In tests using mouse and human melanocytes , experts found UV radiation from sunlight causes enzymes in the cells to create two chemicals that react together . These then excite electrons on the melanin with energy . This means the melanin effectively absorbs some of the energy from the sunlight -LRB- stock image -RRB-

Scientists recently unlocked one of the secrets of how coral shields itself from harmful ultraviolet rays - and they hope it could create ` sunscreen in a pill ' .

A single pill could provide weeks of protection for the skin and eyes , cutting the odds of cancer , removing the need for creams and sunglasses , and keeping wrinkles at bay .

However it would do nothing to bronze the skin , meaning sun-worshippers would have to resort to fake tan if they want a ` healthy glow ' .

The scientists at Kings College London took their inspiration from samples of coral collected from Australia 's Great Barrier Reef .

It was known that the marine organism can shield itself from the sun 's rays and it was thought that the protection came from a compound made by algae that live within it .

The researchers found the algae makes a compound that is transported to the coral , which then modifies it into a sunscreen that protects it from UV damage .

However , Professor Brash and his team , whose results are published in the journal Science , found that it is melanin that is also responsible for this overnight damage .
...
However , in the dark the melanin transfers this energy to the DNA to cause the same damage that can occur in sunlight . Sunlight damages the upper layers of skin -LRB- keratosis pictured -RRB- but also damage the DNA

The diagram above shows the effects of ultraviolet radiation -LRB- yellow arrows -RRB- on the upper layers of the skin . In addition to a ` night-time sunscreen ' , Professor John-Stephen Taylor at the Washington University in St Louis , who studies DNA damage caused by the sun , said that improved daytime suncreens could also help
