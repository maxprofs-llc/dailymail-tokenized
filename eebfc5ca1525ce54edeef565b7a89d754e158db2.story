...
to print a customised engagement ring to the perfect size and shape on any of its printers - including the Replicator Mini -LRB- pictured -RRB- . The
Brooklyn-based company said the app lets users without technical
knowledge to design a ring in 3D

That design is then sent wirelessly to a MakerBot 3D printer , such as the # 999 -LRB- $ 1,700 -RRB- Replicator Mini , according to a report by Pocket Lint .
...
The
design menu on the app -LRB- pictured -RRB- prints a two-part model - which can
...
However , unless users want to give their intended a plastic ring -LRB- stock image pictured -RRB- , the design will then have to be taken to a jewellers to be transformed into its diamond equivalent
