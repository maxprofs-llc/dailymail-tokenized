...
Lights , camera , action ! Computer scientists have developed a camera system -LRB- pictured -RRB- that that lets users see round corners without using a mirror . Using diffusely reflected light from a laser , it reconstructs the shape of objects outside of the field of view
...
This graphic shows the set-up of the equipment . The light source -LRB- red -RRB- and camera -LRB- field of view marked in blue -RRB- both look at a white wall . The objects the experts want to reconstruct -LRB- green box -RRB- are hidden and are only accessible through indirect reflections off the diffuse wall
...
The new camera system lets people see round corners without using a mirror , like a traditional periscope -LRB- pictured -RRB-
...
They will report on their research at the international Conference for Computer Vision and Pattern Recognition -LRB- CVPR -RRB- taking place next week in Columbus , Ohio .
