...
Partners will sell components that can not be 3D-printed , such as motors and an Intel Edison processor , in kits and it is hoped the robot will cost less than $ 1,600 .
...
Partners will sell components that can not be 3D-printed , such as motors and an Intel Edison processor , in kits .
...
Intel describes Jimmy as a research robot , but the company intends to make 3D-printable plans available without charge for a slightly less advanced version , and partners will sell components that can not be 3D-printed , such as motors and an Intel Edison processor , in kits .
...
Partners will sell components that can not be 3D-printed , such as motors and chips