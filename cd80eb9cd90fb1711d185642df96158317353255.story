It is set to be the biggest phone Apple has ever produced - with the largest model believed to have a 5.5 inch screen .
...
The new iPhone 6 , pictured here in a mockup by designer Martin Hajek , is believed to have a 5.5 inch screen - and a special one handed mode so people can still type easily on it
...
` To deal with concerns that a bigger phone will make typing with one hand difficult -LRB- the current iPhone has a four-inch screen -RRB- , some changes to the design of the iPhones ' user interface will allow people to type or use apps with just one hand ; there will be a one-handed mode that can be switched on and off , two employees said , ' the New York Times claims .
...
Since 2012 , Apple has scheduled an iPhone event midweek in September , released the latest software update the following Wednesday , and then released the devices the Friday after . As well as the iPhone , Apple is expected to unveil a male and female version of the iWatch -LRB- concept pictured -RRB- next week
...
The same report predicts that the iPad Air 2 will be announced on the same day as the iPhone 6 rather than in a separate event in October . Experts claim the new iPad 2 Air -LRB- leaked shell images pictured -RRB- will feature a fingerprint sensor and a new thinner design
