...
Hackers have proved that it is possible to steal information , including Amazon passwords , bank details and even home addresses from smartphones that have Wi-Fi turned on , using specially adapted drones -LRB- a stock image of a quadcopter is pictured -RRB-
...
The hackers managed to gain access by looking at a unique identification number known as a Media Access Control -LRB- MAC -RRB- address . This number matches web traffic to a specific device .
...
The drone emits a signal masquerading as a trusted Wi-Fi network , which the phone ` trusts ' . However , once connected , this network intercepts everything a smartphone sends and receives , giving hackers access to password information -LRB- illustrated -RRB- and even bank details that are entered or saved
