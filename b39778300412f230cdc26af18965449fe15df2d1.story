...
A 3D view of the remnant of Nova Persei 1901 -LRB- the green arrow points towards Earth -RRB- : It shows that the stars remains are still moving as fast as 620 miles per second

` Such data are rarely available in astrophysics because as a general rule apparent expansion or , in other words , in the layout of the sky , the majority of objects can not be seen , ' said Romano Corradi , from the Astrophysics Institute of the Canary Islands .
