...
Tesco is challenging Skype 's dominance by launching its own cheap international calling app -LRB- pictured -RRB-
...
The Tesco Calling Card app is available
for iPhone and Android handsets and offers international calls , to any number , for as
little as two pence a minute using a Wi-Fi connection . The app also lets people make calls and send messages app-to-app -LRB- pictured right -RRB- free of charge
...
While Skype and Tesco 's services both require an internet connection to work , an app called Ringo is offering calls between countries for up to 25 per cent less than Skype , using submarine cables .
...
Holiday makers -LRB- stock image pictured -RRB- and football fans visiting Brazil for the World Cup , for example , would pay just 60p for 30 minutes , when using the app . Tesco said a comparable length chat from a hotel in São Paulo would cost around # 60
...
Tesco 's Calling Card app is available for iPhone and Android handsets
