...
But , many Apple users are n't aware that removing a photo from a device does n't automatically remove it from their cloud account .
...
When a user takes a photo , it is stored in their Camera Roll , which is a gallery of images that are physically stored on the device . If My Photo Stream is enabled -LRB- pictured left -RRB- , these photos are also stored in the My Photo Stream album -LRB- pictured right -RRB- , which is automatically uploaded to iCloud and other synced devices
...
Users can also stop photos automatically being uploaded to iCloud , so that future snaps are n't vulnerable either .
...
If the My Photo Stream album does n't appear , the tool has n't been activated , or there is n't an iCloud account connected to that device .
...
Photos are also stored on iCloud if a user backs up the Camera Roll -LRB- left -RRB- . To remove these images , overwrite them with a new backup . This involves moving images from the iPhone to another device , deleting them from the Camera Roll on the phone or tablet , overwriting the backup , and deselecting the Camera Roll option -LRB- right -RRB-
