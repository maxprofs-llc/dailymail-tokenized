...
The Glowfaster sports jacket -LRB- pictured -RRB- synchs with a runner 's smartphone and then uses flashing lights to indicate whether they are running at the right pace
...
A Glowfaster iPhone app -LRB- pictured -RRB- currently works with the jacket and an Android app will soon be added so that users can track their performance , look at biofeedback and set goals
...
The jacket has zip-off lighting strips that react according to a runner 's performance . The ` double zip attachment ' -LRB- pictured -RRB- means that people will be able to upgrade their lights or add different colours
...
The jacket 's lights are powered using a Bluetooth receiver called a Gizmo -LRB- pictured alongside a heart rate sensor -RRB- . The jacket is waterproof , windproof and breathable and will cost # 99
