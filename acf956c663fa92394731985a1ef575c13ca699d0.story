...
The research , published online in the journal Nutrition , found that beverages and juices made with high fructose corn syrup -LRB- HFCS -RRB- all contain 50 per cent more fructose than glucose .
...
` The human body is n't designed to process this form of sugar at such high levels . Unlike glucose , which serves as fuel for the body , fructose is processed almost entirely in the liver where it is converted to fat . '
...
` Health and medical experts state that the body can not distinguish between fructose naturally present in fruit and vegetables and that which may be added ; while the claim that fructose causes obesity or diabetes is advanced by some scientists , it is not the consensus scientific view .
