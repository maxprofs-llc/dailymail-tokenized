...
This means companies do n't know what sites and products have previously been searched for , or how much users paid for items .

It also means they do n't know what platform is being used to search the sites .

By deleting cache and stored cookie data also removes personalisation options .

To make sure websites do n't track future cookies they can also be disabled through a browser 's settings menu .

Be aware that removing cookies will also mean stored passwords , personalised adverts and choices wo n't appear .
...
Researchers examined ten major US retailers along with six hotel and rental car sites . They then recruited 300 people to run product searches on 16 sites . Cheaptickets -LRB- pictured -RRB- presented different results to guests -LRB- top -RRB- , and unadvertised ` Members Only ' prices to logged-in users -LRB- bottom -RRB-

This chart reveals which sites showed products with different prices . A desktop user searching Home Depot , for example , typically received 24 search results , with an average price per item of $ 120 -LRB- # 75 -RRB- . Mobile users received 48 search results , with an average price per item of $ 230 -LRB- # 143 -RRB-

` -LSB- And -RSB- we saw price discrimination from Home Depot , Sears , Cheaptickets , Orbitz , Priceline , Expedia , and Travelocity , with product prices varying from user to user . '
...
Users in groups A and B were shown hotels with an average price of $ 187 per night -LRB- # 116 -RRB- while users in group C were shown hotels with an average price of $ 170 per night -LRB- # 106 -RRB- .
...
For example , Travelocity reduced the prices on 5 per cent of hotel rooms shown in search results by around $ 15 -LRB- # 9 -RRB- per night when searched for on iOS or Android .

Cheaptickets and Orbitz gave unadvertised ` Members Only ' discounts of about $ 12 -LRB- # 7.50 -RRB- per night on 5 per cent of hotels rooms to users who were logged in to their accounts on the site .
...
A desktop user searching Home Depot typically received 24 search results , with an average price per item of $ 120 -LRB- # 75 -RRB- .

In contrast , mobile users receive 48 search results , with an average price per item of $ 230 -LRB- # 143 -RRB- .

Many personalisation techniques are based on cookies . Cookies are small files stored on a user 's computer or phone , filled with data about that particular person . They are used to set prices and show adverts , for example . Cookies are also used by sites such as Netflix -LRB- pictured -RRB- to personalise what films and shows are prioritised

Products were also 41 cents -LRB- 25p -RRB- more expensive , on average , for Android users .
...
It is n't just used to set prices and show adverts , for example .

The cookies are also used by sites such as Netflix to personalise what films and shows are prioritised .

Some store login details so people do n't have to enter their username and password each time they visit the site .
...
This means companies do n't know what sites and products have previously been searched for , or how much users paid for items . It also means they do n't know what platform is being used to search the sites .
...
Desktop user on Home Depot received 24 search results , with an average price of $ 120 -LRB- # 75 -RRB-

@highlight

Mobile users received 48 search results , with an average price of $ 230 -LRB- # 143 -RRB-
...
Affected sites confirmed results found in the study , but did n't explain why