...
A new reporty by the Society of Authors , of which Mr Pullman is President-elect , warns : ` There is a risk that e-books have the potential to undermine the perceived value of books generally to a point below which -LSB- writing -RSB- ceases to be commercially valuable .
...
` Any arrangement that does n't acknowledge that principle is a bad one , and needs to be changed . That is our whole argument . '
...
It also wants the Government to ensure e-books are covered by the Public Lending Right -LRB- PLR -RRB- scheme .
