...
Warning : Motorists are being urged to check the mileage on MOT certificates to avoid being accused of illegally ` clocking ' the odometer -LRB- file picture -RRB-
...
It notes : ' The new certificate carries up to three of the previous recorded mileages . Should the MOT test station make a mistake , the car owner has only seven days to get the tester to correct the error and issue a new certificate . If not , the car 's mileage record is frozen and can not be changed . '

AA head of public affairs Paul Watters said : ` What was designed as a security measure to deter criminal clocking may bite back on the unwary . It is highly unlikely that the tester will make a mistake but the consequences are serious enough for the Vehicle and Operator Services Agency -LRB- VOSA -RRB- to issue a specific warning . '

He said : ' It would be extremely awkward for an innocent owner to be accused of clocking a vehicle when they try to sell it on or get it re-tested , because they had n't checked the certificate .
...
Check : A car 's recorded mileage can not be changed after seven days of its MOT test according to new rules -LRB- file picture -RRB-
...
An official advice leaflet published by the Department for Transport 's Vehicle and Operator Services Agency -LRB- VOSA -RRB- called ` Your MOT certificate and Odometer history ' warns : ' If your MOT test was conducted on or after 18 November 2012 the MOT certificate will now show the vehicle 's recent mileage history .

` This has been introduced as part of a government initiative to reduce vehicle crime .

` Where available , the mileage history will compose of the readings associated with the three most recent VT20s -LRB- test passes -RRB- along with the dates of those readings . This will be in addition to the mileage reading recorded at the time of the current test . '
...
It stresses ominously : ` Please note that if there is an error in one or more of the previous mileage readings then this can not be changed . '
