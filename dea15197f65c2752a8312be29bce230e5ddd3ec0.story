...
According to The Verge , the California firm is working on a wearable device dubbed Surge , which is set to be released by the end of the year and will cost $ 250 -LRB- # 155 -RRB- .
...
The FitbitSurge is expected to go on sale by the end of the year and cost $ 250 -LRB- # 155 -RRB- . It includes GPS , heart rate monitors and a sleep tracker . The wearable will additionally track steps , calories , distance and elevation -- like current models -LRB- pictured -RRB- - but leaked materials state it is designed for more serious athletes .
...
Other features of the wristband include a more advanced sleep tracker , and a silent alarm that wakes wearers up using vibrations . Current FitBit models track runners using the GPS on a connected phone -LRB- pictured -RRB-

It was rumoured Fitbit would release a standalone heart rate monitor called PurePulse , but this technology is now expected to be built into an upcoming device . It is expected to provide real-time workout data , and statistics will sync wirelessly to a smartphone via an app -LRB- pictured -RRB-

These were revealed in a patent application , filed earlier this year , which detailed a wearable device called FitBit Charge that includes , among other features : ` Pedometers ; altimeters ; devices for displaying -LSB- and -RSB- measuring , time , date , steps taken , calories burned , distance travelled , floors climbed , active time , elevation , altitude , speed , pace , hours slept , quality of sleep , heart rate , routes , navigational information , and weather information . '
...
It is being cited as costing $ 250 -LRB- # 155 -RRB- and includes GPS tracking
