...
HIV specialists and network security experts at University College London -LRB- UCL -RRB- made the disovery after creating a simulation of how the virus spreads
...
HIV infects CD4 + T-cells , which play a vital role in the immune system and protect us from diseases . As HIV progresses , it reduces the number of active T-cells in the body until the immune system can not function correctly , a state known as ` acquired immune deficiency syndrome ' or AIDS .
...
` This could prove invaluable when interpreting the results of drug trials to understand what works and why . Using computer models to understand processes that we can not directly observe is common in the physical sciences and supports many fundamental theories .
