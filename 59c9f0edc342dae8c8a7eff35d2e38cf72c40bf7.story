...
A scientist has revealed that the busy stretch of shops has the highest levels of nitrogen dioxide -LRB- NO2 -RRB- , which is produced by diesel fumes and can trigger asthma and heart attacks .

Scroll down for video

Gasp ! Oxford Street -LRB- pictured -RRB- has the highest levels of nitrogen dioxide -LRB- NO2 -RRB- in the world , which is produced by diesel fumes from buses and taxis and can trigger asthma and heart attacks
...
He told the newspaper : ` To my knowledge , this -LSB- level -RSB- is the highest in the world in terms of both hourly and annual mean . NO2 concentrations -LSB- in Oxford Street -RSB- are as high as they ever have been in the long history of air pollution . '
...
Dr Carslaw told MailOnline ` This -LSB- Oxford Street -RSB- is easily the highest annual mean NO2 concentration in Europe . '
...
Not amused : In February , figures from the Department for Environment , Food and Rural Affairs claimed that traffic travelling along the A302 - known as Grosvenor Place - which runs adjacent to Buckingham Palace -LRB- pictured -RRB- produced the highest levels of toxic gas nitrogen dioxide at 152 micrograms per cubic metre of air
...
Simon Birkett , Founder and Director of Clean Air in London , said : ` These levels of nitrogen dioxide -LRB- NO2 -RRB- are nothing short of staggering .

` The World Health Organisation guideline is no human exposure in a single hour over 200 micrograms per cubic metre -LRB- with an annual average guideline of 40 -RRB- .
