...
Precaution : Turning off the ` Voice Dial ' feature will keep personal information safe , but if Siri is enabled for lock screen use the exploit does n't work either
...
Videosdebarraquito recommends turning off the ` Voice Dial ' feature to keep personal information safe , but if Siri is enabled for lock screen functionality the exploit does n't work either , according to ars technica .
