...
Captured by the European Space Agency Planck satellite , it shows the split
second after the Big Bang - and indicates the universe is 80 million years
older that scientists had thought .

Planck 's portrait shows the oldest light in our Universe , imprinted on the
...
Planck 's
primary goal is to observe the Cosmic Microwave Background , the relic
radiation from the Big Bang , and to extract its encoded information
about what our universe is made of , and the origin of its structure .

This
relic radiation can only be reached once all sources of foreground
emission , such as the galactic haze and the carbon monoxide signals ,
have been identified and removed .

The latest image shows oldest light in our Universe , imprinted on the
sky when it was just 380,000 years old .

The image is based on
the initial 15.5 months of data from the # 515m Planck space telescope .

` The extraordinary
quality of Planck 's portrait of the infant Universe allows us to peel
back its layers to the very foundations , revealing that our blueprint of
the cosmos is far from complete , ' said says Jean-Jacques Dordain , ESA 's Director General .
...
The findings bolster a key theory
called inflation , which says the universe burst from subatomic size to
its now-observable expanse in a fraction of a second .

George Esfthathiou , an astrophysicist
who announced the Planck satellite mapping on Thursday , says the
findings also offer new specificity of the universe 's composition .
...
` Since
the release of Planck 's first all-sky image in 2010 , we have been
...
microwave background in the greatest detail yet , ' said George Efstathiou
of the University of Cambridge , UK .

The image is based on
the initial 15.5 months of data from Planck and is the mission 's first
all-sky picture of the oldest light in our Universe , imprinted on the
sky when it was just 380 000 years old .

At that time , the young
Universe was filled with a hot dense soup of interacting protons ,
electrons and photons at about 2700ºC .

When the protons and electrons joined to form hydrogen atoms , the light was set free .

As the Universe has expanded , this
light today has been stretched out to microwave wavelengths , equivalent
...
This
` cosmic microwave background ' -- CMB -- shows tiny temperature
...
cosmology , the fluctuations arose immediately after the Big Bang and
were stretched to cosmologically large scales during a brief period of
accelerated expansion known as inflation .

Planck was designed to
map these fluctuations across the whole sky with greater resolution and
sensitivity than ever before .

By analysing the nature and distribution
of the seeds in Planck 's CMB image , we can determine the composition and
evolution of the Universe from its birth to the present day .

An artist 's conception shows the Planck spacecraft against a microwave view of the sky .

Overall ,
the information extracted from Planck 's new map provides an excellent
confirmation of the standard model of cosmology at an unprecedented
accuracy , the researchers say .

But because precision of Planck 's map is so high , it
also made it possible to reveal some peculiar unexplained features that
may well require new physics to be understood .

One of the most surprising
findings is an asymmetry in the average temperatures on opposite hemispheres of the sky .
...
` But these are early days ; so far , we do n't know whether this is possible and what type of new physics might be needed - and that 's exciting , ' says Professor Efstathiou .
...
Old and new : The previous best image of cosmic background radiation , -LRB- left -RRB- , compared to the new Planck images released today -LRB- right -RRB-
...
New results from a look into the split
