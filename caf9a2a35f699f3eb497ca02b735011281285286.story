...
Now the Electronic Frontier Foundation -LRB- EFF -RRB- has warned that the device , which is widely used across the US by the FBI , is being used for far more routine cases than the terrorism investigations it was originally introduced to help .
...
Los Angeles Police are authorised to use the Stingray for ` regional terrorism investigations ' -LRB- file photo -RRB-
...
' `` I do n't know how the Department of Justice justifies the use of Stingrays given the limitations of the Communications Act prohibition . '' '
