...
` In this analysis we did n't see clear evidence in favour of a multi-regional model , or a single origin from one of the living wolves that we sampled .
...
The scientists sequenced the genome of three grey wolves from different geographic areas , as well as produced genomes for two dog breeds : a basenji -LRB- pictured -RRB- , which originates in central Africa and a dingo from Australia , as both areas that have been historically isolated from modern wolf populations
...
` It 's something more ancient that is n't well represented by today 's wolves , ' he added .
