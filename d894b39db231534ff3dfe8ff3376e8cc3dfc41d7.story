...
The US and Britain are n't alone in their employment of cyber armies . Reports have shown that China , Iran , Israel , Russia and even Syria have legions of hackers awaiting their next marching orders .

The National Security Agency -LRB- NSA -RRB- has spent the last decade-plus using super computers to break codes , obtaining encryption keys and even influencing encryption standards ` to make them more vulnerable to outside attack , ' according to ProPublica , making them nearly useless in the process .

Despite Google using some of the brightest minds in the world to encrypt the data coursing through its networks and servers , that still ca n't completely stop spooks from kicking down the door .
