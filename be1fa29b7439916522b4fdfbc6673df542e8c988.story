...
The # 229 Voice Controlled Thermostat -LRB- pictured -RRB- uses far field voice analysis , which means it can operate with background noise such as a TV or radio . The device is activated by saying ` Hello Thermostat ' , and commands include ` make it warmer ' and ` make it much cooler '
...
The device also features a touchscreen -LRB- pictured -RRB- and links to the Honeywell Total Connect Comfort app . The system is able to learn about its owner 's needs , and become smarter over time with the addition of more commands based on its interactions

When controlled using the iOS or Android app -LRB- pictured -RRB- , the thermostat can be controlled remotely . After installation , the thermostat automatically recognises the owner 's voice
...
Honeywell also makes the ` intelligent heating system ' Evohome , -LRB- pictured -RRB- which lets users control their heating , room by room . Evohome can even turn the heating on or off if a person forgets to do so in the morning
