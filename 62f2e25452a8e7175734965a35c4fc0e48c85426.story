...
When a user registers , they choose to be either a ` hacker ' or an 'em ployer . '
...
It added that it reserves the right , but has no obligation , to monitor for illegal requests , and that it does n't ` endorse or condone ' such activity .
...
This employer is offering between $ 300 -LRB- # 198 -RRB- and $ 4,000 -LRB- # 2,640 -RRB- for the job .

Another reads : ` Defamatory blog post removal de-indexing : A blog comes up on Google .

` It quoted defamatory information from 20 years ago and -LSB- is -RSB- now costing me jobs , business and my kids to be bullied .

` Need this permanently solved by being dropped from -LSB- number one -RSB- on search . '

The site said : ` Hiring a hacker should n't be a difficult process .
...
Some of the jobs being posted on Hacker 's List are illegal , such as accessing email and Facebook accounts without permission , but the site told the New York Times that it is ` insulated from any legal liability because -LSB- it -RSB- neither endorses nor condones illegal activities . '
...
` Hacker 's List 's acceptable use policy claims that you can not use its services for any activities which breaks the law , it relies on users reporting abuse rather than actively policing and vetting postings .

` Of course , it should n't be forgotten , Hacker 's List makes money every time a job is completed .
...
` This type of site is n't new , although typically such activities take place ` below the radar ' , rather than using web sites that are plainly visible .
...
Some of the jobs posted on Hacker 's List are illegal , such as accessing email and Facebook accounts without permission , but the site said it does n't endorse or condone illegal activities . It is also against the site 's terms and conditions to post illegal tasks , but the site is ` under no obligation ' , to monitor for such activity

` Hackers List 's acceptable use policy claims that you can not use its services for any activities which breaks the law , it relies on users reporting abuse rather than actively policing and vetting postings .
...
Hacker 's List lets hacker 's bid for jobs posted by users called 'em ployers '
