If you 've ever sent a text to the wrong person , or regretted texting someone while drunk , then the Ansa app could offer some piece of mind .
...
Ansa -LRB- pictured -RRB- was created by 23-year-old Natalie Bryla from San Francisco . It lets people send self-destructing messages , photos and videos when using the ` off the record ' mode . Users can see when people have read their messages and if a text is sent by mistake , it can be deleted from the other user 's device
...
Videos and photos only appear when a user clicks ` Tap to view ' , and once viewed it is visible for 60 seconds before being deleted . However , people do n't have to use the ` off the record ' function , and can use Ansa to save conversations in a similar way to other messaging apps such as Whatsapp or Skype

Ansa -LRB- pictured left -RRB- is the latest in a line of Snapchat rivals , which include Facebook 's Slingshot -LRB- pictured centre -RRB- and Instagram 's Bolt -LRB- pictured right -RRB-
...
However , people do n't have to use the ` off the record ' function , and can use Ansa to save conversations in a similar way to other messaging apps such as Whatsapp or Viber by not enabling this tool .

In February Facebook bought messaging app WhatsApp for $ 19 billion -LRB- # 11.4 billion -RRB- , after failing in a previous $ 3 billion to buy Snapchat .
...
Ansa was created by 23-year-old Natalie Bryla from San Francisco
