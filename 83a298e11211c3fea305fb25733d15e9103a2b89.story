...
Wired.com has discovered a list of banned Android words , including ` intercourse ' , ` condom ' and even ` geek ' . When an Android user is typing they can enable predictive text suggestions to appear above the keyboard , pictured . Google then guesses which word they 're trying to write but wo n't show any words on the banned list

Selection of banned words Google does n't show in its predictive text tool :
...
So-called banned words are n't words that Google will physically stop users from typing .

Instead they are words that do n't feature in its built-in predictive text dictionary .
...
Many of the banned words relate to reproduction , genitalia and swearing , however there are a number of words that Google wo n't offer suggestions for because it does n't recognise that the words exist . This includes Chromebook , the name of Google 's very own range of laptops , pictured

Google is n't the only company guilty of partly censoring words in messages ; a report in July discovered Apple does similar .
...
Words that are n't generally considered offensive and do n't relate to human anatomy yet are still on the list include ` geek ' and ` thud . '

Christian also points out the word ` supremacist ' is banned , but ` Nazi ' is n't .
...
Words including ` suck ' and ` screw ' also do n't show up as suggestions , which was the case in Android Jelly Bean too .
...
However , other words Google does n't even recognise as words include Chromebook -- the name for its own brand of laptops .
...
If a user types these words , Google does n't show them in its predictive text
