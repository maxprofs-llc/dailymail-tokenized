...
According to the initial reports , the majority of the problems occurred when trying to update the devices using Wi-Fi , also known as Over-The-Air -LRB- OTA -RRB- updates .
...
Although the majority of affected users have been complaining about the phone crashing during the update , on user told MailOnline her phone updated normally , but has since ` switched itself off and still wo n't turn on ' .
