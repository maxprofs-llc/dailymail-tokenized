...
The National Highway Traffic Safety Administration -LRB- NHTSA -RRB- also criticized Takata for what it called ` an unwillingness to move forward ' on a recall , and said the company needs to be open with the U.S. public about the risks of its air bags .
...
` Today 's announcement is overdue but welcome , and it 's my hope that Takata and the other automakers that have n't yet done so will quickly agree to NHTSA 's request - if they do n't , regulators should force a mandatory national recall . '
