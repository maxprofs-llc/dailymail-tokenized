...
Target has since removed the page from the website , but not before dozens took to Twitter to complain that the retailer did n't use a plus-size model in the ad , calling the error ` disturbing ' and ` fatphobic ' .
...
Another noted that the mix-up is confusing for shoppers , since it means they do n't get a clear idea of what the garment would look like on their bodies .
...
One wrote : ` As if the term plus-size was n't disturbing enough , now Target thinks it means `` pregnant '' ' , while another called the mistake ` fatphobic ' .
...
` We appreciate the error being called to our attention and will work hard to ensure something like this does n't happen again . '

Offensive mistake : In April , Target sparked an outrage after a plus-size dress -LRB- pictured -RRB- was listed as ` Manatee Gray ' on their website , while the standard size version of the same item was called ` Dark Heather Gray '
