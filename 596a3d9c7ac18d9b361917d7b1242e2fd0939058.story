...
Secure Sockets Layer -LRB- SSL -RRB- ensures that communication between a browser and website servers are secure and Transport layer Security -LRB- TLS -RRB- is a newer way of doing the same thing , Gizmodo explained .
...
But iPhone and iPad users have not had the full benefit of this as the bug meant that Safari could n't recognise if the servers it was talking to were the valid account , leaving users open to what are known as ` man in the middle ' attacks , or hi-tech eavesdropping .

Security experts have warned that past iterations of iOS dating from as long ago as September 2012 , had a vulnerability that hackers -LRB- illustrated -RRB- could exploit to see financial transactions , emails and Facebook activity
...
The bug also affects MacBooks ' OS X and currently there is not yet a fix for the vulnerability . However , the California company told Reuters that a fix for Mac computers -LRB- pictured -RRB- will be available ` very soon '
