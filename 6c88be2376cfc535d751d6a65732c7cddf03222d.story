...
Two satellites being used in a # 4.4 bn European project to develop a satellite navigation system which rivals the American GPS network have gone into the wrong orbit .
...
The # 4.4 bn project , funded and owned by the European Union , is intended to provide Europe with an
...
The statement did not explain the difference between the satellites ' intended orbits and the one in which it was placed . Space officials are now investigating whether the inaccurate deployment will complicate efforts to create the new # 4.4 bn Galileo satellite navigation system
...
If the two satellites can not be pushed to the correct altitude above the earth , he said , subsequent satellites launched would have to take up the slack .
...
Galileo is a global navigation satellite system -LRB- GNSS -RRB- currently being built by the European Space Agency on behalf of the European Union -LRB- EU -RRB- .

The project , expected to cost the EU # 4.4 bn , aims to create a system which will work with GPS and Glonass , the US and Russian global satellite navigation systems .
...
The fully deployed Galileo system is due to consists of 30 satellites -LRB- 27 of which will operational and three of which are spares -RRB- , positioned in three circular Medium Earth Orbit -LRB- MEO -RRB- planes at 23,222 km altitude above the Earth .
...
Part of # 4.4 bn EU-funded project to provide Europe with alternative system instead of GPS and Russia 's Glonass
