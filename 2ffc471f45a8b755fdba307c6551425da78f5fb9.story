...
But this morning the group 's black jihadist flag could clearly still be seen inside city , raised over a multi-storey building just a few hundred feet away from where the yellow , triangular flag of the Kurdish People 's Protection Unit -LRB- YPG -RRB- could be seen fluttering above a largely destroyed housing complex .

Chilling : ISIS ' black jihadist flag -LRB- circled , background -RRB- was still visible in Kobane this morning - despite weeks of sustained airstrikes by U.S. and Arab warplanes . The flag is just streets from where the yellow flag of the Kurdish People 's Protection Unit can be seen -LRB- circled , foreground -RRB-
