...
Users have been posting on the official Apple Support forum , as well as other technology blogs , complaining that the iOS 7.1.1 update has ` bricked ' their phone - a term used to describe a phone that wo n't switch on .

Many have had to resort to a complete restore and have consequently lost all their pictures , apps and other personal data .

Apple pushed out its iOS 7.1.1 software this week - but there are already reports of it causing problems . Users have been posting on the official Apple Support forum complaining that the update has ` bricked ' their phone - a term used to describe a phone that wo n't switch on
...
If there is n't enough space , users can either use iTunes to update the phone , or remove content in Usage settings .
...
According to the reports , the majority of the problems have occurred when trying to update the devices using Wi-Fi , also known as Over-The-Air -LRB- OTA -RRB- updates .
...
According to the initial reports , the majority of the problems occurred when trying to update the devices using Wi-Fi , also known as Over-The-Air -LRB- OTA -RRB- updates . However , a number of customers have now reported having the same issue when updating using a cable and iTunes
...
Has your phone or tablet been affected by the update ? Please get in touch at victoria.woollaston@mailonline.co.uk
