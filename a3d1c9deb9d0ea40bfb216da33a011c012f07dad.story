...
But the device costs a staggering $ 20,000 -LRB- # 13,200 -RRB- .

Now , a team of hackers has created its own version of the surveillance kit using a cheap circuit board and other parts that total just $ 20 -LRB- # 13 -RRB- .

Scroll down for video

The Turnipschool device was demonstrated at the SchmooCon hacking convention . It features a radio-frequency implant inside a USB stick -LRB- stock image pictured -RRB- , alongside a circuit board , transceiver and a cover . It can be connected to a network and potentially used to attack the PC . The parts total around $ 20 -LRB- # 13 -RRB-
...
Using built-in microphones and speakers in laptops , the researchers managed to transmit passwords and small amounts of data between machines 65ft -LRB- 19 metres -RRB- away from each other .
...
The Turnipschool project was inspired by a covert stick called Cottonmouth-I that appeared in recently leaked NSA documents -LRB- pictured -RRB- and cost $ 20,000 -LRB- # 13,200 -RRB- each . It is part of a wider project called the NSA Playset that attempts to recreate NSA surveillance tools
...
The circuit board is custom printed and costs $ 1.50 -LRB- 99p -RRB- to make .

The microcontroller is made by Texas Instruments , with a radio-frequency transceiver that costs around $ 4 -LRB- # 2.65 -RRB- .
...
` -LSB- We -RSB- demonstrate tools we 've built for the same capabilities . '
...
Leaked documents recently revealed the spy tool costs $ 20,000 -LRB- # 13,200 -RRB-
