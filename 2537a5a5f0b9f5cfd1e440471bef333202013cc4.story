Apple iPhone 4S : The smartphone 's Safari browser is the most popular mobile web browser - Google is alleged to have bypassed privacy features built into the browser

Google and Facebook may have used a computer ` trick ' that allows them to
monitor web browsing via Apple 's Safari browser to build up advertising ` profiles ' - circumventing Apple 's
safety measures .
...
` Unlike other major browsers , Apple 's Safari browser blocks third-party cookies by default , ' says the spokesperson . ` However , Safari enables many web features for its users that rely on third parties and third-party cookies , such as ` Like ' buttons . Last year , we began using this functionality to enable features for signed-in Google users on Safari . ` To enable these features , we created a temporary communication link between Safari browsers and Google 's servers , so that we could ascertain whether Safari users were also signed into Google , and had opted for this type of personalization . '' However , the Safari browser contained functionality that then enabled other Google advertising cookies to be set on the browser . We did n't anticipate that this would happen , and we have now started removing these advertising cookies from Safari browsers .

European regulators recently wrote to
Google CEO Larry Page calling on the search giant to halt the
introduction of its new ` one-size-fits-all ' privacy policy

The
policy was due to come into effect on March 1 , and would allow Google
to share what it knows about users between services such as Google
Search , Gmail and YouTube .

The
move horrified privacy advocates and bloggers - tech site ZDNet said
...
` We call for a pause to ensure that there can be no misunderstanding about
Google 's commitments to information rights of EU
citizens . '

` Given the wide range of services you
offer , and the popularity of these services , changes in your privacy
policy may affect many citizens in most EU member states , '
the group wrote to Google Chief Executive Larry Page .

@highlight

Search giant allegedly used ` cookie ' to monitor browsing habits
...
Privacy group says , ` This is bad news for the company . It 's time for Google to do a better job '