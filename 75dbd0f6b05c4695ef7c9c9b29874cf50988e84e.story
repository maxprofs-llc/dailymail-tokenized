...
The exoskeleton -LRB- pictured centre and right -RRB- uses haptic feedback to allow wearers to feel the size of a visual object they are touching on screen -LRB- shown left -RRB- and could be used alongside an Oculus Rift headset
...
` With Dexmo F2 , we can take virtual reality to its next level , it adds a sense of touch to gaming and now you can now feel the size of a digital object , ' they explained , adding that the device does n't allow a wearer to feel softness yet .

The engineers have used the device to control lighting -LRB- pictured -RRB- , as a tool to be used in music production and art computer programmes and to play a virtual piano
...
The Dexmo classic is available to pre-order from Kickstarter for $ 65 -LRB- # 40 -RRB- plus shipping , with the Dexmo F2 on sale for $ 179 -LRB- # 111 -RRB- .

Both versions of the device are expected to be shipped in May 2015 - providing the firm raises enough money -- and there are metal industrial versions of the exoskeletons available too , for $ 5,000 -LRB- # 3,107 -RRB- .

The Dexmo classic is available to pre-order from Kickstarter for $ 65 -LRB- # 40 -RRB- plus shipping , with the Dexmo F2 on sale for $ 179 -LRB- # 111 -RRB- . Both rare pictured in different colours . The F2 is the bulkier model , with extra devices in the index finger and thumb parts of the exoskeleton

Engineers say the device can be used to control a robotic hand ` providing you with a better sense of presence by simulating a force feedback when an object is hit ' . It can also be used to play a virtual piano -LRB- shown -RRB-
...
The basic model can be ordered from $ 65 -LRB- # 40 -RRB- on Kickstarter and the more advanced F2 , which comes with haptic feedback , from $ 179 -LRB- # 111 -RRB-