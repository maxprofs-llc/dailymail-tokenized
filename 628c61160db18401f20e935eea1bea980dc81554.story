A picture claiming to show the front panels of Apple 's upcoming iPhone 6 has leaked online .

It reveals a much-rumoured larger 4.7 inch screen .

Apple is also believed to be developing a 5.5 inch screen version , with both expected to be unveiled in September and go on sale soon after .
...
` This snapshot WAS spotted on Weibo this morning , ' the site says .

` It features what may be -LRB- or not -RRB- an `` iPhone 6 '' front face .

` By comparison with the iPhone 5 -LRB- left -RRB- , we can estimate year height for the screen of 4.1 inches -LRB- 10.7 cm -RRB- and a width around 2.35 inches -LRB- 6 cm -RRB- .

` This Gives a ratio of width and height 0.55 , which is exactly the one found on the current iPhone 5 and a 4.7 `` diagonal length ! '

Having exactly the same screen dimensions would ensure app developers do not have to create separate versions of their software for the new sizes .

The rumours come amid claims Apple suppliers around the world are about to crank up their production lines for the big screen set to find its way into the iPhone 6 .
...
It has been widely accepted Apple 's rumoured 4.7-inch iPhone 6 -LRB- concept pictured left -RRB- will debut in September , with the 5.5-inch model launching in 2015 . This was blamed on manufacturing problems . The latest reports , instead , are blaming this staggered release date on Apple 's marketing strategy



@highlight

Claims front panel was taken from an iPhone production facility
