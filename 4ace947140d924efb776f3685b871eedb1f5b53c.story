...
For the first property the site does n't ask for proof of residence , but for subsequent addresses users need to show a form of identification or utility bill .
...
And the size of the zone depends on individual makers , although Mr Marcus recommends it covers 500ft -LRB- 152 metres -RRB- around each property .
...
` Many people are concerned about their privacy and safety -LSB- and -RSB- NoFlyZone.org offers these people a method to control the airspace above their property and to prevent drones from flying over .
...
At launch , founder Ben Marcus has partnered with manufacturers Horizon Hobby , Yuneec , Hexo + , PixiPath , Ehang -LRB- which makes Ghost pictured -RRB- , Drone Deploy and RCFlyMaps . By partnering with Mr Marcus , these makers promise to adhere to the registered zones but are not under a legal obligation to do so

Legally , drones ca n't be flown over restricted airspace including national parks , military bases and within a five mile -LRB- 8km -RRB- radius of medium and large airports . Data analysts recently created a map of the US that plots where owners can pilot their drones , and where specifically the drones are banned -LRB- pictured -RRB-
...
The updates to the database are n't made automatically , however .
