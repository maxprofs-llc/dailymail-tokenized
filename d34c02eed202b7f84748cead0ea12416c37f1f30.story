...
` Significant security breach ' : A passenger who has convictions for murder and offenses involving explosives was allowed to pass through the TSA 's PreCheck line -LRB- file picture -RRB- despite an agent recognizing them
...
` However , the supervisor directed the -LSB- officer -RSB- to take no action and allow the traveler to continue through the TSA pre-check lane . '
