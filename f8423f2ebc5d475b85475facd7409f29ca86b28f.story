...
The free Android app -LRB- pictured -RRB- shows users what their friends are typing in real time . The words , and any corrections , appear in the message window before they are sent , meaning users can interject mid-conversation , or plan a reply . An iOS app is ` coming soon '
...
And , if the recipient already knows a story that the sender is typing , they can tell them so they do n't waste time finishing the text .
...
Facebook uses this technology , for example , but the social network has stressed it ca n't see the exact keys pressed , and it does n't monitor keystrokes .

This means the code does n't reveal what is being typed .
...
Only messages that ever go up in database are those that can not be currently delivered , thus waiting for the client device to reconnect , and then it 's delivered and wiped .
...
The app -LRB- pictured -RRB- also means people can have conversations without ever hitting send , making them secure because no data is transferred and stored on a network . But , it is not known how the app itself tracks what is typed , and how much it stores on its own servers . MailOnline has contacted the firm for more information
...
To be clear , Facebook ca n't track the exact keys pressed , and it does n't monitor keystrokes . This means the code does n't reveal what is being typed .
