...
The Dark Energy Survey -LRB- DES -RRB- collaboration have announced the camera , which took eight years to build by scientists on three continents , has achieved first light .
...
The Dark Energy Camera features 62 charged-coupled devices -LRB- CCDs -RRB- , which record a total of 570 megapixels per snapshot .
