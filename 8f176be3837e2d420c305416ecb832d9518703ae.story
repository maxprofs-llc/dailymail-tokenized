...
Scroll down to read document in full
...
` worst case threat scenario , ' is a zombie attack in which zombies eating lots of humans therefore infecting them quickly , leaving little time for a response .

The document also addresses ` CZs ' otherwise known as chicken zombies .

` Although it sounds ridiculous , this is
actually the only proven class of zombie that actually exists , ' the plan
states .

CONPLAN 8888

` So-called ` CZs ' occur when old hens that can no longer lay eggs
are euthanized by farmers with carbon monoxide , buried , and then claw
their way back to the surface , ' CONOP 8888 notes .
...
The Pentagon 's contingency plans for a zombie onslaught emerged in from an unclassified document called ` CONOP 8888 ' - otherwise known as ` Counter-Zombie Dominance '
...
It is not unusual for the Army to be
called upon to save the day in zombie films . In 2004 comedy Shaun of the
Dead , soldiers arrive just in time to save the film 's hero .

In 2012 , troops in the US were trained using a mock zombie invasion .

Hundreds
of military , law enforcement and medical personnel observed the
...
At one point , some of the team are hit
by zombies and have to be taken to a field medical facility for
...
The
MoD replied to the FoI request : ` In the event of an apocalyptic
incident -LRB- e.g. zombies -RRB- , any plans to rebuild and return England to its
pre-attack glory would be led by the Cabinet Office , and thus any
pre-planning activity would also take place there .

` The
Ministry of Defence 's role in any such event would be to provide
military support to the civil authorities , not take the lead .

` Consequently the Ministry of Defence holds no information on this matter . '

@highlight

The Pentagon has a plan in order to ` preserve the sanctity of human life '
