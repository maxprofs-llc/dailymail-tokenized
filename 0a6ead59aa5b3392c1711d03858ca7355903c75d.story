...
Facebook is rumoured to be testing a
system that would make it possible to send private messages directly
from the status box on the homepage , instead of clicking through to the messaging panel .
...
At Google 's I/O conference earlier
this month , the search engine announced it was rebranding its Hangouts
service by creating a ` cross-platform messaging system ' .

The new service lets people send
photos , take part in group video calls and send emails using its
Hangouts app on Android and iOS , as well as across Gmail and Google + .
...
The
new Hangouts lets people send photos , take part in group video calls and
send emails using its Hangouts app on Android and iOS , as well as
across Gmail and Google + .
...
In January , Facebook confirmed plans to start charging users to send messages to
people they are n't already connected to - with a premium to be paid
for contacting very popular people .
...
Communication at a cost : Facebook is trialing a new service which enables users to send messages directly to people they do n't know at a price
...
Sources claim Facebook plans to let users send private messages directly from the homepage
