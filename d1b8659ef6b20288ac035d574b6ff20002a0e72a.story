...
` By fixating on one narrow measurement , we risk focusing on the symptoms rather than the causes of rising pressure on A&E s , which are linked to wider pressures across the NHS and social care sector .

` Cuts to social care mean hospitals have become a holding place for many older patients who ca n't be discharged because there is simply nowhere for them to go .

` This ` exit block ' leads to bed shortages and patients waiting for hours on trolleys to be admitted . Outside of hospitals investment in general practice is declining while demand is on the rise and more care is moved into the community - this simply is n't sustainable .

` We can only get to grips with pressure on A&E s if we look at health and social care in the round , and ensure every part of the system is fully resourced and working well . '
