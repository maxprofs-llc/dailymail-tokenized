...
The prototype , which was funded by the UK 's Defence Science and Technology Laboratory -LRB- DSTL -RRB- , has been ` well received ' and virtual reality training could become common practice in few years .

A 360-degree virtual reality training programme for medics working on the battlefield has been created using Oculus Rift -LRB- pictured -RRB- , which is a headset originally developed for gamers that covers the eyes with two screens presenting a 3D view that looks as though users have entered the world they are playing in

The technology uses ` head tracking ' to enable the user to look around the virtual world they have entered , just as they can in real life . Medics could face frightening scenes of gruesome injuries -LRB- pictured -RRB- in their training one day
...
The simulation emulates pre-hospital care on the battlefield -LRB- pictured -RRB- and allows trainees to negotiate and prioritise clinical needs , teaching teamwork and decision-making skills within high-stress ` under-fire ' scenarios , a spokesman explained
