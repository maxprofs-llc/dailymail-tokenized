...
In 5,000 BC , long before the Egyptians built the pyramids , Europeans were already divided into ` haves ' and ` have nots ' .
...
Radioaactive ` strontium analysis ' of the skeletons , which provides indications of place of origin , indicated that men buried with distinctive Neolithic stone adzes -LRB- tools used for smoothing or carving wood -RRB- had less variable isotope signatures than men buried without adzes .
...
` It seems the Neolithic era introduced heritable property -LRB- land and livestock -RRB- into Europe and that wealth inequality got underway when this happened . After that , of course , there was no looking back : through the Bronze Age , Iron Age and Industrial era wealth inequality increased but the ` seeds ' of inequality were sown way back in the Neolithic . '
