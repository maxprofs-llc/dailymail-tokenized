...
` You need to slow down a bit on approach , you call yourself a careful cyclist but I think you can improve , ' wrote ` CycleGaz ' on YouTube . ` Do n't forget that the green light only means you can go if it is safe to do so - if someone is crossing , even if the man is red , you need to give way to them . '

` The Cycle Ops ' added : ` Why do n't you slow down for these people when you can see they 're in the road ? The onus is on you to avoid them . '
