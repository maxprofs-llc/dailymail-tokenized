...
From powered exoskeleton races to competitions using brain power -LRB- illustrated -RRB- , the first Olympics for bionic athletes , called the Cybathlon , will take place in Switzerland in October 2016

Some of the technology that will be put through its paces by athletes has previously been excluded from the Paralympics .

The event , which will be hosted by the Swiss National Competence Centre of Research -LRB- NCCR -RRB- will include a race for competitors who are paralysed from the neck down , where they control an avatar in a computer game using a headset that links their brain to the computer .
...
Pilots with leg amputation will be equipped with machine operated prostheses and will have to successfully complete a race course -LRB- pictured -RRB- as quickly as possible , which will include obstacles such as slopes , a staircase , cobblestones and a seesaw

In the Powered Exoskeleton Race -LRB- pictured -RRB- , pilots with complete thoracic or lumbar Spinal Cord Injuries -LRB- SCI -RRB- will be equipped with actuated exoskeletal devices , which will enable them to walk along a particular race course
...
Pilots with forearm or upper arm amputations will be equipped with actuated exoprosthetic devices and will have to successfully complete two hand-arm task courses as quickly as possible -LRB- illustrated -RRB- . A close-up camera view will be used to life-display the shoot on the stadium screens . At least two participants will start at the same time on two identical courses , to make the event more exciting
...
The Powered Wheelchair Race -LRB- illustrated -RRB- will allow pilots with different disability levels -LRB- e.g. quadriplegics , paraplegics , amputees -RRB- to be equipped with power wheelchairs , which will enable them to steer along a particular race course . The course will be defined by cones between which the pilots will have to manoeuvre the chair both forward and backward . In addition , obstacles of different sizes will be used

Pilots with arm amputations will be equipped with robotic prostheses and will have to successfully complete two hand-arm task courses as quickly as possible , including a course where they try not to touch a wire with a metal hoop -LRB- pictured -RRB-
...
Powered exoskelton race : Pilots with spinal cord injuries -LRB- SCI -RRB- will use powered exoskeletons to negotiate a race course with obstacles of around 100metres .
...
In one of the six disciplines at the games , participants will use powered wheelchairs to steer along a race course with slopes and uneven -LRB- illustrated -RRB- surfaces as well as a slalom
