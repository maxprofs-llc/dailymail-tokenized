...
There are categories such as ` solids ' -LRB- where the digits repeat eight times -RRB- , ` ladders ' -LRB- 12345678 -RRB- , ` radars ' -LRB- 01133110 - where the number reads the same left-to-right as right-to-left -RRB- and ` repeaters ' -LRB- 20012001 - the second half is the same as the first half -RRB- .

Then there are ` radar repeaters ' -LRB- 12211221 -RRB- , ` super radars ' -LRB- 20000002 - all the internal digits are the same -RRB- and ` super repeaters ' -LRB- where the first two digits are repeated four times , such as 63636363 -RRB- .
