...
The CliMate clip-on device -LRB- pictured -RRB- looks like a cloud and can gather accurate readings of a wearer 's immediate environment , to warn them of possible local climatic challenges
...
The CliMate cloud uses a ` pin-point precise ' sensor that wirelessly measures humidity , UV exposure and temperature -LRB- known as HUT -RRB- .
...
` Excessive humidity , UV and temperature -LRB- HUT -RRB- damage goes way beyond the skin-deep .
...
The CliMate cloud uses a ` pin-point precise ' sensor that wirelessly measures humidity , UV exposure and temperature -LRB- HUT -RRB- and will send readings to an accompanying iOS and Android app every 15 minutes , when it launches in September . It comes with a stand -LRB- pictured -RRB- and lanyard so it can be worn easily

CliMate wearers will also be able to select their skin and SPF cream types -LRB- pictured -RRB- when outside , and the app will warn them when it 's time to reapply suncream , to help them avoid becoming sunburnt
...
Rooti - the company behind CliMate - claims that the device -LRB- pictured -RRB- is more accurate than a large weather station , as it is closer to an individual 's location . It also said the device is more accurate than previous wearable weather trackers as it displays HUT readings

All the data the device collects will be shown in an app . A person 's surrounding environment will be presented as a plant that changes according to the readings -LRB- pictured -RRB- . For example , the plant wraps up in a scarf when it is cold and has sunglasses and frazzled leaves when it is hot
...
Devices can pre-ordered in one of five colours for $ 39 -LRB- # 23 plus shipping -RRB- . CliMates are expected to be shipped in September .

If , in the future , lots of people wander round an area wearing the devices , a map can be created -LRB- illustrated -RRB- to show people local accurate weather information

Early birds can pre-order the device -LRB- pictured -RRB- in one of five colours for $ 39 -LRB- # 23 plus shipping -RRB- . CliMates are expected to be shipped in September
...
CliMates can be pre-ordered on Kickstarter for $ 39 -LRB- # 23 plus shipping -RRB-