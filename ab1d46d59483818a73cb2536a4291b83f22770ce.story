...
This means that the CPS spent has spent more than # 1.1 million on deals for only these two members of staff .
...
CPS says it acted properly over the payments , which exceed # 1.1 million