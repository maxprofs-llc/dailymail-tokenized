...
Power -- less than 5 watts per m2 -LRB- power is consumed only in the -LRB- on -RRB- transparent state -RRB-

Thickness -- 0.4 mm

Viewing angle -- more than 140 degrees

Light transmittance -- On -LRB- 70 % -RRB- Off -LRB- 5 % -RRB-

Haze Coefficient -- On -LRB- 7 % -RRB- Off -LRB- 87 % -RRB-
...
The basic package costs # 160 -LRB- $ 250 -RRB- .

For # 180 -LRB- $ 280 -RRB- the package additionally comes with a Wi-Fi-enabled transformer that connects to your home network .

When connected to the transformer , the film can be controlled using a free smartphone app .

Once the film is cut to size and stuck onto a glass covering -LRB- left -RRB- electronic clips are applied that can be plugged into a Wi-Fi-enabled transformer and can be connected to your home network . Once connected , the blind can be made see-through or opaque using the smartphone app -LRB- right -RRB-
...
SONTE has until 3 July to raise the target of # 128,000 -LRB- $ 200,000 -RRB- .

The SONTE film can be cut to fit any glass covering including showers and bathroom windows . A one-by-one metre film with installation kit and Wi-Fi enabled transformer costs # 179 -LRB- $ 280 -RRB-
