...
The thermal table -LRB- pictured -RRB- was created by Japanese data researcher Ken Kawamoto , who projected light from a Flir One iPhone case onto a table using a process known as projection mapping

Designer Ken Kawamoto used a Flir One thermal imagine iPhone case , which costs around # 250 -LRB- # 390 -RRB- .
...
The project can be created by anyone using a projector and Flir One case -LRB- pictured left -RRB- . The case is fitted with its own battery and lasts for 2 hours continuous use on a single charge . Example image is pictured right

In a video , a cup of ice water is shown turning the table blue , while a cup of hot water is shown turning it red . Mr Kawamoto also pours cold and hot water into a tray -LRB- pictured -RRB- , to see how the liquids combine

Mr Kawamoto began by turning the table into a display using the projector , before beaming images and light via the # 260 -LRB- $ 349 in the US -RRB- Flir One iPhone case .
...
He additionally shows what a MacBook 's battery looks like under thermal imaging -LRB- pictured -RRB- . Mr Kawamoto began by turning the table into a display using a projector , before beaming images via Flir One iPhone case

Using sensor technology originally developed for military night vision , Flir One converts heat to colour images in real time . These images let users see in the dark , but also detect minimal changes in temperature of just 0.1 °C to show which areas of an object are hotter , or cooler , than others -LRB- example image pictured -RRB-
