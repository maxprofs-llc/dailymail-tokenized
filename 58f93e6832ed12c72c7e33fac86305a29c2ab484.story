...
The Google lens contains a control circuit , an image capture -LRB- camera -RRB- component and an image sensor .
...
Under the agreement , Google -LSB- x -RSB- and Alcon will collaborate to develop a ` smart lens ' that has the potential to address ocular conditions .
