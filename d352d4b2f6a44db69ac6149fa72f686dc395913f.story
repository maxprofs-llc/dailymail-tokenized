...
The results come from an expedition , funded by the UK 's Natural Environment Research Council , which used satellite radar images and Global Positioning System receivers -LRB- GPS -RRB- that can detect movements of the Earth 's surface of just a few millimetres .
...
Dr Juliet Biggs , of Bristol University , also an author of the paper , said : ` People were obviously aware that something was happening to the volcano , but it was n't until we saw the changes in the GPS , and the uplift on the radar images that we really knew that molten rock was being injected at such a shallow level beneath the volcano .
