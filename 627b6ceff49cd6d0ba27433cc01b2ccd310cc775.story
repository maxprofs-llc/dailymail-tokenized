...
Ghana requires that a couple must be married to adopt . Single women can adopt , but only if they are a citizen of Ghana . Males can not , unless the man is the biological father .
...
Before a child can travel to the US , they will need : a new birth certificate -LRB- with the new parents ' names -RRB- , a Ghanaian passport and an US immigrant visa .
