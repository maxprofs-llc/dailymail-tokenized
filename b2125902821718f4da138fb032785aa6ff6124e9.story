...
But in a new analysis based on five years of observations using ESA 's Venus Express , scientists have uncovered a very chilly layer at temperatures of around -175 C in the atmosphere 125 km above the planet 's surface .
...
Cosmic flyby : The Venus Express , pictured here in an artist 's impression , is a European Space Agency -LRB- ESA -RRB- mission to study the atmosphere and plasma environment of Venus from orbit
...
` Since the temperature at some heights dips below the freezing temperature of carbon dioxide , we suspect that carbon dioxide ice might form there , ' sayid Arnaud Mahieux of the Belgian Institute for Space Aeronomy and lead author of the paper .
...
` The
temperature profiles on the hot dayside and cool night side at
altitudes above 120 km are extremely different , so at the terminator we
are in a regime of transition with effects coming from both sides .

` The
night side may be playing a greater role at one given altitude and the
dayside might be playing a larger role at other altitudes . '

Venus , as pictured by the Venus Express , has curious clouds in its atmosphere which may be cold enough to lead to carbon dioxide snow
...
Temperatures of -175 C in high atmosphere suggests carbion dioxide ` snow ' on Venus
