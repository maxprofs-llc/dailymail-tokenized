...
In fact , the world 's first tanker sized yacht is called Imāra , a name based on the Arabic word for 'em irate ' .
...
` We have developed the world 's first tanker-sized yacht called Imara , which is based on the Arabic word for 'em irate ' .
...
World 's first tanker-sized yacht is called Imāra , a name based on the Arabic word for 'em irate ' .