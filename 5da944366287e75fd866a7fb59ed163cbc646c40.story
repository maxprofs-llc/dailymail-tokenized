...
` -LSB- Professor Nocera 's -RSB- formidable discovery of the catalyst really set this off , and we had a mission of wanting to interface some kinds of organisms with the harvesting of solar energy .
...
` The advantage of interfacing the inorganic catalyst with biology is you have an unprecedented platform for chemical synthesis that you do n't have with inorganic catalysts alone , ' said Brendan Colón , a graduate student in systems biology and co-author of the paper .

The Harvard technology builds on the work of Daniel Nocera and his ` artificial leaf ' first -LRB- pictured -RRB- . Professor Nocera 's ` leaf ' was made from a silicon strip coated with catalysts on each side . When placed in water and exposed to sunlight , the strip split the water molecules to release and oxygen and hydrogen

The same principles could be used to produce drugs such as vitamins -LRB- stock image shown -RRB-
...
` There have been 2.6 billion years of evolution , and -LSB- Professor Silver -RSB- and I working together a year and a half have already achieved the efficiency of photosynthesis . '
