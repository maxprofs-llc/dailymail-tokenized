...
Blacklist follows on from the events of Conviction . The President shuts down the corrupt Third Echelon , replacing it with Fourth Echelon - led by Fisher . The team is then tasked with stopping a group of terrorist called ` The Engineers ' attacking the United States .

It 's powered by a heavily modified version of the Unreal 2.5 engine - the same one used in Conviction . However , although its visuals did n't stand out at this year 's E3 , they are noticeably smoother than in its predecessor , with animation - in particular - much improved .
...
The Wii U version uses the touchscreen as an inventory and OPSAT -LRB- Fisher 's arm-mounted computer -RRB- as well as presenting thermal vision and motion tracking intel .
