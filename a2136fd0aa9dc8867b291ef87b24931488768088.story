...
Tokyo-based software engineer Cameron Beccario has created a weather map -LRB- shown -RRB- that looks like the infamous Star Wars character Jabba the Hutt . The animation shows wind speeds and weather patterns around the world . In the image Jabba 's ` eyes ' are represented by two vortices
...
The mouth is the ` intertropical convergence zone ' -LRB- ITCZ -RRB- , which is an area that circles Earth near the equator where northeast and southeast trade winds come together .

The pink eyebrows are high-speed winds moving more than 155mph -LRB- 250km/h -RRB- in the upper atmosphere , while the other green lines show the motion of wind elsewhere in the world .

Light green shows the lowest intensity winds , moving up to red and then pink .

` The combination of high altitude winds , colours , and equirectangular projection caused this humourous face to appear , and I could n't stop laughing .
...
` This particular image shows wind velocity at a pressure level of 10 hectopascals , which is roughly 26.5 km -LSB- 16/5 miles -RSB- up , as forecast by the US NWS on 19 January at 12.00 UTC .
...
Mr Beccario told MailOnline that he thought the animation looked ` more like Oscar the Grouch ' -LRB- shown right -RRB- than Jabba the Hutt -LRB- left -RRB- , but the resemblance to both characters is uncanny
...
Of course , this map is n't designed to replicate faces of famous movie character in weather patterns on Earth .
...
It uses data from the Global Forecast System -LRB- GFS -RRB- , National Centres for Environmental Prediction -LRB- NCEP -RRB- , the National Weather Service and the National Oceanic and Atmospheric Administration -LRB- NOAA -RRB- .
...
Mr Beccario told MailOnline he ` could n't stop laughing ' when he saw the face appear in his visualisation