...
The leaked video shows Microsoft 's digital assistant , called Cortana , running on what seems to be a Windows Phone 8.1 handset -LRB- pictured -RRB-
...
Cortana only kicks in when a person asks it to , either by accessing the assistant from the start screen -LRB- pictured -RRB- or at the press of the search button
