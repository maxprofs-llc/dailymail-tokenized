...
Google has been working on similar projects since 2012 when former Apple battery expert Dr Ramesh Bhardwaj began leading a testing team . In a video for Project Loon -LRB- pictured -RRB- , Google revealed it has been working with experts at AllCell Technologies to develop batteries that function at subfreezing temperatures

Fan site AppleInsider recently spotted nine job listings on Apple 's official recruitment site in the past month that relate to batteries . These include one for an iOS battery life software engineer -LRB- pictured left -RRB- and another for iOS software power systems engineer -LRB- pictured right -RRB-
...
Atmel also recently announced its latest microcontrollers -LRB- MCUs -RRB- that can be fitted to a variety of gadgets and are so low power they can harvest energy from a person 's body .
...
Last month , Atmel released its latest microcontrollers -LRB- MCUs -RRB- for a variety of gadgets that are so low power they can even harvest energy from a person 's body . Atmel said its MCUs extend ` battery life from years to decades , reducing the number of times batteries need to be changed in devices '
