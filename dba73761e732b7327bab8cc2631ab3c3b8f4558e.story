...
` It can be exploited remotely since Microsoft Internet Explorer -LRB- IE -RRB- 3.0 .

` This complex vulnerability is a rare , ` unicorn-like ' bug found in code that IE relies on but does n't necessarily belong to it .
