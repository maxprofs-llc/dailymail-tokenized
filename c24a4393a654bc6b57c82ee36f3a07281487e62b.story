...
It is a similar problem that was faced in the year 2000 , when the Millennium Bug , also known as the Y2K , meant certain computers could n't distinguish between the years 1900 and 2000 .
...
Once the bug hits , affected computers will not be able to distinguish between the real time and date , and the year 1901 .
...
For example , a program that looks ahead 20 years will need to be fixed by 2018 . After 2018 , it wo n't be able to register dates after 19 January 2038 and bugs may appear .
...
But because half of the values are negative , and half are positive this does n't range from zero up to 4,294,967,295 .
...
At the time , Google said in a blog post : ` We never thought a video would be watched in numbers greater than a 32-bit integer -LRB- = 2,147,483,647 views -RRB- , but that was before we met PSY . `` Gangnam Style '' has been viewed so many times we have to upgrade ! '
...
At the time of writing , 2,175,046,789 people have watched the music video with its distinctive horsey dance . The number is displayed after digits spin around -LRB- screenshot -RRB- when the mouse hovered over them

The Year 2038 Problem , or Y2038 , specifically affects software using a 32-bit integer system and has been theorised for years .

32-bit systems use four bytes , which mean they can use 4GB of memory in one go . By comparison , a 16-bit system uses two bytes and 64-bit systems use eight .

The upper limit of numbers that a 32-bit system can store is 2,147,483,647 .

This standard four-byte format assumes the beginning of time is 1 January , 1970 , at 12:00:00 a.m. .

When the clock strikes 03:14:07 UTC on Tuesday , 19 January 2038 , a total of 2147483647 seconds since the 1 January 1970 will have passed .
...
After 2018 , it wo n't be able to register dates after 19 January 2038 and bugs may appear .
...
Affected systems will need to upgrade in order to avoid any problems .



@highlight

Psy 's Gangnam Style was recently viewed so many times on YouTube that the site had to upgrade the way figures are shown on the site
