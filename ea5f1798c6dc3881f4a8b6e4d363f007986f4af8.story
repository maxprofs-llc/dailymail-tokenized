...
However , once an aircraft is more than 240km -LRB- 150 miles -RRB- out to sea , radar coverage fades and high-frequency radio is used by air crew to keep in touch with those on the ground .

GPS is only used by pilots to show their own position on a map , and these signals are not relayed to air traffic control .

The ` Black Box ' contains a cockpit voice recorder and a flight data recorder . They emit ultrasonic waves , but have limited range , and do n't use GPS .
