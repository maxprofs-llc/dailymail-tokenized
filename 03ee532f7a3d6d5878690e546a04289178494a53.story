...
Best of both worlds : Roboticists have shown off designs of origami-inspired wheel systems -LRB- pictured -RRB- that allow robots to shape-shift and switch from either being fast or strong
...
The wheel 's lead creator , Professor Kyu-Jin Cho explained that his design can shrink to have a radius of two inches -LRB- 5.5 cm -RRB- , and expand to have a bigger footprint of four inches -LRB- 12cm -RRB- , using just one actuator per wheel .
...
Scientists at Harvard Microrobotics Lab teamed up with the group in Seoul to design origami wheels that automatically expand -LRB- pictured a and b -RRB- and shrink -LRB- pictured c and d -RRB- to enable the robot to be both fast and strong . An earlier design is pictured
...
Cho explained that the wheels -LRB- pictured -RRB- can shrink to have a radius of two inches -LRB- 5.5 cm -RRB-
and expand to have a bigger footprint of four inches -LRB- 12cm -RRB-

Magic ? Researchers from Seoul National University have designed a robotic wheel -LRB- pictured -RRB- based on the ` magic ball pattern , ' which is a traditional technique used to create folded paper spheres
...
The origami wheel can enable the robot -LRB- pictured -RRB- to be both speedy and strong because it expands and shrinks in size . It decides how large it should be for the task automatically
