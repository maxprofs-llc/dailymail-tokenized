...
Local councils and other public bodies that want to check whether an employee is swinging the lead can not easily use the Regulation of Investigatory Powers Act , which allows councils to spy on local residents suspected of minor crimes .
...
` If it can not be completely justified , it should not be done .
...
Observations : Notes made by the private investigators included comments on Mrs Shaw 's -LRB- pictured -RRB- shoes

Details : The council provided the surveillance company with the teacher 's -LRB- pictured -RRB- address and photograph
