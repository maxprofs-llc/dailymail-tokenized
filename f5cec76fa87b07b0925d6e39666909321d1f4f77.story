...
Those on the highest doses of drugs called cholinesterase inhibitors -LRB- ChEIs -RRB- , which are used to treat mild to moderate disease , got the greatest reduction in risk .
...
Professor Peter Nordström , of Umeå University in Umeå , Sweden , who led the study , which included the drugs donepezil -LRB- Aricept -RRB- , rivastigmine and galantamine .
...
Prof Nordström said : ` We can not say that ChEI use is causing the reduction in risk , only that it is associated with a reduction .
...
` We do n't know if the medication itself caused the drop in heart attack risk or if another factor was involved . This is the first study to link an Alzheimer 's medication to reduced risk of heart attacks so we need to see much more research before we can draw any conclusions .
