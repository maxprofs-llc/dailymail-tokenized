...
that affects 2.5 million Britons need not be a life sentence .
...
Commissioned by the Healthcare Quality Improvement Partnership -LRB- HQIP -RRB- , which is funded by the Department of Health , the audit includes data for more than 80 % of the people diagnosed with diabetes in England .
...
` All patients should receive the National Institute for Health and Clinical Excellence -LRB- Nice -RRB- recommended checks without exception .

` Clinical audits such as this are vital in highlighting where this is n't happening so NHS services can be held to account for whether patients are healthy and able to live fulfilling lives . '
