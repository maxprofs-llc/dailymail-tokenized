...
Major benefit : Premier League referees such as Mark Clattenburg -LRB- pictured -RRB- will benefit from technology
...
It also seems illogical that the only person who needs to see replays is the one person who can not currently see them .
...
If the initiators of reviews are the coaches then a limit on the number of challenges would have to be in place . Once used , this could mean a terrible error can not be corrected and that would defeat the object of the exercise completely .
...
Of course if one particular referee keeps losing challenges then he will be exposed as a poor referee and that can not be a bad thing .
