...
` All of these things mean we ca n't do it so we 're stuck with it as it is and everybody has got the same set of problems .

` If we could do it I would certainly be in favour because it would remove a whole load of uncertainty during the season .

` You try to get things done as early as possible but you ca n't . People talk about not doing anything until after the World Cup . '
