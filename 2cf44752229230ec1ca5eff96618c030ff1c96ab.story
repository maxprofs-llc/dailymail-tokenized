...
Testing of an intelligent parking system -LRB- pictured -RRB- is under way Pisa , which helps drivers find a suitable space to park their car quickly and allows them to pay for the parking on their smartphone
...
` The new parking system integrates seamlessly into our intelligent transport system -LRB- ITS -RRB- , ' the mayor of Pisa , Marco Filippeschi , said . ` It eases the flow of traffic and helps to cut CO2 emissions . '

The new smart city service has been installed on Piazza Carrara -LRB- pictured -RRB- , which is located directly on the banks of the river Arno

Drivers can choose to pay for their parking using Pisa 's existing Tap & Park app -- which integrates with the new system -LRB- pictured left -RRB- . They can also see the location of free parking spaces in the new app -LRB- right -RRB- as well as on display panels in the city
...
Sensors on the floor of each parking spot -LRB- pictured -RRB- detect whether they are free or occupied , while several data units collect the information and send it over the mobile network to the city 's server infrastructure

Drivers looking for a parking space in Pisa -LRB- pictured -RRB- make up 30 per cent of inner-city traffic , so the parking trial is expected to decrease traffic congestion across the bustling Italian city
...
A driver leaves their car at a Vehicle Transfer Station -LRB- VTS -RRB- , which uses laser scanners to measure the precise height and width of the vehicle .
