...
` There are certain drivers who do n't respect the traffic police . But with the robot it will be different . We should respect the robot , ' taxi driver Poro Zidane told AFP .
...
While they may not be as terrifying as the robocop in the science fiction action film -LRB- pictured -RRB- , they have proven effective at combating traffic crime
...
It also boasts cameras that point at the ground , which stops it from running into people , and its face will have an 'em otive display ' which will allow it to express ` simple emotions ' . Each unit costs only $ 20,000 .
...
Each hand is fitted with green and red lights that regulate flow of traffic
