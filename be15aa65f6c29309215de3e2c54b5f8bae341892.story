...
` Watching X factor on catch up , adverts destroy the programme , ' one wrote , while another posted : ` Note to self : X factor must only ever be watched on catch up ! -LSB- Fast forward through -RSB- adverts , judges , all the chit chat c *** and BOOM a tidy 30min show . '
