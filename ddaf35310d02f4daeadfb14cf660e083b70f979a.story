...
High flyers : A team of Hungarian scientists have managed to engineer the first ` flock ' of drones that can fly as a coordinated group -LRB- pictured -RRB- . The collection of 10 copters can fly in formation , follow a leader and change flight patterns without human input
...
Experts created their own computer simulation after fitting tiny GPS trackers to pigeons -LRB- stock image pictured -RRB- to see how the birds fly as a flock and used the knowledge to inform the behaviour of their drones
...
The scientists created their own computer simulation -LRB- pictured -RRB- after fitting tiny GPS trackers to pigeons . While some people might fear that swarms of thinking drones could prove a surveillance menace , the scientists said they could be used for many peaceful applications , such as delivering food
...
` Each has a little brain in the form
of an on-board computer and is completely autonomous . All decisions ,
directions , flight positions are decided by them , ' he explained .

The
drones can be instructed to form a circle and they each find a position
along it and rotate slowly in the same direction . Their autonomous
decisions avoid collisions in the air .

The group of 10 drones can coordinate their movements to form circles -LRB- pictured -RRB- or lines , which could be useful if one day the technology is used to create swarms of surveillance drones

The researchers had to overcome the
challenges of noise and delay , which it hard for copters to ` see ' each
other 's positions and sped up their reaction times . They plan on
replacing radio signals with cameras to help the drones ` see ' one
another more easily in the future .
