...
Australian scientists say our galaxy could be teeming with habitable worlds -LRB- illustration shown -RRB- . If each star has an average of two planets , there will be 200 billion . They base this on a 200-year-old method called the Titius-Bode relation . This was used to predict some planets in our own solar system

The researchers from the Australian National University -LRB- ANU -RRB- made the finding using a 200-year-old method .
...
In 1776 , German astronomer Johann Daniel Titius wrote that the position planets from the sun - then only confirmed to be just Mercury , Venus , Earth , Mars , Jupiter and Saturn - could be predicted by a mathematical relation .

The relation is the number four plus another number , which is zero , three , six , 12 - and so on , doubling each time .

So , for example , Mercury is four plus zero ` parts ' from the sun - four in total .

Venus is four plus three - seven - while Earth is four plus six - ten - and so on .

The work was followed up fellow German Johann Elert Bode in 1772 . He postulated that , using the relation , one noticed a gap in the pattern of the planets .

He found that , after Mars , there was a rather large gap to Jupiter .

` Can one believe that the Founder of the universe had left this space empty ? Certainly not , ' he wrote at the time .

Thus , he predicted the appearance of the dwarf planet Ceres between Mars and Jupiter . The relation also predicted the orbit of Uranus .

There is no solid theoretical explanation as to why this law works , although possible explanations involve the orbital resonance of a planetary system - namely , a condition where all the planets are stable .

Its accuracy and use has been called in to question , though . In our solar system , it failed to account for the asteroid belt , Pluto , and many other bodies beyond the orbit of Neptune .

The team look at multi-planet systems that were known to contain at least three planets , as detected by the Kepler space telescope -LRB- illustrated -RRB- . ` We use a generalised Titius-Bode relation to predict the periods of 228 additional planets in 151 of these Kepler multiples , ' the researchers wrote
...
` The universe is not teeming with aliens with human-like intelligence that can build radio telescopes and space ships . Otherwise we would have seen or heard from them , ' he said .

` It could be that there is some other bottleneck for the emergence of life that we have n't worked out yet . Or intelligent civilisations evolve , but then self-destruct . '
