...
And while Google and car makers are working on the next generation of vehicles , a $ 10,000 -LRB- # 5,900 -RRB- gadget could beat the big firms to controlling your car remotely , as soon as next year .
...
Easy driver : The Cruise RP-1 -LRB- pictured -RRB- claims to be the world 's first ` highway autopilot ' and can take control of car on a motorway , keeping it safely in lane and a suitable distance from the car in front
...
Cruise control : The gadget , which comprises a rooftop sensor unit , computer in the boot and control panel next to the driver -LRB- pictured -RRB- , can be pre-ordered for $ 10,000 and is set to arrive next year
...
The all-seeing eye : Through a combination of sensors , cameras , radar , and other measurement systems , the ` sensor pod ' -LRB- pictured -RRB- relays what it detects back to the ` Cruise computer ' to make real-time decisions on where to position itself on the road
...
Brains in the boot : ` Using advance computer vision and obstacle detection , the RP-1 keeps you in your lane and a safe distance from vehicles in front of you , ' the company says . It does this using sensors and a computer in the boot -LRB- pictured -RRB- that makes the calculations needed to drive the car
...
It claims to be world 's first ` highway autopilot ' and costs $ 10,000 -LRB- # 5,900 -RRB-
