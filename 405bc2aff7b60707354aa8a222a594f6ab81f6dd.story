...
Headphones fitted with the Remote Control and Mic buttons , including Apple 's EarPods -LRB- pictured -RRB- can be used to skip songs , rewind tracks , calls and take photos on iPhones and iPads running iOS 8
...
The video -LRB- above -RRB- was created for Business Insider by New York-based producer Will Wei and the tips are taken from Apple 's EarPods user manual . Some of the tricks are relatively well-known , such as using the microphone during hands-free calls and playing music with the centre button . But many are more obscure

When the camera app is opened the volume buttons -LRB- shown -RRB- act as a remote . Clicking the centre button three times in quick succession skips back a track , while pressing the button twice and holding it down fast forwards through the current song or chapter
