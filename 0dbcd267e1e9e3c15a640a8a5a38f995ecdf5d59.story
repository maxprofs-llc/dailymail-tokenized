...
` It 's not huge in terms of energy , ' Grabette said . ` But if all these vehicles charge at peak times , even with slow car chargers , it could add between 3 and 6 gigawatts -LRB- GW -RRB- of peak demand , which would be felt if it comes at the wrong moment . '
...
` You can have only 1,000 cars , -LRB- but -RRB- if 500 of these are connected to the same building , you 'll have a problem with this building and the neighbourhood around it , ' he said .
...
` If it is developed well , in a coordinated way , it is n't a problem and could even help to rebalance a network , especially by integrating more renewable energy , ' RTE 's Grabette said .
...
` You do n't need to work with 10,000 players , but five or 10 who are leaders in their field . However , that raises the issue of the big players ' egos , ' Schmitt said .
