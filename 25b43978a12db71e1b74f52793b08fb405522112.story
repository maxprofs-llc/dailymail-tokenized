...
Connecticut State Police has started using a golden Labrador -LRB- stock image pictured -RRB- called Thoreau to find concealed memory cards , hard drives and USB sticks . The dog identifies the scent of the metal and components used in the devices and is being used to find storage devices containing images of child porn
...
Thoreau received 22 weeks of training and , last month , found a flash drive containing child pornography hidden inside a tin box , within a metal cabinet . When training dogs to sniff out contraband , handlers and trainers associate the smell of the drug , memory card -LRB- stock image pictured -RRB- or similar with the animal 's favourite toy

` If it has a memory card , he 'll sniff it out , ' Detective Houston told The Providence Journal . ` This is how -LSB- Thoreau -RSB- eats every day . '
