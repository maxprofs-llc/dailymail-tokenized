...
The team was able to teleport a qubit -LRB- a standard unit of data in quantum computing -RRB- 97 kilometers across a lake using a small set of photons without fiberoptic cables or other intermediaries .
...
This produces a pair of photons with the same wavelength , but opposite -LRB- and unknown -RRB- polarization values .

One photon was sent 97km across Qinghai Lake -LRB- using a telescope to focus the beam -RRB- , while the second was analysed locally , according to the team 's research paper , published in Nature .
