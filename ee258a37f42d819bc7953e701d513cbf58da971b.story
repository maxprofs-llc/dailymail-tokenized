...
Here , a ` Shrewbot ' robot based on the smallest terrestrial mammal uses whiskers to explore its surroundings . The diminutive robot shrew can map its surroundings using touch alone and follow a smaller prey robot -LRB- pictured -RRB- using its whisker sense
...
A humanoid known as iCub -LRB- pictured -RRB- , who is part of the eFAA Project , can dance and interact with music.The robot is designed to demonstrate its emotional capability by establishing a sense of understanding and enjoyment with a human dancer
...
An art installation by Konstantinos Grigoriadis using robots -LRB- pictured -RRB- reflects an interest in a biomechanical , postapocalyptic world , which might emerge as the result of rapid advances in science and technology
