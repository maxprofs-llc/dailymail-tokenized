...
AirGuard accurately recognises smoke from cigarettes and marijuana . The handheld version -LRB- left -RRB- is battery-powered and connects to an Android app , via Bluetooth . The plug-in version -LRB- right -RRB- connects to a network over Wi-Fi and is fitted using tamper-proof screws to make sure it ca n't be removed from a hotel room or bedroom
...
Meanwhile , the plug-in version connects to a network over Wi-Fi and is fitted using tamper-proof screws to make sure it ca n't be removed from a hotel room or bedroom .
