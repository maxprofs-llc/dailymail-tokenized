...
Surgeon and assistant performing operation -LRB- posed by models -RRB-

He has now won # 7,000 in compensation from the Cambridge University Hospitals NHS Foundation Trust .

The award comes after Addenbrooke 's was heavily criticised by health watchdog Monitor , which cited a series of so-called ` never events ' - incidents that simply should n't happen - as one of its major failings .
...
Mr O'Sullivan was treated at Addenbrooke 's Hospital in Cambridgeshire -LRB- pictured -RRB- which has been criticised by the health watchdog Monitor
...
` The importance of an open culture can not be underestimated . We expect that Robert Francis will make further recommendations on the duty of candour when the Mid Staffordshire Inquiry is published , and we are committed to taking whatever further action we think is needed as a result .

` But we can not wait - creating this contractual duty of candour now ensures that NHS contracts for the next financial year will champion patients ' rights to basic honesty , as well as safe care . '
