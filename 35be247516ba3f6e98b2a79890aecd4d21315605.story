...
Each time a Digit account is opened and linked to a bank account , the service automatically sets up a savings account for that user -LRB- pictured -RRB- . Once or twice a week , Digit transfers money from the bank to the Digit savings account based on how much money the user has , and how much they 've been spending recently
...
The website uses 256-bit bank-level security , and does n't store bank login details .

A user 's information is anonymised , encrypted and securely stored and all funds held within Digit are insured up to a balance of $ 250,000 -LRB- # 162,750 -RRB- .

This is typically between $ 5 -LRB- # 3 -RRB- and $ 50 -LRB- # 32 -RRB- but is never more than the user can afford .
...
` Digit does n't require you to figure out an arbitrary amount to transfer every month .

` We believe so strongly in our math and the ability to safely identify money you do n't need that if we overdraft your account we 'll pay the fee . '

Accounts can be accessed and managed using the mobile site or desktop dashboard .

Transfers are typically between $ 5 -LRB- # 3 -RRB- and $ 50 -LRB- # 32 -RRB- but are never more than the user can afford . Over time , the service uses a built-in algorithm to learn more about the user 's spending habits and if the user ever needs extra money they can transfer it back at any time for free using text -LRB- pictured -RRB-

In terms of security , Digit uses 256-bit bank-level security , and does n't store bank login details .
...
Accounts can be accessed and managed using the mobile site or desktop dashboard -LRB- pictured -RRB- . Security-wise , Digit said it uses 256-bit bank-level security , and does n't store bank login details . A user 's information is anonymised , encrypted and securely stored and all funds held are insured up to $ 250,000 -LRB- # 162,750 -RRB-
...
It uses 256-bit bank-level security and does n't store login details
...
This is typically $ 5 -LRB- # 3 -RRB- to $ 50 -LRB- # 32 -RRB- based on what the user can afford
