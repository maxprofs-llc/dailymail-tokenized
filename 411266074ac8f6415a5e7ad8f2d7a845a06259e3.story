...
The device being used by the Marshals Service identifies itself as having the closest , strongest signal -- though it does n't -- and causes all the cellphones that can detect its signal to send in their unique registration information . Cellphones are programmed to connect automatically to the strongest cell tower signal .
...
People familiar with the program told the Journal they do get court orders to search for phones , but it is n't clear whether those orders describe the methods used because the orders are sealed .
