...
Jane Ellison -LRB- pictured -RRB- made the announcement at an evening adjournment debate in the Commons
...
` Standard packs mean that the tobacco industry can not use glitzy packaging to help addict the next generation . Standard packs are backed by the public ... and health professionals . '
...
` It is also completely pointless , given that cigarettes are behind the counter so you ca n't now see the packets anyway .

Public Health Minister Jane Ellison also revealed a ban on smoking in private cars will come into force from October -LRB- file picture -RRB-
