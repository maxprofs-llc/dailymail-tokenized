...
Questions asked include how to calculate a pitcher 's ERA -LRB- earned run average -RRB- , how to read an NBA box score , and how to spell the names of notable -LRB- if not quite ` star ' -RRB- athletes with interesting surnames . Examples include Dwyane Wade and Tedy Bruschi .
...
According to forum postings found on SportsJournalists.com -LRB- which date back to 2010 and contain a 2008 version of the same test -RRB- , this assessment is only the tip of the iceberg for potential applicants . Some accounts claim that they were quizzed on their sports knowledge over the phone before the interview , while others claim that they experienced many in-person interviews with supervisors after taking this test .
