...
Kepler detects this effect by measuring the changes , or so-called Transit Timing Variations -LRB- TTVs -RRB- . Planetary systems with TTVs can be verified without requiring extensive ground-based observations , accelerating confirmation of planet candidates . The TTV detection technique also increases Kepler 's ability to confirm planetary systems around fainter and more distant stars.Five of the systems -LRB- Kepler-25 , Kepler-27 , Kepler-30 , Kepler-31 and Kepler-33 -RRB- contain a pair of planets where the inner planet orbits the star twice during each orbit of the outer planet .

Four of the systems -LRB- Kepler-23 , Kepler-24 , Kepler-28 and Kepler-32 -RRB- contain a pairing where the outer planet circles the star twice for every three times the inner planet orbits its star .
