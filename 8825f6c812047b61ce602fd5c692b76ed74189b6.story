...
` We 've learned the weather patterns are quite complex . The cloud structure varies quite strongly as a function of atmospheric depth and can not be explained with a single layer of clouds , ' she said .
...
` The exciting bit is this is only the start . With the next generations of telescopes and in particular the 39 m European Extremely Large Telescope -LRB- pictured -RRB- we will likely see surface maps of more distant brown dwarfs - and eventually a surface map for a young giant planet , ' said Dr Beth Biller from Edinburgh University
