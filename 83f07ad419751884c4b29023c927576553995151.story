...
These results come from research by The Global Language Monitor -LRB- GLM -RRB- - a Texas-based analytics firm that uses online tools to track and scan conversations on blogs , social networks and news sites .
...
Agency -LRB- NSA -RRB- accessing people 's personal records and intelligence ,
...
for example , or if a page ca n't load . This was often used in
