...
While some dismiss this as a coincidence , others claim that so-called ` random ' playlists are n't random at all . Instead , they say , music services are conspiring against listeners to promote tracks .
...
The human brain is designed to notice coincidences . It is also programmed to expect something to happen if it has n't occurred in a while .

For instance , people often think that if they have n't won anything in a scratch card lottery a couple of times in a row , they should have bigger chance of winning the next time .
...
` If you just heard a song from a particular artist , that does n't mean that the next song will be more likely from a different artist in a perfectly random order , ' says Spotify on its blog .
...
The other will imagine flipping a coin 30 times and also write the sequence of results . They do this in secret , so you do n't know who has flipped the real coin and who has flipped the imaginary one .
...
The first list is properly random . The second is a human attempting to be random . You can tell the difference because humans are very , very bad at faking randomness . We just ca n't do it .
...
Perfectly random means that the following two orders are equally likely to occur -LRB- different colours represent different artists -RRB- . However , to the human brain the bottom row does not appear random
...
Spotify is n't the only one who has had to make its playlists less random in order to appear more random .
