...
A Kentucky-based inventor has designed a shirt with heated pockets . Called Podz Gear -LRB- shown -RRB- it has six pouches that store thermo-chemical packs . The pockets are positioned in a way that a person 's whole body is heated . Regular hand warmers can also be used in each of the pockets
...
The entrepreneur developed the thermal base layer - which has reusable heaters on the shoulders , stomach and hips - which sells for # 47 in the UK -LRB- $ 74.95 in the US -RRB- .
...
Researchers at the Institute of Textiles and Clothing in Hong Kong have created a fabric circuit board -LRB- FCB -RRB- that could be incorporated into clothing for a number of purposes .
...
The top is available in green , blue , red or black , while the thermal insets can also be replaced by hand warmers bought from garages and supermarkets . The pockets are designed to dissipate heat evenly around a person 's body -LRB- illustration shown -RRB- and keep them warm in all circumstances

The # 47 -LRB- $ 74.95 -RRB- product is currently part of a Kickstarter campaign . ` Podz Gear takes the place of multiple layers of clothing and keeps the user warmer while not restricting mobility , ' the company writes on Kickstarter . ` Pockets are designed to hold thermo-chemical packs and are arranged along major blood vessels '

Wearing the shirt against your skin with no layer underneath keeps the heat packs as close as possible to your body -LRB- illustrated -RRB- . This allows them to transfer heat to your arteries and veins , which can then be circulated around your body in cold weather
...
The # 47 -LRB- $ 74.95 -RRB- product is currently part of a Kickstarter campaign