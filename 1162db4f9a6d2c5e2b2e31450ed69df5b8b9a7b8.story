...
Researchers have shown that aircraft contribute less to global warming by avoiding the places where the thinly shaped clouds , called contrails -LRB- pictured -RRB- are produced - even if that means flying further and emitting more carbon dioxide
...
The findings suggest that policymakers need to consider more than carbon emissions in discussions about how to make aviation -LRB- illustrated -RRB- less environmentally damaging
...
For example , for a small aircraft that is predicted to form a contrail 20 miles -LRB- 32km -RRB- long , if an alternative route adds less than 200 miles -LRB- 322km -RRB- onto the route - 10 times the length of contrail that would have been produced - then the alternative route would have a smaller climate impact .
...
than 60 miles -LRB- 97km -RRB- which equates to three times the contrail length .

Just like natural clouds , contrails -LRB- pictured -RRB- reflect some of the sun 's incoming energy , resulting in a cooling effect , but also trap some of the infrared energy that radiates from Earth into space , to have a warming effect
