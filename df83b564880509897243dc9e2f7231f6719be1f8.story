...
The MPs ' report notes : 'Re locating the runways in this way might result in less noise annoyance for residents under the current flight path , thus addressing the most politically significant objection to the expansion of Heathrow . '
...
favour and just one -LRB- Torbay Lib Dem Adrian Sanders MP -RRB- voting against ,
with no abstentions .
...
It also calls for controversial Air Passenger Duty -LRB- APD -RRB- airport departure tax to be reduced or abolished if research suggests it is harmful to the economy or Government revenue .
...
Simon Buck , chief executive of the British Air Transport Association -LRB- BATA -RRB- welcomed ` some refreshingly pragmatic and straight forward cross-party thinking ' which puts the ` the national interest first . '
