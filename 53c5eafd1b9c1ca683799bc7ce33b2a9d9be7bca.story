...
This means that those with access to the technology could use it for ` preventing wireless devices from communicating with other wireless devices -LRB- such as in academic settings -RRB- , and for forcing certain electronic devices to enter `` sleep mode '' when entering a sensitive area ' .
