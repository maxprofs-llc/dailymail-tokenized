...
At the start of the video a message appears that reads : ` Your games which are producing from you , we do the same actions in the battelfields -LRB- sic -RRB- !! ' . As the video continues , the players can be heard chanting Islamist slogans whenever a bomb explodes or another character is killed .
...
The modification actually started as an anti-ISIS update , with video game players creating characters to fight against who were based on the Islamist militants . Users initially played the game as the Iraqi army -LRB- pictured -RRB-
