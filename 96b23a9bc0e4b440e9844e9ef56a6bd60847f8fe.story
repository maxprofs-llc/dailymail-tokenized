...
Actor and author Richard Belzer -LRB- pictured as Detective John Munch in Law and Order -RRB- has turned his attention to the hunt for missing flight MH370
...
` Someone 's got to be right , ' she said . ' I myself ca n't explain how such a sophisticated plane can just disappear . '
...
It 's a theory that still ` can not be ruled out ' , the authors contend .

` All in all , the evidence indicates that diverting Flight 370 to Diego Garcia , by whatever means , for whatever reasons , can not be ruled out as a possibility .

` And we 're not saying that we know what those reasons are , or that that is definitively what happened to Flight 370 .

` But we are saying that diversion to Diego Garcia can not currently be eliminated as a possibility , ' they write .
...
The ADV Ocean Shield -LRB- pictured -RRB- , an Australian vessel , was involved in the initial search for the downed plane

USE OF ADVANCED TECHNOLOGIES

The book posits that an advanced kind of electronic warfare technology could be deployed to ` hide ' the missing plane .

` Today 's electronic warfare -LRB- EW -RRB- capability includes weaponry that can hide planes , ' the authors write in one passage .
