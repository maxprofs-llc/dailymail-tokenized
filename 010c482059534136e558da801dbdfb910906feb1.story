The deep web is a hive of illegal activity , rife with child pornography , drug deals and human trafficking .
...
The Defense Advanced Research Projects Agency -LRB- Darpa -RRB- has developed an engine dubbed Memex - a combination of memory and index - that not only scours content on this so-called dark net , but also identifies subtle patterns in activity .

Scroll down for video

The Defense Advanced Research Projects Agency -LRB- Darpa -RRB- has developed a search engine dubbed Memex - a combination of memory and index - that not only scours content on the so-called dark net , it identifies patterns and associations that may be too subtle to be recognised by human investigators
...
' -LSB- But -RSB- common search practices miss information in the deep web - the parts of the web not indexed by standard commercial search engines - and ignore shared content across pages . '
...
The Silk Road used an underground computer network known as the The Onion Router -LRB- TOR -RRB- , which is a matrix of encrypted websites and servers that disguise the identity of users .
...
In particular , Darpa wants to use Memex to uncover human trafficking rings by searching for patterns in the number of online sex adverts being posted from certain regions , or porn sites featuring the same email addresses or phone numbers .
...
It was written by Vannevar Bush , director of the US Office of Scientific Research and Development -LRB- OSRD -RRB- during World War II .
...
The Memex program gets its name from a hypothetical device described in a 1945 article for The Atlantic Monthly . In the article -LRB- pictured -RRB- , Memex was described as an analog computer that would supplement human memory to store and automatically cross-reference all of the user 's books , records and other information

In December , Prime Minister David Cameron -LRB- pictured -RRB- said a specialist unit was being set up to hunt down paedophiles using the dark net to share child pornography . The National Crime Agency and the Government Communications Headquarters -LRB- GCHQ -RRB- will use advanced technology to trace ` digital footprints ' of criminals
...
The National Crime Agency and the Government Communications Headquarters -LRB- GCHQ -RRB- will use advances in analysing images and communications to trace the ` digital footprints ' left by the users who share them .
...
The dark net consists of a network of encoded websites that sit behind the publicly available websites and can not be found with normal search engines .
...
Hidden capabilities that let users email and host file storage through encrypted and anonymous networks are provided by services the The Onion Router -LRB- Tor -RRB- .
