...
Trust Special Administrators -LRB- TSA -RRB- , appointed by the Department of Health in April , said in their report outlining the proposals that ` there is no alternative but to make significant change ' at Stafford and neighbouring Cannock Chase Hospital .
...
91 per cent of patients currently using services at Stafford Hospital -LRB- pictured -RRB- would still be accessing care at the hospitals if the changes went ahead . Among the services that are proposed to stay the hospital are elective surgery , adult inpatient care , as well as out-patient and diagnostic appointments

The report 's authors say that without major change ` future local patient safety is at stake ' pointing to the trust 's small size as one reason why care at the trust in its current form can not safely continue , in the long-term .
...
The TSA came up with its draft recommendations after discussions with patient groups , the public and clinicians including hospital trusts in Stoke-on-Trent , Wolverhampton , and the local Clinical Commissioning Groups -LRB- CCGs -RRB- which buy in health services for the area .
