Precision Guided Firearms -LRB- PGFs -RRB- that can automatically aim at targets ? Terrifyingly , there 's an app for that .

Known as TagTrackXact -LRB- TTX -RRB- , Texas firm TrackingPoint 's software is used to enable an advanced array of weaponry .

And in a new video , one YouTube user shows how TTX lets him hit a smartphone with a rifle from one kilometre -LRB- 0.62 miles -RRB- away .

Scroll down for video

TrackingPoint 's TagTrackXact software enables a shooter to accurately fire at targets by ` painting ' them in the distance before the software helps them align their gun . Others can even follow along with the action on an iOS app on an iPhone or an iPad -LRB- pictured -RRB-
...
The rifle employs the aforementioned TTX targeting system , which boasts a range of up to 1.1 kilometres -LRB- 0.68 miles -RRB- .
...
In the video YouTube user RatedRR fires several shots at an HTC One -LRB- stock image shown -RRB- , highlighting the impressive level of accuracy of the gun . He mentions , though , that the central dot is quite big so at a distance of one kilometre -LRB- 0.62 miles -RRB- it is hard to know which part of the phone he is shooting at

The US military has been testing out some of the Precision Guided Firearms -LRB- pictured -RRB- with a view to employing them in the field in the future . Back in January it was reported they acquired six $ 27,000 -LRB- # 16,000 -RRB- smart rifles from Texas-based TrackingPoint
...
The smart rifles can shoot even if the target is moving as fast as 10 miles -LRB- 16 kilometres -RRB- per hour .
...
A new YouTube video shows off a Precision Guided Firearm -LRB- PGF -RRB-
