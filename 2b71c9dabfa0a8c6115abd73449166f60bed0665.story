...
A Memphis-based company has released a system to observe veins . Called VeinViewer -LRB- shown -RRB- it uses infrared light to look ` under ' the skin . It can then project a high-definition image of the veins onto the surface of the skin . The device enables doctors and nurses to find a vein immediately
...
VeinViewer works by emitting near-infrared light , which is absorbed by hemoglobin in the blood and then reflected by surrounding tissue . The information is processed digitally by the unit and projected in real-time onto the skin . It can see patterns up to 0.6 inches -LRB- 15mm deep -RRB- , and veins up to 0.4 inches -LRB- 10mm -RRB- deep
...
This provides an accurate image of the patient 's blood pattern . It can see patterns up to 0.6 inches -LRB- 15mm deep -RRB- , and veins up to 0.4 inches -LRB- 10mm -RRB- deep .
...
` It is also the only device of its kind that has been shown through clinical studies to increase both first-stick success and patient satisfaction by up to 100 per cent while reducing medically unnecessary -LSB- catheter -RSB- lines by over 30 percent . '

A fine detail mode also increases the contrast in the image , bringing out more detailed vein formations . This can allow a clinician to find turns in your veins , called bifurcations -LRB- shown -RRB- , and valves
