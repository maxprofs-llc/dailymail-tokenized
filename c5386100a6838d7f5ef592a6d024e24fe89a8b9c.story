...
For example , it does n't show the intricate network of cables under the waters of the Gulf of Mexico .
...
` On the one hand , internet users in central countries tend to have faster and cheaper connections to the Internet - there are no countries with low-cost Internet access that are n't also relatively well-connected .
...
Selecting a cable on the map , pictured , or from the submarine cable list , shows details of the cable 's name , ready-for-service -LRB- RFS -RRB- date , length , owners , website , and landing points
