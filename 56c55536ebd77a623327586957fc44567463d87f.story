...
Rumours of the Google update come a month after Microsoft released a preview of Skype Translator -LRB- shown -RRB- . It lets people of different languages talk to each other on video calls . The software translates Spanish or English into text and speech , using a Windows 8.1 device
...
Initial reports from Skype 's beta version -LRB- shown -RRB- say it is good , although not perfect . ` For Skype Translator to work properly , there is a little mental conditioning involved , ' reported Gizmodo . They say you need to speak slowly , and now ` um ' or ` ah ' too much
...
It 's also recommended that the speaker does n't ` um ' and ` ah ' too much , as this can confuse the translation tool .
...
Google will also launch a freshly branded app that translates foreign text into a user 's native language using a smartphone camera . The ability to do this already exists via an app called Word Lens , in which users instantly see a translated sign , for example -LRB- pictured -RRB- , on the screen of their phone

Microsoft first unveiled the technology -LRB- shown -RRB- two years ago . At the time , though , it was deemed too inaccurate to release to the general public . But a breakthrough by the Skype and Microsoft Translator teams in neural network-based speech recognition reduced errors in speech recognition by more than 30 per cent
