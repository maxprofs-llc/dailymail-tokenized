...
For around # 40 -LRB- 6,000 yen -RRB- customers will have their bodies mapped using a 3D scanner , with the resulting file used to 3D print a mould for the one-of-a-kind product .
...
On White Day , the reverse happens . Men who received a honmei-choco -LRB- ` chocolate of love ' -RRB- or giri-choco -LRB- ` courtesy chocolate ' -RRB- on Valentine 's Day are expected to give gifts in return .
...
Two day workshop : For around # 40 -LRB- 6,000 yen -RRB- customers will have their bodies first mapped using a 3D scanner , then the resulting file will be used to 3D print a mould for the one-of-a-kind product
...
A post on the cafe 's site reads -LRB- courtesy of Google Translate -RRB- : ` We have prepared a plan to use high-spec 3D printers , 3D scanners again , they make a gummy whole body of you who do not lose the impact of the chocolate face .
