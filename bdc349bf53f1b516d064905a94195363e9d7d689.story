...
The site was also able to identify many of the components used , including the GPS chip , made by Cambridge Silicon -LRB- orange -RRB- , the Wifi control chip -LRB- red -RRB- and the audio chip -LRB- green -RRB- that drives the bone conduction speaker in glass , as well as the headphones that can be plugged in .

Glass also has a touchscreen control , shown here , controlled with a Synaptics chip -LRB- red -RRB-

The Glass Memory , supplied by Toshiba , is shown in red , and a second type of memory from SK Hynix is in Green . Glass has an applications processor chip -LRB- orange -RRB- and a power management chip as well , along with a special maths chip -LRB- yellow -RRB-
...
The ` arm ' that contains the glass circuitry -LRB- left -RRB- showing the camera lens exposed . On the right is the prism that allows wearers to see an image .
...
One owner , Dawn Martin , commented : ` My glass has been useless for phone calls and nav because I ca n't hear it well enough ... yay for updates/upgrades ! '

Another fan of the device , Jeremiah Townsend , commented : ` Ca n't wait ... now that we 'll be able to use them with prescription glasses , they 'll be glued to my face . '
