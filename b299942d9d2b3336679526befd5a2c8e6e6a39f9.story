...
Google has announced a new tool that locates missing handsets simply by searching for the term ` find my phone ' on the search engine 's homepage -LRB- animated -RRB- . It works with all Android phones that have the latest Google app installed and when the user is signed into their Google account on Chrome

The same Google account must be signed into on the phone .

The Californian firm announced the tool on its Google + page .

It said : ` We 've all been there - you 've searched under your car seat , tossed around the sofa cushions and you still ca n't find your phone .

` If you know where your computer is you can now ask Google to find your Android phone from your desktop .

To locate a lost phone , sign into a Google account on Chrome and type ` find my phone ' into the search engine . A map -LRB- pictured -RRB- appears as the first result with a message asking the user to sign in again to confirm their identity . The phone 's location is shown and clicking ` Ring ' will remotely call the handset

Google 's latest tool ca n't lock the missing phone , or erase its data . Users will need to install the Android Device Manager -LRB- ADM -RRB- app -LRB- pictured -RRB- if they want these features . Both tools override the selected sound profile , too , meaning that even if a phone is on silent it will still ring at full volume for five minutes
...
Google 's latest tool ca n't lock the missing phone , or erase its data and users will need to install the Android Device Manager -LRB- ADM -RRB- app if they want these features .
...
Google 's latest tool ca n't lock the missing phone , or erase its data .

Users will need to install the Android Device Manager -LRB- ADM -RRB- app if they want these features .
