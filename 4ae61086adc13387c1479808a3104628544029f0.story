...
It also used so-called Fourier Transform InfraRed -LRB- FTIR -RRB- residue analysis to identify organic residue .
...
The tools and remains were discovered at a Lower Paleolithic site in Revadim , Israel -LRB- marked -RRB- . The team used ` use-wear analysis ' to examine the surfaces and edges of the tools . It also used so-called Fourier Transform fraRed -LRB- FTIR -RRB- residue analysis to identify organic residue

The researchers studied three tools : a flake , biface -LRB- pictured -RRB- and scraper . No use-traces or identifiable residue were found on the flake but the biface and scraper both revealed ` clear use-wear traces ' . The biface use traces indicate the processing of ` medium-hard material ' believed to be evidence of hide scraping

The scraper -LRB- pictured -RRB- instead featured traces of ` soft or medium material ' . This is believed to be animal tissue . Both tools additionally showed residue of adipocere , or animal fat , and on the scraper , both tissues and vegetable residues were found

The experts said the ` handaxe ' was the equivalent to a prehistoric ` Swiss army knife ' -LRB- stock image -RRB- - capable of breaking down bone , sinew and hide
...
Experts used ` use-wear ' and Fourier Transform InfraRed -LRB- FTIR -RRB- analysis
