...
` Given the sensitivity of the site , we ca n't probe under the surface of the soil . However , through our survey , we have found a higher density of packing stones on one side , supporting the case that the stone has been orientated intentionally , ' said Dr. Brown .
