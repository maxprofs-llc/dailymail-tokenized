...
Tokyo-based Takara Tomy has released ` smart fingernails ' called LumiDecoNail that uses Near Field Communication -LRB- NFC -RRB- to light up when it comes near an NFC-enabled device . The Android-only technology is currently available just in Japan , but other countries fret not - the company has plans for a worldwide release if they prove popular

The ` LumiDecoNail ' uses a technology called Near Field Communication -LRB- NFC -RRB- , in which small amounts of power are transferred very short distances , to communicate with a smartphone .

London-base CuteCircuit claims its wearable technology -LRB- right -RRB- does n't compromise on fashion .
...
The product is on sale in Japan , with a set of 16 nail stickers - one of which contains the LED - costing 1,200 yen -LRB- # 7 ; $ 12 -RRB- .
...
The product -LRB- pictured -RRB- is on sale in Japan , with a set of 16 nail stickers - one of which contains the LED - costing 1,200 yen -LRB- # 7 ; $ 12 -RRB- . The micro-thin LED sticker apparently builds on the popularity of manicure art - where intricate patterns and small gem-like stones are stuck on the nail
