...
California-based Facebook has unveiled simplified privacy information on their site -LRB- screenshot shown -RRB- , which uses infographics to explain how data is used by the social network . It also has step by step instructions for users to alter their settings
...
` Until companies stop bamboozling their users with complicated and lengthy jargon , they simply can not claim to be transparent or take the privacy of their users seriously . '

Facebook -LRB- stock image shown -RRB- has been criticised in recent years for its privacy settings , but it is launching the site to make it simpler for people to understand the terms and conditions of the social network

The new site -LRB- screenshot shown -RRB- is designed to make it easier for people to understand what they are signing up for . But one expert warns this should be just the first step of many
