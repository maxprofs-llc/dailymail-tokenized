Nasa has revealed the design chosen for its next generation spacesuits by a public vote - and a sci-fi inspired ` Tron ' design has won .
...
The new design will now be incorporated into the final version of the suit , which is expected to be ready for testing by November 2014 . Each iteration of the suit will test new technologies that one day will be used in a suit worn by the first humans to step foot on the Red Planet .

The public was given three choices of suit design :
...
The public was given a choice tof three designs .
...
Jeff Bridges in Tron : Legacy , the film believed to have inspired the design
...
In a
blog post , Nasa said : ` As spacesuit engineers , -LSB- we -RSB- have found
...
Suit is the successor to the space agency 's ` Buzz Lightyear ' Z-1 model
