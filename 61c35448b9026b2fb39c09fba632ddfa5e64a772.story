...
The reaction , referred to as the P300 response , happens too fast for the test subject to control , so the subject ca n't game the system .

It works by flashing images of crime scenes or bomb specs in front of the wearer , then looking for tiny changes in the brain that have been found to correspond with recognition .

Veritas Scientific 's proprietary Friend or Foe Algorithm takes then takes millions of data points collected in these tests , processes and weights them accordingly , and generates a scored - showing the operator a Green Light -LRB- Friend -RRB- or Red Light -LRB- Foe -RRB- .

When you recognize a picture that is of emotional significance to you , your brain experiences a 200 to 500 microsecond blip .

The reaction , referred to as the P300 response , happens too fast for the test subject to control , so the subject ca n't game the system .

` If I flash you a picture of a diagram that shows you how to build an IED , that would be a pretty strong indicator that you might be a foe ... You would n't be studying how to make an IED if you were a friend , ' Veritas CEO Eric Elbot told Defence One .
...
` Veritas Scientific 's HandShake captures brain signals in response to stimuli through multiple Event-Related Potentials -LRB- ERPs -RRB- and Blood Oxygenation Level Dependent -LRB- BOLD -RRB- readings , bookended by a Friend Making Interview -LRB- FMI -RRB- and a Foe Problem Interrogation -LRB- FPI -RRB- , ' the firm says .
