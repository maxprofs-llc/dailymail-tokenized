...
They hope the scout , which is about 30 inches -LRB- 76cm -RRB- long , will be used on a planned joint Nasa and European Space Agency mission to bring back samples of soil from Mars to Earth .

Scroll down for video

British engineers are testing a new intelligent scout robot -LRB- shown -RRB- . They say it could be deployed from a larger vehicle on the Martian surface . It would ` scurry ' ahead to find objects of interest for the rover to explore . This would make the process of analysing objects on Mars quicker
...
The Mars Exploration Rovers , Spirit and Opportunity , of which the latter is still active , managed an average of just 0.02 mph -LRB- 0.03 km/h -RRB- , while Curiosity has a top speed of 0.08 mph -LRB- 0.13 km/h -RRB- .
...
` This calls for a lightweight rover that will cover about 20km -LSB- 12 miles -RSB- in about six months . To put things in perspective , the American MER Rover did the same in about six years .
...
Current rovers on Mars are very slow . Curiosity , for example , moves at just 0.08 mph -LRB- 0.13 km/h -RRB- . ` We are looking at the next critical mission , which will be Mars Sample Return , ' said Dr Elie Allouis , a robotics systems engineer at Airbus Defence and Space who has been helping to develop the scout rover

The scout -LRB- shown -RRB- would trundle ahead of the main rover to assess its route across the red planet for soft sand and hidden rocks that have damaged and even killed off previous rovers . Using a range of laser scanners and soil analysers , the scout is able to tell the main rover that its path is safe
...
Dr William Lewinger , who is part of the team developing the soil sensors on the scout at the University of Surrey , said : ` The problem on Mars is that there is a thin crust on top of the surface , so with cameras it all looks the same and you ca n't see that there is nasty soft bits underneath .
...
` If it is not ok then Bridget -LSB- the nickname of the Exomars rover -RSB- plans a new path and sends the scout on that path to check that out first . '
...
Current rovers on Mars are very slow - Curiosity moves at 0.08 mph
