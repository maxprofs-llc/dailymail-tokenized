...
The Drosera capensis , a carnivorous plant , produces strap-like leaves that are up to 3.5 cm long and 0.5 cm wide . They are covered in brightly coloured tentacles -LRB- pictured -RRB- which secrete a sticky mucilage that traps insects
...
Darkfield microscopy , a method where the light source is blocked off causing light to scatter as it hits the specimen , was used to take an image of a Vorticella -LRB- a single-celled organism -RRB- at 20 times magnification .

These tiny objects only show their true beauty under the microscope , when they come alive under huge magnifications .

Darkfield microscopy , a method where the light source is blocked off causing light to scatter as it hits the specimen , was used to take an image of a Vorticella -LRB- a single-celled organism -RRB- at 20 times magnification . These single-celled organisms consist of a bell-shaped head , and a stalk that is anchored to the substrate
