...
They claim our slowing reflexes
suggest we are less smart than our ancestors , with a loss of 1.23 IQ points
per decade or 14 IQ points since Victorian times .

While
an average man in 1889 had a reaction time of 183 milliseconds , this
has slowed to 253ms in 2004 .

They found the same case with women , whose
speed deteriorated from 188 to 261ms in the same period .

The
research team from Umea University , Sweden , the University of Amsterdam
and University College Cork said IQ scores are excellent predictors of
job performance and those with higher intelligence are both more
productive and creative .

But
the scientists were unable to directly compare IQ from different eras
as earlier generations had limited access to education , improved
nutrition and hygiene , which would have boosted modern results .

Instead ,
they compared reaction times , which they claim ` can be used to
meaningfully compare historical and contemporary populations in terms of
levels of general intelligence ' .

The
figures indicate a decline in brainpower since the Victorian era , which
contradicts the so-called Flynn effect , which has found a worldwide
increase in measured IQ scores of three points a decade since the Second World War .
...
` In conclusion however these findings do indicate that with respect to `` genetic g '' -LSB- general intelligence -RSB- the Victorians were indeed substantially cleverer than modern populations . '
