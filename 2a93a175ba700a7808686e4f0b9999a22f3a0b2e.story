...
The super bike also boasts ` MissionOS ' - a user interface that lets a driver access an on-board GPS system , Bluetooth and an image-stabilised HD camera , as well as the usual readings -LRB- pictured -RRB- via an HD touchscreen
