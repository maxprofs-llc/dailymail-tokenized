...
UK-based Jaguar Land Rover have unveiled a smart concept car . It uses cameras to make certain parts of the car ` transparent ' -LRB- shown -RRB- . When a driver looks to the side , for example , the pillar between the driver and passenger door becomes see-through . This enables the driver to see obstacles or cars outside the vehicle
...
` We want to present all of this information on a Heads-Up Display in the driver 's eye-line , so the driver does n't have to seek it out for themselves and take their eyes off the road ahead . '
