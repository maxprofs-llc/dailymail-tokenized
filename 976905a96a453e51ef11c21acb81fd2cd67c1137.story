...
Scientists have revealed the optical trickery behind an invisibility ` cloak ' that has been shown to make a kitten -LRB- pictured -RRB- and goldfish mysteriously ` disappear '
...
Dr Bin said : ` When light goes through this device it disperses sideways and follows a certain path to reach the same point as if it did n't encounter any objects , so visually it seems that the object inside has disappeared .
...
A diagram showing how the device works . When light goes through the device it disperses sideways and follows a certain path to reach the same point as if it did n't encounter any objects , so visually it seems that the object inside it -LRB- the light blue hexagonal space at the centre of the structure , which is hollow -RRB- has disappeared

Here , it is possible to see the beam of light bending around the hexagonal structure . It is this optical effect , which means the object at the hexagon 's centre -LRB- such as a goldfish -RRB- is hidden from view
...
However , the device is more sophisticated than previous attempts that only work with polarised light or microwaves , which humans can not see .

The team hopes that one day the technology can be developed to ensure that objects can not
...
The device , pictured here making part of a pencil invisible , is more sophisticated than previous attempts that only work with polarised light or microwaves , which humans can not see
