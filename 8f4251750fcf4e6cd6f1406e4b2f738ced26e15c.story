...
It said : ' We believe that this long awaited decision will considerably enhance exchanges between the United Kingdom and northern Europe -LRB- Germany , Holland -RRB- and will over time add between 3 and 4 million new passengers per year to the 10 million already using the existing high speed passenger services . '
...
The high speed German-built Inter City Express -LRB- ICE -RRB- trains have to pass stringent safety tests to pass through the Channel Tunnel - including evacuations .
...
The announcement comes as ministers are embroiled in a ` jobs for British workers ' row after confirming that Germany 's Siemens had won a controversial # 1.6 bn contract to build trains for the Thameslink line .
