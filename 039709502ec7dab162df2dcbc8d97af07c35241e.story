...
Curiosity 's Sample Analysis at Mars -LRB- SAM -RRB- instrument analyzed an atmosphere sample last week using a process that concentrates selected gases .
...
SAM found that the Martian atmosphere has about four times as much of a lighter stable isotope -LRB- argon-36 -RRB- compared to a heavier one -LRB- argon-38 -RRB- .
...
Curiosity measures several variables in today 's Martian atmosphere with the Rover Environmental Monitoring Station -LRB- REMS -RRB- , provided by Spain .
...
This illustration shows the instruments and subsystems of the Sample Analysis at Mars -LRB- SAM -RRB- suite on the Curiosity Rover of NASA 's Mars Science Laboratory Project , which the rover used to analyse the Martian atmosphere

Dust distributed by the wind has been examined by Curiosity 's laser-firing Chemistry and Camera -LRB- ChemCam -RRB- instrument . Initial laser pulses on each target hit dust .
...
As the Sample Analysis at Mars -LRB- SAM -RRB- suite of instruments on NASA 's Curiosity Mars rover heats a sample , gases are released -LRB- or `` evolved '' -RRB- from the sample and can be identified using SAM 's quadrupole mass spectrometer . Here are its first readings .

For the rest of April , Curiosity will carry out daily activities for which commands were sent in March , using DAN , REMS and the Radiation Assessment Detector -LRB- RAD -RRB- .
