...
When using the printer for the first time the user will need to pour the ink themselves into the printer 's tank -LRB- shown -RRB- . Epson says this is ` hassle-free ' using drip-free bottle spouts . Once depleted refills can be bought for # 8 - but it has to be Epson 's own brand of ink

Purchasing replacement ink cartridges -LRB- stock image shown -RRB- for existing printers can be a costly and complex process , so the new refillable printers will be welcome new to many
