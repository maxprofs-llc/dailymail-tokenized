...
` This discovery is paradigm shifting , ' said Professor Deborah White , Director , Cancer Research with the South Australian Health and Medical Research Institute -LRB- SAHMRI -RRB- , who conducted the study with the University of Adelaide 's Centre for Personalised Cancer Medicine .
...
` If we can find what 's specific about that cancer , we can spare the normal cells , ' said Ms Schafranek .
...
The researchers found that blocking a protein named STAT5 proved lethal for chronic myeloid leukemia -LRB- CML -RRB- cells , and Professor White said the findings extend beyond CML to all targeted cancer treatments .
