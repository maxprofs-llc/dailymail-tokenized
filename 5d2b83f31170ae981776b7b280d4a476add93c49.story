...
Crisis : A shortage of hospital beds and surgeons are to blame for the high number of cancelled operations , new figures reveal -LRB- stock photo -RRB-
...
'Em ergencies will always take priority so if you fill your hospitals up with emergency cases then elective cases are going to be bounced back .

` These numbers show that hospitals ca n't cope with the combined caseload . '
...
The number of elective operations being cancelled is at the highest level for years -LRB- stock photo -RRB-
