...
` We get 10 serious alerts every day at our airports all round the country and so that means we need that force to focus fairly on that and squarely on that and this additional force to come in and supplement so that we can ensure that the issues in the past do n't reoccur , like the Khaled Sharrouf case . '
