...
Threat Research and Intelligence Group -LRB- JTRIG -RRB- , a British spy unit whose
goal is to ` destroy , deny , degrade -LSB- and -RSB- disrupt ' enemies .
...
The main cyber attack is the ` distributed denial of service ' -LRB- DDoS -RRB- attack .
...
When sent to adversaries , says the presentation , the virus will ` encrypt itself , delete all emails , encrypt all files , make -LSB- the -RSB- screen shake ' and block the computer user from logging on .
...
Using the GCHQ 's SIGINT -LRB- signal-intelligence -RRB- program it was used to spy on trade delegations , foreign diplomats , and other targets with a taste for the high life .

NBC news reported GCHQ would not comment on the newly published documents or on JTRIG 's operations .

In a statement it told them : ` All of GCHQ 's work is carried out in accordance with a strict legal and policy framework , ' said the statement , ` which ensure -LSB- s -RSB- that our activities are authorized , necessary and proportionate , and that there is rigorous oversight , including from the Secretary of State , the Interception and Intelligence Services Commissioners and the Parliamentary Intelligence and Security Committee . All of our operational processes rigorously support this position . '
...
Spy unit whose goal is to ` destroy , deny , degrade -LSB- and -RSB- disrupt ' enemies