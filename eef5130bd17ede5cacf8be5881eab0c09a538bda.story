...
Apple and its CEO Tim Cook -LRB- right -RRB- have previously
strenuously denied any collusion with the NSA in a backdoor spying
program aimed at users of iPhones -LRB- pictured left -RRB- . The conclusion was based on an analysis of 600 million iOS devices , with handsets running the most recent versions of the software at particular risk
...
Mr Zdziarski focused on three particular services known by the technical names com.apple.pcapd , com.apple.mobile.file _ relay and com.apple.mobile.house _ arrest .
...
` This software is n't some legacy code left on the device by Apple engineers for testing - it has been actively updated and expanded in various iOS revisions , ' The Register claimed .
...
` The problem with this is that these services dish out data -LRB- and bypass backup encryption -RRB- regardless of whether or not ` Send Diagnostic Data to Apple ' is turned on or off , and whether or not the device is managed by an enterprise policy of any kind , ' Mr Zdziarski said on his blog .
