...
The bike bell gadget by Frolic uses Bluetooth Low Energy -LRB- BLE -RRB- to connect to a user 's smartphone .
...
The system connects to an iPhone via Bluetooth Low Energy -LRB- BLE -RRB- . Walking away after from the bike drops a pin on to the smartphone 's map , allowing GPS to guide the rider back .
...
Andrew Spitz -LRB- pictured -RRB- and Ruben van der Vleuten , who are behind the Amsterdam-based design consultancy Frolic , were able to make a fully-functional prototype of their idea in just one day
