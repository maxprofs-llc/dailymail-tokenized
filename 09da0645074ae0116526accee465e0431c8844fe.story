...
The change , which came into effect on Wednesday , covers Aberdeen -LRB- 01224 -RRB- , Bradford -LRB- 01274 -RRB- , Brighton -LRB- 01273 -RRB- , Middlesbrough -LRB- 01642 -RRB- and Milton Keynes -LRB- 01908 -RRB- .
...
Currently , Ofcom can not allocate local phone numbers where the first digit is 0 or 1 . This is because the network computers may confuse the number with other existing dialling codes or with a number reserved for special use .
...
` The measure was first implemented in Bournemouth , Christchurch and Poole -LRB- the 01202 code area -RRB- in November 2012 and the process ran smoothly . '
