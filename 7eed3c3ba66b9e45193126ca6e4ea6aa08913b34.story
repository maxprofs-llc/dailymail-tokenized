...
If it ca n't be resolved , a call centre agent will arrange for an engineer to visit the property and fix the boiler .
...
If the fault can be fixed remotely , an engineer will make the changes and the customer will be informed . If it ca n't be resolved , a call centre agent will arrange for an engineer to visit the property and fix the boiler . Stock image pictured . More than 700 homes are taking part in the trial , which runs until the end of 2014

Kassir Hussain , director of British Gas Connected Homes , said : ` Current boiler technology means many engineer visits to investigate a boiler fault result in a return visits because engineers can not carry every potential spare part with them for every visit . '
