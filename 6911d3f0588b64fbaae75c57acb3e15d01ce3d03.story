...
South African researchers have claimed that the universe is governed by a ` golden ratio ' . They say space-time itself is defined by this mathematical constant . The ratio - 1.618 - is found across nature in plants , hurricanes and more -LRB- shown -RRB- . But the researchers say it is also ever-present in the universe
...
For those who have n't read the populist thriller , it is the number 1.618 which has been plucked from the famous Fibonacci sequence .
...
This is n't that impressive on its own . Until you realise that this ratio is the key to everything from encrypting computer data , to the numbers of spirals on a sunflower head , our own limbs and why the Mona Lisa is so pleasing to the eye .
...
` Spectacular examples include the Whirlpool Galaxy -LRB- M51 -RRB- , ammonites , the shape of Nautilus shells , Hurricane Katrina and the distribution of planets , moons , asteroids and rings in the solar system . '

The researchers suggest that the reason that this ratio is so ubiquitous is that it is actually a property of space-time .

` The argument that this amazing consilience -LRB- self-similarity -RRB- arises from a common environmental constraint , which can only be an intrinsic feature of curved space-time , is compelling , ' they write .
...
The researchers say the golden ratio might make up space-time itself . Some have suggested our universe may have been the only one in the multiverse theory to have this ratio that allowed it to form . Pictured is the spiral galaxy Messier 101 -LRB- M101 -RRB-
