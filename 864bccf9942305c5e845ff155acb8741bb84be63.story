...
According to the research , the average face -LRB- pictured -RRB- is androgynous . It is not race-neutral because the original sample set was biased towards caucasian faces .
The researchers said they hope to fix this problem in the future as they collect more faces

To plot the dimensions , the researchers used Eigenfaces analysis - a statistical face recognition technique . These Eigenfaces can be thought of as ` face ingredients ' . To calibrate the model , the researchers calculated 60 ` ingredients ' taken from random faces -LRB- pictured -RRB-
...
Each time a new face is uploaded , it is compared to these points and is created using a linear combination of the individual Eigenfaces . Sliders along the side of each image -LRB- pictured -RRB- can be used to change the features across each of these 60 points to see the face change from male to female , for example
...
This means prominent features -LRB- highlighted in shadows pictured -RRB- would be equally prominent , though opposite , in the anti face
...
` -LSB- With the average face -RSB- , all the coordinates are zero . This face resides exactly in the middle of the face cloud . '
