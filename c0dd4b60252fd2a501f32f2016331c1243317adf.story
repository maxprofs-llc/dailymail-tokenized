...
Aides
claimed the issue was ` close to -LSB- the Prime Minister 's -RSB- heart ' as
...
` They 're getting round what 's going to happen by cutting their cheapest tariffs . Their four tariffs wo n't be cheaper ones .
...
` However , it 's important that simplification does n't come at a cost . The biggest danger is that consumers start to lose discounts and incentives that are valuable to them .
...
` We 've written to customers on historic variable products to advise them that their tariff is no longer available and that we 'll be moving them to our standard offering -LRB- as required -RRB- .
...
Age UK take a commission of around 1.5 per cent from the tariffs through their enterprise arm which raises money for the charity .
...
` And in fact we have been clear with all suppliers that they are allowed to keep social tariffs -LRB- which for example offer discounts to customers who have difficulty paying bills -RRB- under our rules . '
