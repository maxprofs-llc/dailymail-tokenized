...
By inputting a Twitter handle , such as a celebrity 's a result page is generated that counts the number of recent words studied and lists the latest tweets . It can be used to show the difference between people 's emotional , social and thinking styles . For example , President Obama -LRB- left -RRB- is upbeat , while Katy Perry -LRB- right -RRB- is depressed
...
` You scored high in this category if you discuss actions instead of emotions , use big words and do n't reference yourself much , ' it says .
...
Dr Pennebacker has previously developed a computer program called Linguistic Inquiry and Word Count -LRB- LIWC -RRB- which looks at the choice , frequency and context of words to gauge a person 's psychological state , Maria Konnikova writes for the New Yorker .
