...
Initially the virus spreads within the U.S. , the The left panel depicts the simulation from the perspective of the outbreak location -LRB- Atlanta -RRB- and the radial distance is an effective distance compute from traffic flows in the underlying network
...
` So we do n't need to know anything about the disease , ' Brockmann explained .
