...
While Apple has n't placed a number on the amount of handsets affected , the term for ` iPhone 5 ' on Google has the query ` iPhone 5 sleep button not working ' as one of the top searches .
...
A problem with the switch mechanism means affected devices ca n't be turned on or off , or locked in the usual way
