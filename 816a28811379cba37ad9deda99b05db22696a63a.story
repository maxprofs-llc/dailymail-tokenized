...
The claims were made in Peter Cochrane 's -LRB- pictutred -RRB- Future Technologies of Health and Care , Wellbeing and Transformation report
...
` -LSB- Population figures -RSB- sound bleak , but the reality is that technology has satisfied all our desires and needs and we 've never been in a better position than we are today , ' said Mr Cochrane .
...
The NetDoctors website , for example , already offers virtual appointments with doctors , so patients can discuss conditions or problems , ask queries about an odd-looking rash or seek advice when they ca n't get an appointment with their GP .
...
Philips , for example , has been working with devices including Blue Touch -LRB- pictured -RRB- . It uses blue LED lights , which recently won the Nobel Prize in Physics , to detect and relieve back pain . It uses the lights to stimulate the body 's natural production of nitric oxide to boost circulation and the spread of oxygen around the body

Technology , and in particular smart lighting , is similarly being used to tackle food shortages and waste . For example , an indoor farm in Japan uses 17,500 LED lights -LRB- pictured -RRB- to mimic day and night . By monitoring photosynthesis process carefully , the system grows lettuce two-and-a-half times faster than an outdoor farm
...
And home lighting , including examples such as Philips Hue -LRB- pictured left -RRB- and LiFx -LRB- pictured right -RRB- , can now alert users if there is someone at the door , flash when a favourite team scores a goal , or change colour when a text message is received to make our lives easier

Finally , the report looked at how jobs will change and evolve thanks to advances in technology . In the next 25 years , Mr Cochrane believes new jobs will be created , such as ` cyborg engineers ' , ` crime predictors ' - similar to those seen in film Minority Report -LRB- Tom Cruise pictured -RRB- - and ` information caretakers '
