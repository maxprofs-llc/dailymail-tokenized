...
` Often , an investigator will receive a part of a firearm or a firearm that is n't functional .
...
` We can take that and compare it with our reference collection , determine what is n't functioning , and repair it so we can obtain the test fires we need to conduct examinations with bullets and cartridge cases . '
