...
OptoFidelity used its Touch Panel Performance Tester -LRB- TPPT -RRB- to measure the accuracy of the touch panels on each phone .
...
Researchers then used the robot , called the OptoFidelity Touch Panel Performance Tester -LRB- TPPT -RRB- to simulate typing on each device along the QWERTY keys .
...
OptoFidelity used a robot called the Touch Panel Performance Tester -LRB- TPPT -RRB- to simulate typing on each device along the keys on the keyboard . This image shows the typing accuracy of the Galaxy S3 , which only lost accuracy at the edges -LRB- shown in red -RRB-
...
The Touch Panel Performance Tester -LRB- TPPT -RRB- , pictured , is fitted with artificial fingers . It presses the ` fingers ' onto the screen and records the coordinates , to within one millimetre
