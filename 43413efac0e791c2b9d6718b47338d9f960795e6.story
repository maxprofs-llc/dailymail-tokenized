...
The pplkpr app -LRB- right -RRB- syncs with a Bluetooth heart rate monitor -LRB- left -RRB- to track emotions . When the monitor spots a change in heart rate , the app alerts the user . It asks the wearer to explain how they 're feeling and who they 're with , and over time , an algorithm learns the difference between the varying heart rates
...
From this list , the free iOS app ranks friendships based on different emotions -LRB- left -RRB- . The app can then reveal which friends should be avoided during times of stress , it can block people who make the wearer anxious -LRB- right -RRB- , or send text messages to people who make the wearer happy or calm

Using GPS , the app also notifies wearers when they change locations , to ask if they 've just left , or are about to meet someone . The measurements are based on a metric called ` heart rate variability ' -LRB- example pictured -RRB- , where subtle changes in heart rhythm signal changes in an emotional state . This is fed into an algorithm
...
` -LSB- It -RSB- implements a complex metric called `` heart rate variability '' that uses subtle changes in heart rhythm to determine your emotional state .
...
And for people who do n't have a heart rate monitor , the app also lets them add manual emotional readings .
