Facebook announced it was splitting its messaging services -LRB- Messenger app pictured -RRB- in April , and the changes have begun rolling out to users worldwide
...
` Keep in mind that Android controls the way the permissions are named , and the way they 're named does n't necessarily reflect the way the Messenger app and other apps use them . '

Scroll down for video

Users have been left annoyed and outraged at the changes , and have flocked to app stores to complain . Experts have also raised concerns about the vast number of permissions the app asks for on the Android versions -LRB- pictured -RRB- . These give Facebook access to send texts , make calls , access USB storage and more
...
Other users have complained as to why iOS permissions are n't so comprehensive , but this is due to the way the two different operating systems work .
...
Facebook Messenger is n't new , it originally launched in 2011 . When asked why Facebook decided to separate its apps , Mr Kent said :
...
` With a portfolio of apps , there 's more room to manoeuvre ; you do n't have to use Facebook anymore .

Earlier this week , the app was averaging a one-star rating on the Play Store , but has since risen to 4.1 -LRB- pictured -RRB- This is despite 90 per cent of the first 100 reviews rating it as low as possible . Reviews on the store include : ' I DO NOT want this messenger . Why is Facebook forcing this on everyone ? This application sucks '

Facebook recently responded with a blog post -LRB- pictured -RRB- explaining why it needs certain permissions : ` Almost all apps need certain permissions to run on Android , and we use these permissions to run features in the app . Keep in mind that Android controls the way the permissions are named ' said the social network site

For users annoyed with the change , there is an alternative way to use Facebook messages , by accessing them through a mobile browser -LRB- pictured -RRB-

` Facebook does n't always get it right , though , it tried to launch a dedicated phone and home launcher , and they really did n't get a positive response . '

Analyst Brian Blau , research director of Consumer Technology and Markets at Gartner added : ` As with most changes that Facebook makes , users are typically not happy in the beginning and they do n't understand the motivations as to why the changes are being made .

` And , as with most changes we see from Facebook users will accept the change and just move on .

` This issue probably wo n't impact Facebook over the long term . '
...
Facebook responded with a blog post assuring users their data is n't at risk