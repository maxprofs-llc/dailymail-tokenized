...
The industry regulator Ofgem responded in March by introducing a new system requiring energy companies to give a Tariff Comparison Rate -LRB- TCR -RRB- for each energy type .

The TCR is similar to an APR for credit cards and tells householders how much a tariff costs per kilowatt hour -LRB- kWh -RRB- based on medium usage for both gas and electricity .
...
The group 's executive director , Richard Lloyd , said : ` If the energy companies ca n't even explain how to accurately compare tariffs then their customers stand no chance .
...
It added : ` Energy deals can not be compared in the same way as petrol pump prices as there are number of additional factors influencing the amount a customer pays .
...
Do n't forget , prices are different all over the country and the cheapest supplier for you will depend where you live . You only need to be interested in the tariff that is going to be cheapest where you live , so do your own comparison to find the best price .
...
In March Ofgem introduced a new system requiring energy companies to give a Tariff Comparison Rate -LRB- TCR -RRB- for each energy type to customers
