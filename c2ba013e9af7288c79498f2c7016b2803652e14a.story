...
The credit card-sized gadget also locks devices again as soon as a user moves out of range at a distance of 10 feet -LRB- three metres -RRB- .

Scroll down for video

Convenient : The Salt card -LRB- pictured -RRB- is designed to end the tiresome task of manually unlocking a smartphone or tablet , by automatically unlocking it whenever the user is nearby
...
The duo , based in Chicago , Illinois , came up with the idea as an increased method of security and a time-saving device and recently raised more than $ 82,000 -LRB- # 53,512 -RRB- on Kickstarter to put it into production .
...
The credit card-sized gadget -LRB- illustrated -RRB- also locks devices again as soon as a user moves out of range . It connects to an app on a user 's Android handset or iPhone via Bluetooth and also tells them if they have strayed too far from their wallet , where it is suggested the Salt card is stored

The start-up claims that its Salt card is more secure than fingerprint scanners , such as the one in Apple 's iPhone 6 handset -LRB- pictured -RRB- and it can be used with gloves in the winter
...
From then on , their phone automatically unlocks when they move within 10ft -LRB- three metres -RRB- of it .
...
` You do n't have to connect it your phone like you normally do with Bluetooth - it basically acts as a beacon and finds your phone , unlocking it , ' Mr Paglione said .
...
` So you could set it for 30 feet -LRB- 9 metres -RRB- when you 're in your house so you do n't have to put in your pin at home , but when you 're out you might want it so it only unlocks when the card is in your hand , so you could set it to one foot proximity , ' he explained .
...
The card costs $ 20 -LRB- # 13 -RRB- and can be ordered from the company 's website .
...
There are already key fobs that can unlock handsets and many people no longer input a PIN , instead using biometric technology such as fingerprint scanners and iris scanners -LRB- illustrated -RRB- to unlock their smartphones
...
The pattern does n't change significantly after the age of two , and it is difficult to injure its surface and difficult to forge .
