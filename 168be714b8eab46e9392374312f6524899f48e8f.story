...
Astronauts on the ISS have printed the first 3D object in space -LRB- shown -RRB- . They used a printer built by California-based company Made in Space . It was taken to the ISS in September by SpaceX 's Dragon capsule . The demonstration is an important step to having ` replicators ' on future missions
...
` When the first human fashioned a tool from a rock , it could n't have been conceived that one day we 'd be replicating the same fundamental idea in space , ' Aaron Kemmer , CEO of Made in Space , said in a statement .

The printer was installed on the station by astronaut Butch Wilmore , in the station 's Microgravity Science Glovebox -LRB- shown -RRB- , which is used for conducting science and technology experiments . The printer used plastic to form the first of a series of calibration coupons

The device was created by California-based company Made in Space -LRB- shown on parabolic flight -RRB- , who were contracted by Nasa to design it for the ISS . Called the 3D Printing in Zero-G Technology Demonstration , it aims to show the ` additive manufacturing ' technique can make 3D printed parts and tools in space .
