Google has today finally released its maps app for the iPhone 5 , a move certain to be welcomed by users frustrated with the widely criticised mistakes in Apple 's own version .

The iPhone 's default maps app was previously powered by Google until Apple took over with its own software in early September and blocked users from using Google 's app .

But the gadget maker was bombarded with complaints for its app 's errors and forced into a humiliating apology to customers that led to the sacking of the man in charge of its development .
...
The new Google Maps app will include public transport directions and traffic information , for which they are famous , as well as rotating 2D and 3D views and street view , according to a Google blog post .

It will be available for the iPhone and iPod Touch -LRB- 4G -RRB- iOS 5.1 and higher , and will work in more than 40 countries and 29 languages .
...
The overwhelming feeling on opening Google Maps for the first time is relief - it suddenly feels as if a part of your iPhone has been given back .

Gone is the nagging doubt and foreboding that , for the navigationally challenged like myself , things would not end well every time you typed a place into Apple 's maps app .

Instead , Google 's superb service is back - and better than ever .

The app has been completely redesigned , and is slicker and more straightforward than before .

There are some massive improvements , notably around directions , which are fast and simple to use - and unlike Apple 's version , include public transport .

There 's also access to Street View , which give Google a massive advantage .

In some areas , Apple does have the edge - its 3D maps , for example , are stunning , and the maps themselves look cleaner and sharper .

However , in terms of day to day use , there is absolutely no question that Google wins , and by a huge margin , simply for having a vastly more developed database of places , and fewer of the embarrassing errors that have plagued Apple 's service .

Apple maps ca n't -LRB- quite -RRB- be written off , and it has improved dramatically since its launch - and will no doubt continue to do so . In a few years , it may become a true competitor to Google 's product .

But for the foreseeable , it 's good to have Google -LRB- and my virtual sense of direction -RRB- back .
...
On Monday police in Australia warned drivers with iPhones not to navigate with Apple Maps after users looking for one city found themselves in barren outback more than 40 miles away .
...
There still is n't a Google mapping app for Apple 's top-selling tablet computer , the iPad , but the company plans to make one eventually . In the meantime , iPad users can access see the maps in an iPhone mode .
...
Some iPhone owners even refused to upgrade to Apple 's newest software , iOS 6 , because they did n't want to lose access to the old Google mapping application built into iOS 5 and earlier versions .

@highlight

Apple evicted Google from its latest generation of of devices in September
