...
The PC is available for pre-order online in the US , before being released in stores on 9 November , and costs $ 1,899 -LRB- # 1,180 -RRB- . More country release dates are yet to be announced .

Scroll down for video

HP 's $ 1,899 -LRB- # 1,180 -RRB- Sprout PC -LRB- pictured -RRB- has a 23-inch touchscreen display with an interactive touch mat . A projector is fitted to the top of the monitor , known as the HP Illuminator , and the California-based firm calls the technology Blended Reality

The California-based firm calls the technology Blended Reality .

The projector , dubbed the HP Illuminator , is fitted with Intel 's RealSense 3D technology , similar to Microsoft 's Kinect , and combines a 14.6 MP camera , the projector itself , and an LED desk lamp .

This camera system means it is able to beam images on to the mat , but can also be used to scan physical objects .

HP 's $ 1,899 -LRB- # 1,180 -RRB- Sprout PC has a 23-inch touchscreen display with an interactive touch mat .

A projector is fitted to the top of the monitor , known as the HP Illuminator .

It is fitted with Intel 's RealSense 3D technology , similar to Microsoft 's Kinect , and combines a 14.6 MP camera , the projector itself , and an LED desk lamp .
...
` We did n't want to introduce a product that was n't a breakthrough . '
...
The HP Illuminator -LRB- pictured -RRB- is fitted with Intel 's RealSense 3D technology , similar to Microsoft 's Kinect , and combines a 14.6 MP camera , the projector , and an LED desk lamp . This camera system means it is able to beam images on to the mat , but can also be used to scan physical objects
...
Once an object has been scanned , a virtual copy can be manipulated in 2D and 3D either on the touchscreen , or on the mat -LRB- pictured -RRB- using a stylus , or touchscreen controls such as pinch and swipe . Users can also type onto the mat using a software-based keyboard because the cameras recognise 20 touches at one time
...
It launches in the US on 9 November , and costs $ 1,899 -LRB- # 1,180 -RRB-
