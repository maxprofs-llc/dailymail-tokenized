...
` It can not be allowed that we have expressions which refer to the possible destruction of UN member states , ' she said .
...
` Our current nuclear test is the primary countermeasure taken by the DPRK -LRB- Democratic People 's Republic of Korea -RRB- in which it exercised its maximum self-restraint , ' said the North Korean diplomat Jon .

` If the U.S. takes a hostile approach toward the DPRK to the last , rendering the situation complicated , it -LRB- North Korea -RRB- will be left with no option but to take the second and third stronger steps in succession , ' he said , without elaborating on what that might entail .
