...
Apple 's iOS 8 software -LRB- pictured -RRB- was unveiled in June and is released today . Users can upgrade by opening Settings , General , and selecting Software Update . If the page states that the software is up-to-date , it means iOS 8 is not currently available for that device
...
Once iOS 8 is available , users should select Update .

It is advised that phones are connected to a Wi-Fi network and plugged into the mains .

Users are also advised to backup their phone to iCloud , or an external drive , to make sure no photos or contacts are lost .
...
The search function on Apple 's Photos app -LRB- pictured -RRB- has been improved to make it easier to find photos , based on location , dates or album name . Users can fine-tune edits , and the latest smart composition tools automatically straighten horizons , and crop images
...
This means they do n't have to open the specific app , or leave the app they were already using .
...
One of the stand-out features of iOS 8 is Interactive Notifications -LRB- pictured -RRB- . They let users reply to texts , emails , accept calendar invites , tweet and send Facebook messages straight from the notification banner . This means users do n't have to open the specific app , or leave the app they were already using

QUICKTYPE

In iOS 8 , Apple has added support for more third-party keyboards and improved its own keyboard to add predictive text .

In iOS 8 , Apple has added support for more third-party keyboards and improved its own keyboard to add predictive text -LRB- pictured -RRB-
...
Apple has also improved its Spotlight tool , -LRB- pictured -RRB- which searches for files and information on the device , and the web.The app now considers the answer , and uses context to provide the most relevant choices
...
It means users do n't have to open the specific app , or leave the app they were already using .

In iOS 8 , Apple has added support for more third-party keyboards and improved its own keyboard to add predictive text .

As a user types , they 'll see a choice of words or phrases the software thinks they will type next , based on past conversations and writing style .

The new Health app on iOS 8 features a dashboard -LRB- pictured -RRB- showing all the user 's health and ﬁtness data . The app puts all heart rate , calories burned , blood sugar , and cholesterol information in one place , and blood type and allergy information can be accessed from the Lock Screen , in case of an emergency

The software is compatible with the iPod touch 5 , iPhone 4S , iPhone 5 , 5S , and 5C , and comes pre-loaded on Apple 's latest iPhone 6 -LRB- pictured left -RRB- and 6 Plus handsets -LRB- right -RRB- . Users can additionally upgrade their iPad 2 , iPad with Retina Display , iPad Air , iPad mini and the iPad mini with Retina display to iOS 8 , too
...
Apple 's iOS 8 software was unveiled in June and is released today
