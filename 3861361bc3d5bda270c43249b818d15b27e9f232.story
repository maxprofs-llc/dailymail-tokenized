...
` I want to live to be thousands of years old , I do n't want to die and I do n't know why anybody would .

` -LSB- The idea behind the sensor -RSB- is very fun . It 's meant to capture people 's imagination . '

Cannon created the sensor , called Circadia 1.0 , pictured , using a Bluetooth connector , computer chip , and fitted it with LED lights . The sensor is set to go on sale ` soon ' for around $ 500 -LRB- # 313 -RRB- and is open source , meaning the data can be collected and used in whichever way the owner wants
...
The Circadia 1.0 is set to go on sale ` soon ' for around $ 500 -LRB- # 313 -RRB- and is open source , meaning that the data can be collected and used in whichever way the owner wants .

This does not include fitting , which Haworth said he would charge around $ 200 -LRB- # 125 -RRB- .
...
Would-be hackers will soon be able to buy the sensor for $ 500 -LRB- # 313 -RRB-