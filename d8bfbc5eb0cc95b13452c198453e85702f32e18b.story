...
The Mouse Box concept was created by Poland-based Przemysław Strzelczyk and a team of software developers . It is the same size as a traditional mouse , meaning it would fit comfortably in the hand , and runs on a 1.4 GHz ARM processor , like the chip inside the Samsung Galaxy Note 10 , for example
...
It is the same size as a traditional mouse , meaning it would comfortably in the hand , and runs on a 1.4 GHz ARM processor , like the chip inside the Samsung Galaxy Note 10 , for example .
...
This ca n't be physically expanded , but can be increased using cloud storage .
...
` However , it still is n't ideal as it is necessary to transport a lot of its parts - a monitor , a keyboard , a CPU and a mouse .
...
Mouse-Box -LRB- pictured -RRB- connects to a monitor or projector via a standard HDMI cable , and comes with the same amount of storage as a high-end iPhone 6 Plus . It charges wirelessly on an inductive charging pad that doubles up as a mouse pad . This means it should never run out of battery
...
In a video , the Mouse-Box is shown being used to make presentations , as an alternative to the work PC -LRB- pictured -RRB- , or to replace a PC at home . The startup is currently looking for funding to create a prototype , and later put the device into mass production , so a release date and price have not been announced
