...
The Smart Wallit Pro Bluetooth device -LRB- pictured -RRB- slots into the card holder of a purse and automatically links with a smartphone app so that its whereabouts can be tracked
...
If the wallet goes out of range of the app , a warning message will flash on the screen , displaying the last location where the wallet was used -LRB- pictured -RRB-

Clever and colourful : The device will be available to buy in five shades so it can be matched to purses . It measures 4.2 mm thick and is powered by a rechargeable Lithium-ion polymer battery

The device is just 4.2 mm thick and is powered by a rechargeable Lithium-ion polymer battery .
...
The device -LRB- pictured -RRB- can be ` called ' with the app from 30 feet away so that it makes a loud ringing noise to let owners know where it is , which could prove a godsend to people who regularly misplace belongings around their house
...
The gadget works with an iPhone , iPod Touch , and some Android 4.3 devices . The Bluetooth device can also be attached to luggage so that it is easily found at an airport -LRB- pictured -RRB- as well as fixed to keys
...
The Smart Wallit Pro will be manufactured in March this year and retail prices will be approximately # 36 , but the device can be ordered via Kickstarter for prices starting from $ 39 -LRB- # 23 plus shipping -RRB- .
