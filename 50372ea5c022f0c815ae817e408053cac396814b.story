...
California-based Zya has released their Ditty app for Facebook Messenger . Users can type in a 70-character message and have it turned into a song . Music available includes Brave , Chandelier and Counting Stars . The iOS and Android app is free , although some songs cost 80p
...
While some of the dozens of songs on the service are free , most such as ` Counting Stars ' and ` The Gambler ' require payment of # 0.80 -LRB- $ 0.99 -RRB- .
...
When a user loads up the app they are presented with a window to type messages in at the bottom , and a scrollable list of songs to choose from -LRB- left -RRB- . After typing a message , a user can then preview what it will sound like with different songs before sending it over Facebook messenger -LRB- right -RRB-
...
` Everyone loves music , but making it has always divided people into two camps - those who can and those who ca n't , ' the company said in a statement .
...
The release of Ditty follows news from the F8 Developer Conference in San Francisco , where Facebook boss Mark Zuckerberg -LRB- pictured -RRB- announced their Messenger app would be opened to third party developers . Known as the Messenger Platform , it will allow developers to build new services into the app
...
California-based Zya has released their Ditty app for Facebook Messenger
