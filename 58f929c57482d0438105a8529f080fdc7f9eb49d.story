...
` The issue will be resolved this evening . Claims that the outage was caused by a distributed denial of service -LSB- DDoS -RSB- attack are not true . '
...
` If you trust one another , you do n't spy on each other , ` Westerwelle said . ` Doing so regardless puts pressure on the friendship . '
...
Germans say ` If you trust one another , you do n't spy on each other ' after latest Edward Snowden leak