...
And the report estimates that the exodus of experienced employees from the workplace is already costing the British economy # 1.3 billion every year .
...
` -LSB- It -RSB- recommends that the Government works with selected local authorities in different areas to investigate alternative methods for supporting carers to remain in work , and for developing the care and support market more generally .

` Investment now may lead to a ﬁnancial proﬁt as well as creating huge social and health value . '

Madeleine Starr , the director of innovation at Carers UK , said : ` Government must urgently examine how to cultivate good quality , affordable care services for older people who do n't qualify for local council social care services which are increasingly being rationed to only those with little or no savings and the highest levels of need . '
