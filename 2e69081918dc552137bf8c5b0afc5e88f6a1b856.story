...
` People do n't like to use bins that look full or dirty , ' the report said . ` This is because people do n't want to touch rubbish inside the bin and do n't want to touch a dirty bin ' - and ones with small hatches are worse
...
` People do n't like to use bins that look full or dirty . This is because people do n't want to touch rubbish inside the bin and do n't want to touch a dirty bin .
...
The Local Environmental Quality Survey of England was carried out by Keep Britain Tidy on behalf of the Department for Environment , Food and Rural Affairs -LRB- Defra -RRB- .
...
Keep Britain Tidy chief executive Phil Barton warned towns are suffering because of government cuts - but insisted people can not rely on the state to clear up their mess .
...
` We can not afford to be complacent . If we want to keep our country clean and litter-free we can not and must not rely on councils ' capacity to `` clean up after us '' .
...
Keep Britain Tidy : ` People do n't like to use bins that look full or dirty '
