...
An app called SnoopSnitch -LRB- homescreen pictured left -RRB- claims to detect IMSI catchers -LRB- right -RRB- - eavesdropping devices used for intercepting mobile phone traffic and tracking the movement of smartphone users - and warn smartphone users if their devices are giving up their personal information and connecting to them
...
The GSM specification - the default global standard for mobile communications - requires a smartphone to authenticate to the network , but does n't require the network to make itself known to the handset .
...
The free Android app 's Google Play listing reads : ` SnoopSnitch collects and analyses mobile radio data to make you aware of your mobile network security and to warn you about threats like fake base stations -LRB- IMSI catchers -RRB- , user tracking , and SS7 attacks . '
...
The flaw , is in a global telecom network called Signal System 7 -LRB- SS7 -RRB- .
...
Crucially , the app ca n't prevent a smartphone from connecting to stingrays , but lets a user known there is surveillance in a certain area .
