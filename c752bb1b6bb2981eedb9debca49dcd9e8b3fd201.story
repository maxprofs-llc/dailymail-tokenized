Votubia -LRB- everolimus -RRB- could shrink brain tumours by up to 50 per cent in children with the rare disease tuberous sclerosis complex

A drug that can shrink brain tumours by up to 50 per cent in children with a rare disease has been launched in the UK .

NHS doctors will be able to apply for funding from health trusts for Votubia -LRB- everolimus -RRB- for children with growing non-malignant brain tumours associated with a condition called tuberous sclerosis complex -LRB- TSC -RRB- .
...
The drug , which has been granted orphan drug status for rare diseases , has been shown to shrink subependymal giant cell astrocytoma -LRB- SEGA -RRB- tumours associated with TSC .
...
` The way it works in the signalling pathway can be simply likened to blocking a receiver so it can not process signals from the aerial on an analogue radio , so that the signals can no longer transmit to drive in this case tumour cell growth . '
