...
American Science and Engineering -LRB- AS&E -RRB- has revealed its portable X-ray detection system that can be used by security enforcement on the go .
...
Massachusetts-based AS&E have unveiled their Z Backscatter X-ray scanner called the Mini Z . It will retail for # 30,000 -LRB- $ 50,000 -RRB- and is apparently able to detect potential threats in locations other scanners can not reach , such as airplane seats and in bags at events

The Mini Z , which costs # 30,000 -LRB- $ 50,000 -RRB- , can detect a range of ` hidden organic threats ' according to AS&E .

Length : 11.5 in -LRB- 29.2 cm -RRB-

Width : 9.8 in -LRB- 24.9 cm -RRB-

Height : 7.6 in -LRB- 19.3 cm -RRB-

Weight : 9 lbs -LRB- 4 kg -RRB-

Operating Time : 4 hrs per battery charge

Scan Speed : 6 in -LRB- 15 cm -RRB- per second -LRB- typical -RRB-

Ambient Operating Temperature : 0 °C to 45 °C -LRB- 32 °F to 113 °F -RRB-
...
When the user presses a button on the top , it begins scanning items and procures a real-time image of the target on a tablet , which acts as the screen -LRB- demonstration shown -RRB- . This can spot materials that more traditional systems such as transmission X-ray can miss such as explosives , currency and drugs
...
The product is a miniaturisation of the technology used in the Z Backscatter Van -LSB- ZBV -RSB- already manufactured by the company , which is used to scan much larger objects like trucks and containers .
...
The device will sell for # 30,000 -LRB- $ 50,000 -RRB- and could be used by a variety of law enforcement services including the military