...
REALITY : The figure is based on gross domestic product -LRB- GDP -RRB- data for 2011 . But a huge proportion of the income from North Sea oil and gas goes to foreign investors , and gross national income -LRB- GNI -RRB- is therefore the figure that should be used . No Scottish data on GNI is available . UK oil and gas production has fallen by an average of 7.8 per cent a year since 1999 . Nuclear disarmament
...
CLAIM : A Scottish Broadcasting Service -LRB- SBS -RRB- would be established using the assets of BBC Scotland . SBS would broadcast Strictly Come Dancing , Doctor Who and CBeebies in return for giving the BBC access to its existing resources north of the border .
