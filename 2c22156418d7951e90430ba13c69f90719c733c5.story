From food to houses , it appears there is very little that a 3D printer ca n't be used for .
...
One hacker in Berlin has built a website -LRB- picutred -RRB- that lets people design their own sex toys , and print them out . Users can create different shapes , as well as adjust the height , curviness , colour and angle of the toys to produce a computer model
...
Users of the website tool are greeted with an outline of a basic sex toy -LRB- pictured -RRB- and can manipulate different points to change its shape to suit their preferences

While most people do not have a sufficiently advanced 3D printer at home -LRB- stock image -RRB- that can handle piping silicon , the tool does , in theory , allow anyone to print out a sex toy of their own design
...
The curviness and style can be altered by selecting various options to create strange shapes -LRB- pictured -RRB- - the likes of which may not be on offer at somewhere such as Ann Summers . Designer Ikaros Kappler used programming language Javascript and 3D library Three.js to build his extrusion/revolution generator
