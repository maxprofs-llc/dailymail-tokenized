...
Parents can also set a timer so that the phone can not be switched on during lessons or late at night , for example . However , calls to the parents ' phones can be made at all times .
...
Bemilo founder Simon Goff said : ` Unlike an app , Bemilo 's SIM will work on any mobile device or tablet , and most importantly can not be bypassed by the child . '
