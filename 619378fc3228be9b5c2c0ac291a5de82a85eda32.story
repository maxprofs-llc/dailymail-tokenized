...
There will be internet options to block particular kinds of content , individual sites or restrict access at specific times of the day -LRB- posed by model -RRB-
...
The Prime Minister says the Mothers ' Union , which has advised the Government on how to shield children from adult and violent internet content , is backing alternative proposals to allow parents to tailor exactly what they can and can not see .
...
Some might ask why , then , this Government has not taken the route of ` default on ' filters for new computers , so that each one that is bought comes with blanket filters for all unsuitable content.There 's a simple reason why we have n't done this : all the evidence suggests such a crude system would n't work very well in practice .

With the system , when people switch on their new computer , a question will pop up asking if there are children in the house . If there are , then parents will be automatically prompted to tailor their internet filters -LRB- posed by model -RRB-
...
However , the filters were so wide-ranging that she then found she could n't access things like TV stations on demand ; they were blocked too .
