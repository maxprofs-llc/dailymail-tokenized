...
Maven observed the edges of the Martian atmosphere using the Imaging Ultraviolet Spectrograph -LRB- IUVS -RRB- , which is sensitive to the sunlight reflected by these atoms .

The first images from the Mars Atmosphere and Volatile Evolution -LRB- MAVEN -RRB- spacecraft has provided scientists their first look at a storm of energetic solar particles on Mars .
...
Solar energetic particles -LRB- SEPs -RRB- are streams of high-speed particles blasted from the sun during explosive solar activity like flares or coronal mass ejections -LRB- CMEs -RRB- .
...
The Imaging Ultraviolet Spectrograph -LRB- IUVS -RRB- instrument obtained these false-color images eight hours after the successful completion of Mars orbit insertion . The image shows the planet from an altitude of 36,500 km in three ultraviolet wavelength bands . Blue shows the ultraviolet light from the sun scattered from atomic hydrogen gas in an extended cloud that goes to thousands of kilometers above the planet 's surface . Green shows a different wavelength of ultraviolet light that is primarily sunlight reflected off of atomic oxygen , showing the smaller oxygen cloud . Red shows ultraviolet sunlight reflected from the planet 's surface ; the bright spot in the lower right is light reflected either from polar ice or clouds .
