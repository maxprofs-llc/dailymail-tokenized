...
Before it 's served , the treat is a light blue colour -LRB- pictured -RRB- , but this quickly changes when the server adds a spray of ` love elixir , as Mr Linares calls it . The spray transforms the ice cream into a dark pink shade in around 10 to 15 seconds
...
Using a technique known as Temporal Dominance of Sensations -LRB- TDS -RRB- , researchers have analysed how much ` coldness ' , ` creaminess ' and ` roughness ' is need to make the perfect frozen dessert .
...
sweetened milk -LRB- M -RRB- and the right containing milk , cream , egg and the
chemical hydrocolloids -LRB- MCEH -RRB-
