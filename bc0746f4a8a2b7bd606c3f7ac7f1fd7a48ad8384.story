...
` The legitimate government in Iraq will have asked for help , I do n't think it would be right for Britain with its air power and other resources to stand apart and leave it to the Bahrainis or the Americans . '
...
` We have made it clear that ISIS has to be defeated in Syria and Iraq but we do n't have the authority to support in Syria at the moment .
...
He added : ` If we find there is a contribution we can make in Syria and it is lawful we can do it , but at the moment we do n't have the authority from Parliament . '
...
` There could be terrorist strikes across Western Europe as -LRB- IS fighters -RRB- are returning to countries as far apart as Norway and Australia . '
...
` We have got to degrade ISIL 's military capability over time , that is n't going to happen overnight .

` So I do n't want to suggest that there is anything readily that the coalition can do that will make a fundamental difference on the ground in this battle , in the tactical situation that 's faced around Kobani . '
...
Cautious : US secretary of state John Kerry -LRB- right -RRB- and Mr Hammond -LRB- left -RRB- have reacted cautiously to a Turkish proposal to establish a ` buffer zone '
...
` Although we the coalition are confident that we will win that strategic battle we can not say with confidence that we will be able to win any specific tactical engagement . '
...
` But at the same time you 'd have to guarantee safety , guarantee there would n't be attacks by the government .

` It needs a thorough examination . '

Mr Hammond added : ` We would have to explore with other allies and partners what is meant by a buffer zone , how such a concept would work , but I certainly would n't want to rule it out at this stage . '
...
Mr Hammond indicated ministers would be prepared to go back to Parliament to seek permission to extend British military action into Syria if US Central Command -LRB- Centcom -RRB- considered it ` militarily useful ' .
