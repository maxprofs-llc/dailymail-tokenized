...
` There was about 10 people -LRB- in the cell -RRB- who probably used the phone , so it 's hard to say .
...
` I 'm not the guilty one on this . '
...
var p = new anv_pl_def -LRB- -RRB- ;p . loadVideoWithKey -LRB- `` eyJtIjoiR1JUViIsInAiOiIxMSIsInYiOiIyODg2NTY2In0 = '' -RRB- ;
