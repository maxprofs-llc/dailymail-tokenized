...
Most playing cards memorised - 1,456 -LRB- 28 decks -RRB- , held by Ben Pridmore
...
Chambers told The Times that the most effective way to do this is to use playing cards in place of numbers , and then assign certain attributes to these cards .
...
A simpler method could be to use a person 's initials , such as Adolf Hitler -LRB- AH -RRB- for the Ace of Hearts , for example
