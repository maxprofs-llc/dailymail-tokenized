...
The update has n't yet been confirmed by the Mountain View , California-based company , but users of the app have taken to Twitter to confirm its appearance on their Android handsets .
...
The update has n't yet been confirmed by WhatsApp , but users of the app have taken to Twitter to confirm its appearance on their Android handsets - although it is yet to appear on iOS
...
However , some people say they can not see the update , which is available from the Google Play Store or WhatsApp 's site , indicating that it may not have rolled out everywhere yet .

And some users are n't that impressed .
...
Other messaging apps , including Viber , already offer free voice and video calls to users , and it 's believed WhatsApp 's update is designed to rival such services . Like Viber 's app , WhatsApp shows users when they have missed a call -LRB- a screenshot is shown above -RRB-

In December , Dutch site AndroidWorld uncovered clues about the feature while studying the app 's test code . It then extracted layout files from the raw code to create mock-up screenshots -LRB- pictured -RRB- . The new tool was only available to select users , but if someone with the feature called someone without it , it forced the update
