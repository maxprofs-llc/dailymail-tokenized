...
` Over the past few weeks the company has held discussions with a number of parties with a view to finding a stable financial future for the business . The discussions , which have been wide ranging , including both stakeholders and third parties , are with a view to achieving the best possible terms for the business . Without the authority to issue equity on a non pre-emptive basis , the directors can not issue shares in the timeframe required .

` At the current time the assets -LRB- other than Ibrox -RRB- , cash flow and business of Rangers does not support a significant financing , on an open market commercial basis , to achieve the goals which the directors have set for the club .
