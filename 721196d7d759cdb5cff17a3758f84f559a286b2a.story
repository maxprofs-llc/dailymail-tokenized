...
The belt contains a ` new breed of Lithium Ceramic Polymer flexible battery ' , six layers of which are sandwiched between the leather part of the belt -LRB- pictured -RRB-

The belt contains a ` new breed of Lithium Ceramic Polymer flexible battery ' .

There are six overlapping layers of this battery sandwiched between the belt leather to give a base power of 1,300 mAh of charge .

` Add this to the 800mAh in each buckle -- for a total of 2,100 mAh -- and you 've enough to fully charge an iPhone 6 with some left over , ' the company says .
...
Made from leather the Xoo Belt looks completely normal , but its buckle incorporates a charger -LRB- pictured -RRB- that is held in place by magnets so it can be easily connected and disconnected
...
` It looks , feels and weighs about the same as a really nice belt but comes with a mighty 2,100 mAh of hidden charge .
...
The belt is available to pre-order from Indiegogo from $ 125 -LRB- # 80 -RRB- .

The belt , which comes in black and brown -LRB- pictured -RRB- , can be charged like an ordinary smartphone via a USB cable and has enough power to charge an iPhone 6 from scratch
...
Belt is available to pre-order from Indiegogo from $ 125 -LRB- # 80 -RRB-