...
It does n't let users make phone calls from the device , but like other smartwatches such as the Moto 360 , they can read texts , emails , social media updates and see other notifications .

The Microsoft Band -LRB- pictured -RRB- contains built-in GPS and 24-hour heart rate monitoring . It does n't let users make phone calls , but like other smartwatches such as the Moto 360 , they can read texts , emails , social media updates and see other notifications on the touchscreen

But unlike other smartwatches on the market , the Band 's battery life lasts more than two days - despite having a coloured screen , vibrations and is monitoring heart rate constantly . The wrist-worn device -LRB- pictured left -RRB- works alongside a health app called Microsoft Health -LRB- shown on various devices -RRB-
...
And all of these features , stats and notifications can be customised on the Microsoft Health app that is n't tied to Microsoft 's Windows Phone and works across Android and iOS as well .
...
Smartwatch features : The device does n't allow people to make calls directly , but does push notifications about calls , texts and emails from a user 's smartphone to their Microsoft Band .
...
All of these features , stats and notifications can be customised on the Microsoft Health app -LRB- pictured -RRB- which is available across Android , iOS and Windows Phone . This app additionally syncs with other health and fitness devices and services such as UP by Jawbone , MapMyFitness and RunKeeper
...
The Band -LRB- pictured -RRB- is available for pre-order from Amazon , Currys PC World and Microsoft Store or via O2
...
These vibrations are also used to alert a user to Facebook and Twitter notifications , emails and text messages and a Quick Read button will show the text of these notifications word-by-word so you do n't have to scroll through on the small screen .
