...
The Emperor Penguin -LRB- Aptenodytes forsteri -RRB- is the tallest and heaviest of all living penguin species and is endemic to Antarctica .

The male and female are similar in plumage and size , reaching 48inches -LRB- 122cm -RRB- in height and weighing anywhere from 49 to 99lbs -LRB- 22 to 45 kg -RRB- .
...
In hunting , the species can remain submerged for up to 18 minutes , diving to a depth of 1,755 ft -LRB- 535m -RRB- .
...
It treks 31 -- 75 miles -LRB- 50 -- 120 km -RRB- over the ice to breeding colonies which may include thousands of individuals .
...
Researchers from the Alfred Wegener Institute , Helmholtz Centre for Polar and Marine Research -LRB- AWI -RRB- , in Bremerhaven , Germany , used a mathematical model to recreate the positions , movements and interactions of individual penguins in a huddle .
...
The stop-and-go motion of the penguins plays a vital role in keeping the huddle as dense as possible to protect the penguins from the cold , while the wave -LRB- illustrated in a computer model -RRB- also helps smaller huddles merge into larger ones
