...
Originally conceived in 1938 , the View-Master , a handheld device showing 3D slides , was originally aimed at adults , but became a popular toy in the 1960s -LRB- an old version of the toy is shown -RRB-

Children of the 1960s and onwards have marvelled at slides showing everything from 3D scenes of the world -LRB- two examples are shown -RRB- to cartoon characters though their View-Master toy . New version of the disk to be used in the new device will cost $ 15 -LRB- # 10 -RRB- for a themed pack of four
...
The device itself is set to be released in autumn for $ 30 -LRB- # 20 -RRB- , with reels sold in themed packs of four for $ 15 -LRB- # 10 -RRB- .
...
South Korean electronics firm LG has also worked with Google to make a plastic virtual reality device based on Cardboard .

It will be given away free with the firm 's G3 smartphones from this month , enabling owners to play on VR-compatible apps and games .

The smartphone slots into the plastic gadget 's viewer , which has two holes for users to peer through to see action on the phone 's screen .

South Korean electronics firm LG has also worked with Google to make a plastic virtual reality device called VR for G # -LRB- pictured -RRB- based on Cardboard

The design of ` VR for G3 ' deviceis based on the blueprint for Google Cardboard .

The neodymium ring magnet on the side of the VR for G3 works with the magnetic gyroscope sensor in the G3 to select applications and scroll through menus without touching the display .
...
The toy is a tool for Google to get a younger audience into virtual reality .

Mike Jazayeri , Product Director for Google Cardboard said that the toy will ` make immersive virtual reality experiences as accessible as possible for everyone . '

` Many of us on the Google Cardboard team grew up playing with View-Master , so we were excited to collaborate with Mattel and to see the viewer evolve and work with Google Cardboard , ' he added .

The device was teased in an invite last week , where many commentators correctly guessed that Google would base the toy on its Cardboard project .
...
Google seems to be intent of winning the hearts and minds of children , having announced last week that it has acquired Launchpad Toys , which is behind the iPad app Toontastic .
...
There was some speculation that Google may have re-focused its ` Cardboard ' project for children . Last summer , Google revealed a virtual reality headset made of cardboard -LRB- pictured -RRB- but it was n't commercialised
