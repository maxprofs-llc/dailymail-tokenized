...
Groundbreaking : Testing of the drug suramin on mice in America has found it can help to correct autism-like symptoms -LRB- stock image -RRB-
...
` This results in changes to metabolism and gene expression -LRB- activity -RRB- and reduces the communication between neighbouring cells . Simply put , when cells stop talking to each other , children stop talking . '
