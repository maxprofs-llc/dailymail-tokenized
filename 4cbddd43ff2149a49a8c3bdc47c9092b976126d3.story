...
Run-n-Read then syncs with an dedicated e-reader app on a tablet or phone and will bounce the text on the screen in time with a runner 's eye movements , making it appear as if the words are n't moving at all .
...
The company has raised around $ 8,000 -LRB- around # 5,000 -RRB- of its $ 30,000 -LRB- # 19,000 -RRB- goal and , if successful , plans to ship the device by January 2014 for around $ 40 -LRB- # 25 -RRB- .
