...
A satellite containing five geckos has been saved . The five lizards are flying in the Gecko-F4 experiment aboard the satellite -LRB- ground control experiment shown -RRB- . They are being observed to see how their bodies and sexual behaviour are affected by microgravity
...
The species being used is the Mauritius ornate day gecko -LRB- Phelsuma ornate -RRB- , according to Spaceflight 101 , which can reach up to 4.7 inches -LRB- 12 centimetres -RRB- in length .

Inside
their habitat is a ventilation system to supply fresh air , food for two
months , environmental control in the form of temperature and light and a
waste disposal system .

A video camera is being used to monitor their behaviour and any eggs that are produced .

These
are expected to hatch after 40 days , which means they will hatch while
the mission is still in space - an important goal that would assess the
effects of microgravity on birth .
...
The reason communication was lost with the 6.8-ton satellite is n't known , but Roscosmos thinks it may have been due to impact with space debris or a mechanical failure .

The satellite will be studied on its return to Earth in September to see what the cause was .

If it does turn out to be space debris , this will be cause for concern ; it is estimated there are 22,000 man-made objects four inches -LRB- 10 cm -RRB- or larger in Earth orbit .

And there are some fears Earth orbit may become polluted to such an extent that many spacecraft are at risk .

The biological experiment launched from the Baikonur Cosmodrome in Kazakhstan last week . Ground controllers had been unable to communicate with the Foton-M4 satellite -LRB- illustration shown -RRB- . The Foton series of satellites are designed to perform biological experiments in space

Following
the launch , the satellite had been failing to respond to commands to
start its engine and move to a higher orbit , according to the Progress
space firm .

However , the rest of its systems were operating nominally , which means the animals on board remained alive .

` The
equipment which is working in automatic mode , and in particular the
experiment with the geckos is working according to the programme , ' said
Oleg Voloshin after lanch , a spokesman of Russia 's Institute of
Medico-Biological Problems , which is running the experiment .
...
At the moment the spacecraft is still orbital height of about 155 miles -LRB- 250 kilometres -RRB- .

The original mission specification , however , called for the spacecraft to be raised to an altitude of 357 miles -LRB- 575 km -RRB- .
...
A spacecraft launched from Kazakhstan carrying animals has been saved
