...
Unified front : Mr Cameron also claimed at the summit yesterday that plans for withdrawal from Afghanistan by the end of December 2014 are ` on track and on target '
...
Even if the withdrawal goes to plan , British taxpayers will bankroll the Afghan security forces for years to come , starting with a handout of # 70million in 2015 . Yesterday 's summit saw countries pledge # 2.2 billion in total , with Britain set to fund an officer training centre dubbed Sandhurst in the Sand .

A British source claimed the cost to taxpayers would decline over time .

` Long-term World Bank projections suggest the Afghans wo n't be able to be self-funding until the mid-2020s , but we expect the amount required to fall as the Afghan state continues to develop , ' they said .
