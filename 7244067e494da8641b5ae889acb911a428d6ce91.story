...
This means that if search warrants are served on Google for the customer 's information , it wo n't legally be able to get hold of it .

Google began adding encryption tools to devices in 2011 and it was a standard feature of Android Jelly Bean . However , the tool was optional and many users either did n't know how to enable the feature , or were n't aware it existed .
...
Known as Android L - which may stand for Lollipop or even Layer Cake - the software is the successor to KitKat used on current phones like the Samsung Galaxy S5 -LRB- shown -RRB- . Google is rumoured to be gearing up to release Android L later this month
...
SamMobile add that the test version is still in its alpha stage , so it does n't run entirely smoothly , and there are a number of glitches to iron out before it 's released .
