...
The robotic arm has enough strength to easily lift and move a full drinks can -LRB- pictured -RRB- thanks to a small vacuum pump at the end of the suction cup on the arm

When operated together , the machines can perform more complex task , such as transferring liquid from one cup to another

The creators of the uArm tiny industrial desk robot -LRB- pictured -RRB- envisage it could be installed on every office desk to make life easier in the future
...
Chinese inventors created the miniature desktop robot that can pour drinks , fetch items and even play the xylophone -LRB- pictured -RRB-

uFactory 's Kickstarter page says : ` Robots are awesome , and would n't it be nice if everybody who wants a robot arm can actually afford one ? After all , $ 50,000 -LRB- # 30,160 -RRB- is kind of a lot of money . This is when we , the uFactory come in . '
...
The robot is designed to help with minor manual tasks such as moving business cards and unpacking a box -LRB- pictured -RRB-

Cheers ! When used as a pair , the robots can pour liquid between cups -LRB- pictured -RRB- . They are made from either wood or acrylic and can be programmed to perform bespoke tasks using open source software

uFactory originally asked for $ 5,000 -LRB- # 3,150 -RRB- of investment on crowd funding site Kickstarter , but has pulled in over $ 71,000 -LRB- # 42,825 -RRB- so far , showing that its labour-saving robots are in demand .
...
A kit containing an acrylic arm with a gripper and sucker costs $ 229 -LRB- # 138 -RRB- and comes assembled for $ 279 -LRB- # 168 -RRB- plus shipping .

Mechanical kits without the motors and electric modules start from $ 69 -LRB- # 42 -RRB- and a custom model costs $ 1,000 -LRB- # 603 -RRB- .

The design of the uArm was inspired by giant industrial robots that are used to build cars -LRB- pictured -RRB- and to move heavy packages

The robots are controlled by a mouse and can work together to perform more complex tasks . But as they cost $ 229 for an assembled kit , a factory-style production line does n't come too cheap
...
The robots are available on Kickstarter and cost $ 279 -LRB- # 168 -RRB- assembled