...
Scientists used laser beams to create a lattice that traps single atoms of super-cooled stontium -LRB- above -RRB-
...
In an optical lattice clock , millions of strontium atoms are held in a column of laser optical traps .
...
The lasers beams are used to create an egg-box lattice with each cup holding an atom of strontium -LRB- above -RRB-
...
The new clocks could help to measure gravity induced time dilation as predicted by Albert Einstein -LRB- above -RRB-
...
The most accurate atomic clocks currently used are called fountain clocks - so called the cesium atoms are tossed in the air and fall back down inside a vertical tube during a key routine repeated thousands of times an hour .
...
Two vertical laser beams produced by the six lasers are used to gently toss the atom balls upward through the flight chamber -LRB- the `` fountain '' action -RRB- , and then all of the lasers are turned off .
...
During the trip , some atomic states of the atoms are altered , while others remain the same , as they interact with a microwave signal from a maser . When the trip is finished , another laser is pointed at the atoms .

Some atoms -- those whose energy states were altered by the microwave signal -- emit light , or fluorescence .

The resulting photons , the tiny packets of light emitted , are measured by a detector .

This process is repeated while the microwave signal in the cavity is tuned to different frequencies .

Eventually , a microwave frequency is found that alters the states of most of the cesium atoms .

This frequency is the natural resonance frequency of the cesium atom -LRB- 9,192,631,770 Hz -RRB- , or the frequency used to define the second .



@highlight

Japanese researchers have created super-accurate optical lattice clocks
