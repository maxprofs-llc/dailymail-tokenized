...
Dr John McCauley , director of the World Health Organisation Collaborating Centre for Influenza at the Medical Research Council National Institute for Medical Research -LRB- NIMR -RRB- in London , said : ` This case reminds us to be aware of human infections from animal influenza viruses .

` Previously we did not think that H7N9 infections might be so lethal .

` More human infections by avian H10N8 viruses can not be ruled out . H10N8 viruses are of low pathogenicity in poultry and so infection in birds is not easy to detect . Whether humans are frequently exposed and infected is also not known . `
