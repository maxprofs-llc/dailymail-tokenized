...
Google has recently bought seven companies that specialise in robotics including California-based Meka , which makes humanoid robots , pictured . The firm is n't expected to make these technologies available to consumers but instead could use them to automate deliveries of goods
...
The company has n't confirmed , or denied , exactly what the robots will be used for but co-founder Larry Page wrote on Google + : ` I am excited about Andy Rubin 's next project .
...
` It is still very early days for this , but I ca n't wait to see the progress . '
