...
The software , called A3 , then prevents a hacker -LRB- illustrated with a stock picture -RRB- ever infecting a computer again . It works with a virtual computer that emulates the operations of a specific machine and is designed to watch over the virtual machine 's operating system and applications
...
` A3 technologies could find their way into consumer products someday , which would help consumer devices protect themselves against fast-spreading malware or internal corruption of software components . But we have n't tried those experiments yet , ' he said .
...
To demonstrate the power of the system , the researchers , together with Massachusetts-based defence contractor , Raytheon BBN , showed officials from the Defense Advanced Research Projects Agency -LRB- Darpa -RRB- how their software copes with a software bug called Shellshock .
...
A3 is intended to protect servers and business computers that run on the Linux operating system , as well as military machines -LRB- illustrated by the briefing room of General David Petraeus in Mosul , Iraq -RRB- . It could in the future be adapted for home laptops too
