...
The vulnerability has been dubbed the Heartbleed Bug because it was discovered ` in the OpenSSL 's implementation of the TLS/DTLS -LRB- transport layer security protocols -RRB- heartbeat extension -LRB- RFC6520 -RRB- , ' the team said .
