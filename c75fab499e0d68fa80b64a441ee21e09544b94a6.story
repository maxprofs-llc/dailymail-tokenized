...
The School of Information Systems , Computing and Mathematics -LRB- SISCM -RRB- has provided 200 robots for first year students to take home , look after and experiment with throughout the year .
...
Apart from moving in different directions , the robots -LRB- known as finches -RRB- have a beak that can change colour , an accelerometer so the orientation is known , IR sensors to detect obstacles , a light sensor , a thermocouple to determine temperature and a buzzer .
...
The robots -LRB- known as finches -RRB- were developed by Carnegie Mellon University .
