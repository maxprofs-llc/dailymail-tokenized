...
A powerful new model to detect life on planets outside of our solar system -LRB- artist 's impression pictured -RRB- has been developed by researchers
...
They estimate that they can now detect methane at temperatures of up to 1,500 K/1220 °C - something which was not possible before .
...
Methane -LRB- molecules pictured -RRB- is an organic molecule present in gaseous form in the Earth 's atmosphere . It widely acknowledged as being a sign of potential life , as on Earth it is produced as a byproduct of many living organisms

Methane -LRB- CH4 -RRB- is an organic molecule present in gaseous form in the Earth 's atmosphere .
...
However , the presence of methane itself does n't necessarily indicate alien life .
...
` We limited the temperature threshold to 1,500 K to fit the capacity available , so more research could be done to expand the model to higher temperatures still .

` Our calculations required about 3 million CPU -LRB- central processing unit -RRB- hours alone ; processing power only accessible to us through the DiRAC project .
...
New model can detect methane at temperatures of up to 1,500 K/1220 °C
