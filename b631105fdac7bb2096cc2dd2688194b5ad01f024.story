...
Halifax -LRB- branch pictured -RRB- recently completed a successful trial of ` cardiac authentication ' for its online accounts using the Nymi band . Nymi reads the wearer 's heart rhythms , which is said to be as unique as a person 's fingerprint , to authenticate who they are
...
Nymi only works with a registered person 's cardiac rhythm , meaning if the bracelet is stolen it ca n't be hacked . The technology was developed by Toronto-based Bionym .
...
The Nymi functions on a three-factor security system - the bracelet , a unique heartbeat and an Authorized Authentication Device -LRB- AAD -RRB- , which is a device registered with the app .
...
The Nymi functions on a three-factor security system - the bracelet , a unique heartbeat and an Authorized Authentication Device -LRB- AAD -RRB- , which is a smartphone or device registered with the app .
...
In the first-of-its-kind trials by a UK bank , Halifax asked staff and customers to use the wristband to login to their online accounts . When connected to an account , the band could , in theory , be used to pay for goods using contactless readers too -LRB- example shown -RRB-

An ECG differs from person to person and depends on the location and size of the their heart . Nymi only works with a registered person 's cardiac rhythm , meaning if the bracelet is stolen it ca n't be hacked . The technology -LRB- pictured -RRB- was developed by Toronto-based Bionym

The bank said the band -LRB- illustrated -RRB- only works when worn by the account owner and it must be paired with the device being used
...
The Nymi bracelet can be pre-ordered for $ 79 -LRB- # 50 -RRB- . Devices were due to ship in December but the site has not updated when it will go on general sale .
...
This is called a cardiac rhythm and is tracked on electrocardiogram -LRB- ECG -RRB-
...
And because it only works with a registered person 's cardiac rhythm it ca n't be hacked if the bracelet is stolen
