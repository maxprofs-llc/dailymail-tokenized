Cockroaches are known to be able to survive a nuclear explosion -- and once day they could be saving trapped victims in a variety of disasters .
...
Rise of the robo-roach : Scientists have developed technology that allows cyborg cockroaches , or biobots -LRB- pictured -RRB- to pick up sounds with small microphones and seek out the source of the sound . They could one day be used in emergency situations to detect survivors
...
Professor Bozkurt 's team has recently demonstrated technology that creates an invisible fence for keeping biobots in a defined area .

This is significant because it could be used to keep them at a disaster site and to keep the biobots within range of each other so that they can be used as a reliable mobile wireless network .

The technology could also be used to steer biobots to light sources , so that tiny solar panels on biobot backpacks can be recharged .
...
The idea of turning cockroaches into cyborg slaves is not new , Gizmodo reported .

Kits are available for under $ 100 -LRB- # 63 -RRB- that enable people to control their own insect by stimulating its antennae with electrical signals .

This lets people ` drive ' an insect for a few minutes .

While the creators of the ` Roboroach kit ' claim the cockroach forgets the experience after 20 minutes , some people think it is cruel .
