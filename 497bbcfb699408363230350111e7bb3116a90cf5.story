...
The chin strap , -LRB- setup pictured -RRB- is made from a smart piezoelectric material known as PFC , which consists of integrated electrodes and adhesive polymer . It produces an electric charge when it stretches , and is subjected to mechanical stress
...
In their study , researchers from Sonomax-ÉTS Industrial Research Chair in In-ear Technologies -LRB- CRITIAS -RRB- in Montreal , Canada , created an energy harvesting strap made from a single layer of PFC and attached it to a pair of ear muffs using a pair of elastic side straps .
...
To ensure maximum performance , the chin strap was fitted snugly to the user , so when the user 's jaw moved it caused the strap to stretch . The maximum amount of power harvested from the chin strap -LRB- pictured -RRB- was 18 microwatts , but researchers are working on increasing this output significantly
...
` The only expensive part of the energy harvesting device is the single PFC layer , which costs around $ 20 -LRB- # 12 -RRB- .
