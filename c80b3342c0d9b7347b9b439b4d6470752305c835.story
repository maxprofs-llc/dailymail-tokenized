...
Researchers found that the ` neuropeptide Y system ' -LRB- NPY -RRB- , may play a central role in determining how fat we become .
...
In humans the neurotransmitter communicates with four well-known ` cell surface receptors ' in the brain -LRB- Y1 , Y2 , Y4 and Y5 -RRB- which trigger the system 's effects .
