...
Paul Clement -LRB- left -RRB- celebrates winning the Champions League with Real Madrid manager Carlo Ancelotti

Assistant manager Clement chats with Real Madrid star Gareth Bale -LRB- left -RRB- before a La Liga match
...
` That does n't mean I have n't got my eye on what I want to do next , which is to try to be a head coach somewhere . '
...
` When we played at Anfield we went into the boot room after the game , so when they played here and then trained here the following morning we all sat down together in my office - Carlo -LSB- Ancelotti -RSB- , Brendan and former sporting director Frank Arnesen , ' he says .
...
` That does n't mean I have n't got my eye on what I want to do next , which is to try to be a head coach somewhere , ' adds Clement