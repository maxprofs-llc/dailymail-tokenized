...
` We wo n't get to choose the circumstances of the next Labour government , ' he will say . ` If we win the election , we will come to power in tougher economic circumstances than we have seen in generations , and that will have to shape the way that we govern .

` Our starting point for 2015/16 will be that we can not reverse any cut in day-to-day , current spending unless it is fully funded from cuts elsewhere or extra revenue -- not from more borrowing .

` So when George Osborne stands up next week and announces his cuts in day-to-day spending , we wo n't be able to promise to reverse them because we can only do so when we can be absolutely crystal clear about where the money is coming from .

` It 's a hard reality . But I am clear
about it , -LSB- Shadow Chancellor -RSB- Ed Balls is clear about it , and everyone
