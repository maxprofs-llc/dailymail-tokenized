...
Currently the technology is restricted by the length of time it takes to sequence DNA and its high cost - around # 8,000 per megabyte of stored material .
...
` The DNA we 've created can not be incorporated accurately into the genome -LRB- genetic code -RRB- , ' said Dr Goldman . ` It uses a completely different code . '
