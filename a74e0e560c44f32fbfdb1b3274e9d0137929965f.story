...
Dr Markus Kuhn from the University of Cambridge said the SIM -LRB- stock image -RRB- could have been replaced long ago . He believes alternatives include typing in a user identifier and password directly into a phone
...
` At the time mobile phones were bulky devices , usually mounted in cars -LSB- and -RSB- a SIM would help customers quickly and easily transfer their phone number and contacts from one phone to the next , without the need to type in long identifiers and access codes each time .

Alternatively , QR codes -LRB- example pictured -RRB- are a convenient way to store and access data using a smartphone camera
...
A Global System for Mobile -LRB- GSM -RRB- network was established in the late 1980s to create a communication standard throughout Europe . Communications .

In 1991 , German smart-card maker Giesecke & Devrient sold the first 300 SIM cards to Finnish operator Radiolinja .

In 2014 5.2 billion SIMs -LRB- different sizes shown -RRB- were sold making them lucrative for manufacturers
...
Dr Kuhn said SIM cards were a useful feature when mobile phones were mounted in cars -LRB- pictured -RRB- and customers wanted to transfer contacts from one phone to the next . But as phones have become more mobile , he believes the technology is outdated and should be replaced with a modern alternative

Password-authenticated key exchange -LRB- PAKE -RRB- techniques exist that use passwords as a five-digit PIN to create highly secure encrypted connections that even the supercomputers of eavesdropping intelligence agencies ca n't break .
