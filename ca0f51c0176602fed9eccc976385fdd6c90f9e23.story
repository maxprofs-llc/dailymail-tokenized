...
The Prime Minister said that he would stop the use of methods of communication which can not be read by security services , such as WhatsApp , which encrypts its data
...
The Prime Minister also added that he would stop the use of methods of communication , which can not be read by the security services such as WhatsApp and Snapchat , due to data being encrypted .
...
He explained : ` Are we going to allow a means of communications which it simply is n't possible to read ?
...
Data used by both messaging apps are encrypted and can not be read by security services
