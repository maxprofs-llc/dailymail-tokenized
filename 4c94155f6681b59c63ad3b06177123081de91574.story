...
Messenger -LRB- MErcury Surface , Space ENvironment , GEochemistry , and Ranging -RRB- is the first spacecraft
...
call for the acquisition of more than 80,000 additional image .
...
` The thing that 's really amazing on
Mercury is , this did n't happen yesterday , ' said Timothy Grove , a
professor of geology at MIT .

` The crust is probably more than 4 billion years old , so this magma ocean is a really ancient feature . '

The team translated the chemical
element ratios from the surface into the corresponding building blocks
that make up rocks , such as magnesium oxide , silicon dioxide and
aluminum oxide .

The researchers then consulted what Grove refers to as a
` pantry of oxides ' -- finely powdered chemicals -- to recreate the rocks
in the lab .

` We just mix these together in the
right proportions and we 've got a synthetic copy of what 's on the
surface of Mercury , ' Grove says .

The researchers then melted the
samples of synthetic rock in a furnace , cranking the heat up and down to
simulate geological processes that would cause crystals -- and
eventually rocks -- to form in the melt .

Lava flows from Kilauea volcano : Experts say magma may have once covered the surface of Mercury , explaining the strange chemical composition of rocks on the surface
...
After cooling the samples , the researchers picked out tiny crystals and melt pockets for analysis . Grove found the two compositions were
too different to have originated from the same region , and instead may
have come from two separate regions within the planet .

The easiest explanation for what
created these distinct regions , Grove says , is a large magma ocean ,
which over time likely formed different compositions of crystals as it
solidified .

This molten ocean eventually remelted , spewing lava onto the surface of the planet in massive volcanic eruptions .

The images reveal giant craters on the surface of Mercury seen in unprecedented detail . This basin 's outer rim is about 306 km in diameter and the inner -LRB- peak -RRB- ring is about 140 km in diameter
...
That process of colliding and accreting may produce enough energy to completely melt the planet -- a scenario that would make an early magma ocean very feasible . ` The acquisition of data by spacecraft must be combined with laboratory experiments , ' Charlier says .
