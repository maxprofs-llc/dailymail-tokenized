Between three and four billion years ago , changes in an asteroid belt between Mars and Jupiter hurled a devastating barrage of space rocks at our planet .
...
` What we have done is provide the
foundation for understanding how to interpret the layers in terms of the
size and velocity of the asteroid that made them , ' said Jay Melosh ,
professor of earth and atmospheric sciences , physics and aerospace
engineering at Purdue University .

` This is the first real solid evidence that this asteroid bombardment
actually happened , ' Melosh said . ` Some of the asteroids that we infer
were about 25 miles in diameter , much larger than the one that
...
` But when we looked at the number of impactors as a function
of size , we got a curve that showed a lot more small objects than large
ones , a pattern that matches exactly the distribution of sizes in the
asteroid belt . For the first time we have a direct connection between
the crater size distribution on the ancient Earth and the sizes of
asteroids out in space . '
