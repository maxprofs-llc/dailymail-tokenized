...
malicious activity on our systems , in particular attempts by third
parties to log into users ' accounts , ' said Google in a blog post this week .

` When we have specific
intelligence -- either directly from users or from our own monitoring
efforts -- we show clear warning signs . Today , we 're taking that a step further for
a subset of our users , who we believe may be the target of
...
` You might ask how we know this activity is state-sponsored . We ca n't go into the details without giving away information that would be helpful to these bad actors , but our detailed analysis -- as well as victim reports -- strongly suggest the involvement of states or groups that are state-sponsored . '
...
Google wo n't reveal exactly HOW it knows users may be under threat
