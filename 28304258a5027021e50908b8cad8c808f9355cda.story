...
` The weird part is , Old Navy DOES have a Big and Tall selection in their men 's clothing , but you do n't really see it until you click on the item you want to buy , ' user lilfunky1 pointed out .

` But the women 's stuff is separated out as a whole new category of Women 's Plus . '

According to one beady-eyed user , the reason for the bizarre menu layout is that the Canadian version of the website does n't appear to offer a maternity section for women - the category which sits alongside Women 's Plus on the main US site .

' -LSB- The Canandian site -RSB- do n't have a Maternity category for some reason , ' arnaudh explained .
...
` If you go to the US version , it does n't display that way because of the additional category .

starmartyr added : ` Why would n't they have a Maternity section in Canada ? Does Old Navy believe that Canadians are hatched from eggs ? '
...
And while the store insisted that ` unique fabrics and design elements ' were to blame for its female customers being charged more money for larger sizes - while the menswear designs remain the same price regardless of size - Ms Posey insisted that the explanation was n't good enough .
...
Fed up : Renee Posey -LRB- pictured -RRB- started a campaign in November to try and force Old Navy to scrap its ` discriminatory ' prices
