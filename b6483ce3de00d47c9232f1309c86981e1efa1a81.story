...
Flash of light : The debris narrowly missed a direct and devastating hit on Chelyabinks , which has a population of 1.13 million , but nevertheless spread panic through its streets as the sky above lit up with a blinding flash
...
` The Dnepr radar in Mishelevka might have detected the meteorite if it looked up , but it did n't - as an early-warning radar its mission is to search the narrow strip of space just above the horizon , which a ballistic missile would cross if it ever comes .

` They do n't -LRB- and should n't -RRB- much care about anything else . These radars are not supposed to search the entire sky on a continuous basis - it would be a waste of energy and would decrease the effective detection range .

` An early-warning radar could see objects at higher elevations -LRB- up to 34.5 degrees in the case of Dnepr -RRB- and does so if it is asked to track a satellite .
...
` It still leaves an interesting question , ' the researcher writes . ` What happens if you see a 500-kt explosion on -LRB- or above -RRB- your soil and have no idea what it is and where it came from ?
