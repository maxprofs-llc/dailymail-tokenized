...
Experts say there is a ` slight risk ' those treated by the dentist may have been exposed to the virus -LRB- pictured -RRB-
...
` Whilst we therefore think the risk is extremely low we can not guarantee that there is no risk , so we have set up a freephone help-line where patients can ask questions and then decide if they want to have an HIV test .
