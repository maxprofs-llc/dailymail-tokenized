...
Samsung has unveiled its first phone to run the Tizen operating system , called the Samsung Z -LRB- pictured -RRB- . It will launch in Russia from July this year , and boasts , among other features , a fingerprint and heart rate sensor . Tizen is seen as a direct competitor to Google 's Android platform
...
4.8 '' HD Super AMOLED -LRB- 1280 x 720 -RRB-

Processor

2.3 GHz Quad core application processor
...
5.4 x 2.7 x 0.3 inches -LRB- 138.2 x 69.8 x 8.5 millimetres -RRB-

Weight

136 grams -LRB- 0.3 pounds -RRB-
...
8 megapixel -LRB- rear -RRB- , 2.1 megapixel -LRB- front -RRB-
...
Samsung already uses the Tizen operating system on its Gear 2 smartwatch -LRB- pictured -RRB- . The release of a phone running Tizen is seen as an attempt to unify the operating system between its various devices . Tizen also runs using HTML5 , the popular web language of choice over Java and Flash

The vast majority of Samsung 's current smartphones , including the Samsung Galaxy S3 -LRB- pictured -RRB- , run Google 's Android Platform . Tizen will be Samsung 's first attempt at irunning a unique operating since Bada , which launched in 2009 but flopped after receiving a lukewarm response from developer
