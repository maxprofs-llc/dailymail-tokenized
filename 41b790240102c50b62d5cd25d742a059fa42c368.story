...
Whether Ray 's proposal will become law in the conservative Western state is unclear : Utah Governor Gary Herbert , a Republican , wo n't say if he 'll sign the measure . His spokesman , Marty Carpenter , did issue a statement this week acknowledging that the method would give Utah a legitimate backup method if execution drugs are unavailable .
...
Ray said he did n't expect much debate on the proposal because it seemed many lawmakers had made up their mind about the idea from the start .
...
In Wyoming , a measure to allow firing squads if the lethal drugs are n't available died . In Oklahoma , lawmakers are considering legislation that would allow the state to use nitrogen gas to execute inmates .
...
Utah 's proposal keeps lethal injection as the primary method of execution , but it allows for the state to use firing squads if the state can not obtain lethal injection drugs .
...
Gunshots : Utah State Prison -LRB- right -RRB- after Ronnie Lee Gardner -LRB- left -RRB- was executed by firing squad on Friday , June 18 , 2010 in Draper Utah
