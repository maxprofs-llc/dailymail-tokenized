Bristol-based designers have created a concept 3D printer that combines facial recognition with a hot plate and layers of batter -LRB- concept illustrated -RRB-
...
It uses Computer Numerical Control -LRB- CNC -RRB- technology to convert online designs into numbers , similar to coordinates on a graph .
...
` Too little time and the darker tones would n't be achieved , too long and the pancake would burn . '

The concept uses Computer Numerical Control -LRB- CNC -RRB- technology to convert online designs into numbers , similar to coordinates on a graph . Dubbed ` interactive eating experience ' , the machine is currently a tongue-in-cheek concept but the firm told MailOnline the technology -LRB- mock-up example illustrated -RRB- is possible
...
Miguel Valenzuela , from Oslo , Norway , recently built a 3D pancake printer using Lego called PancakeBot . Videos posted to YouTube show the machine ` printing ' words and designs such as hearts and galloping horses onto a griddle below -LRB- grab pictured -RRB-
