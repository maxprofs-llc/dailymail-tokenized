...
The images are said to be so detailed , each shot uses around 2.5 GB of computer space - 1,300 times more than the average iPhone photo .

Keeping track of polar bear populations -LRB- stock image pictured -RRB- in icy and treacherous conditions could be easier from space , according to research . Scientists have used satellite pictures to monitor the creatures off the coast of Canada
...
Conservationists
from the British Antarctic Survey -LRB- BAS -RRB- have developed a way of using
...
An earlier survey suggested there were around 100 bears off the coast of Rowley Island , Canada -LRB- pictured -RRB- , and the satellite estimate confirmed this . Wildlife experts now claim using satellites could be useful in keeping track of the Arctic polar bear populations , as the speed at which Arctic ice is melting has increased
...
This image reveals where the polar bears were spotted during the aerial survey -LRB- in blue -RRB- . The yellow dots are the polar bears discovered using DigitalGlobe 's satellite images

These images were taken during late summer in 2012 . Polar bears are present in the circles in the target image -LRB- top -RRB- but absent in the reference image -LRB- bottom -RRB- . Features that remain consistent between images , including rocks and substrate , are shown with red arrows
