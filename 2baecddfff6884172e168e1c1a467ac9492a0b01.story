...
It tracks blood pressure , electrocardiography -LRB- ECG -RRB- , heart rate , blood oxygen , temperature and lung functions with what the company calls a ` high level of accuracy ' - and the measurements can be shared .

The Wello case , pictured , is fitted with monitoring sensors that measure a number of key health vitals . It tracks blood pressure , electrocardiography -LRB- ECG -RRB- , heart rate , blood oxygen , temperature and lung functions with what the company calls a ` high level of accuracy ' - and the measurements can be shared
...
A Tricorder is a scanning device used by Starfleet personnel in the Star Trek universe . There are two variations ; a regular -LRB- engineering -RRB- tricorder , pictured here being used by Spock , played by Leonard Nimoy , and a medical tricorder
