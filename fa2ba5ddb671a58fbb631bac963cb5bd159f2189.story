...
Scientists have shown that using deep brain stimulation -LRB- DBS -RRB- , a technique already used to treat Parkinson 's disease , can boost memory by causing new brain cells to be formed .

A ` pacemaker ' fitted with electrodes is inserted into the brain through holes drilled in the skull .

Deep brain stimulation is already used to treat Parkinson 's , but now researchers now believe it could be used to improve brain function and ward off diseases such as dementia -LRB- file image -RRB-
...
Tests on lab mice showed improved memory within just 24 hours , while the rodents ' life-spans were unaffected -LRB- file image -RRB-
