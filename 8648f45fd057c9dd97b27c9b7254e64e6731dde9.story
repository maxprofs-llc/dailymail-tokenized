Hackers have used photos to recreate the fingerprint -LRB- stock image -RRB- of a German politician
...
One expert has recreated the fingerprints of Germany 's Minister of Defence , Ursula von der Leyen -LRB- stock image -RRB- , using photos taken at a press conference . From these images , he reconstructed an accurate thumbprint using the VeriFinger software.This software is good enough to fool fingerprint security systems

A security researcher known as Starbug , used the publicly available software , plus a variety of photos of a finger taken from different angles to replicate the fingerprint . Starbug previously hacked Apple 's iPhone 5S fingerprint sensor -LRB- pictured -RRB- just two days after the phone launched in 2013
...
In September 2013 , hackers from CCC used a photograph of a fingerprint on a glass surface , scanned it and then used a laser printer to print it onto a transparent sheet to make a new print using wood glue . This technique relied on a print obtained from a glass surface -LRB- pictured -RRB- whereas the new one only needs photos
...
Relying on your fingerprints to secure a device may be okay for casual security -- but you should n't depend upon it if you have sensitive data you wish to protect . '
