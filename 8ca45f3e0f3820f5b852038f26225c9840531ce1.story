...
Microsoft has been granted a patent for ` inconspicuous mode , ' which would automatically adjust the brightness and volume of a handset to show a a dimmer and simplified screen -LRB- right -RRB-
...
The patent was granted last week , having been submitted in 2013 and shows the feature is intended to be used when a smartphone user is going to sleep as well as in cinemas , where noisy phones with bright screens can be very distracting for people trying to concentrate on a film -LRB- illustrated with a stock image -RRB-
...
While Windows Phones currently do n't have such a sophisticated app , they support a feature called ` quiet hours ' .
...
There already similar apps available , including one for Android handsets . The ` do not disturb ' app lets people block in ` quiet time ' when they do want want any noisy distractions using a calendar -LRB- left -RRB- , and choose excatly which notifications they want to receive -LRB- right -RRB-
