...
Home security : Built-in sensors detect human shapes and the camera will start recording automatically if a person is spotted . A message will then be sent via mobile -LRB- screenshot pictured -RRB- to alert a homeowner
...
-LRB- IP-66 -RRB- : Nubo is IP-66 rated weather resistant and can be used indoors and outdoors
...
Secret eye : The clips are uploaded to a free cloud service , and footage is taken at 720p with 10 frames per second to limit how much data the camera uses -LRB- camera pictured -RRB-

Elsewhere , the camera has an infrared detectors and works in low lighting .

During its press conference , Panasonic also announced it is launching its own mobile network using Vodafone 's infrastructure - making it a mobile virtual network operator -LRB- MVNO -RRB- - and service plans for the Nubo on this network will start at # 5 -LRB- $ 7 -RRB- a month .
...
Additional plans will be available up to in a # 33 -LRB- $ 50 -RRB- a month for 2,500 alarms and 90 days of cloud storage .
...
$ 250 -LRB- # 160 -RRB- device ships in November and plans start at $ 7 -LRB- # 5 -RRB- a month