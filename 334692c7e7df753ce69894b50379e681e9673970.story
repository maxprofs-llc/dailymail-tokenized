...
Laboratory and mouse experiments showed that the MC1R-RHC gene variant both lowered a cell 's guard against harmful ultraviolet -LRB- UV -RRB- rays , and stimulated cancer-causing biological signals . RHC stands for ` red hair colour ' .
...
Previous research had shown that the melanocortin-1 receptor -LRB- MC1R -RRB- gene plays a key role in protecting melanocytes from UV-induced DNA damage .
