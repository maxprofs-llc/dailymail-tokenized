...
The combination of an imaging infrared -LRB- IIR -RRB- seeker and an onboard target database ensures that the missile can seek out and detect targets up to 100 nautical miles away with pinpoint precision .
...
Kongsberg is also developing a Joint Strike Missle -LRB- JSM -RRB- for the Lockheed Martin F-35 Fighter Jets used by the US and Britain 's RAF .
