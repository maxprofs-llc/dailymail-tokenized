...
called ` always on ' , which means it does n't timeout , it is a simpler and
more energy-efficient way to watch videos , for example .

The clever case , which is available to pre-order via the company 's website costs $ 129 -LRB- # 81 -RRB- , or $ 149 -LRB- # 94 -RRB- when shipped to the UK .
...
It uses Plastic Logic 's OTFT -LRB- organic thin film transistor -RRB- backplane display technology and the screen is called electrophoretic because it moves fluid around an electric field .
...
The iPhone 5 and 5S cases start at $ 129 -LRB- # 81 -RRB- and go on sale next month
