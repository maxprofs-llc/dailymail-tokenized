...
Users have some simple tools , including zooming in and out , dragging , and even rotating the image -LRB- click on Shift and the left mouse button -RRB- .
...
The Complutense University of Madrid -LRB- UCM -RRB- is leading a project called Cities at Night to catalog the images .
...
` Algorithms can not distinguish between stars , cities , and other objects , such as the moon . Humans are much more efficient for complex image analysis . '
...
The images include major cities such as this one - which Nasa admits it can not identify itself .

Volunteers use a special online app to pinpoint exactly where the image is from

` We do n't know which direction the astronaut pointed the camera , only where the station was at the time the image was taken , ' explains Sanchez .
...
` We do n't know which direction the astronaut pointed the camera , only where the station was at the time the image was taken , ' Sanchez said .
