...
Errata security researcher Robert Graham tweeted -LRB- pictured -RRB- an example of how the bug can be exploited , and how code can be added , to websites on Macs running OSX . He warned that Bash is ` probably a bigger deal than Heartbleed ' because it could threaten the security of millions of websites
...
According to experts , there have n't been any reports of real-word attacks , but that does n't mean they wo n't ever be affected , nor does it mean they have n't happened in the past , without being detected .
...
The responsibility to fix the flaw lies with the website owners , meaning everyday users ca n't do anything to protect themselves .
...
` The number of systems needing to be patched , but which wo n't be , is much larger than Heartbleed . '
...
Unlike Heartbleed , which forced users to change their passwords , Bash does n't have an easy fix . It will largely be up to system administrators and software companies to issue patches .
