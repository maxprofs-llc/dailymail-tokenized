...
It then manipulates these solutions , while trying something slightly different each time , until it finds one that it ca n't improve on .
...
Olsen is the man behind the ` Where 's Waldo ' -LRB- ` Where 's Wally ' in the UK -RRB- algorithm where he looked at numerous pages of the famous children 's illustrative challenges , and developed a mapping theory on how best to locate all the bespectacled characters .
