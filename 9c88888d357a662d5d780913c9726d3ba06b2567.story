...
The leaky official said : ` The amount of the current contract -LSB- between Apple and Samsung -RSB- is around $ 9.7 billion .
...
Samsung 's faster solid state drive -LRB- SSD -RRB- storage . '
...
will find the size -LRB- almost -RRB- pocket-friendly , and Google are likely to
...
bought around # 4.9 billion worth of parts from Samsung in 2011 including
...
New model ` will have 7.85 ins screen '
...
Apple and Samsung are fierce rivals -LRB- even though Apple spends # 7bn a year on Samsung parts -RRB-