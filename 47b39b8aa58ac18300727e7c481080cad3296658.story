...
Astronomers that the frequencies iRobot wants to use are the same as they use to detect methanol -- a key sign of star formation . There is already a ban on the use of mobile phone close to the Green Bank Telescope -LRB- pictured -RRB- in West Virginia , which the National Radio Astronomy Observatory owns
...
But this does n't go far enough , say astronomers .

They want the company to implement ` exclusion zones based on geolocation ' to keep lawnmowers at least 55 miles -LRB- 89km -RRB- from telescopes .
