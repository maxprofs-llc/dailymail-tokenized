...
If correct , Deloitte 's prediction would mean instant messaging has almost doubled in popularity in just a year , up from 160 billion last year , and 25 billion in 2010 -LRB- plotted on this graph -RRB- . The findings come from the Deloitte Global Mobile Consumer Survey 2014
...
Text messages are still the most popular form of communication -LRB- as seen in this graph -RRB- but instant messaging leads on the number of messages sent overall . Deloitte is also predicting that 2014 will be the first year texting will decline since it was invented in 1992

` Around 10 years ago , teenagers would visit internet cafes and send hundreds and thousands of IMs to each other .

` That behaviour has n't changed , it 's just moved onto smartphones . In the same way emails are now accessible on phones .

` Also , IMs do n't have a marginal cost , so people can be quite wasteful with the amount of IMs they send .
