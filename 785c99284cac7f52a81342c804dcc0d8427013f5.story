...
His whole system cost $ 1,000 -LRB- # 600 -RRB- - but prices could be cheaper if different antennas and transmitters were used .
...
In February , hackers demonstrated a homemade devices called the CAN Hacking Tool -LRB- CHT -RRB- .
...
A 60p -LRB- $ 1 -RRB- computer chip is used to bypass any encryption on the car before reading and writing data from the flash memory of the vehicle 's engine control unit .
...
Dr Cesare 's transmitter , antenna and amplifier system cost $ 1,000 -LRB- # 600 -RRB-