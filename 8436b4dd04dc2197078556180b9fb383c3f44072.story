...
Google 's modular smartphone could be available in January 2015 for as little as $ 50 -LRB- # 30 -RRB- .

According to an earlier developer kit , Ara
phones will be able run on multiple batteries - when one battery dies ,
it can be detached and replaced with a full battery module .
...
In
theory , any sensor that can be fitted to a module will be able to
attach to a module and while Google will make the shell , these modules
will be made by other companies .
...
It will consist of a simple frame , screen , Wi-Fi connection and processor
