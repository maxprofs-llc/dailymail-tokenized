Today our methods of pinpointing locations on Earth are reliant on space-based satellite navigation systems such as the Global Positioning System -LRB- GPS -RRB- .
...
Modern satellite navigation systems like Europe 's Galileo -LRB- artist 's illustration shown -RRB- rely on space-based technologies , but a breakthrough by the UK 's Defence Science and Technology Laboratory could lead to Earth based ` quantum compass ' navigation systems
...
This means that when a submarine eventually resurfaces , efforts to locate it can be out by more than half a mile -LRB- one kilometre -RRB- .

A quantum compass would , apparently , reduce that inaccuracy down to just three feet -LRB- one metre -RRB- .

That 's according to the scientists behind the project at the UK Defence Science and Technology Laboratory -LRB- DSTL -RRB- in Porton Down , UK .
...
` There is nothing in physics that could be used - given the knowledge we have now - to disrupt one of these -LSB- new -RSB- devices , '' Bob Cockshott at the National Physics Laboratory , who are also involved in the research , said in the Financial Times .
...
Currently GPS does not work underwater , so when submarines dive and eventually resurface their location can have an error of about 0.62 miles -LRB- one kilometre -RRB- . A quantum compass could improve this accuracy by a factor of 1,000 , according to the scientists
...
` Quantum TNS -LSB- Time , Navigation and Sensing -RSB- technologies could bring game-changing advantages to the UK defence sector and support markets measured in billions of pounds , here in the UK and around the world .
