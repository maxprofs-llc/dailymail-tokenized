...
But weather patterns are n't the only culprit - the airline has been using the smaller jet to fly to and from Europe in an attempt to cut costs .
...
While there 's little to be done about unpredictable weather patterns , travellers can use several tricks to better their chances a flight wo n't make an unannounced pit stop .

The best way is by checking the plane model . Airlines often show seat maps during ticket purchasing . This often reveals if the aircraft used will be a 757 -LRB- with one aisle -RRB- or a larger carrier with two aisles .
