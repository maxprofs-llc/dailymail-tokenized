In App permissions on Android , pictured , Facebook asks to ` Read your text messages -LRB- SMS or MMS -RRB- '

Buried within the latest update for Facebook 's Android app is a feature that is causing growing concern among some users .

In the App permissions menu , the site asks for access to ` Read your text messages -LRB- SMS and MMS -RRB- ' , and to ` Add or modify calendar events and send email to guests without owners ' knowledge . '
...
` Keep in mind that this list does n't include all of the Android permissions we request or all of our uses of those permissions . '

For example , confirmation codes are sent via SMS , yet the permissions also grants access to multimedia messages and the reason for this is n't explicitly given .

One member complained directly to Facebook support : ` It 's already too much that the app was already apparently collecting people 's phone numbers without their permission . I 'm sorry , but no , Facebook , you do n't get to read my texts . '

Facebook 's help pages , pictured , state permission is needed for when users add a phone number to an account . This lets the site confirm the number on an account automatically by scanning text messages for the confirmation code . These codes are sent via SMS , so this does n't explain the need for access to MMS '
...
Facebook Android engineer Franci Penov responded to this thread and said : ` We require -LSB- access to text messages -RSB- so we can automatically intercept login approval SMS messages for people that have turned two-factor authentication on for their accounts , or for phone confirmation messages when you add a phone number to your Facebook account .
...
This includes written messages -LRB- SMS -RRB- as well as picture messages -LRB- MMS -RRB-
