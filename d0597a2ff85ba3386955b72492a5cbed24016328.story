...
chips - both dynamic random access memory -LRB- DRAM -RRB- chips and NAND memory
...
on the list of initial memory chip suppliers -LRB- for new iPhones -RRB- .
...
The chips are on the table : A Chinese production line for mobile phone components -LRB- stock image -RRB-
