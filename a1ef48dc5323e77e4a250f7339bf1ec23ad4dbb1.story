...
A New Zealand scientist has suggested the search for missing MH370 should be extended to Besh-Tash Valley in Kyrgyzstan -LRB- pictured -RRB-
...
` For example , someone should go and take a look at the suggested crash site in the Besh-Tash Valley -LRB- Kyrgyzstan -RRB- which was indicated by a smoke plume just when the aircraft would have been expected to have crashed , ' he said .
...
given vital information about the composition of the BFOs -LRB- Burst
Frequency Offsets -RRB- and the modelling that Inmarsat performed .
