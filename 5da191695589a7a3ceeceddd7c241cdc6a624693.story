...
` If we wish to accurately simulate recent climate change in models , we can not neglect the ability of these smaller eruptions to reflect sunlight away from Earth . '
...
` These are then used to estimate natural forcings over the 20th century , which are then used in greenhouse gas signal detection -LRB- attribution -RRB- studies .

` If the historical reconstructions were n't capturing the full magnitude of volcanic effects on the climate , as this study suggests , that presumably means those attribution studies need re-examination as well . '
