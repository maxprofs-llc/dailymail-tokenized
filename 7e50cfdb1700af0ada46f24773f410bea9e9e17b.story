...
Home brewers then add the grain to the main compartment of the machine -LRB- called the step filter -RRB- and pour hops into the appropriate hops cages that slot into the step filter , according to the recipe , before selecting the recipe to brew using the front panel screen on the machine .
...
PicoBrew Zymatic costs $ 1,600 -LRB- # 992 -RRB- and claims to brew ` high quality all-grain beer ' in a week from three ingredients
