...
Hands on : A new app that works alongside a small USB device called the Leap Motion Controller -LRB- pictured -RRB- lets people create music using hand gestures while they sit in front of their computer
...
Infinite possibilities : The Muse app , which costs $ 9.99 -LRB- # 6 -RRB- enables people to create layers of chords , drums and ` atmospheric sounds ' using a strange interface of shapes -LRB- pictured -RRB- to come up with electronic compositions . It uses the Leap Motion Controller so people can compose by waving their hands in mid air
...
The Muse app , which costs $ 9.99 -LRB- # 6 -RRB- enables people to create layers of chords , drums and ` atmospheric sounds ' using a strange interface of cubes , The Next Web explained .
...
The Muse app , which costs $ 9.99 -LRB- # 6 -RRB- , enables people to create layers of chords , drums and ` atmospheric sounds ' using an interface of shapes