...
Once in the water , the Panther is remarkably stable for a boat that is only 15 ft -LRB- 4.6 m -RRB- in length .
...
Both intake and exhaust valves are controlled by Acura 's Variable valve Timing and lift Electronic Control -LRB- VTEC -RRB- system .
...
The Turn-key minus version does n't come with an engine .

The Panther starts at # 49,800 for a ` Rolling chassis ' , # 70,000 for a ` Turn-key minus ' version , and # 89,000 for a complete Panther . The Rolling chassis is a kit and additional components can be bought off the shelf . The Turn-key minus version does n't come with an engine
