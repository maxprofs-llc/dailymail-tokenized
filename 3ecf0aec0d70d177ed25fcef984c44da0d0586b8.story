...
If a 20kt nuclear bomb was dropped on Oxford , pictured , the cloud altitude could reach 7,210 m . It could cause 11,950 deaths and 42,750 injuries

Each bomb is shown with its relative yield in tonnes or kilotonnes , which determines the size and impact of the nuke .

Wellerstein adds that all of the information used to create the Nukemap 3D is publicly available and does n't provide any secret data .
...
Previous versions of the Nukemap use Google Maps but do n't have the 3D animations of the Nukemap 3D .
