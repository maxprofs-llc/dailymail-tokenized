...
Scientists at the University of Utah create system to find lost dogs -LRB- shown -RRB- . Their website called FindingRover.com matches dogs with an online database . It studies distinctive features on dogs such as eyes and snout . This is then correlated with dogs at a shelter to reunite them with owners

The website is called FindingRover.com and was recently used to successfuly reuinte a pet at San Diego County
Animal Services with its owners .
...
A
study in Animal Cognition found that dogs interacted with robots
similar to how they would with humans if those robots seemed ` social ' .
...
The
website keeps a database of photos from the three county shelters and
tries to match eight distinctive facial markers on dogs with images
uploaded by users searching for lost pets .

Eyes and noses are important
areas that differentiate pooches , including eye size and their position
near the snout .
...
Every dog entering San Diego County 's
three shelters is added to the photo database .

Daniel deSousa , the
system 's deputy director , says the program can work two ways :

Someone can find a dog , take its picture and sends it to the database ,
where a match generates a notice to the owner .

The owner then can call
the good Samaritan and arrange a pickup .
...
The
technology powering Finding Rover was built by Dr Steven Callahan and Dr John
Schreiner of the University of Utah 's software development center .

They
found the eight markers on dogs are far fewer than the 128 points on
the human facial recognition program .

` People
are sort of uniform , the shape of their faces , skin tones , all their
eyes , noses and mouths are in the same general location , ' Dr Callahan said .

But dogs ' eyes and snouts are in different places .

It 's
difficult to measure accuracy , Dr Callahan said , but if there are 100 dogs
in a database , a top-three match would be hit 98 percent of the time .

` It
worked surprisingly well , better than I thought it would . I had low
expectations , ' Dr Callahan said .

` It would take off if you had all the
shelters in an area included . '
