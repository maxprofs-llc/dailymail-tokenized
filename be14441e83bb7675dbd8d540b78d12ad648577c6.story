...
But one ambitious organisation called the Media Development Investment Fund -LRB- MDIF -RRB- is planning to turn the age of online computing on its head by giving free web access to every person on Earth .
...
The New York company plans to ask NASA to test their Outernet technology on the International Space Station -LRB- left -RRB- so that they can begin broadcasting Wi-Fi to web users around the world -LRB- right -RRB-
...
Using a technique known as User Datagram Protocol -LRB- UDP -RRB- multitasking , which is the sharing of data between users on a network , Outernet will beam information to users .
...
` There is n't a lot of raw research that is being done here ; much of what is being described has already been proven by other small satellite programs and experiments .
