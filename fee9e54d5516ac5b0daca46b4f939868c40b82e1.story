...
The attack can extract full 4096-bit RSA decryption keys from laptop computers -LRB- of various models -RRB- , within an hour , using the sound generated by the computer during the decryption of some chosen ciphertexts .
