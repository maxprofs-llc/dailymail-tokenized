...
` After success for Northern Ireland this summer as host to both the G8 Summit -LRB- in Co Fermanagh in June -RRB- and the World Police and Fire Games , disorder on the streets is a hugely regrettable step backwards . '
...
Mr Hamilton added : ` We would call on anyone with any influence to stand up and be counted , actually to show some leadership around what is a difficult set of circumstances for us , but we actually need those with influence within the community to use that for good , so that we do n't resort to the violent scenes that we saw last night . '
