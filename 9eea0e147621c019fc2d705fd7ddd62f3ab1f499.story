...
Scientists have found that colonies of two types of bacteria can grow on a mineral called magnetite . Magnetite is an iron -LRB- III -RRB- oxide mineral that forms smooth black crystals , like those shown above , in rock . One species of bacteria dumped electrons while another harvested from them depending on levels of sunlight
...
The researchers grew the bacteria on nano-sized magnetic particles of magnetite -LRB- left -RRB- , which can be seen gathering on the inside of the bottle beside the magnet on the right in a solution of purple bacteria
...
This diagram shows the conditions that the scientists believe leads to the bacteria -LRB- marked in pink -RRB- adding or removing electrons to the magnetite -LRB- the black circle -RRB- according to water levels and sunlight available
...
` For example , magnetite can reduce the toxic form of chromium , chromium VI , to the less toxic chromium -LRB- III -RRB- , which can then be incorporated into a magnetite crystal .
