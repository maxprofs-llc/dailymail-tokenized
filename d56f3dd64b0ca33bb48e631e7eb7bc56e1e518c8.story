...
In one email , an exasperated official asks : ` Do n't we need to do more than give them a stern talking to ? '
...
He also noted that a prominent Ethiopian minister had given assurances over Tsege 's treatment -- ` but I would n't take them with complete confidence ' .
...
` I do n't think we are going to be able to find time for that at the moment , ' wrote his private secretary . He also turned down sending a ` negative ' letter , asking for it to be rewritten ` setting out areas of co-operation . It can end with a paragraph on the Tsege case . '
