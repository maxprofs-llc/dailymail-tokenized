...
The Nosee prototype consists of an app -LRB- pictured left -RRB- and an external sensor -LRB- right -RRB- . The web-connected sensor constantly monitors local pollen and air quality levels and will report changes in levels to the app
...
The Nosee sensor -LRB- pictured left -RRB- can be placed in a garden , or outside a house or office . Local readings are combined with Met Office pollen data and weather forecasts . The app uses a traffic light colour system to warn users about low , medium or high levels and asks them to record how they 're feeling -LRB- pictured right -RRB-

The service also learns a user 's personal hayfever triggers , such as which types of pollen affect them the most , and can send specific alerts about these triggers . Nosee is a prototype -LRB- watch concept pictured -RRB- , designed to show what apps and sensors are capable of recording
...
Nosee is a prototype , designed to show what apps and sensors are capable of . The team at 383 do n't have any current plans to release the device .
