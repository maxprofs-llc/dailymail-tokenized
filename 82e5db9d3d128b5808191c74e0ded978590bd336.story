...
The site 's users are currently attempting to track down the thief . Writes Defcon : ' # Attacker 1 : -LRB- Responsible for 95 % of theft -RRB- , ' wrote one administrator . ` Suspected French , responsible for vast majority of the thefts . Used the following six vendor accounts to order from each other , to find and exploit the vulnerability aggressively . '
