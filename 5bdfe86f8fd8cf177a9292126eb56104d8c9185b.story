...
` Thus , tactile sensations which may be beneficial to survival -LRB- such as soft furs , for example , which provide warmth -RRB- may activate the parts of the limbic system mediating pleasure , whereas others which may be harmful -LRB- such as jagged stones -RRB- may be connected to those areas mediating aversion . '
