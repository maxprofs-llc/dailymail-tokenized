...
Engineers at University of Sheffield developed the prototype 1.5m-wide unmanned aerial vehicle -LRB- UAV -RRB- using a cheap , common technique that builds objects using layers of plastic .
...
FDM is slower than other printing methods , including selective laser sintering -LRB- SLS -RRB- , which uses lasers to fused particles together .
...
It was built using a technique called fused deposition modelling -LRB- FDM -RRB- , and is made of a polymer called thermoplastic .

FDM is slower than other printing
methods , including selective laser sintering -LRB- SLS -RRB- , which uses lasers to
...
Thermoplastics work out at approximately # 5.50 -LRB- $ 9 -RRB- per 2kg bag , although prices vary .
...
The craft , pictured , designed by Advanced Manufacturing Research Centre -LRB- AMC -RRB- was built using a 3D printing technique called fused deposition modelling -LRB- FDM -RRB- . Engineers said the design could form the basis of cheap , and potentially disposable crafts built within 24 hours
...
The Sheffield UAV is made up of nine parts printed separately that are snapped together . It weighs less than 2kg -LRB- 4.4 lb -RRB- and is made from thermoplastic .
...
Drone was 3D printed using fused deposition modelling -LRB- FDM -RRB- technique
...
It weighs 2kg , is 1.5 m wide and consists of nine parts that snap together

@highlight

The materials for each drone start at approximately # 5.50 -LRB- $ 9 -RRB-
