...
Iris recognition -LRB- IR -RRB- is an example of biometric identification .
...
Lemur : Lemurs only see in black and white . This means they do n't choose food based on what it looks like , but instead of how it smells . Their monochrome vision makes it easier to see at night . The word ` lemur ' comes from the Roman mythological word , lemures , which means ghosts or spirits
...
Chimpanzee : Chimpanzees , also known as chimps , have eyes similar to humans because they can distinguish colours that other mammals ca n't see . The eyes on a chimp are close together , like on humans , so they can see stereoscopically and make out shapes in 3D , with depth perception
...
Guinea pig : The guinea-pig is a domesticated rodent , also known as cavy . It does n't exist naturally in the wild . The term to be used as a ` guinea pig ' , referring to being a test subject , comes from when the rodents were tested on during the 19th century
