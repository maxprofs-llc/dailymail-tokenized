The WW9000 machine is allows a person to control and monitor their washing using their smartphone
...
The futuristic washing machine , which will go on sale in May across Europe , also has a ` super speed wash setting ' that cleans clothes in under an hour by quickly filing the drum with water through its twin water supply

The array of options can be navigated by a 5inch colour touchscreen instead of knobs and dials so that the machine can easily display the most used and favourite settings to let users navigate all the options easily .
...
Air and water are pulled in to generate bubbles , dissolving and activating the detergent , which then penetrates faster and more evenly throughout the wash load , according to Samsung .

This helps to dissolve washing detergent , creating rich soapy foam that penetrates clothes faster , so less hot water is required , and therefore saves energy on every load , it claims .

The WW9000 model has an extra large door and a ` translucent deep blue crystal finish ' that Samsung says ` creates a beautiful spectrum of colours when it comes into contact with light ' .

An array of washing options can be navigated by a five inch colour touchscreen -LRB- pictured -RRB- instead of knobs and dials so that the machine can easily display the most used and favourite settings
...
WW9000 washing machine is designed to be remotely operated as well as by a large colour touchscreen on the appliance
