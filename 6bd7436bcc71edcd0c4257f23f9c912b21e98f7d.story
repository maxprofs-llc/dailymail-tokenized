...
The car relies on 28 cameras , sensors and lasers as well as software rules to drive itself on busy roads . Initially , the cars -LRB- illustrated -RRB- will drive autonomously on selected roads with suitable conditions , for example without oncoming traffic , cyclists and pedestrians
...
The system , however , is n't designed to negotiate exceptional weather conditions or if the end of a route is reached . In such cases , the driver will be prompted to take over .

If the driver does n't take over in time , the car will bring itself to a safe place to stop .
