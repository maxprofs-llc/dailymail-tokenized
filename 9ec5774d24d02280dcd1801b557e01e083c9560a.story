...
Fresh : Mint -LRB- pictured -RRB- contains menthol which tricks a receptor protein that senses the change in temperature
...
We do n't exactly understand how TRPM8 does it . Whenever there is a drop in temperature , the voltage on TRPM8 somehow changes and its shape changes so that it allows calcium ions to flow into the nerve cell .
...
We still do n't understand exactly how it works , but one way it may act is by activating its receptor , TRPM8 .
...
Menthol tricks this protein but it is n't known why