...
` Google provides search services to millions of people and can not be responsible for policing internet content .
...
Google had argued that it already has a system in place to remove individual web addresses -LRB- URLs -RRB- and that it would be wrong for the court to order it to block the abuse as it appears .
...
Google , whose corporate motto is ` Do n't be evil ' , set aside a budget of # 1.68 m to fight the case in contrast to Mr Hegglin 's budget of just over # 600,000 .
