...
` So thankfully we managed to grind it out because I do n't know what I would have said if we 'd drawn that one .

` When Stephen McManus scored I jumped out of my seat in the studio because it was hugely important to get that win .

` That night is a reminder of what can happen in any game of football . It can be difficult and at this level you do n't want to lose a goal to give yourself an uphill task .
...
` These are the games we have to win and historically it has n't been that easy for us .
...
` I do n't know what will happen on Sunday -- the manager will decide that .
