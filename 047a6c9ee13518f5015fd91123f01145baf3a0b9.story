...
Researchers from the University of Surrey claim that many selfies could be improved simply by holding the camera further away , and zooming in , to change the perspective . But when using a smartphone , place the camera at arm 's length , and hold the phone in landscape when taking group shots -LRB- Oscars selfie is pictured -RRB-
...
When using a digital camera , Dr Sporea said a wide-angle lens needs to be positioned further away from the subject and zoomed in , to achieve a more accurate perspective -LRB- pictured -RRB-

When a wide-angle lens is too close to a subject , the distance from the lens is approximately the same distance between the subject 's features . This causes the image to be distorted . A selfie-stick -LRB- pictured -RRB- can be used to get extra distance between the lens and face
