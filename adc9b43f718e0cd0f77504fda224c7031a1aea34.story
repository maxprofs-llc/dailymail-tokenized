...
London 's new # 4.2 billion ` super sewer ' will stop the capital returning to the days of the ` Great Stink ' but could see household bills rise by # 80 , it has been revealed .
...
Situated 65 metres below the river , and with a capacity of 1.6 million cubic metres , the sewer is said to be needed to prevent an average of 55million tonnes of untreated sewage being discharged into the river each year .
...
Exploratory works for the # 4.2 billion project have already been carried out in the River Thames . Construction could get underway as early as 2016 if given the go-ahead

Thames Water has insisted the multi-billion pound project is crucial to stop London returning to the days of the ` Great Stink ' when the river acted as an open sewer

Built from three main construction sites in Fulham , Battersea and Southwark , the Thames Tideway Tunnel is expected to help treat some of the 55million tonnes of ` overflow ' raw sewage which the current system can not cope with .
...
British engineer Sir Joseph William Bazalgette -LRB- standing top right -RRB- built London 's current drainage system in the 1860 's , but his sewers are now starting to overflow
