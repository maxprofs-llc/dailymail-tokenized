...
Companies such as Coca-Cola are using a new image recognition software to track their logos - as well as 2,500 other ` details ' - in the 1.8 billion photos that flood social networking sites each day .
...
The program then uses an interface to access information about who posts images with the logo , by analysing faces in the image and their ` corresponding facial mood score -LRB- FMS -RRB- ' .
...
The company describes how the software can also ` access information about who posts images with your logo ' by tracking ` faces in the image and their corresponding facial mood score -LRB- FMS -RRB- ' .
...
1.8 bn photos are posted every day to social media sites such as Instagram
