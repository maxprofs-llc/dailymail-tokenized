...
` We can not and will not rely only on cutting public spending and targeting welfare to finish the job .
...
` And what a fight it has been . It started in those election debates when the Conservatives said ` we can not afford it ' .
...
` Do n't get me wrong , it must be hard to be a Tory in a Treasury delivering so much Lib Dem policy , so it 's no surprise if some of them have gone native . '
