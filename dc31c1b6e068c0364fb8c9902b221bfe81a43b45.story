...
Toyota says it added Easy Speak ` so parents do n't have to shout to passengers in the back . ' But chances are many parents will yell into the microphone anyway .
...
And the feature only works one way , so the kids ca n't talk back . At least not with amplified voices .
...
More relaxing drives : Toyota says it added Easy Speak ` so parents do n't have to shout to passengers in the back '
...
` Driver Easy Speak ' works only one way , so the children can not talk back