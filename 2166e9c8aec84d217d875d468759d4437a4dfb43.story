...
Now researchers are looking into ways to add radio frequency identification -LRB- RFID -RRB- chips into guns so that they can only shoot when they are fired by their owner .
...
Radio-frequency identification -LRB- RFID -RRB- is the wireless non-contact use of radio-frequency electromagnetic fields to transfer data , for the purposes of automatically identifying and tracking tags attached to objects .
...
A semiconductor industry analyst said an RFID tag -LRB- pictured -RRB- could be surgically implanted into a person 's hand or embedded in a ring or bracelet to override a lock on a smart gun
...
firing of a stolen weapon much more difficult if the key is n't in very close proximity .

According to Mr Handy , RFID chips cost less than ten cents -LRB- six pence -RRB- each and the electronics used in the reader costs less than a dollar or 61 pence .
...
Scientists are researching using radio frequency identification -LRB- RFID -RRB- chips in guns to prevent people firing stolen or borrowed weapons
