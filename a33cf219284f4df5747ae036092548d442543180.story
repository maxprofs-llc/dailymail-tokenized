...
investigations that we undertake across the service that do n't use
...
The Government Communication Headquarters -LRB- GCHQ -RRB-
...
1 -RRB- iSafeguard Freeware 6.2 : This program will secure emails and files using strong encryption and syncs with most popular email clients .

2 -RRB- HushMail : This web-based email service uses a Java applet to encode emails with 1024bit public key encryption .

3 -RRB- GnuPG : This Linux-only application is an open-source replacement for PGP -LRB- Pretty Good Privacy -RRB- . PGP was one of the first military-grade encryption products available to the general public .
...
The
services that might be targeted by the probes were n't identified ,
...
` We have heard that the government has -LRB- redacted -RRB- options in dealing with the challenge encryption poses , ' the report said .
