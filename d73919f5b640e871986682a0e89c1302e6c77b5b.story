...
But , according to the latest figures , hidden among these active users are approximately 23 million that do n't ever visit the microblogging site .
...
Twitter now has more than 270 million active users , -LRB- chart pictured -RRB- of which approximately 23 million never visit the site . Instead , they pull information from Twitter automatically using other apps . It is unsure how many of these users are non-human bots . The figure does not include the number of bots that actively tweet
...
Twitter has not revealed how many of its 271 monthly active users are tweeting bots . These bots include a number of company , parody or industry accounts . For example , @big_ben_clock -LRB- pictured -RRB- tweets the word ` bong ' every hour , depending on what the time is

Elsewhere , @MarmiteBot -LRB- pictured -RRB- automatically tweets ` My mate Marmite ' every time someone mentions the spread on Twitter -- even if they 're not tweeting the bot directly
