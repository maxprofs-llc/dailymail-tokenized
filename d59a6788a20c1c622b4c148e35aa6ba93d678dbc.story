...
` It seems to us that -LRB- a -RRB- a penalty to a rider shall be applied only based on very precise and verified circumstances -LRB- b -RRB- UCI and yourself -LRB- Cookson -RRB- have written that the provisional suspension is imposed because it is likely that the rider 's results will be affected by the asserted anti-doping rule violation - thus you believe he is guilty ; and -LRB- c -RRB- we believe that justice shall be administered treating all cases in the same manner and not on a case by case basis . '
