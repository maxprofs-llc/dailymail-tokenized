...
The Electronic Frontier Foundation -LRB- EFF -RRB- released its Secure Messaging Scorecard today , evaluating dozens of messaging technologies on a range of security best practices .
...
2 . Is your communication encrypted with a key the provider does n't have access to ?
...
` The revelations from Edward Snowden confirm that governments are spying on our digital lives , devouring all communications that are n't protected by encryption , ' said EFF Technology Projects Director Peter Eckersley .

` Many new tools claim to protect you , but do n't include critical features like end-to-end encryption or secure deletion .
