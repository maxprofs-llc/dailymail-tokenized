...
All smiles here : The hosts , which include -LRB- from left -RRB- Whoopi Goldberg , Nicolle Wallace , and Rosie Perez , have not gelled well , according to several reports , and the ratings are not good either
...
Power struggle ? : A source has claimed that the 52-year-old TV personality -LRB- far left -RRB- is not happy that Goldberg -LRB- second from left -RRB- has all the power as the ` moderator '
