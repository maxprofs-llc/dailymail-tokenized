...
Speaking to Chemistry world , Yuichiro Nagame , a researcher at the Japan Atomic Engery Agency who took part in the study , said : ` -LSB- Lutetium and lawrencium -RSB- -- the last column of lanthanides and actinides -- could be put into the group III column of the periodic table , under scandium and yttrium . '
...
Lawrencium , represented by the diagram left , was discovered by nuclear scientist Ernest Lawrence -LRB- right -RRB-
...
The researchers found this matched a recent prediction of 4.96 eV - giving it the lowest ionisation potential of all elements in the f-block .
...
They said : ` Since the introduction of the ` actinide concept ' as the most dramatic modern revision of the Periodic Table of the Elements by Glenn Seaborg in the 1940s , the element with atomic number 103 , lawrencium -LRB- Lr -RRB- , played a crucial role as the last element in the actinide series .
...
The researchers were able to study lawrencium for the first time using an ionizer cavity -LRB- left -RRB- which revealed that the element has one of the lowest ionisation potentials of any of the atoms in the f-block -LRB- right -RRB-
