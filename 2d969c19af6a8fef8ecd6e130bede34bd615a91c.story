...
Entrepreneur Mr Weinberg had the idea for the company in 2006 , while taking time out to do a stained-glass making course . He had just sold successful start-up Opobox , similar to Friends Reunited , for $ 10million -LRB- # 6.76 million -RRB- to Classmates.com .
...
DuckDuckGo , named after an American children 's tag game Duck Duck Goose -LRB- though not a metaphor -RRB- , was solo-founded by Mr Weinberg in 2008 , in Valley Forge , Pennsylvania .
...
` For example , when you search for something private , you are sharing that private search not only with your search engine , but also with all the sites that you clicked on -LRB- for that search -RRB- , ' he points out on his website .

` In addition , when you visit any site , your computer automatically sends information about it to that site -LRB- including your User agent and IP address -RRB- . This information can often be used to identify you directly .
...
Within two weeks of NSA 's
operations being leaked by former employee Edward Snowden -LRB- pictured -RRB- , DuckDuckGo 's
traffic had doubled - from 1.7 million searches a day to
3million
...
Currently , 50 per cent of DuckDuckGo 's users are from the U.S. , 45 per cent from Europe and the remaining 5 per cent from Asia-Pacific -LRB- APAC -RRB- .

On June 3 , the company reported it
had more than 19million direct queries per month and the zero-click Info
API gets over 9million queries per day .

It
has partnerships with apps , browsers and distributions that include
DuckDuckGo as a search option : Browsers , distributions , iOS , and
Android . Companies can use DuckDuckGo for their site search , and the
firm offers an open API for Instant Answers based on its open source
DuckDuckHack platform .

Speaking
on U.S. radio channel , American Public Media , Mr Weinberg said :
` Companies like DuckDuckGo have sprung in the last couple years to cater
to the growing number of data dodgers .
...
User feedback on the company website say
the search engine reminds them of the early days of using Google ; it 's
like an ` honorable search site to complement Wikipedia ' ; and other are
` amazed ' that a search engine company is ` doing exactly the right
thing '
...
Competitors include Ixquick , a Dutch meta-search engine firm , based in the Netherlands and New York . It returns private meta-search results from other
providers .
...
YaCy is another free search engine that is fully decentralized . It prides itself on making all users of its search engine network as equal , not storing user search requests and does n't censor content .
