...
` There are academic studies which compare what happened the disaster of the Costa Concordia to other similar tragedies . For example , the Twin Towers , how is that during that attack people threw themselves from windows but did n't do the same on the Concordia ? I was actually given an academic award for my presentation . '
...
` Both the families of Russel Rebello and Maria Grazia Tricarichi have been informed because we ca n't rule out the possibility that the remains are hers , ' the police said in a statement .
