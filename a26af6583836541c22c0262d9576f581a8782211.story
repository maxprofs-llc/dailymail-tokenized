...
The Bump Mark label is filled with gelatine , set over a bumpy plastic sheet -LRB- pictured -RRB-

The Bump Mark label is filled with gelatine , set over a bumpy plastic sheet .

Because jelly is solid when it sets , the bumps can not be felt at first , but as the gelatine decays , it becomes a liquid .
...
Gelatine is protein , so it decays at the same rate as protein-based foods.The label -LRB- pictured -RRB- copies what the food in the package is doing , so the expiry information is more accurate than a printed date . This means all users , including blind people , can quickly identify when food is safe to eat , and when it should be thrown away
...
` This is why I worked to create a cheap solution that could be applied to existing food packages and also provides information that even sighted people have n't had access to before : information about the actual condition of food . '
...
This graphic reveals how the layer is created . Gelatine is solid when it sets , meaning the bumps can not be felt at first , but as the gelatine decays , it becomes a liquid . This means that the bumps underneath the plastic sheet can be felt , letting users know it has expired

The technology is similar to patches unveiled earlier this year . These patches -LRB- pictured -RRB- contain gel that starts out red but changes colour over time , as its ingredients react with each other . The rate of the colour change corresponds with the speed of growth of the food poisoning bug E coli at different temperatures
...
When the gelatine is solid , the bumps ca n't be felt when touched
