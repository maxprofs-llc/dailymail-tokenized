...
That 's one of the potential uses of a new technology developed by researchers at the Massachusetts Institute of Technology -LRB- MIT -RRB- .
...
Massachusetts Institute of Technology -LRB- MIT -RRB- researchers have developed a method to detect hazardous gases and pollutants . They modified NFC chips -LRB- shown -RRB- to make them detect things in their environment , and the information could then be sent to your phone

The sensors are made using modified near-field communication -LRB- NFC -RRB- tags .
...
These phones can send out short pulses of magnetic fields at radio frequency -LRB- 13.56 megahertz -RRB- , inducing an electric current in the circuit on the tag , which relays information to the phone .
...
The team refers to the modified tags as Cards -LRB- chemically actuated resonant devices -RRB- .
...
Dr Tim Swager told MailOnline the technology could have a variety of uses . ` It is ideal for large volume applications wherein consumers can check for example freshness of food for themselves , ' he said . ` You could have a NFC system in your fridge that reads the sensor ' -LRB- stock image shown -RRB-
