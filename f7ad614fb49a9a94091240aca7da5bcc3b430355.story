...
Researchers have written an algorithm for 2D touchscreens that modify the friction between a user 's finger and the screen to add physical sensations to what a viewer is looking at . Disney Research said the technology can be sued to feel features in a video -LRB- pictured -RRB-

One key feature of the algorithm is that it is light weight and can be implemented in real-time . A 3D model of objects -LRB- like the kettle seen here -RRB- can be zoomed and panned in real-time to sense fine edge and protruding features of the object
...
Disney Research claims that it can reproduce edges , ridges , protrusions and bumps as well as other sensations using its technology , which creates the ability for people to feel the geography of maps , including raised mountains -LRB- pictured -RRB-
