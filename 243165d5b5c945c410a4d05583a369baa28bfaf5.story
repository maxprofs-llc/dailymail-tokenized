...
Nasa scientists have recreated the ` scent ' of Saturn 's moon Titan -LRB- pictured in ultraviolet and infrared -RRB- by combining gases in a lab and letting them react . This helped to determine the identity of a material that had been detected in the atmosphere by the Cassini spacecraft , which is now thought to be benzene
...
Because
Titan is less massive than Earth , its gravity does n't hold onto its
gaseous envelope as tightly , so the atmosphere extends 370 miles -LRB- 600 kilometres -RRB-
into space .
...
frozen solid on Titan where the surface temperature is -180 °C -LRB- -290 °F -RRB- .
...
In the animated television series Futurama , Professor Farnsworth creates a comical ` Smell-O-Scope ' -LRB- pictured -RRB- that lets him and his crew ` smell ' the composition of distant stars and worlds , used in one scene to spot a rip in space-time . Nasa 's lab experiment , while less impressive-looking , surprisingly used a similar principle
...
Nasa 's Cassini spacecraft -LRB- illustration shown -RRB- has been orbiting Saturn and its moons since 1 July 2004 . The probe has been a huge success , revealing untold secrets of the Saturnian system including liquid oceans on Titan 's surface , huge storms on Saturn and geysers on the icy moon Enceladus
