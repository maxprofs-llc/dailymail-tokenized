...
Association -LRB- APALSA -RRB- at the University of California .

` Even if we can not undo history , we can acknowledge it and ,
...
Now the California Supreme Court has granted him a posthumous license , saying ` even if we can not undo history , we can acknowledge it '