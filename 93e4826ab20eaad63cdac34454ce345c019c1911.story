...
A tiny sensor found in smartphones could instantly turn your mobile phone into an earthquake sensor , according to a new study

Known as a Micro-Electro-Mechanical System -LRB- MEMS -RRB- accelerometer , the sensors measures the rate of acceleration of ground motion and vibration of cars , buildings and installations .
...
The test showed that the MEMS accelerometers could detect moderate to strong earthquakes , greater than magnitude 5 , such as the one that hit Pakistan earlier this month
...
VIDEO : The iShake app developed by University of California , Berkeley

Their hope is to create an urban seismic network that could transmit real-time ground motion data to a central location .

This is n't the first time that smartphone sensors have been used to detect earthquakes .
...
MEMS sensors can detect earthquakes greater than a magnitude of 5
