...
Dubbed WireLurker , the malware targets both Mac computers and laptops -LRB- pictured -RRB- as well as phones and tablets running iOS . It was discovered by experts at Palo Alto Networks who detailed their findings in a research paper
...
` It is only the second known malware that attacks iOS devices through OS X via USB -LSB- and -RSB- is the first malware to automate generation of malicious iOS applications , through binary file replacement . '
...
WireLurker monitors iOS devices , including iPods , iPhones -LRB- pictured -RRB- and iPads , connected to a Mac via USB . The virus begins by infecting the Mac OS software , through malicious files or links . When a device is connected to this infected Mac , the malware automatically installs malicious apps onto the phone or tablet

Palo Alto Networks said that the attacks have been concentrated in China , and only currently affect Chinese users because the malware originated from a Chinese third-party apps store called Maiyadi -LRB- pictured -RRB- . However , they warned it has the potential to spread to other regions
