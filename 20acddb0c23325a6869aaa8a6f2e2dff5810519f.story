...
A spokesman for the Department for Communities and Local Government said : ` The Government is far from complacent , which is why despite the need to tackle the deficit we 're investing # 19.5 billion public and private funding in an affordable housing programme set to deliver 170,000 homes , putting # 1.3 billion into unlocking stalled sites and building the infrastructure we need and making enough formerly used , surplus public sector land available to deliver 33,000 new homes .
...
` As things stand the owner occupied model just is n't delivering the required numbers , and we need to focus on a range of options .
