...
Engineers have tested voice and data connections in London -LRB- shown in map -RRB- . They travelled back and forth on the ten most popular lines . All were found to be plagued by poor voice and data connections . One in three internet tasks were dropped during testing

The research was carried out by Global Wireless Solutions -LRB- GWS -RRB- .
...
When attempting to send data ` packets ' while on the routes , one in four 3G packets and one in three 4G packets did n't send properly .
...
But GWS ' testing suggests that it 's not just the mobile internet that Londoners struggle to use while commuting : one in seven voice calls -LRB- 14 per cent -RRB- made from trains fail too .
...
Meanwhile , one in four of the data task failures -LRB- 24.18 per cent to be exact -RRB- GWS ' engineers experienced occurred while they were on trains in stations , while one in five occurred when they were on trains on open stretches of track .
...
GWS found that voice and data failures are more likely to occur when a train is travelling from zero to five miles -LRB- eight kilometres -RRB- per hour than when it is travelling between speeds of five and 50 -LRB- eight and 80 kilometres -RRB- per hour .

Failures are most likely to occur when a train is travelling above 50mph -LRB- 80km/h -RRB- .

For stations , St Pancras has by far and away the worst connectivity of all of those tested by GWS .

The engineers experienced an average of 99 voice and packet data failures -LRB- across the four operators -RRB- while testing in the famous station .
...
` Pressure from commuters makes it inevitable that trains wo n't keep their status as mobile dead zones for much longer .
