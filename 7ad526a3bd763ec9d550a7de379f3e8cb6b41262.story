...
Acceptable ? The authors of a new medical paper have claimed that doctors should , in some cases , be able to use the Internet search engine , Google , to seek information on the people they are caring for -LRB- file picture -RRB-

Although the American Medical Association 's -LRB- AMA -RRB- guidelines provide doctors with general advice on the use of the Internet , they do not explicitly refer to the practice of ` Googling ' , the co-authors claim .

Despite this so-called ` Google blind spot ' , physicians ' use of the search engine to find out patients ' details is typically perceived -LRB- by both the public and doctors themselves -RRB- as an invasion of privacy .
...
Co-authors : Sometimes ` patient-targeted Googling ' is necessary to protect patients - and others - from harm , say Maria Baker -LRB- left -RRB- and Daniel George -LRB- right -RRB- , co-authors of the Journal of General Internal Medicine paper
...
Popular Internet search engine : Although the AMA 's guidelines provide doctors with general advice on the use of the Internet , they do not explicitly refer to the practice of ` Googling ' , the co-authors say -LRB- file picture -RRB-
...
Although anecdotal reports highlight some benefit -LRB- for example , intervening when a patient is blogging about suicide -RRB- , real potential exists for blurring professional and personal boundaries . '
