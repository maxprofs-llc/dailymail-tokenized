...
The new version of wi-fi - known as 802.11 ac - is designed to deal with households where lots of devices are connecting to the same wi-fi network .
...
The new version of wi-fi can deliver speeds of up to 1.3 Gbps per second - in theory , delivering entire DVDs ' worth of data in seconds .
...
Even with the fastest version of wi-fi currently on offer - 802.11 n - streaming video can cause problems .
...
` Consumers are demanding seamless , pervasive connectivity -- something that will be possible with new technologies such as 802.11 ac , ' said Broadcom via a release .
