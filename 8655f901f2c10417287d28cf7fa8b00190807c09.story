...
All life on Earth is said to have come from one common ancestor , a single-celled organism known as life 's Last Universal Common Ancestor -LRB- Luca -RRB- .
...
Using mathematical modelling , researchers claim the Last Universal Common Ancestor -LRB- LUCA -RRB- passed energy through a ` leaky ' membrane . This caused it to grow and evolve . As it moved to new surroundings , membranes evolved independently causing bactera and archaea organisms to evolve separately -LRB- shown in this illustration -RRB-
...
The Last Universal Common Ancestor -LRB- Luca -RRB- is the name given to a crude organism that is now traceable in all domains of life ; plants , animals , fungi , algae , and so .
...
This drives the production of a molecule called adenosine triphosphate -LRB- ATP -RRB- , which makes modern-day cells grow , for example .
...
The researchers claim that this evolution process explains why membrane bioenergetics are universal in archaea -LRB- pictured -RRB- and bacteria - yet ion pumps and membranes are different , which has been the big unknown
...
Lead author Victor Sojo , a researcher in UCL 's Biosciences department , added : ` Exploiting gradients is universal across all life , but understanding how Luca used one to drive growth gave us a bit of a chicken-and-egg problem : Luca would n't make a gradient if it did n't know how to exploit it , but how could it learn how to exploit a gradient if it did n't make one in the first place ?

` We propose that natural proton gradients provide a solution because Luca did n't have to make the gradient ; it was already there for free . We show that modern ` non-leaky ' membranes had to evolve later , and they did so independently in archaea and bacteria .
...
Researchers believe they have discovered clues about life 's Last Universal Common Ancestor -LRB- LUCA -RRB-
...
This would n't have been possible if the membrane did n't ` leak '
