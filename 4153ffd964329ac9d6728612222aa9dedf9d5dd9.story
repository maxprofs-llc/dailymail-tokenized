...
If a pedestrian or obstacle is too close , the Collision Mitigation Braking System -LRB- CMBS -RRB- automatically applies gentle brake pressure to warn the driver . If they do n't respond , the system automatically brakes to avoid an obstacle and a driver can steer the while to activate a ` collision avoidance effort ' -LRB- pictured -RRB-

If the distance gets closer , the Collision Mitigation Braking System -LRB- CMBS -RRB- will automatically apply gentle brake pressure to warn the driver .

If they do n't respond , the system will automatically brake hard to avoid an obstacle .
...
But the camera used in the new system can spot them within 196ft -LRB- 60 metres -RRB- ahead of the vehicle .

The system itself recognises the car 's surroundings and the intentions of the driver , the company says .

For example , the Road Departure Mitigation -LRB- RDM -RRB- system keeps a car in its lane . The camera detects the lane boundaries and if the car looks like it will stray from a detected line , the steering wheel will vibrate to warn the driver .

The bundle of sensing technology also uses the camera to read traffic signs -LRB- illustrated -RRB- to show them on the dashboard display , or a heads-up display projected onto the windscreen , making it easier for drivers to notice a change in the speed limit
...
If there is a risk of a collision , the system warns the driver and if they do n't respond , it brakes hard .
