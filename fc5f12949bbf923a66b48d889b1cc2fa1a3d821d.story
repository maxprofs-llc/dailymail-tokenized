...
Although the handset is n't expected to be bendy , the use of a flexible screen could mean it has a more curved display than current phones .
...
Although rival Samsung announced plans to launch a flexible display last month , LG is expected to be the first to bring it to market on the G Flex phone , rumoured to launch next month . Although the handset is n't expected to be bendy , the use of the screen , pictured , could mean it has a more curved display than current phones
...
OLED 's -LRB- organic light-emitting diodes -RRB- are used to create digital displays in TVs , computer monitors , phones , tablets and games consoles .

An OLED display works without a backlight , which means it can display deep black levels and can be thinner and lighter than a liquid crystal display -LRB- LCD -RRB- .

In low lighting , an OLED screen can produce a higher contrast ratio than an LCD , too .

In March last year , LG Display also
developed the world 's first 6-inch Electronic Paper Display -LRB- EPD -RRB- based
