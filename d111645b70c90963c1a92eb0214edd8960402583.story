...
When the sound of a finger moving across sandpaper -LRB- stock image left -RRB- and velvet -LRB- right -RRB- were played , the participant reported noticeable changes in how the plastic felt beneath her finger . Researchers want to study how sounds can be manipulated to affect a person 's mood and perception
...
But , the effect sounds have on these senses and experiences have n't been investigated in depth .
...
In the process of converting what it sees , the brain tries to make sense of the different colours and patterns . This creates a perception that does n't match the image , and confuses the brain .

Similarly , in terms of audio changes , the information collected by the ear is processed by the brain , which then tries to make sense of the differences .

As the brain tries to account for discrepancies , it produces a variety of sensations .

The sensations are similar to those experience when people watch optical illusions -LRB- pictured -RRB- . In the case of optical Illusions , colour , light and patterns are used to create images that deceive or mislead the brain . The information collected by the senses processed by the brain , which then tries to make sense of it
