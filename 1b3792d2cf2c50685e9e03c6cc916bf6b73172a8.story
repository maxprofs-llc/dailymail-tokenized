...
Although the patent does n't explicitly
...
Although the patent does n't explicitly say what the sensors would consist of , signals could be taken from web-enabled devices already in the home , or be bought separately .

The patent , originally uncovered by Patently Apple , said the assistant would be ` in communication with a plurality of sensors distributed throughout the domain and adapted to convey observed facts relating to the user 's behaviour -LRB- e.g. , ` the user is in the kitchen ' ; ` the user is in the dining room ' ; ` the user is in the bathroom ' -RRB- .
...
Although the patent does n't explicitly say what the sensors would consist of , signals could be taken from web-enabled devices already in the home , or bought separately . Future versions , in theory , could reverse the process and be used to control devices or the sensors using Siri , stock image pictured

Future versions , in theory , could reverse the process and be used to control devices or the sensors using Siri .

The patent , called 8,677,377 : Method and apparatus for building an intelligent automated assistant , was published by the US Patent and Trademark Office -LRB- USPTO -RRB- on Tuesday .

Outside of the home , the patented said : ` Such systems may assist individuals who are impaired in some way -LRB- e.g. , visually , auditorially , physically , cognitively , etc. -RRB- , including elderly people , who may be stricken by one or more ailments -LSB- and -RSB- surgeons , whose eyes , hands and brains are constantly busy when performing operations , among others . '
