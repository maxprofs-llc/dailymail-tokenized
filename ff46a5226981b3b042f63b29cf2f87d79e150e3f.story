...
Called the Hyper Velocity Asteroid Impact Vehicle -LRB- HAIV -RRB- , their system would be able to launch and reach an Earth-bound asteroid within 100 days or so , destroying it before it reached our planet .
...
Boom ! A Danish NGO is planning to develop an Earth-saving spacecraft called the Hyper Velocity Asteroid Impact Vehicle -LRB- HAIV -RRB- . In the diagram above , NED stands for nuclear explosive device . The front of the spacecraft would create a small crater , which the nuclear device would then travel in to and explode

The concept was created by the Emergency Asteroid Defence Project -LRB- EADP -RRB- , based in Denmark .

They are seeking to find a way to protect Earth from destruction when all other methods have failed .

Ranging from # 340 million to $ 1 billion -LRB- $ 500 million to $ 1.5 billion -RRB- , the cost of the mission would depend on how large the incoming asteroid that needed to be destroyed was .

Called the Hypervelocity Asteroid Intercept Vehicle , or HAIV , the craft would rendezvous with an asteroid in deep space .

It consists of a fore body -LRB- a leader spacecraft -RRB- , which would hit the comet and create blast crater .

A few seconds later , an aft body -LRB- a follower spacecraft -RRB- carrying nuclear explosives would hit inside the crater - which increases its effectiveness by up to 20 times .
...
This diagram shows a simulation of the area affected if something the size of Halley 's Comet , with a diameter of approximately 6.2 miles -LRB- 10km -RRB- , hit the US - a possible global extinction event

This simulation shows the area that would be affected , if a medium asteroid 330ft -LRB- 100 metres -RRB- in diameter hit London . The EADP team says there is a significant threat of an asteroid hitting Earth
...
It relies upon near-Earth objects -LRB- NEOs -RRB- being tracked , so that the threat of one hitting Earth can be measured in advance .
...
On the left is a typical journey for the HAIV vehicle to intercept an asteroid that could dangerous to Earth . In this instance it would take 121 days to stop the asteroid before it hit , illustrated right
...
The team is now looking to raise # 675,000 to # 6.75 million -LRB- $ 1 million to $ 10 million -RRB- in the next year or so , through crowdfunding sites like Kickstarter .

By 2018 , they want to build a version of HAIV that could destroy an asteroid 165ft -LRB- 50 metres -RRB- across .

And by the end of the decade , they want to be ready to stop asteroids up to 985ft -LRB- 300 metres -RRB- in size - which account for 99.9 per cent of asteroids near Earth .
...
Hyper Velocity Asteroid Impact Vehicle -LRB- HAIV -RRB- will be a ` rapid ' response
