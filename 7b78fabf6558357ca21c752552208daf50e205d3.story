...
But it has been impossible to directly ` see ' a black hole - the gravity that surrounds the objects is so intense that even light can not escape .
...
The team is connecting up to 50 radio telescopes scattered around the globe , including the Submillimeter Telescope on Mt. Graham in Arizona , telescopes on Mauna Kea in Hawaii -LRB- pictured -RRB- and the Combined Array for Research in Millimeter-wave Astronomy in California
