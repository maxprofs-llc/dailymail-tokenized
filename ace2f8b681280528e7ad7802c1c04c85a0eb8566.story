...
Physicists at the Australian National University have created a tractor beam on water that controls flow patterns using wave generators -LRB- pictured -RRB- . This means the researchers can move objects at will , without touching them . The ` beam ' could be used to control oil spills , for example

Last year , a team from the University of St Andrews and the Institute of Scientific Instruments -LRB- ISI -RRB- in the Czech Republic built a laser capable of moving tiny spheres of polystyrene floating in water .
...
Using a ping pong ball in a wave tank , the researchers used the size and frequency of the waves , when viewed through a slow-motion camera , -LRB- pictured -RRB- to work out their different size and frequency . They were then able to manipulate these waves to move the ball in whichever direction they wanted
...
Advanced particle tracking tools , developed by team members Dr Nicolas Francois and Dr Hua Xia , revealed waves generate currents on the surface of the water -LRB- illustration pictured -RRB- . Using this , the researchers realised the particle motion on the surface is too complex to handle with any existing mathematical theory

Previous research into ` tractor beams ' have concentrated on moving objects using lasers , as seen in science fiction films and TV shows . The Starship Enterprise from Star Trek -LRB- pictured -RRB- is shown using its tractor beam on a smaller spaceship
