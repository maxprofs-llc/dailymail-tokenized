...
Called the CAN Hacking Tool -LRB- CHT -RRB- , the device can be fitted to any car 's Controller Area Network ` within minutes ' and run malicious code through the vehicle 's system .

Once hackers take hold of this network they can control lights , locks , steering and even brakes - and it costs just $ 20 -LRB- # 12 -RRB- .

Scroll down for video

In February , Spanish security researchers created the $ 20 -LRB- # 12 -RRB- CAN Hacking Tool -LRB- CHT -RRB- -LRB- pictured -RRB- - a device that can be fitted to any car 's Controller Area Network ` within minutes ' and run malicious code through the vehicle 's system . Once hackers take hold of this network they control lights , locks , steering and brakes

Many cars come with built-in software that run on an operating system in a similar way to phones and computers .

The CAN Hacking Tool -LRB- CHT -RRB- has four wires that are attached to the different outputs of a car 's Controller Area Network .

A
60p -LRB- $ 1 -RRB- computer chip is used to bypass any encryption on the car before
...
Hacking tools can be attached to a car 's Controller Area Network -LRB- CAN -RRB- , pictured . This diagram shows the electronic layout of a typical car and the features controlled by the CAN are shown along the black lines including lights , climate , seats , heating and locks
...
Toyota previously said it ` was n't impressed ' with Miller and Valasek 's hack and claimed its systems were robust and secure .
...
Gadget is fitted to the Controller Area Network -LRB- CAN -RRB- of a modern car
...
CAN Hacking Tool -LRB- CHT -RRB- runs malicious code into the car 's system
