...
A prototype toilet that generates ` everlasting ' electricity from urine has been launched near at a university bar -LRB- stock image used -RRB- . The scientists behind the ` pee-power ' toilet hope it can be used by aid agencies in disaster zones to supply much-needed electricity to refugee camps
...
` The microbial fuel cells -LRB- MFC -RRB- work by employing live microbes which feed on urine for their own growth and maintenance , ' explained Professor Ioannis Ieropoulos .
...
Prof Ieropoulos added : ` One microbial fuel cell costs about # 1 -LRB- $ 1.5 -RRB- to make , and we think that a small unit like the demo we have mocked up for this experiment could cost as little as # 600 -LRB- $ 900 -RRB- to set up , which is a significant bonus as this technology is in theory everlasting . '
...
Its inventors say the system could cost as little as # 600 -LRB- $ 900 -RRB- to set up