Nasa is preparing to test its next-generation space telescope in a giant thermal vacuum chamber , with stunning photos revealing engineers hard at work ahead of testing of the James Webb Space Telescope -LRB- JWST -RRB- .
...
Nasa is preparing to cryogenically test its new telescope in a vacuum chamber -LRB- shown -RRB- in Houston , Texas . The huge Chamber A at the Johnson Space Center is being refurbished to accommodate the telescope

The James Webb Space Telescope -LRB- JWST -RRB- will be a large infrared telescope with a 6.5-meter -LRB- 21ft -RRB- primary mirror .
...
Once fully assembled and launched into space , the telescope will allow scientists to explore ever further into the cosmos , seeing things that even the mighty Hubble Space Telescope ca n't .

Before the telescope is launched one million miles -LRB- 1.6 million km -RRB- into space to its destination , it must undergo a series of detailed tests to ensure it 's ready for the harsh environment of space .

This spring , a model of the telescope called Pathfinder will begin cryogenic optical testing inside this chamber .

` Maintaining the schedule with a very large number of optical and ground support equipment integration efforts , while securing the telescope to a suspension system inside the chamber and conducting a cryo-strength test is an incredible integration and test challenge , ' said Mark Voyton , manager for the Optical Telescope Element and Integrated Science Instrument Module -LRB- Otis -RRB- .

This coming spring a test model called Pathfinder will undergo cryogenic optical testing inside the chamber -LRB- engineers seen at the mouth bottom left -RRB- . A suspension system -LRB- right -RRB- inside the chamber will hold the telescope in place as it is cryogenically tested
...
Earllier in December the JWST 's Integrated Science Instrument Module -LRB- ISIM -RRB- structure endured a ` gravity sag test ' as it was rotated upside-down in what looked like a giant cube in a Nasa clean room at the Goddard Space Flight Center in Greenbelt , Maryland .
...
The James Webb Space Telescope 's Integrated Science Instrument Module -LRB- ISIM -RRB- structure recently endured a ` gravity sag test ' as it was rotated in what looked like giant cube in a Nasa clean room -LRB- pictured -RRB-
...
The ISIM is one of three major elements that comprise the Webb Observatory flight system . The others are the Optical Telescope Element -LRB- OTE -RRB- and the Spacecraft Element -LRB- Spacecraft Bus and Sunshield -RRB- .
...
The Secondary Mirror of the JWST Pathfinder -LRB- test -RRB- Telescope is shown here being stowed in the large cleanroom at Goddard Space Flight Center . Instrumentation will be added to the telescope arms to monitor temperatures during cryogenic testing in the Chamber A thermal vacuum facility at Johnson Space Center in 2015

@highlight

Nasa is preparing to cryogenically test its new telescope in a vacuum chamber in Houston , Texas
