...
` Since Twitter now allows users to interact in a similar way as Facebook -LRB- i.e. , write posts and upload images , videos , and location check-ins -RRB- , the researcher theorizes that the effects of Twitter use on interpersonal relationships are comparable to those associated with Facebook . '
