...
If Davies is correct , this would have been some sort of removable panel , covering a safety net , which was manned by an assistant . ` He -LSB- Holmes -RSB- needed at least two accomplices : one up top , one below , ' the actor said .

` Leaping off a second-floor balcony 's no big deal if there 's something to catch you at the bottom , if you 've dug yourself a big hole with a tightly sprung net inside -LSB- and -RSB- rigged up a camouflage frame -- which slides across . '
