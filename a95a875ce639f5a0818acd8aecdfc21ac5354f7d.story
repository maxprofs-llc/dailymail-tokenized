...
-LRB- Left -RRB- the mannequin compared to the standard size 10 model and -LRB- right -RRB- Lizzie Singleton from Debenhams dresses a new size 16 mannequin which are due to be rolled out in stores in the UK
...
-LRB- Left -RRB- the new size 16 mannequin and -LRB- right -RRB- both the size 16 and size 10 models displaying the same dress
...
campaign in 2010 -LRB- L -RRB- shows a model before and after airbrushing -LRB- R -RRB- in a
