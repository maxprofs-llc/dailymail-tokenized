...
Astronomers have managed to chart 219 million stars in the Milky Way in an incredible new map , which is the largest of its kind ever produced . Scientists at the University of Hertfordshire spent 10 years creating a map using a 8.2 ft -LRB- 2.5 metre -RRB- mirror on the Isaac Newton Telescope -LRB- INT -RRB- in the Canary Islands

Scientists at the University of Hertfordshire spent 10 years creating the map using a 8.2 ft -LRB- 2.5 metre -RRB- mirror on the Isaac Newton Telescope -LRB- INT -RRB- in the Canary Islands .
...
Astronomers created the map using a 8.2 ft mirror on the Isaac Newton Telescope -LRB- INT -RRB- in the Canary Islands
