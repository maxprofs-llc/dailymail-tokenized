...
Lancashire-based BAE Systems paid # 2.5 million -LRB- $ 3.7 million -RRB- for this setup and said the ` result is one of the most perfectly aligned fast jet airframes in the world . '

The Typhoon itself is 49ft -LRB- 15 metres -RRB- long from tip to tip and the material is ` no more than the thickness of a match stick . '
...
And it can fly from Lands End to John ` O Groats - a total of 603 miles -LRB- 970km -RRB- - in under 30 mins .
...
This means the jet -LRB- pictured -RRB- will be in ` near perfect alignment whatever the moon may be doing , ' said Martin Topping , Head of Typhoon Maintenance and Upgrade
...
. Lancashire-based BAE Systems paid # 2.5 million -LRB- $ 3.7 million -RRB- for this setup -LRB- pictured -RRB- and said the ` result is one of the most perfectly aligned fast jet airframes in the world '

Sensors on the helmet -LRB- pictured -RRB- ` talk ' to the fixed sensors on the aircraft so the Typhoon always knows exactly where the pilot is looking . Weapons sensors on the Typhoon track enemy aircraft and missile information and feed it back to the plane
...
The cockpit is made of glass and includes a wide-angle Head Up Display -LRB- HUD -RRB- , full-colour Multifunctional Head Down Displays -LRB- MHDDs -RRB- and Helmet Mounted Symbology System -LRB- HMSS -RRB- .

The cockpit is made of glass and includes a wide-angle Head Up Display -LRB- HUD -RRB- , full-colour Multifunctional Head Down Displays -LRB- MHDDs -RRB- and Helmet Mounted Symbology System -LRB- HMSS -RRB- . These displays and computer systems provide pilots -LRB- pictured -RRB- with information from sensors and flight instruments

Inside the cockpit , BAE Systems has designed lighting that is clear and legible at all times . The company 's Ambient Light Facility in Warton -LRB- Chris Gerrard , lighting test engineer is pictured -RRB- is specifically designed to replicate the full range of lighting conditions of each journey
...
And to reduce pilot workload , the Typhoon has a Voice Throttle and Stick -LRB- VTAS -RRB- system which means the pilot can keep his hand on the throttle and operate the majority of the aircraft 's controls from this position .
