...
The researchers even created a formula for predicting happiness .

Although the formula itself is complicated , put simply it looks at the event -LRB- t -RRB- , how important or significant that event is to that person -LRB- w -RRB- and when the event occurred , also known as the ` forgetting factor ' .
...
The researchers created a formula -LRB- pictured -RRB- for happiness .
Although the formula is complicated , put simply it looks at the event -LRB- t -RRB- , how important or significant the event is -LRB- w -RRB- and when the event occurred -LRB- y -RRB- . EVj is the reward for taking part , and RPE is the reward compared to the expectation
...
British
scientists found that day-to-day wellbeing does not reflect how well
things are going , but whether things are going better than expected .
...
While
low expectations can make us happy if they are exceeded later , having
high expectations to begin with make us happy earlier , the found .
...
A recent study found that the articiulation of vowels influence how we feel and that the most positive letter is ` i ' while the most negative - and likely to make us feel sad or grumpy -LRB- stock image -RRB- is ` o '
...
British scientists found that day-to-day
