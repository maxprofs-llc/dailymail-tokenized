...
Pigeon post : Pigeons were often used to carry messages from the front line when radio , Morse code and human runners had failed . Here an officer -LRB- far right -RRB- writes a message as the pigeon 's handler , having removed the bird from its cage , holds it upside down to attach the note
...
` But if I ca n't source an original object I can often find a replica on the internet . I 've even found items on eBay . ' Some things , however , are simply left to the artist 's instinct and Frank admits that ` there will always be an element of artistic licence in colourisation , but accuracy will always be striven for ' .
...
Entente Cordiale : A Tommy befriends two French children in June 1916 . Such images of the Franco-British alliance in action were useful propaganda but belied often edgy relations between soldiers and local civilians , who were accused of overcharging their defenders . The soldier belongs to the 15th Battalion , the London Regiment -LRB- Civil Service Rifles -RRB- , a unit raised from civil servant volunteers in the capital
