...
Screen readers for the blind are n't new , but they typically cost in the region of # 150 -LRB- $ 250 -RRB- to # 1,000 -LRB- $ 1,500 -RRB- .

But now a Massachusetts firm has developed a screen reading app for iOS devices that detects and reads any text aloud , and costs a relatively cheap $ 99 -LRB- # 60 -RRB- .

The KNFB Reader app is capable of scanning for text -- even within images - and converts it into speech automatically .

Scroll down for video

The $ 99 -LRB- # 60 -RRB- app is available for the iPhone 5 and above , running iOS 7 and higher . When a user wants to read text , they hold the device above the piece of paper , over the advert or at a shop window , and the app will scan for writing -LRB- pictured left -RRB- . Once it detects text and is in the best position , it takes a photo of it -LRB- pictured right -RRB-

The $ 99 -LRB- # 60 -RRB- app is available for the iPhone 5 and above , running iOS 7 and higher .
...
If the app does n't detect any text , or it is n't in the correct position , it will tell the user to either move the phone or the paper -- and it guides the user throughout .
...
And it does n't need a web connection to work , meaning it can be used underground and on planes when in Airplane mode .

This photo is then decoded and the speech begins almost instantaneously -LRB- pictured left -RRB- . The app supports English , French , German , Dutch , Italian , Spanish , Portuguese , Danish , Finnish , Swedish , and Norwegian - and works with all Braille displays supported by VoiceOver on iOS . Preferences menu is pictured right
...
App is available for iOS devices running iOS 7 or higher and costs $ 99 -LRB- # 60 -RRB-
