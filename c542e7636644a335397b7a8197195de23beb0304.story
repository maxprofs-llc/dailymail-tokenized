...
` Our culture does n't have a space for closeness without pressure .
...
` We 're not getting the right type of contact often enough ; we do n't give and get enough hugs .
...
In the event of an awkward or inappropriate cuddle , members can report the other user . Push notifications can alert users to requests -LRB- pictured -RRB- and the app also lets users share a picture of the cuddle

For potential cuddlers , users will see how many successful and unsuccessful cuddles they 've had in the past , using up and down arrows -LRB- pictured -RRB-
...
The app deliberately does n't feature a chat function , photo albums or shared interests because , as the developers explained , this can keep users from actually meeting .
...
In addition , the app does n't share the user 's location until they 've indicated they want to cuddle a chosen person , and users can be blocked .

The app does n't currently have filters for age or gender .

` We encourage you to consider cuddling with people who you would n't date , sleep with , or even find attractive - as well as those you would , ' said the developers .
...
The app is currently only available for iOS , but Mr Williams told the MailOnline the Android app is in the works , but is n't likely to launch until next year .
