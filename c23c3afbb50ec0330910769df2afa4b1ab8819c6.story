...
Researchers may have now taken a large step towards settling the debate after enlisting the help of magnetometers and ground-penetrating radar -LRB- GPR -RRB- .
...
Location , location , location : Roanoke Island is located just off what is now the state of North Carolina -LRB- seen in this 16th century map in red -RRB- . The area of recent interest is the section at the left centre of the map where the two rivers meet
...
Markings : Experts say the black spots on the image above show ditches that are distinctly different from Native American design . The image above right is a ground penetrating radar -LRB- GPR -RRB- image of the same area
...
Riddle in invisible ink : The map -LRB- left -RRB- of
...
the settlement when it was illuminated from underneath -LRB- right -RRB- in recent
...
The Museum of the Albemarle suggested the use of a proton magnetometer to enable the researchers to double-check their GPR findings , which can find objects buried about 13ft -LRB- four metres -RRB- underground .
...
Scientists are searching these areas using ground penetrating radar -LRB- GPR -RRB-
