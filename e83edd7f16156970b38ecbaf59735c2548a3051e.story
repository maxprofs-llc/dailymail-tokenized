...
Students at Oregon State University and Intel have devised a ` smart ' bike helmet -LRB- shown -RRB- that collects data during a crash . The ` black box ' has accelerometers and sensors to work out what happened . It also records the rider 's distance , speed and direction at all times
...
The helmet syncs with an app that can provide medical questions to the rider after a crash or call emergency services by asking the rider questions via a speaker -LRB- shown above the LED headlamp -RRB- . And the helmet can also play music or allow for hands-free calling

Inside the 3D-printed outer shell is a regular bike helmet -LRB- shown -RRB- . The product is only in the prototype phase at the moment so no potential release date or price has been announced
...
` Did they hit their heads ? Did they get really injured ? Because when they come back -LSB- after biking -RSB- they just say `` I got hurt , '' so we are n't really sure how bad it was .

` Could we build something that would help us understand ; -LSB- and -RSB- if a crash happens , the helmet can act like a black box ? '
...
The circuitry is stored in the back of the helmet -LRB- the white section in the image above -RRB- . The technology built into the helmet , such as the microphone and speakers , has other functions as well . For example , the speakers can be used to play music without covering the rider 's ears or for hands-free calling .
