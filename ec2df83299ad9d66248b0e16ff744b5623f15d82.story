...
sun at 488 miles -LRB- 785km -RRB- .
...
Surrey 's Surrey Space Centre -LRB- SSC -RRB- and Surrey Satellite Technology Ltd
-LRB- SSTL -RRB- are testing how gadgets that are available on the high street can
perform in space .
...
Indian Space Research Organizationís -LRB- ISRO -RRB- Polar Satellite Launch Vehicle , PSLV-C 20 lifts off from Sriharikota in Andhra Pradesh carrying the smartphone satellite
...
Also fitted on the 3.9 in -LRB- 10cm -RRB- x 11.8 in -LRB- 30cm -RRB- satellite - which weighs
9.5 lbs -LRB- 4.3 kg -RRB- - is a new Linux-based high-speed processor , an orbit
control system and two water-alcohol fuelled plasma thrusters .

The smartphone is pressed up against a side panel of the 30cm-long , 4.3 kg cubesat , so that it 's 5MP camera can look out and take pictures of the Earth and the Moon .
...
The STRaND-1 -LRB- which stands for Surrey Training Research and Nanosatellite Demonstration -RRB- is a joint project between Surrey Space Centre and Surrey Satellite Technology Limited , a world leader in small commercial spacecraft .
...
iTesa , which will record the magnitude of the magnetic field around the phone during orbit . Used as a precursor to further scientific studies , such as detecting Alfven waves -LRB- magnetic oscillations in our upper atmosphere -RRB- , the iTEsa app could provide proof of principle .
...
The first , known as the Water Alcohol Resisto-jet Propulsion De-orbit Re-entry Velocity Experiment -LRB- which benefits from the grand acronym Warp Drive -RRB- , will use the ejection of a water alcohol mixture to provide thrust .
...
' I ca n't wait to see what happens next . '
