...
The dinosaur range has been created by New York-based group , Elemental Path , who is currently attempting to raise $ 50,000 -LRB- # 32,500 -RRB- on Kickstarter to take the toys into production .
...
Early adopters can order the toy on Kickstarter for $ 99 -LRB- # 65 -RRB- . The toys are expected to begin shipping on November 1st .

Prototypes of the CogniToys dinosaur are already been created using 3D printing system -LRB- left -RRB- . Within the dinosaur , there is a speaker , microphone , battery pack , and a small piece of hardware that connects to the cloud . Pictured on the right is the IBM Watson supercomputer

The current design -LRB- illustration pictured -RRB- is aimed at children aged four to seven , and the system can be customised to include information such as the child 's name and age . Early adopters can order the toy on Kickstarter for $ 99 or a two-pack for $ 190 . The toys will begin shipping on November 1st
