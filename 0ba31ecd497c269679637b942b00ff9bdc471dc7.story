...
According to the Institute of Physics , metamaterials can bend electromagnetic radiation such as light around an object to give the appearance that it is n't there .
...
The strings of particles are connected using barrel-shaped molecules known as cucurbiturils -LRB- CBs -RRB- , which can be used to control the spacing between nanoparticles and lock them in place .
...
` We have controlled the dimensions in a way that has n't been possible before .
