...
Dorothy was created by Washington-based iStrategyLabs and is powered by an Arduino micro-controller with a built-in Bluetooth chip , accelerometer , and a cell battery , all inside a clip called Ruby . The Ruby attaches to any shoe -LRB- pictured -RRB- and connects wirelessly to the Dorothy iPhone app
...
A ` trigger ' is activated using three clicks of the heel , and these triggers can be customised . The prototype version 's triggers include receiving a call , sending a template text to three friends , or ordering a taxi -LRB- pictured -RRB- , but the firm is working on developing more options
...
The Dorothy gadget was inspired by the ruby slippers worn by Judy Garland in the 1939 film Wizard of Oz -LRB- pictured -RRB- . In the film , she clicks her heels together three times to magically transport back to Kansas

DJ Saul said the device -LRB- pictured -RRB- can also be used to get out of an awkward situation , by faking a phone call discreetly , and it can even be used a security measure to alert people when the wearer is in trouble . DJ Saul told MailOnline that the priority is to make the device smaller before discussing a release date or price
