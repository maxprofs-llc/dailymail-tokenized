...
Futuristic : Dr Themis Prodromakis -LRB- left -RRB- from Nano Group , ECS , University of Southampton and Philip King Director , right , of Newbury Electronics Ltd show off the chip
...
The word ` tricorder ' is a combination of ` tri - ' and ` recorder ' , referring to its three device input keys , which by default cover GEO -LRB- geological -RRB- , MET -LRB- meteorological -RRB- , and BIO -LRB- biological -RRB- functions .
