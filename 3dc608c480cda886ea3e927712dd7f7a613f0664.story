...
providers -LRB- ISPs -RRB- must install a special device - at their own considerable expense - on their servers to allow
the FSB to track all credit card transactions , e-mail messages and internet use .

Then in 2000 , Russia 's Minister of Information Technology and Communications Leonid Reiman issued order 130 that concerned ` the introduction of technical means ensuring investigative activity -LRB- SORM -RRB- in phone , mobile and wireless communication and radio paging networks ' .
...
The longest torch relay before a Winter Olympics will show off Russia 's variety as well as its sheer scale of taking the flame though all 83 regions in a more than 65,000 km -LRB- 40,400 mile -RRB- journey around the world 's biggest country .
