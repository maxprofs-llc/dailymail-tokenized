...
Mr Coleman -LRB- above -RRB- said : ` CommBank asked us to create the image to launch ` Where 's My Wallet ' , which is an interactive online game that allows Aussies to search the city of Sydney for virtual lost wallets worth $ 200 '
...
Jessica Myers -LRB- above -RRB- from CommBank , says the image is ` pushing boundaries ' for the bank
