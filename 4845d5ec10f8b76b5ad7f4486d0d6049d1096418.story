...
The hot spot , near the Four Corners intersection of Arizona , Colorado , New Mexico and Utah , covers only about 2,500 square miles -LRB- 6,500 square kilometers -RRB- , or half the size of Connecticut .

A recent Nasa map shows is produces more than triple the standard ground-based estimate - and researchers say they do n't know why . .

Scroll down for video

The Four Corners area -LRB- red -RRB- is the major U.S. hot spot for methane emissions in this map showing how much emissions varied from average background concentrations from 2003-2009 -LRB- dark colors are lower than average ; lighter colors are higher -RRB- . The hot spot , near the Four Corners intersection of Arizona , Colorado , New Mexico and Utah , covers only about 2,500 square miles .
...
Other investigators are from the Cooperative Institute for Research in Environmental Sciences -LRB- CIRES -RRB- in Boulder , Colorado ; the National Oceanic and Atmospheric Administration -LRB- NOAA -RRB- ; and the University of Michigan , Ann Arbor .
...
The Next-Generation Airborne Visible/Infrared Imaging Spectrometer -LRB- AVIRISng -RRB- , which observes spectra of reflected sunlight , flies at a higher altitude and will be used to map methane at fine resolution over the entire region .

Using this information and ground measurements from the other research teams , the Hyperspectral Thermal Emission Spectrometer -LRB- HyTES -RRB- will fly over suspected methane sources , making additional , highly sensitive measurements of methane .

Depending on its flight altitude , the NASA aircraft can image methane features with a spatial resolution better than three feet -LRB- one meter -RRB- square . In other words , it can create a mosaic showing how methane levels vary every few feet , enabling the identification of individual sources .
...
In the study published online today in the journal Geophysical Research Letters , researchers used observations made by the European Space Agency 's Scanning Imaging Absorption Spectrometer for Atmospheric Chartography -LRB- SCIAMACHY -RRB- instrument , which measured greenhouse gases from 2002 to 2012 .
...
Research scientist Christian Frankenberg of NASA 's Jet Propulsion Laboratory -LRB- JPL -RRB- in Pasadena , California , first noticed the Four Corners signal years ago in SCIAMACHY data .

` We did n't focus on it because we were n't sure if it was a true signal or an instrument error , ' Frankenberg said .
...
` Satellite data can not be as accurate as ground-based estimates , but from space , there are no hiding places , ' Frankenberg said .
