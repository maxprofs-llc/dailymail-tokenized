...
` Researchers have been fascinated for decades by the differences in behaviour between chimpanzee communities ; some use tools some do n't , some use different tools for the same job , ' said Dr Catherine Hobaiter of the University of St Andrews in Scotland .
...
Different individuals were observed to develop two novel variants : moss-sponging -LRB- a sponge made of moss or a mixture of leaves and moss -RRB- and leaf-sponge re-use -LRB- using a sponge left behind on a previous visit -RRB- .
...
The researchers investigated the spread of new variations of ` leaf-sponges ' , which are tools dipped in water to drink from , commonly manufactured by the Sonso chimpanzees by folding leaves in their mouth -LRB- pictured -RRB-
