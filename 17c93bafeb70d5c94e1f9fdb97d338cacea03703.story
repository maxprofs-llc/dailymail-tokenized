...
Frustration : Students argue that a question was ` impossible to answer using the data provided ' in a chemistry exam on Tuesday -LRB- file pic -RRB-
...
They argue that one question was ` impossible to answer using the data provided ' while some claim there was n't enough time to complete the difficult paper .
...
Another said : ' I know that a lot of students spent a long time trying to work out a rational answer and so ran out of time to answer other questions . I feel sorry for a lot of people who are now worried that they wo n't get into university because of this exam . '
...
` However , the alternative ratio given in A6 -LRB- d -RRB- -LRB- ii -RRB- leads to an answer that is different to what students would normally expect to see .
