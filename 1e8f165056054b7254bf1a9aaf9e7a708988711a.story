...
Forensics experts are building chemical profiles of popular fragrances in a lab -LRB- pictured -RRB- to help them identify scents left on clothing and items touched by offenders . They hope that by building up a ` scent profile ' of the person behind a crime , it can help to narrow down lists of suspects and even be used as evidence in court
...
Experts from Staffordshire University said there is a complex mixture of different personal care products that can be used together to narrow down a list of suspects . For example , Chanel No 5 -LRB- left -RRB- uses a particular aldehyde and could reveal details of a person 's background.Lynx -LRB- right -RRB- tends to be used by younger men
