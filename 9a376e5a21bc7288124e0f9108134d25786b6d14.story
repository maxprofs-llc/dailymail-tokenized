...
The famous image was re-created with an atomic force microscope and a process called ThermoChemical NanoLithography -LRB- TCNL -RRB- .
...
Jennifer Curtis , an associate professor in the School of Physics and lead author of the study that was published in journal Langmuir , said : ` By tuning the temperature , our team
manipulated chemical reactions to yield variations in the molecular
concentrations on the nanoscale .

` The spatial confinement of these
reactions provides the precision required to generate complex chemical
images like the Mini Lisa . '

The famous image was re-created with an atomic force microscope -LRB- pictured -RRB- and a process called ThermoChemical NanoLithography -LRB- TCNL -RRB- . Going pixel by pixel , scientists positioned a heated cantilever at the substrate surface to create a series of confined nanoscale chemical reactions
...
Professor Curtis -LRB- pictured -RRB- said technique should enable a wide range of previously inaccessible experiments and applications in fields as diverse as nanoelectronics , optoelectronics and bioengineering
