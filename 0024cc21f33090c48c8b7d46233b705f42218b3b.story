...
The memo said : ` The expression the Dowler test has pushed its way into the popular political lexicon , when in fact it does n't exist . Not yet that is . We need to define what the Dowler test actually is . '
...
The Hacked Off document said : ` He -LRB- Cameron -RRB- would favour a robust form of self-regulation as long as it passed the Dowler test . We can use these words against him . Defining the Dowler test is key .

The Prime Minister can not go back on it . The opposition must not be allowed to define it , we must . '
