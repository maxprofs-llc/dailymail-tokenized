...
on old devices and versions -LRB- pre-Android 3.0 -RRB- and does not reflect the
...
The phones were all bought from eBay -LRB- image shown -RRB- . These were phones where the previous owners had performed a factory reset or a ` delete all ' operation on their devices with in-built software , apparently to no avail . More than 80,000 used smartphones are for sale daily on eBay in the U.S. , according to Avast
...
3 . For added protection you then need to load your phone with ` dummy ' data , such as stock photos and video , so people ca n't steal your identity .
