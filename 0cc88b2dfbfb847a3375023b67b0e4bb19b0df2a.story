...
The researchers used electroencephalography -LRB- EEG -RRB- headsets to record electrical activity from neurons firing in the brain , and convert the words ` hola ' and ` ciao ' into binary .

The researchers used electroencephalography -LRB- EEG -RRB- headsets which recorded electrical activity from neurons firing in the brain to convert the words ` hola ' and ` ciao ' into binary . In EEG , electrical currents in the brain are linked with different thoughts that are then fed into a computer interface
...
The receiver 's brain -LRB- pictured -RRB- was stimulated -LRB- areas shown by dots -RRB- to see sequences of light that could be decoded into a message . Researchers then conducted a similar experiment in which thoughts were successfully transmitted from two participants , one in Spain and one in France
