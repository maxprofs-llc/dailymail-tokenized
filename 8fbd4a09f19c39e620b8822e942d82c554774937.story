...
The Nymi is a lightweight , wearable wristband which authenticates a user 's identity through their electrocardiogram -LRB- ECG -RRB- - or heartbeat rhythm .
...
When the Nymi is activated , it communicates a secure , digitally signed identity credential via Bluetooth Low Energy -LRB- BLE -RRB- to smart devices - everything from a smartphone , to a vehicle , to a locked door .
