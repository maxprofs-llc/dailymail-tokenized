...
` Once the bug report becomes public -LRB- typically once a patch is available -RRB- , you 'll be able to monitor vendor time-to-fix performance , see any discussion about exploitability , and view historical exploits and crash traces .
