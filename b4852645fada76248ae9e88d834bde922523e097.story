...
Journalist and security expert Jacob Appelbaum used his slot at the event to pull back the curtain on the National Security Agency 's arsenal of high-tech spy gear including how it can use radar wave devices to harvest electronic information from computers , even if they are n't online .
...
A backdoor is a hidden remote access from an outside source to the device -LRB- stock image pictured -RRB- that enables the hacker to have almost full access with little detection
...
Another slide showcased a futuristic-sounding device described as a ` portable continuous wave generator , ' a remote-controlled device which - when paired with tiny electronic implants - can bounce invisible waves of energy off keyboards and monitors to see what is being typed , even if the target device is n't connected to the internet .

A third slide showcased a piece of equipment called NIGHTSTAND , which can tamper with wireless internet connections from up to eight miles -LRB- 13 kilometers -RRB- away .

An NSA spokeswoman , Vanee Vines , said that she was n't aware of Appelbaum 's presentation , but that in general should would not comment on ` alleged foreign intelligence activities . '
...
The investigation followed earlier reports of the NSA -LRB- headquarters pictured -RRB- spying on Apple products , which suggested a ` backdoor ' in iOS could provide hackers with valuable information . Apple said at the time that it had never worked with the NSA to deliberately weaken its products

The documents included in Appelbaum 's presentation were first published by German magazine Der Spiegel on Sunday and revealed details about the undercover work carried out for the NSA by an elite team of hackers known as Tailored Access Operations -LRB- TAO -RRB- .
...
When agents with the TAO division want to infiltrate a network or a computer , they turn to their technical experts known as Advanced Network Technology -LRB- ANT -RRB- , which produces tools for penetrating network equipment and monitoring mobile phones and computers .

ANT 's products have helped TAO agents infiltrate networks and divert or even modify data wherever the NSA 's usual methods are n't enough .

TAO has a catalog of
high-tech gadgets for hard-to-crack cases , including
computer monitor cables specially modified to record what is being typed
across the screen , USB sticks secretly fitted with radio transmitters
to broadcast stolen data over the airwaves , and fake base stations
intended to intercept mobile phone signals on the go .
...
These tools have n't just been used exclusively to track suspected terrorists . GSM base stations , for example , make it possible to monitor mobile phones , such as that belonging to German Chancellor Angela Merkel .
...
The catalog is n't up to date and many of the software solutions on offer date from 2008 . As a result some apply to server systems or mobile phone models that are no longer on the market .
...
The NSA has also targeted products
made by well-known American manufacturers and found ways to break into
professional-grade routers and hardware firewalls , such as those used by
internet and mobile phone operators .
...
Appelbaum and Der Spiegel have both
played an important role in the disclosures of NSA leaker Edward
Snowden , but neither has clarified whether the most recent set of slides
came from Snowden .
...
They can also use radar wave devices to harvest electronic information from computers , even if they are n't online
