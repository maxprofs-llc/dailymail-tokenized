...
optical fibre , which was developed by Japanese firm Nippon Telegraph and Telephone Corporation -LRB- NNT -RRB- .
...
The speed achieved means that the experts could use the network to download a one gigabyte film in 0.2 milliseconds , which is faster than the time it takes a person to blink . It is hoped that faster networks will make slowing loading screens -LRB- pictured -RRB- a thing of the past
...
This is an illustration of an air waveguide . The filaments leave ` holes ' in the air -LRB- red rods -RRB- that reflect light . Light -LRB- shown by arrows -RRB- passing between these holes stay focused and intense
