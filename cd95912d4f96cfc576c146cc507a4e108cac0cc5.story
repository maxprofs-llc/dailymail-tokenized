...
Romanian company MB Telecom has revealed the Roboscan 2M Aeria . It uses a cone of radiation to sweep across planes -LRB- shown -RRB- and look inside . The device is accurate enough to find a filament in a light bulb . But the radiation it emits is not safe for passengers yet

The Roboscan 2M Aeria is being developed by Romanian company MB Telecom -LRB- MBT -RRB- .

It costs $ 3 million -LRB- # 2.1 million , $ 3.2 million -RRB- , reported The Times , and is apparently already being used to check trucks at borders in Eastern Europe , where it has helped seize 76,000 packs of illegal cigarettes .
...
The device can be used to detect weapons -LRB- shown -RRB- and other contraband in small or medium-sized jets that land at low-security airports
...
` You can not touch it , but you can scan it , ' said Radu Tudor of MBT at the Counter Terror Expo in London this week .

There are four main components that allow an aircraft to be scanned . The first is the operating truck -LRB- shown -RRB- , from which an operator can use the system and look inside the plane

The plane is pulled forwards through the scanner by a battery-operated tug -LRB- shown -RRB- over a wide detection module . By firing X-rays out of the arm , a cone of radiation sweeps over the plane
