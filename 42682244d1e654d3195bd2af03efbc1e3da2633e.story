...
Joachim Kempin , a former Microsoft executive who oversaw the building of the Windows brand , told the BBC last month that he believes Ballmer ` does n't have the vision ' to be CEO .
...
and do n't see the familiar ` start ' button and menu .
...
learning curve -LSB- to Windows 8 -RSB- and we can work to address that . '
...
The tune-up announced on Tuesday wo n't be released to consumers and businesses until later this year .
...
For now , Microsoft is n't saying what kind of changes will be introduced with the release of Blue , which the company plans to anoint with a different name when the update is available .

Microsoft also is n't saying whether it will charge existing owners of Windows 8 devices to get the fixes in Blue . The company plans to release Blue in time for the holiday season .
...
But one thing that Blue wo n't fix : the relatively small selection of mobile applications tailored for Windows 8 . Ms Reller said the Windows 8 store now has more than 60,000 apps .
...
In one of the most glaring omissions on Windows 8 , Facebook Inc. still has n't designed an app to make its online social network more accessible on that system .
