...
A ham radio operator from Poland has received images from the ISS . On Reddit he revealed his low-cost method to talk to cosmonauts . He used a USB dongle known as an RTL-SDR to receive sounds . When decoded these were revealed to be images of Russian space history -LRB- postcard of Yuri Gagarin shown -RRB-
...
Over the weekend , the Russians decided to use a picture transmission method known as slow-scan television -LRB- SSTV -RRB- to relay images to Earth .
...
` Images are transmitted using the Slow Scan Television -LRB- SSTV -RRB- protocol , ' Mr Karwacki explained on imgur , where he posted the images .
...
To receive the images and sounds , Mr Karwacki said he used an RTL-SDR USB dongle -LRB- shown -RRB- , an antenna , the SDRSharp programme to receive the data and MMSTV software to decode it
...
The software is available free online , while such a dongle costs around # 10 -LRB- $ 15 -RRB- .
...
Astronauts and cosmonauts on the International Space Station -LRB- pictured -RRB- regularly communicate with amateur radio - also known as ham radio - operators back on Earth
