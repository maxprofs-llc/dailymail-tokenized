...
The results revealed that at least six per cent -LRB- 400 out of the 6588 participants -RRB- learnt ` many of their matches ' from the Fisher-Price set .
...
The colours in the toy -LRB- upper row -RRB- , the average colour choice for each letter from the 6188 synesthetes -LRB- middle row -RRB- , and the most commonly assigned colour for each letter for the 400 synesthetes are shown here . Fig C shows when the choice does not match the toy -LRB- bottom row -RRB-
...
` This indicates learning of letter-colour pairings from external -LSB- sources -RSB- can occur in a substantial fraction of synesthetic , and are consistent with the hypothesis that synesthesia is a kind of conditioned mental imagery . '
