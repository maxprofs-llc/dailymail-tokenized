...
Punishment : Courts will have the power to issue the U.S.-style electronic tag -LRB- pictured , a SCRAM tag -RRB- , which records the convict 's alcohol intake by measuring air and perspiration emissions from the skin every half hour
...
` The Alcohol Abstinence and Monitoring Requirement -LRB- AAMR -RRB- requirement is already law . Under the AAMR , an individual can be required to abstain from alcohol for a fixed period of time as part of a community order or suspended sentence order .
