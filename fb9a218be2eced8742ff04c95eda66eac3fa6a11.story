...
However , despite the lush colours of autumn , temperatures were set to plunge as low as -3 C , in a sign that winter is not too far away .
...
Big freeze : Temperatures are set to fall as low as -3 C in parts of Britain as winter starts to bite
...
In Aberdeen , it is set to be as cold as -3 C as winter starts to bite in Britain 's extreme north .
...
Weather experts said balmy continental air was responsible for keeping temperatures more than 1.5 C above average , making it the ninth warmest October since 1910 .
...
` The temperatures were well above by 1.7 C degrees across the UK . The average temperature for the UK for the month is 9.49 C - we had 11.2 C.

` Many weather stations in Southern Scotland did not even record one night of air frost .

` The average temperature for England in October is 10.38 C , but we had an average of 12.2 C last month , according to intermediary data .
...
But rain is set to return overnight as temperatures fall to 5C in London and as low as -3 C in parts of Scotland