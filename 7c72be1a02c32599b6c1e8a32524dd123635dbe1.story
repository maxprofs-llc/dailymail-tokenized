...
A previous study by the publication revealed that brands have abandoned support for some of the TVs that are a few years old -- rendering them less smart because some apps -LRB- illustrated -RRB- could n't be accessed
...
Coined the ` red-button attack ' - named after the red button used on modern smart TV remotes to access additional content - the flaw can be exploited with a $ 250 -LRB- # 150 -RRB- transmitter .
...
This would be done by using a simple amplifier , on a rooftop to hijack networks across an area of 0.5 square miles -LRB- 1.4 square kilometres -RRB- .
...
Samsung , LG , Panasonic and Toshiba all push adverts onto a TV 's homescreen , and while users can stop them being targeted , they can not be blocked completely .
...
If they ca n't agree , or either party changes their technology or software , consumers can lose services .
...
If an older TV does n't meet these requirements , customers will get a poorer experience and Netflix could develop a reputation for providing a sub-standard service .
...
` Yet in the middle of this , consumers can lose out . Since the product itself has n't developed a physical fault , it 's a grey area for consumer rights . '
...
If viewers reject conditions they ca n't access some features on their TV sets - and Samsung and Toshiba owners ca n't use them at all