...
Execution chamber : The American Pharmacists Association has approved a proposal declaring that participation in lethal injection executions by compounding pharmacies would be a violation of core pharmacy values -LRB- file photo -RRB-
...
Texas ' prison agency scrambled this month to find a supplier to replenish its inventory before getting drugs from a compounding pharmacy it wo n't identify .

Texas Department of Criminal Justice spokesman Jason Clark said Monday that he had no comment when told about the ruling .

Concerns : Pharmacists now join doctors in having national associations with ethics codes that restrict credentialed members from participating in executions -LRB- file photo -RRB-

After a troubling use of a two-drug method last year , Ohio said it will use compounded versions of either pentobarbital or sodium thiopental in the future , though it does n't have supplies of either and has n't said how it will obtain them .
...
Tennessee has approved the use of the electric chair if lethal-injection drugs are n't available , while Utah has reinstated the firing squad as a backup method if it ca n't obtain the drugs . Oklahoma is considering legislation that would make it the first state to allow the use of nitrogen gas as a potential execution method .
