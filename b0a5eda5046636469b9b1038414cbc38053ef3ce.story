Nasa has released an incredible image that shows the dizzying array of colours that can be seen emanating from the sun in wavelengths that can not be seen by the human eye .
...
The wavelengths SDO observes , measured in Angstroms -LRB- a measurement used to express the sizes of atoms , molecules -RRB- :
