...
In a scathing attack on practices within the force at the height of the scandal , Her Majesty 's Inspectorate of Constabulary -LRB- HMIC -RRB- savaged the ` unacceptable ' culture within its public protection unit .
...
But during that period there were ` only three officers across the whole force with a permanent responsibility for CSE -LSB- child sexual exploitation -RSB- ' .
...
It said : ` We found that where a victim is vulnerable , either through age or mental health issues , and it appears that there is any doubt regarding the authenticity of the report , a no-crime -LSB- report -RSB- is often submitted . '
