...
The National Crime Agency and the Government Communications Headquarters -LRB- GCHQ -RRB- will use the latest technology to crackdown on users of the so called dark net , or deep web .
...
Hidden capabilities that enable users to email and host file storage through encrypted and anonymous networks are provided by services like the The Onion Router -LRB- TOR -RRB- .
...
GCHQ and National Crime Agency to use latest technology to track down dark net users who are sharing child pornography over secret networks
