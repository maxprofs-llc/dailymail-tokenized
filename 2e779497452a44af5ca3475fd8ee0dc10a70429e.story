...
This # 65 -LRB- $ 100 -RRB- smart cat scale claims to be the answer , providing alerts on what your pet has been up to and monitoring their health , weight and waste .

And the device will also be used to see if it 's true that cats can detect oncoming earthquakes .

Scroll down for video

A San Diego-based company has designed a smart litter box for cats -LRB- pictured -RRB- . Called Tailio the internet-enabled scale is placed under a regular box . It then sends information on a cat 's habits to a smartphone app . It can monitor the health and weight of a cat and provides alerts
...
` Tailio will alert you if they have n't shown up to the litter box in their usual routine , so you can see what may be needed , ' the company writes .
