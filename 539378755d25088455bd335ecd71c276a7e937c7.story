...
Using binary principles , Muller assigned two bits of information for each molecule in DNA , and converted these bits into bytes to discover the entire code equates to just 1.5 GB .

Scroll down for video

Human genetic code is contained in a sequence of four molecules , represented by letters A , T , G and C. Each can be encoded with two bits of binary information - 00 , 10 , 11 , 01 . When multiplied by 6 billion letters , and divided by eight bits per byte , a physician claims the entire code contains just 1.5 GB of data
...
byte , Muller worked out the entire code contains just 1.5 GB of
data .

Expanding this
further , Muller continued that each cell in the human body contains this
1.5 GB of data , and there are 40 trillion cells .
...
In 1963 , the American Standard Code for Information Interchange -LRB- ASCII -RRB- stated there are seven bits of information to encode all of the letters in the alphabet , including upper and lower case letters and symbols .
...
Each can be encoded with two bits of information - 00 , 10 , 11 , 01 - and when multiplied by the 6 billion letters , then divided by eight bits per byte , Muller worked out the entire code contains just 1.5 GB of data .

Expanding this further , Muller continued that each cell in the human body contains this 1.5 GB of data , and there are 40 trillion cells .

This works out at 60 zettabytes of information , or 60 followed by 21 zeros .

Furthermore , because 99.9 per cent of this information is shared with other humans , less than one part in a 1,000 is unique - and this small amount of data could easily fit on a floppy disk -LRB- stock image pictured -RRB-
...
A human 's genetic code contains 6 billion letters and when this divided by eight bits per byte , it equates to 1.5 GB per human
