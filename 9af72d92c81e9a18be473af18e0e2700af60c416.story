...
As of this week , Microsoft is retiring its iconic Clip Art tool -LRB- pictured -RRB- and replacing it with Bing Image search . Customers can also still add images from their own files saved on their PC , SharePoint and OneDrive
...
Clicking a link to the source of the image reveals the details of an image 's license , and any conditions . Google has a similar tool . The Bing filters can be accessed by going to the Images tab and selecting License -LRB- left -RRB- On Google , the filters are under Search Tools and Usage rights -LRB- right -RRB-
...
Microsoft did n't add clip art files to its software until 1996 . It began with 82 images and its library closed with more than 140,000 files .
