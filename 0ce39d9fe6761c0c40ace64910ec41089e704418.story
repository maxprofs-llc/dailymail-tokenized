...
Pedius -LRB- pictured -RRB- uses voice recognition and speech translation to make calls more natural . When a call is made using the app the user types a message on the screen . This is translated to speech in real time , so the recipient can ` hear ' them . The recipient 's spoken response is then immediately translated into text
...
` Of course , a human translator wo n't fit in your pocket , and they may not always be able to accompany you to that very authentic Thai restaurant or overseas vacation , ' explained Verbalink .

` When you need immediate results , and they do n't have to be perfect , it 's OK to use Google Translate .

' -LSB- But -RSB- for any sort of business or commercial documents , or anything that has to be precise , it 's best to stick with human translators . '
...
A similar app called Be My Eyes takes advantage of an iPhone feature called VoiceOver , to help blind people use the device with synthetic speech . To ask for help , a blind person opens the app and requests assistance . This can be anything from knowing the expiry date on the milk -LRB- pictured -RRB- , to navigating new surroundings
