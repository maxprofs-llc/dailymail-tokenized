...
The malicious drive has been dubbed ` USB Killer ' and it uses a high voltage and current to ` fry ' the laptop 's components . The prototype -LRB- pictured -RRB- was created by a Russian electronics expert known as Dark Purple
...
The English post said : ` I work in -LSB- a -RSB- company engaged in the development and manufacture of electronics .

` In modern computers , the USB ` physics ' is built in the processor -LSB- and -RSB- the task of the designed USB flash drive is to burn all of this stuff , or at least kill the USB port . '

Dark Purple posted photos and specifications about his project on Russian blog Habrahabr . The user said : ` In modern computers , the USB ` physics ' is built in the processor -LSB- and -RSB- the task of the designed USB flash drive is to burn all of this stuff , or at least kill the USB port ' -LRB- the custom circuit board is pictured -RRB-
...
` When connected to the USB port , an inverting DC/DC converter runs and charges capacitors to -110 V -LSB- and -RSB- when the voltage is reached , the DC/DC is switched off .
