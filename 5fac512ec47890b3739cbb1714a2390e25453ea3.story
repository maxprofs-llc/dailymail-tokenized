...
` Thousands of planet candidates have been seen to transit in only optical light , ' said Katja Poppenhaeger of Harvard-Smithsonian Center for Astrophysics -LRB- CfA -RRB- in Cambridge , Massachusetts .
...
The observations , made using Nasa 's Chandra X-ray Observatory -LRB- pictured -RRB- , could be the first time such a collision has been detected in X-rays
...
An X-ray image shows the main star -LRB- middle -RRB- . The source in the lower right is the faint companion star . The source at the bottom of the image is a background object not contained in the HD 189733 system
