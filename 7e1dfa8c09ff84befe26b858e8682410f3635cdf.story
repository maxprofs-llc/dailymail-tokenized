...
He then reduces the sizes of some of the stars so they do n't block the view of the nebula , before improving the contrast and creating the final image .

This image shows the intermediate spiral galaxy NGC 3982 before -LRB- left -RRB- and after -LRB- right -RRB- colour is added to the image to highlight some of its key features
...
` The colours in Hubble images , which are assigned for various reasons , are n't always what we 'd see if we were able to visit the imaged objects in a spacecraft , ' Nasa said on their Hubble website .
