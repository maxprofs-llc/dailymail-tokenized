Google Wallet says it has changed its policy when storing users ' funds as they will now be federally-insured -LRB- file photo -RRB-

For those who use Google Wallet , their money just became safer with federal-level insurance .

Google confirmed to Yahoo Finance in a statement that its current policy changed - meaning the company will store the balances for users of the mobile transfer service -LRB- similar to PayPal and Venmo -RRB- in multiple federally-insured banking institutions .
...
The policy states that ` funds held by Google Payment Corp. or its service providers -LRB- including any bank service providers -RRB- in connection with the processing of Payment Transactions are not deposit obligations of Buyer , and are not insured for the benefit of Buyer by the Federal Deposit Insurance Corporation or any other governmental agency ' , according to 9to5 .
