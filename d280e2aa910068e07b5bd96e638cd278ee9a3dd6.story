...
This means that all cookies , history , tabs and windows are deleted - and ca n't be recovered .
...
A web browser tracks a user by storing information as the user browses web pages . This includes history , images , videos , text and other data on these pages . As a result , browsers offer a privacy mode so the user can browse without being tracked . On Google 's Chrome , this is called Incognito Mode -LRB- pictured -RRB-

In November , Firefox launched a Forget button.The button can be added to the browser and will automatically delete browsing history -LRB- pictured -RRB-

As the files explained : ` -LSB- Patent -RSB- relates to equipping a web browser with the ability to automatically open web pages in a privacy mode based on content of the web pages so that a user is not required to manually activate the privacy mode .
