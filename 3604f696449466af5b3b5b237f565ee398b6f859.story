...
DeepFace uses a 3-D model to rotate faces , virtually , so that they face the camera . Image -LRB- a -RRB- shows the original image , and -LRB- g -RRB- shows the final , corrected version which the software can then attempt to recognise .
