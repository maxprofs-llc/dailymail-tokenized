...
The year aims to raise awareness of the achievements of light science , its applications , and its importance to humankind . This beautiful scene in the Gippsland Lakes in south eastern Australia , shows bioluminescence as well as stars in the Milky Way . It 's produced by a chemical reaction inside a living organism . Most bioluminescence occurs in deep water where sunlight can not reach
...
Natural wonders such as dramatic lightning strikes against city spaces -LRB- pictured -RRB- are included in the gallery . This image shows the Burj Khalifa in Dubai . In storm clouds , the friction between particles builds up a large separation of electric charge , creating voltages approaching 100 million volts . This causes a discharge that heats the gas around it to ten thousand degrees , causing a bright glow observed as a lightning bolt
...
This intriguing photo shows a ` sun dog ' - a pair of bright lights seen on either side of the sun , typically when it is setting . Sun dogs belong to a large class of atmospheric phenomena caused by the bending of sunlight by small ice crystals in the air . The crystals act as prisms , bending the light rays . If the crystals are randomly oriented in the atmosphere , a complete ring around the Sun a halo is seen -LRB- shown -RRB-

Optical fibres -LRB- shown -RRB- - hair-thin flexible strands of glass or plastic - carry massive amounts of data in the form of light and serve as the backbone of the Internet . They can be used in endoscopes for imaging the interiors of both people and machines . or as fibre lasers , can generate light energy to cut everything from human tissue to thick steel
