...
They will have to do this every time they send a customer a quote for an annuity -- when a pension pot is turned into a fixed income for life . The Financial Conduct Authority -LRB- FCA -RRB- said that using a ` simple quote comparison ' would expose bad-value contracts .

Under new rules to be introduced in the UK next year , firms will have to advertise what deals rival firms are offering and how much more retirees could earn if they switched to a different provider -LRB- file picture , posed -RRB-
...
The Financial Conduct Authority -LRB- FCA -RRB- said that using a ` simple quote comparison ' would expose bad-value contracts and the new regulations would ` prompt customers to consider the benefits of shopping around '
