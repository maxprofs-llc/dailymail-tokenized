...
` If drivers are of the opinion that there is some flexibility around speed limits the danger is that when it comes to lower speed limits , which are much more crucial in road safety , we do n't want drivers to have that same flexibility .

` Driving at 40mph in a 30mph area is incredibly dangerous . '

He called for variable limits for different times of the day . ` In the UK we do n't trend to treat our drivers as intelligent .
...
AA claims the ` default limit ' is now 80mph because police wo n't prosecute
