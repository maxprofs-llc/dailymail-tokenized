...
Glasgow-based experts at retailer liGo have now created an interactive guide -LRB- pictured -RRB- that reveals how to save battery life using tips specific to individual phones , such as Apple 's iPhones , HTC and Samsung 's range of devices , and Sony 's handsets . Tips scroll across the screen
...
The reason this drains battery is because , even when the phone is n't being used , these apps use a network to pull in data . This tip applies to Samsung 's Galaxy S5 , too .
...
Apple iPhone 5S -LRB- pictured -RRB- users can save battery by disabling Handoff . Handoff allows users to pass over work to other iCloud devices . It is disabled through Settings , General and Handoff & Suggested Apps . The guide does assume that smartphone owners are running the most up-to-date version of operating system available
...
And for Windows Phone users , seen on the Lumia range of devices and HTC One -LRB- M8 -RRB- for Windows , limiting what tiles are pinned to the start will reduce power usage .
