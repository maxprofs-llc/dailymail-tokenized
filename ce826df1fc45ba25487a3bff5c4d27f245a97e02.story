...
One image reveals the name ` iTime ' -LRB- pictured left -RRB- , although an ` iWatch ' patent was filed in 2013 so it 's still unclear what the device will be called when it 's eventually released . The patent images resemble the iWatchz Kube band sold as an official accessory on the Apple store , fitted with an iPod Nano -LRB- pictured right -RRB-

Images also reveal the electronic device could slot in , and out , of the band similar to the Fitbit or Withings Pulse O2 activity trackers -LRB- pictured -RRB-
...
Examples detailed in the patent include ` a horizontal movement for one user input option -LRB- e.g. , decline incoming call -RRB- , and might be a vertical movement for another user input option -LRB- e.g. , accept incoming call -RRB- . '
