...
Is this the future of gardening ? U.S. students have created a prototype autonomous machine -LRB- pictured -RRB- that not only cuts grass in a specified area , but uses the waste cuttings to power itself - potentially saving gardeners both time and money
...
The machine trims grass using a low-power electrical bar cutter -LRB- pictured -RRB- unlike many mowers that use a rotating blade
...
The grass pellets pass into a small gasifier -LRB- illustrated -RRB- where they are converted to gas and the resulting fuel is cooled , filtered and mixed with air
...
In the future users of the robotic lawnmower will be able to program the machine by selecting an area to mow using Google Maps -LRB- pictured -RRB- - and tell the mower to avoid certain obstacles so flowerbeds are not cut down too
