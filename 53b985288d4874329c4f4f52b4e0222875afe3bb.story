...
The development of Sovaldi -LRB- sofosbuvir -RRB- has been hailed as a ` game-changer ' in the treatment of the illness .
...
Prof Foster adds : ` Later this year we expect to see the availability of other new drugs , which we can combine with sofosbuvir . This will allow us to stop using interferon , which causes the worst side effects and ca n't be tolerated by the sickest patients .
