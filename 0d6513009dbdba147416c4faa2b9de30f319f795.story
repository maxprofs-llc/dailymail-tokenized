...
06:02 EST , 3 September 2013

Deep space can be a lonely place . But what if astronauts could beam their favourite HD videos from Earth ? Or create their own 3D films for us to see ?

That 's exactly what Nasa hopes to achieve by testing a system that could replace primitive radio transmissions , which are currently used in space , with laser-based communication .

The agency claims the technology will make it possible to eventually send huge amounts of data to deep space .

However , its first step will be to establish a two-way laser communication with the moon to prove that the technology is possible .

Scroll down for videos ...

Nasa is planning to ditch primitive radio transmissions and start communicating with lasers in space . The experiment is part of the Lunar Laser Communication Demonstration -LRB- LLCD -RRB- mission which will be hosted aboard LADEE satellite -LRB- pictured -RRB-

The experiment is part of the Lunar Laser Communication Demonstration -LRB- LLCD -RRB- mission which is scheduled to launch on Friday .
...
Since Nasa first ventured into space , radio frequency -LRB- RF -RRB- communication has been the communications platform used . But it is now reaching its limit as demand for more data capacity increases .

According to Nasa , laser communication would be less likely to suffer from interference , another limitation of radio frequency -LRB- RF -RRB- signals .

` LLCD is designed to send six times more data from the moon using a smaller transmitter with 25 per cent less power as compared to the equivalent state-of-the-art radio -LRB- RF -RRB- system , ' said Cornwell .
...
VIDEO : In January , an image of Mona Lisa was transmitted to Nasa 's Lunar Reconnaissance Orbiter -LRB- LRO -RRB- spacecraft orbiting the moon
...
Recently , an image of Leonardo da Vinci 's painting , the Mona Lisa , was transmitted to Nasa 's Lunar Reconnaissance Orbiter -LRB- LRO -RRB- spacecraft orbiting the moon .
...
` Lunar Laser Communication Demonstration ' mission will launch on Friday
