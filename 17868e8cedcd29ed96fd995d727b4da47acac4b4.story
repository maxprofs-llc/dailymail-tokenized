...
The Thai Delicious program was setup to improve meals across Thailand . Its ` e-delicious machine ' -LRB- illustrated -RRB- features 10 sensors that identify taste signatures for dishes , by measuring the conductivity of the samples at different voltages . Dishes are then given an authenticity score out of 100
...
The technical specifications have not been revealed , but Nakah Thawichawatt , a Thai businessman involved in the project , told the New York Times the machines cost around # 11,000 -LRB- $ 18,000 -RRB- each .
...
During tests , the New York Times used the machine to discover the authenticity of a green curry from the Foreign Correspondents ' Club of Thailand -LRB- stock image pictured -RRB- . It scored a below-par 78 out of 100

Last week , PhD student Joana Guerreiro from Aarhus University in Denmark released details of a nanosensor -LRB- pictured -RRB- that performs a similar ` taste ' test for wine . Dubbed ` mini-mouth ' , the sensor mimics the reaction that wine creates on a person 's tongue to determine how the alcohol tastes and how astringent it is
