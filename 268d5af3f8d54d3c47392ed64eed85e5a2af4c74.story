...
The request may breach school admission rules , which say state schools can not request any type of financial contribution as part of the admission process .
...
The latest admissions code for state schools in England says that admissions authorities must not ` request financial contributions -LRB- either in the form of voluntary contributions , donations or deposits -LRB- even if refundable -RRB- -RRB- as any part of the admissions process ' .
