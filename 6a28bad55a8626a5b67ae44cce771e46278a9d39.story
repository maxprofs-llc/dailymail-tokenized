...
Although some of the materials can be collected in the same bins , documents prepared by the Department for Environment , Food and Rural Affairs -LRB- Defra -RRB- explain that this can rarely be done for glass -- and claim that in other cases separate bins will often prove ` necessary ' .
...
` People are resentful . A lot of people do n't bother to recycle properly now . They say that if the council is n't bothered to collect the rubbish once a week , then I 'm not bothered about recycling properly . '
