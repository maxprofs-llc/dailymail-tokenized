...
Scientists have observed for the first time a weird quantum phenomenon known as the ` Cheshire Cat ' effect -LRB- illustration shown -RRB- . The ` cat ' in question was a subatomic neutron particle , and the ghostly ` grin ' the particle 's magnetic moment , which describes the strength of its coupling to an external magnetic field

The groundbreaking research was performed by an team at the Institut Laue-Langevin -LRB- ILL -RRB- in Grenoble , France .
