...
Farewell familiar friend : Microsoft has confirmed that it is dropping the Internet Explorer brand -LRB- logo pictured -RRB- and instead will use a new name for its forthcoming browser , which is currently code named Project Spartan
...
The browser , which does not yet have a name , is likely to be rolled out with Windows 10 . The new operating system marks the return of the Start Menu , which has the traditional list layout of previous versions of the interface , combined with the tile set-up that Microsoft introduced in Windows 8 -LRB- pictured -RRB-
...
The new software will also allow users on hybrid devices like the Surface Pro tablet to jump between and keyboard and touchscreen modes -LRB- pictured -RRB-
...
Windows 10 is designed to bring together all of Microsoft 's different hardware , such as a the surface tablet -LRB- left -RRB- and the Xbox One -LRB- right -RRB- under the same software
...
Although the new software wo n't be formally released until later this year , analysts have already said that its success is crucial for Microsoft and new CEO Satya Nadella .
