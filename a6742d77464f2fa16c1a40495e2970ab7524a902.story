...
KeyMe is a New York-based digital locksmith . The app lets homeowners scan -LRB- pictured left -RRB- and store their keys in the cloud -LRB- pictured right -RRB- , share these scans with family and friends , and order duplicates in the post . KeyMe is free on iOS but is only currently available in the US
...
This does n't , in theory , protect people from criminals taking photos of other people 's keys though .
...
' -LSB- They -RSB- would then have to provide a valid credit card to purchase these keys and a mailing address . All of the data provided during this exchange could be used to easily identify -LSB- them -RSB- . '
...
Once a key is successfully scanned and stored , users can send their digital keychain to friends , family and housemates over email -LRB- illustrated -RRB- . The owner and recipient can then order duplicates from within the app . Storing keys is free , but the cost depends on the type of key being copied , with prices starting at $ 10 -LRB- # 6 -RRB-

Alternatively , photos can be used by physical locksmiths to create copies . To order a key from a locksmith , the app produces a code -LRB- pictured -RRB- that the locksmith can use to create the duplicate . This code reveals the type of key , as well as its ` biting ' code , which gives details about the shape and cut of the key

In an emergency , users can additionally print keys from KeyMe kiosks -LRB- pictured -RRB-
...
KeyMe sends an email confirmation when the recipient has accepted the key , but shared keys ca n't be deactivated .

The owner and recipient can then order duplicates from within the app .

Storing keys is free , but the cost of ordering duplicates depends on the type of key being copied .

As an example , a basic version starts at $ 10 -LRB- # 6 -RRB- .
...
Photos must be taken on a white background up to 4-inches -LRB- 10cm -RRB- away
...
Storing scans is free , but prices for a basic key start at $ 10 -LRB- # 6 -RRB-