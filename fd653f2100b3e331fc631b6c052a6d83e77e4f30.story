...
Only around half of the restaurants in Enfield were meeting minimum health requirements , with Edinburgh second on the list followed by Lewisham , Harrow , Camden and Brent -LRB- file image -RRB-
...
Reasons for failing health requirements could range from simple problems such as not keeping raw and cooked meat separate , to larger concerns about mice and rats -LRB- file image -RRB-
...
` These figures do n't necessarily reflect the challenges and circumstances that councils in different areas are tackling .
