...
Last updated at 5:07 PM on 7th December 2011
...
At the time , Mark Zuckerberg promised , ` you can tell the whole story of your life on a single page ' .

Now it seems that the company is to launch Timeline - but only in New Zealand .
...
` Starting today , we are making Timeline more widely available as we measure speed and other types of performance . '

` We 'll begin by making it available to people in New Zealand and then roll it out more broadly in the near future . '

Timeline has been available to a million developers in an early test version already - but has not been available to the public at all so far .

New Zealand has been chosen , presumably , because it has a relatively low population - just 4.4 million - and is English-speaking , allowing Facebook to iron out early problems with the service .

Even before launch , some have pointed out that Timeline , with its month-by-month approach , may have some unwanted side effects , such as allowing people to see who ` defriended ' them and when .
