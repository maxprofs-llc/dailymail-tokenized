...
And it is n't the first time TV networks have tried to shorten reruns . Similar techniques include cutting the opening sequence , speeding up the closing sequence and overlapping the next show .
...
Pennsylvania-based company Prime Image uses a tool known as Time Tailor -LRB- bottom right -RRB- . A five per cent time reduction means that a 15 second commercial can be inserted into a five minute program
...
` But talks seem to be in the early stages , which means terms like pricing and timing are n't close to being ironed out . '
