...
Contested : The existing power line -LRB- yellow -RRB- will be removed but the
proposed new line of pylons -LRB- purple -RRB- will run directly over a road where Carol Vorderman owns a property
...
However , National Grid says the cost of burying the entire route underground would be # 1.5 billion - twice the # 75million of its current proposed mechanism .
...
` We are proposing to take down the 132,000 v line from Hinkley to Seabank in Avonmouth and build a 400,000 v connection .
