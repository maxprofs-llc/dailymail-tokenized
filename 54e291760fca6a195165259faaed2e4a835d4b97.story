...
From visiting famous landmarks from your sofa , to looking for strange sites , Google 's Street View has many uses .
...
Scientists have used photos of streets in
U.S. cities to make maps showing the safety of New York , Chicago ,
Detroit and Boston , based on how people rated photos on the website . Click on the interactive maps above to see streets that are perceived to be safe -LRB- marked in green -RRB- and less desirable addresses -LRB- in red -RRB-

Scientists at Massachusetts Institute of Technology -LRB- MIT -RRB- created the survey to let people choose between two streets , to indicate which they believe to be safer .
...
` We can use StreetScore to explore the
determinants of urban perception , including both the local features that
affect people 's perception of a street view , such as the quality of
buildings ... the local context of a neighbourhood ... such as its proximity
to a highway ... and the historical , economic and demographic forces that
shape a city , such as architectural movements ... and social segregation , ' they
explained .

The map of New York City -LRB- pictured -RRB- contains more than 300,000 data points of perceived safety.The scientists developed their algorithm because , to make such a detailed map without it , would have required more than two million comparisons of images
...
Scientists at Massachusetts Institute of Technology have created maps of New York , Chicago , Detroit and Boston
