...
` In the end a harbour dinghy took them off because the lifeboat could n't reach them .

` They had been on the top of the tide and it deposited them on the rocks .

` Subsequent tides have not been as big so the yacht has n't floated off yet . The next tide that might do it is this afternoon .

` If that does n't do it then it might be lucky to survive because the weather forecast does n't look good .
