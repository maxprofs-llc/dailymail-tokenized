...
` Collywell Silhouette ' -LRB- left -RRB- and ` Throckley tunnel overload ' by Ian Hobson
...
A work by light artist Ian Hobson entitled ` Entoptic Overload Spiral ' -LRB- left -RRB- and one entitled ` Chatton Blue Spirals ' , which was created using blue handheld LEDs above prehistoric rock carvings in Northumberland , England
