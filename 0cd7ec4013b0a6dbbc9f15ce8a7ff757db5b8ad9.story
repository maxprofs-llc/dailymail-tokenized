After months of testing , leaked screenshots and videos , Apple has officially announced its iOS in the car service goes live this week .
...
In April last year Texas researchers found
that using voice commands to send text messages while driving - on software such
as Apple 's Siri - is just as dangerous as texting with fingers .

They found that both methods impacted
driver response times equally - but that it often took voice
recognition users longer to fix mistakes with their messages .

The findings were then confirmed by the AAA Foundation for Traffic Safety in
the U.S in June .

It similarly found that as mental workload and distractions increase ,
...
When a user receives an incoming message or notification , they can reply using voice commands . Siri can also read the messages and let drivers dictate longer responses or emails .
...
Commenting on the news , Patrick Salyer , CEO of Gigya said : ' There 's an all out war for identity on the web and Apple has taken a first step towards entering the fray .

` The internet of things is now clearly becoming a part of consumers ' everyday lives , and while Apple 's extension to the driver 's seat is a positive sign , Apple would benefit in many more ways if it opened up Apple ID as an identity provider across devices and platforms .
