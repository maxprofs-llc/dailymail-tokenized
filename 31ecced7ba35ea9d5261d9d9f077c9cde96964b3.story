...
It concludes they cost the economy # 27.4 billion a year -- more than the expected revenue from council tax . In at least 24 cases , the Government 's own impact assessment finds estimated costs outweigh the estimated benefits .
...
Difficult balance : EU diktats cost the UK # 27bn a year including # 4.5 bn for banking rules , # 3.4 bn climate and energy legislation and # 4.1 bn for the Working Time Directive
...
Annual figures for the five costliest EU regulations are capital rules for banks at # 4.5 billion ; the Working Time Directive , # 4.1 billion ; the EU Climate and Energy Package , # 3.4 billion ; the Temporary Agency Workers Directive , # 2billion ; and the Energy Performance of Buildings Directive , # 1.5 billion .
...
They found that the cost to the UK of # 27.4 bn - more than the total revenue gained from council tax
