...
The bedroom of the future -LRB- illustrated -RRB- was designed by London-based Betta Living . Its predictions include carpets that switch to beams , floating beds and personal stylists built into mirrors
...
Betta Living claims mirrored glass on wardrobe doors will be superseded by virtual smart mirrors . Oral B has already developed a similar prototype for the bathroom -LRB- pictured -RRB- . The intelligent surface will not only display the contents of the wardrobe , but micro-tagged clothes can be tried on virtually using gestural technology

Elsewhere in the futuristic bedroom , traditional windows will be replaced with ` smart windows ' , automated to the time of day , or personal preferences . The screen can be translucent , fade to black , display a scene of the user 's choice , or be used as a TV . Samsung has a similar design , called Transparent Smart Window -LRB- pictured -RRB-
...
To boost and monitor health , future bedrooms could be fitted with home automation systems linked to fitness tracking gadgets . The system would be able to optimise the heat and light to a person 's exact needs . Honeywell 's evohome -LRB- pictured -RRB- already lets users schedule , and personalise heating and hot water wirelessly

This trend has also been seen recently with products such as LightwaveRF -LRB- pictured -RRB- - that controls everything from power sockets and light dimmers from smartphones - and Beddit 's ultra-thin film sensor , which connects wirelessly to a smartphone to provide sleep analytics
...
On the subject of fitness , Betta Living also predicts that bedrooms of the future will double up as gyms . Homeowners will be able to elevate the bed to reveal a home gym , such as the Domyos Training Box . This box -LRB- pictured -RRB- contains a weight-lifting bar and selection of weights and a weight bench

Experts also predict that the flooring will be interchangeable at the flick of a switch . This means that carpets could be switched for laminate flooring at the touch of a button , and it could be cleaned using Roomba vacuums -LRB- pictured -RRB- that can be set to clean whenever the owner wants
...
The Sleep Council recently created a similar bedroom of the future concept , -LRB- pictured -RRB- with adaptable furniture and augmented reality displays to show constellations or flight paths overhead . It also featured a holographic Colin Firth that read people bedtime stories
