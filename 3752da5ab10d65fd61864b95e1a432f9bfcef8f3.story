...
A number of severe bugs were recently discovered on Apple 's OS X operating system -LRB- pictured -RRB- that left it at risk of hackers . Although Apple has had the technology to automatically update people 's computers for years , it typically asks a user 's permission before installing security updates of this kind

Apple spokesman Bill Evans told Reuters the update is ` seamless . It does n't even require a restart . '
...
The bug specifically targets what 's known as the network time protocol -LRB- NTP -RRB- , used to synchronise clocks on computers .
...
The flaws -LRB- details pictured -RRB- were found by the Department of Homeland Security and the Carnegie Mellon University Software Engineering Institute . The bug specifically targets what 's known as the network time protocol -LRB- NTP -RRB- , used to synchronise clocks on computers . The flaws left these networks at risk from hackers

In OS X Yosemite , users can set their Mac to automatically install updates as needed -LRB- pictured -RRB- . Apple 's update is available for OS X Mountain Lion v10 .8.5 , OS X Mavericks v10 .9.5 and OS X Yosemite v10 .10.1
...
People who do n't enable the Always Update feature are shown a notification in the Apple menu telling them updates are available .
...
Apple said the update is ` seamless . It does n't even require a restart '
