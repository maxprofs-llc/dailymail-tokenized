...
The idea of storing computer information inside living cells - or human brains - has formed the plot of sci fi thrillers such as Johnny Mnemonic -LRB- pictured -RRB- .
...
In the computer world , their work would form the basis of what is known as non-volatile memory -- data storage that can retain information without consuming power .

The team calls its device a ` recombinase addressable data ' module , or RAD for short .

They used RAD to modify a particular section of DNA within microbes that determines how the one-celled organisms will fluoresce under ultraviolet light .

¿ It took us three years and 750 tries to make it work , but we finally did it , ¿ said Jerome Bonnet , PhD , of his latest research , a method for repeatedly encoding , storing and erasing digital data within the DNA of living cells

The microbes glow red or green depending upon the orientation of the section of DNA .

Using RAD , the engineers can flip the section back and forth at will .

They report their findings in a paper that will be published online May 21 in the Proceedings of the National Academy of Sciences .

` Previous work had shown how to flip the genetic sequence -- albeit irreversibly -- in one direction through the expression of a single enzyme , ' Bonnet said , ` but we needed to reliably flip the sequence back and forth , over and over , in order to create a fully reusable binary data register , so we needed something different . '
...
The researchers found it was fairly easy to flip a section of DNA in either direction .

` But we discovered time and again that most of our designs failed when the two proteins were used together within the same cell , ' said Endy . ` Ergo : Three years and 750 tries to get the balance of protein levels right . '

Bonnet has now tested RAD modules in single microbes that have doubled more than 100 times and the switch has held .

He has likewise switched the latch and watched a cell double 90 times , and set it back . The latch will even store information when the enzymes are not present . In short , RAD works . It is reliable and it is rewritable .

For Endy and the team , the future of computing then becomes not only how fast or how much can be computed , but when and where computations occur and how those computations might impact our understanding of and interaction with life . ` One of the coolest places for computing , ' Endy said , ` is within biological systems . ' His goal is to go from the single bit he has now to eight bits -- or a ` byte ' -- of programmable genetic data storage .
...
To get there , however , science will need many new tools for engineering biology , he added , but it will not be easy .

` Such systems will likely be 10 to 50 times more complicated than current state-of-the-art genetic engineering projects , ' he said .
...
` We 're probably looking at a decade from when we started to get to a full byte , ' he said . ` But , by focusing today on tools that improve the engineering cycle at the heart of biotechnology , we 'll help make all future engineering of biology
