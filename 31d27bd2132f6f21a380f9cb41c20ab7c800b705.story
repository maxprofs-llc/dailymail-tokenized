...
Last month , London-based developers released the Emojli app -LRB- pictured -RRB- . It only lets users communicate using the popular miniature images - and even usernames have to be comprised of a selection of emoticons . Meanwhile , the Keymoji keyboard app on iOS 8 converts any text into emojis as the user types

A study in April found that the top trending word of the year , at that time , was emoji -- the small digital images used to express an idea or emotion
in electronic communication - which are continuing to spread like
wildfire online .

The words and phrases were plucked from among millions used online in social media , blogs and global media .

Other terms to make the list include ` futebol ' , and ` ghost plane ' - relating to the
...
Currently , users can only search for friends using their username , and it does n't let people find friends via emails , for example .

Mr Gray and Mr Scott said they created the app after being inspired by Yo , which allows users to simply send the word Yo .

` The two of us had the idea at about the same time - we were n't sold on it until we realized that usernames should be emoji too , ' Gray said .

` At that point , we burst out laughing and realised we had to build it . '

Emoji -LRB- selection pictured -RRB- were originally popular in Japan , and widely used online , however , in recent years they have become hugely popular elsewhere . Originally meaning pictograph , the word emoji literally means ` picture ' -LRB- e -RRB- + ` letter ' -LRB- moji -RRB-
...
Emojli is a free app that only lets users communicate using emojis
