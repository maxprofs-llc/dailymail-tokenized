...
Scientists at Facebook -LRB- logo shown -RRB- have come up with questions that they say artificially intelligent machines must answer if they can ever match human brainpower -- but some of them are a bit tricky , meaning some people may fail them too
...
1 -RRB- The first question of the 20 listed in the research paper was the simplest for a computer to answer . It is :
...
2 -RRB- A harder example for a computer to answer is a question that requires it to differentiate three separate arguments , such as :
...
3 -RRB- Another task tested a machine 's ability to perform simple counting operations by asking about the number of objects . For example :
...
4 -RRB- Basic deduction skills were tested by questions such as :
...
5 -RRB- And reasoning about size was tested by this question :
...
The experts aim to ` classify these tasks into skill sets , so that researchers can identify -LRB- and then rectify -RRB- the failings of their systems . '
