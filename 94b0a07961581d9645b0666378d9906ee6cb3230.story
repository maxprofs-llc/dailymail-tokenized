...
` We know that UK women diagnosed with breast cancer are not routinely given CT scans to check if the disease has spread , which could mean we are n't always accurately staging more advanced disease , ' she said .
