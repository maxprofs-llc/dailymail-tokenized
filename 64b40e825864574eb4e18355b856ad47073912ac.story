...
Nil point for discrimination ! Abba might have won the Eurovision Song Contest -LRB- pictured -RRB- in 1974 with a cracking song , but a study has found that hidden voting patterns play a part in deciding the winner . People 's votes are driven by loyalties based on culture , geography , history and migration - but not discrimination
...
Statisticians at University College London -LRB- UCL -RRB- and Imperial College London analysed voting patterns over the past two decades to identify the patterns and found no evidence to support Sir Terry Wogan 's criticism that the contest is marred by blatant bias and discrimination .
...
Success mapped : In line with previous findings , the data suggests that voting congregates within four broad groups of nations that tend to give each other points : one combining countries including the former Yugoslavia , Switzerland and Austria -LRB- red -RRB- , one covering central and southern Europe -LRB- blue -RRB- ; plus a larger area which includes the former Soviet bloc as well as the UK , Ireland and Scandinavia -LRB- yellow -RRB- , which divides more-or-less randomly into two groups each year
...
Hitting a bum note ? The UK has friends in the form of Ireland , Malta and Italy . But such alliances were not found to have a dramatic impact on the likelihood of a given performer winning - and were not enough to save the UK 's 2003 entry , Jemini -LRB- pictured -RRB- being awarded nil points
