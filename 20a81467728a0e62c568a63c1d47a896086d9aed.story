...
The full meal costs $ 9.99 -LRB- approximately # 7.85 -RRB- per week and $ 8.99 -LRB- approximately # 7.05 -RRB- for vegetarian .
...
Other upcoming dishes include 'Em peror Bream with Herb Risotto ' or ` Panserotti with Ricotta ' , and ` Chicken Breast with Pepper ' or ` Pumpkin Gnocchi with Ragout ' .
