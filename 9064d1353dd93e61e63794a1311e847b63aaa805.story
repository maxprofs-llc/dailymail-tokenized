...
Getting better all the time : There have been concerns over the grading system after GCSE and A-level results rose for the 29th year running -LRB- file picture -RRB-
...
` However , we would be concerned if any changes mean that students do n't get awarded the grades their hard work merits if the grades have been set so that a fixed percentage of students are awarded A * s and As . '
