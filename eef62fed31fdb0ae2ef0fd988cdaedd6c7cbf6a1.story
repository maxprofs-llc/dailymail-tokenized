...
The judge can not see the computer or the human , but can ask them questions via the computer . Based on the answers alone , the human judge has to determine which is which .
...
It is n't just poetry generated in human form that is gaining popularity . In December , Stanford University held its first code poetry slam to reveal the literary side of computer code
...
And it is n't just poetry generated in human form that is gaining popularity . In December , Stanford University held its first code poetry slam to reveal the literary side of computer code .
