...
` The
concern is government has become so polarized that if it can not pass -LRB- a
budget -RRB- , there 's a greater chance that the debt ceiling battle will go
...
A
brief shutdown would n't hit the economy and stock market that hard . But
...
brinkmanship is the dominant reason -LRB- the United States ' credit -RRB- rating
...
Missing targets : The U.S. Federal Reserve -LRB- pictured -RRB- recently held off on slowing its stimulus program , saying economic growth was not meeting its targets
