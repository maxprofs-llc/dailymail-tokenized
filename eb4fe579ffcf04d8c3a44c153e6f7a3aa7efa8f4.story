...
The 3D Touch device -LRB- pictured -RRB- is fitted with an accelerometer and gyroscope , and lets people control an onscreen mouse using a wave of their finger . The intelligent device was created by Anh Nguyen and Amy Banic from the University of Wyoming in Laramie
...
The device also uses optical flow sensors to track movement against a 2D surface -LRB- pictured -RRB- . All of this location data is streamed to a laptop and is used to move the cursor , it can also be used with touchscreen-style gestures such as double tap and long press
...
By combining data from all of the sensors , the 3DTouch can accurately determine the location on the screen , and the researchers claim it can be used to move objects with a positioning error of only 1mm . A button between the forefinger and thumb -LRB- pictured -RRB- is used in place of the left-click button on a standard mouse

The original mouse prototype was patented in 1947 . It is now widely used with PCs and Macs -LRB- pictured -RRB-
...
' -LSB- It -RSB- is designed to fill the missing gap of a 3D input device that is self-contained , mobile , and universally working across various 3D platforms .
...
The Muse app works alongside a small USB device called the Leap Motion Controller -LRB- pictured -RRB- and lets people create music using hand gestures while they sit in front of their computer
...
People can use the Leap Motion Controller , which costs $ 89 -LRB- # 74 ; $ 79 -RRB- to make their own ambient music .
