...
` However , we 're not sure about the effects of this incident -LSB- MH17 -RSB- .

` Hopefully , the number wo n't be affected too much , if we base our predictions on the first incident . '
...
Malaysia says ` hopefully ' tourism figures ` wo n't be affected too much '