...
The worldwide approach ensures data is n't tainted by effects such as ` urban heat islands ' - the warmer local climate in cities .
...
The Berkeley group 's approach allows the scientists to deal with such data without omitting readings that do n't ` fit ' with the overall trend .
