...
Researchers from Eindhoven University of Technology -LRB- TU/e -RRB- have used a seven-core fibre network to transfer data at a record-high of 225 terabits per second -LRB- Tbps -RRB- . Current fibre networks -LRB- pictured -RRB- typically use single cores and achieve a commercial maximum of 100Gbps
...
And to put this into perspective , the average web speed globally is only a meagre 3.9 Mbps .
...
The breakthrough was achieved by researchers from Eindhoven University of Technology -LRB- TU/e -RRB- and the University of Central Florida -LRB- CREOL -RRB- .
...
The advanced fibre uses seven cores -LRB- pictured -RRB- through which light can travel , instead of the single core typically used . Researchers also introduced two so-called ` orthogonal dimensions ' . This is the equivalent to driving three cars on top of each other on a seven-lane motorway , compared to a single-track road
...
Network can transfer data at a record-high of 255 terabits per second -LRB- Tbps -RRB-
