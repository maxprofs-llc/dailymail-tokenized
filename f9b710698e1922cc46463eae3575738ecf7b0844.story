...
China is said to be building the world 's first hack-proof computer network , top stop eavesdroppers it has been reported -LRB- file picture -RRB-
...
The project is being led by Professor Pan Jianwei , a quantum physicist at the Unversity of Science and Technology of China -LRB- USTC -RRB- .
...
Quantum Key Distribution -LRB- QKD -RRB- -- delivers private data using the smallest possible packets of light .
...
Quantum Key Distribution -LRB- QKD -RRB- -- delivers private data using the smallest possible packets of light -LRB- file picture -RRB-
...
` Other attack traffic studies have placed China in top spot -LSB- like Akamai -RSB- , others have placed other countries top . '
