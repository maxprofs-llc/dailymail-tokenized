...
Especially when they discover that the limited edition pink iPhone 6 can be only purchased for the princely sum of # 1,899 -LRB- $ 2,887 -RRB- .

A London-based luxury phone company is releasing a pink iPhone 6 -LRB- shown -RRB- . It is the same as a regular iPhone 6 - but has a pink case . It costs # 1,899 -LRB- $ 2,887 -RRB- , while a gold version is also being released for # 2,499 -LRB- $ 3,797 -RRB- for anyone who wants to splash out even more
...
Amosu are also planning to release a gold version of an iPhone 6 , which will sell for an eye-watering # 2,499 -LRB- $ 3,797 -RRB- .
