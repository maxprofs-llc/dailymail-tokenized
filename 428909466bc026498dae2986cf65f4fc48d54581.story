...
A mathematical calculation by a professor at the University of Ottawa - -LRB- bN -RRB- -LRB- S/N -RRB- Z = bSZ - describes the rate that humans would become zombies as they are gradually infected by the living dead .
...
In his zombie apocalypse equation - -LRB- bN -RRB- -LRB- S/N -RRB- Z = bSZ - where N represents the total population , S is the number of people susceptible to zombie attacks , Z is the number of zombies and b is the likelihood of transmission , the model shows that people would quickly become zombies .
...
Virologist Ian MacKay talked about zombies in film World War Z starring Brad Pitt -LRB- pictured -RRB- . He said zombies are ' a virus taking over a host and spreading very quickly and efficiently '

Dr Smith believes the rapidity of infection in zombie infections -LRB- depicted in films -RRB- makes the spread of disease unstoppable as ` it only takes one zombie to overtake a city ' .
...
The zombie maths models have helped develop another working model for a real disease - human papillomavirus -LRB- HPV -RRB- .
