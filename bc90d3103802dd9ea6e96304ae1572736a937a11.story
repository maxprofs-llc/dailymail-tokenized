...
The late Mr Dickens -LRB- pictured -RRB- planned to expose eight figures connected to child abuse
...
` The higher penalties . . . could be available when victims/partners are under 13 -LRB- perhaps limiting them in the case of younger offenders to when girls involved are under 12 -RRB- . '

They add : ` Paradoxical though it might seem to argue that -LSB- the point at which tougher sentences are applied -RSB- should be lower than the average age of puberty -LSB- 13 -RSB- , it is not unreasonable . . . A large number of 12-year-old girls have already attained puberty and may not only be willing to take part in sexual activity but may actually initiate it . '
