...
The cuts to components of the iPhone 5 -LRB- pictured -RRB- comes after Apple has come under intense pressure from Samsung and other phones which use Google ¿ s Android operating system
...
Meanwhile , South Korea-based Samsung is expected to report that 2012 was its best year ever with profits up to $ 8.5 bn for the last three months .
...
` This is the first time that this dominance has been seen so consistently across manufacturers and reflects two trends : the inexorable increases of data consumption in smartphone devices and the relatively consistent use of tablets in WiFi -LRB- rather than cellular -RRB- coverage areas ' .
...
` However , the introduction of new data-intense features on recent smartphones -LRB- such as the A6 chipset , larger Retina display and LTE support on the iPhone 5 -RRB- raises the expectation that the users of these new smartphones will be even more intense data consumers ' .
