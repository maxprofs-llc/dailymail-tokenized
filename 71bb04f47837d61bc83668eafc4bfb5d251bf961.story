...
His Unite union has given # 8.4 million since Ed Miliband became leader .
...
The unions should be reformed so that sub-par clowns like Red Len would not ever be anywhere near a position of power . It should be quite simple , actually : Change the laws so that the right to strike is tied with voting in the unions ' leadership elections . If you still go on strike without the right to do so , it would be grounds for an immediate an automatic dismissal . -LRB- This should apply to all illegal strikes . -RRB-
