...
The difference in costs can be as large as ten per cent , and most sites do n't even warn you when they are using price steering techniques .
...
` By personalizing the search results -LRB- e.g. , by taking the user 's history of prior searches into account -RRB- , Google is able to return results that are potentially more relevant -LRB- e.g. , computer products , rather than orchards -RRB- . '
...
` In the real world , there are coupons and loyalty cards , and people are fine with that , ' he said . ` Here , there 's a transparency problem . The algorithms change regularly , so you do n't know if other people are getting the same results . '
