...
He said : ' I certainly did n't invent the concept of sending strangers unsolicited files using AirDrop , but I 'd like to think that I 'm doing it in a way that 's more fun than malicious .
...
Apple 's AirDrop allows iPhone users to send pictures and files to other Apple devices over WiFi and Bluetooth networks but those who leave the service set to receive from ` Everyone ' -LRB- right -RRB- are vulnerable to hackers
