...
furniture , objects and people , to make sure the web pages are n't
distorted .
...
Microsoft did n't reveal exactly how the system works , but said : ` After a one-time setup procedure that scans a room for projectable surfaces in about a minute , our prototype can render immersive multi-display web rooms at greater than 30 frames per second with up to 25 screens and up to a 1440x720 display . '

This creates what the firm calls the Room Skeleton .

Any screen on a computer can be beamed onto the wall , including maps , pictured

The designers also stress that the system is secure and ca n't detect faces or read documents in a room , such as bills on a table for example .
...
` Our
system uses the appearance and the geometry of the room -LRB- captured by
Kinect -RRB- to adapt the projected visuals in real-time without any need to
custom pre-process the graphics . '

In
conclusion , the SurroundWeb research team added : ` Our -LSB- work -RSB- enables
