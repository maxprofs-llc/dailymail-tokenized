...
The most ambitious attack campaign saw it compromise a number of industrial control system -LRB- ICS -RRB- equipment providers , infecting their software with a remote access-type Trojan .
...
Both are remote access tool -LRB- RAT -RRB- type malware which provide the attackers with access and control of compromised computers .
...
` These are people working with Fapsi -LSB- Russia 's electronic spying agency -RSB- ; working to support mother Russia . '
