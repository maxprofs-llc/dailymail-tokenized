...
It can detect Gamma-Hydroxybutyric -LRB- GHB -RRB- , or ` liquid ecstasy ' , which can can make anyone fall into a deep sleep .

The simple test for date rape drugs : GHB Orange , the fluorescent sensor for detecting date rape drug GHB -LRB- bottle in top left -RRB- , under UV light with the drug GHB -LRB- bottle in top right -RRB- , and when it was mixed into red wine without GHB -LRB- vial in front left -RRB- and with GHB -LRB- vial in front right -RRB-
...
Professor Chang Young-Tae , from the Department of Chemistry at National University of Singapore , said : ` The current method in the market is using -LRB- a -RRB- kind of paper -LRB- a tissue-like piece of paper -RRB- and ... run the paper chromatography separations .

` The problem is , to run those samples -- the paper chromatography -- it takes about 10 minutes of your time . '

` Currently , we are using the test tube kind of approach ... but who would want to bring this -LRB- a test tube -RRB- to the discotheque ? '' '

Scientists from the National University of Singapore -LRB- NUS -RRB- have now found a way for GHB to show itself instantaneously - by changing the colour of the drink .
