...
A spokesman told MailOnline : ` As part of our drive to save # 1.5 billion the BBC is restructuring and cutting the number of posts we have - so when we do need to recruit priority consideration is given to internal candidates in order to save on redundancy costs . '

A union source suggested that this was nothing more than ` good HR practice ' - but an employment lawyer warned that closing off job opportunities could leave the BBC liable to discrimination claims if it can not prove that it has encouraged applications from all sectors of society .

` The biggest risk by not advertising externally is restricting the talent base , ' said Philip Pepper , a partner at Midlands-based law firm Shakespeares . ` You run the risk that you 're actually restricting your workforce - so you could risk a claim -LSB- for discrimination -RSB- .
...
Guidance based on the Equality Act 2010 reads : ` If an employer does n't advertise at all or advertises in a way that wo n't reach people with a particular protected characteristic , this might in some situations lead to indirect discrimination , unless the employer can objectively justify their approach .
