...
` People complain because they want to know what has gone wrong , they want an apology and they want to make sure others do n't suffer the same problems .

` We see example after example of cases where hospitals are n't using complaints as the vital source of feedback they are . Learning from patients , improving services and building trust all flow from managing complaints effectively . '

The Health Service Ombudsman investigates serious complaints from patients and relatives which have n't been properly dealt with by hospitals .
