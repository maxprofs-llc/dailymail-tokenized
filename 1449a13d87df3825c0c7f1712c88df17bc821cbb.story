...
The chart ranks the apps -LRB- top to bottom -RRB- that ask for the most permissions .
...
` Most developers are n't evil , but they often do n't know what to do with respect to privacy and security , ' Hong added , explaining that some developers may simply collect data with their apps because they can , and nobody stops them .
...
Alternatively , you can try to find a replacement app that has similar functionality -LRB- e.g. there are many flashlight apps that do n't need an Internet connection or location data -RRB- .
...
` Smartphones have access to our communications -LRB- email , contacts list , and social networks -RRB- , activities -LRB- location , call logs , photos , accelerometers -RRB- , and more .
