...
He acknowledged that the flood of tax-exemption applications from tea party groups were considered part of a ` Sensitive Case Report ' project , meaning that the IRS ` can not resolve any of the cases without coordinating with Rob -LSB- Choi -RSB- ' -- who was then in charge of IRS ` rulings and agreements ' in the agency 's Washington , D.C. headquarters .
...
On April 2 , 2013 , she emailed IRS investigators about a ` Be On the Lookout ' -LRB- BOLO -RRB- list that was circulated agency-wide .
...
Levin has focused in his letter to the IRS on an apparent contradiction in two separate Treasury Department regulations . One specifies that 501 -LRB- c -RRB- -LRB- 4 -RRB- status , one of several tax-exempt designations the IRS can award , is reserved for groups that operate ` exclusively ' for social welfare and do n't engage in partisan politics .
...
In May 2013 , a Treasury Department inspector general report found that the IRS had been ` using inappropriate criteria to identify -LSB- conservative -RSB- organizations applying for tax-exempt status -LRB- e.g. , lists of past and future donors -RRB- . '
