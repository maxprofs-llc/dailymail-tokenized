...
Rather than looking down at a 2D map or chest-worn computer , the soldier sees virtual icons -LRB- such as navigation waypoints , friendly/blue forces , and aircraft -RRB- overlaid on their real-world view .
...
The firm experimented with dozens of prototypes for the system before deciding on the final model -LRB- left -RRB-
...
` ARC 4 does more than present conventional communications and directional information -LRB- e.g. , messages , tweets , maps , pictures -RRB- in a heads-up fashion .
