...
She added : ` The thresholds -LSB- at which stamp duty is charged -RSB- have been held at the same levels for years now . Rising property prices mean that an increasing number of first-time buyers have to pay the three per cent rate .

` This is n't right and it is time for the government to reform this tax . ' The Council of Mortgage Lenders said rising house prices are helping homeowners with an interest-only mortgage , which means they only pay the interest on the loan , but not the loan itself .

Around 2.2 million people have an interest only mortgage , and it said only ` a relatively modest ' number have no plan for repaying the loan when the time comes .
