...
Reducing greenhouse gases to manageable levels will cost up to four per cent of global GDP by 2030 , according to a draft version of a report to be published in Berlin on Sunday by the Intergovernmental Panel on Climate Change -LRB- IPCC -RRB- .
...
Britain would be an ideal place to try the technology , because there are thousands of old coal mines -LRB- pictured -RRB- and gas wells which could be used as storage facilities for carbon dioxide
...
The draft IPCC chapter on energy systems says : ` A combination of bio-energy and carbon capture and storage -LRB- BECCS -RRB- generally will result in net negative emissions . BECCS is one of the few technologies that are capable to remove past CO2 emissions remaining the atmosphere . '
...
` But compared to the problem it can only play a minor role . And we do n't actually know if the CO2 will even remain in the ground .
...
It adds : ` Delaying mitigation -LSB- to -RSB- 2030 will increase the challenges of , and reduce the options for , bringing atmospheric concentration levels -LSB- to safe levels -RSB- by the end of the century . '
