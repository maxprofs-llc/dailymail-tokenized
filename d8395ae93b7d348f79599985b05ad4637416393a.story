...
Details of California-based Apple 's two new devices have been revealed . The leak was spotted by Mark Gurman from 9to5mac in an iOS 8.1 iPad user guide for iBooks on iTunes -LRB- screenshow shown -RRB- . The leak came ahead of today 's official announcement for the devices
...
The leak confirms a number of features including Touch ID sensors for both and a ` Burst Mode ' -LRB- shown -RRB- for taking pictures on the iPad Air 2 . Apple has since taken the images down from its website and when was yet to comment when contacted by MailOnline
...
Screen : 5.96 inch display , 1440 x 2560 resolution -LRB- 493ppi -RRB-

Platform : Android Lollipop

Processor : Snapdragon 805 quad-core 2.7 GHz with Adreno 420 GPU for graphics
...
The leak came just minutes after Google revealed unveiled its new operating system , Lollipop , alongside the new Nexus 6 smartphone and Nexus 9 tablet yesterday -LRB- shown -RRB- . Both mobile devices will run the new version of the firm 's mobile operating system , Android 5.0 , which has been confirmed to have the name Lollipop
