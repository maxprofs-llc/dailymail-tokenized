...
They suggested that every female character from the last decade is a ` descendant of some primordial creature ' with ` huge round cheeks and a disturbingly small nose ' .

They then go on to say that the reason behind the similarities is ` lazy sexism ' .
...
They did the same with male faces and noticed that most of them were different

They first spotted the distinctions when looking at stills from the new animated film Inside Out

The green drawings -LRB- male -RRB- and the red lines -LRB- female -RRB- show the differences between the two
...
A Disney spokeswoman reacted to the controversy by saying : ` Animation is an intricate and complex art form .

` These comments were recklessly taken out of context . As part of a roundtable discussion the binaries was describing some technical aspects of CG animation and not making a general comment on animations females versus males or other characters . '
