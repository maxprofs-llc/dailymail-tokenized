...
The most recent release from the Atlas experiment at the European Organisation for Nuclear Research -LRB- Cern -RRB- shows that their data contains two clear peaks indicating new particles .
...
The double reading : The blue plot in this graphic provided by Cern shows the 123.5 GeV signal , while the red plot shows the 126.5 GeV signal , findings which have rocked physicists at the LHC
...
There seems to be one version of Higgs boson with a mass of 123.5 gigaelectron volts -LRB- the unit particle physicists prefer using to measure mass -RRB- and a second Higgs with a mass of 126.6 GeV .

A graphical representation of particles smashing into each other in the Large Hadron Collider : It had been hoped the findings would finally prove the Standard Model of physics

The Higgs boson was proposed in 1964 - it is the last missing piece of the Standard Model , the theory that describes the basic building blocks of the universe .

The other 11 particles predicted by the model have been found - the Higgs is the last jigsaw piece .
...
The anomalous result could of course still have been caused be a statistical blip that is not repeated as further data is collected , but their are certain versions of the Standard Model that predict the existence of multiple Higgs particles .
...
For the moment , the scientists at Cern are not too concerned . Tommaso Dorigo , an experimental particle physicist on the projects CMS experiment says it is likely to turn out to be a blip .

He blogs : ` This is normal business - if we had to get excited at every slight disagreement between our measurements and our expectations , we 'd be sick with Priapism -LRB- sorry ladies for this gender-specific pun -RRB- . '
