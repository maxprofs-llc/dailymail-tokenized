...
These so-called latent cells are the main reason that HIV can not be cured -- they lie low in the body , quietly resting until drug treatment stops , and then roar back into action .
...
HIV infection : New findings show that radioimmunotherapy -LRB- RIT -RRB- could potentially eradicate HIV-infected cells in a similar method to how cancer is treated
