...
Called Automatic Ingestion Monitor -LRB- AIM -RRB- , the device lets wearers track eating habits . A sensor , worn around the ear -LRB- pictured -RRB- monitors movements of the jaw . It is activated by vibrations caused by chewing , and filters out movements made by talking . The camera captures images of food to estimate its calorie content
...
Dr Edward Sazonov -LRB- pictured -RRB- intends to test the AIM 's accuracy as an alternative method to tracking energy use from water samples . This method measures the body 's elimination rate of stable isotopes of hydrogen and oxygen added to the water , a process that can take two weeks

Earlier this year , researchers from Canada created a chin strap that harvests energy from jaw movements , including chewing and talking . The strap , -LRB- pictured -RRB- is made from a material known as PFC , which consists of electrodes and adhesive polymer that produces a charge when it stretches
