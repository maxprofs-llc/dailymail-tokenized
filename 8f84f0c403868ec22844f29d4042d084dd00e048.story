...
Once the user downloads BrainWave , all of their compatible music apps - including Pandora , iHeart , Spotify , Beats , Google Play - are automatically added to the apps list -LRB- left -RRB- . When a user selects their preferred music player , BrainWave will automatically run in the background , working even if the screen is switched off -LRB- right -RRB-

• Gestures are recognised 1-3ft -LRB- 30-90cm -RRB- away from the phone
...
` -LSB- Its accuracy -RSB- is pretty dead on , ' said Mr Fink . ` It should work almost every single time . ` In the near future , Brainwave 's creators are hoping to add gesture control that will adjust volume and like/dislike songs .
...
` -LSB- Its accuracy -RSB- is pretty dead on , ' creator Robert Fink told MailOnline . ` It should work almost every single time '
