...
` A lot of them are very bright , motivated and better at English than native speakers -- and they wo n't want to be sitting an exam that 's been skewed for their sake . It represents an erosion of exam standards . '
...
The 30-page guide suggests that test designers should ` present information in short sentences ' and ` use simple sentence structures with a logical conceptual flow -LRB- subject , verb , object -RRB- ' .
...
It encourages ` simple , active sentences such as subject-verb-object -LRB- SVO -RRB- ' in favour of passive sentences and also advices test designers to avoid using more than 65 characters in one line .
