...
Huang demonstrated near photo-realistic simulations of environments and human faces , run on the new chip . He said Epic Games will adapt the next version of its Unreal Engine , the basis for many popular games , so that it will work on the chip . He did n't announce when the chip would be available or any gadget makers that were adopting it .
