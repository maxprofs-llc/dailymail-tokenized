...
The setup uses an Oculus Rift headset -LRB- d -RRB- , the OptiTrack optical tracker -LRB- e -RRB- , laser scanner from Geomagic and Autodesk 3DS Max software to create the final reconstructions . The computer system is shown at -LRB- a -RRB- , -LRB- b -RRB- is the Oculus USB connector , and -LRB- c -RRB- is a wall-mounted tracker
...
To demonstrate the system , the researchers chose to reconstruct a shooting in an internet cafe -LRB- pictured -RRB- . The scene was recorded by a surveillance camera , and the team then used a laser to scan the surroundings . The aim was to show how close bullet trajectories came to injuring people in the room
...
Oculus Rift -LRB- pictured -RRB- is worn on the head and measures the orientation of the wearer in real time
...
When used for gaming , the headset does n't typically need to use positional information of the head is usually not required .
...
The technology is similar to the fictional holodeck in Star Trek -LRB- pictured with Deanna Troi played by Marina Sirtis left and Jonathan Frakes as William Riker right -RRB- . Holodecks were installed on starships , space stations , and at Starfleet for entertainment , training , and investigative purposes
