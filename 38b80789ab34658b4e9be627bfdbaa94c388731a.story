...
It is n't however as simple as being able to pick the six most likely numbers to win the National Lottery , it is however possible to pick several combinations of numbers which are more likely to be drawn based on probability .
...
If you toss a coin you have a one in two chance of getting a head but you might not get one at all . If you toss the coin many times you 're going to move more towards a 50/50 split of heads or tails -LRB- i.e. it 'll look more like the probability you 've been given -RRB- .
...
For example , If someone were to choose all low numbers -LRB- in the 1-9 range -RRB- they have a 0.0007 % chance of their template coming up as there 's only 84 combinations of using these numbers .

But if they were to choose one across all the different colours -LRB- with two purples -RRB- they have a 2.6403 % chance of their template coming up as there 's 324,000 different combinations that use these numbers .
