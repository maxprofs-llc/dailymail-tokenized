...
Caroline Flint MP , Labour 's shadow energy secretary , told BBC2 's Newsnight : ` The truth is , this policy is n't going anywhere because the Prime Minister actually announced a policy that within 10 hours has disappeared .

` We need transparency so we can see when the companies say `` we ca n't do this because we need to invest , '' whether what they 're saying is right and we need to know that when wholesale prices come down , they pass on those cuts to the consumers just the same way as they do when they go up . '
