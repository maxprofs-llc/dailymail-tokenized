...
Snapchat : Snapchat is a photo-sharing web tool that allows users to send pictures that only appear on their screen for a limited time so they can not be saved
...
Snapchat is a photo-sharing web tool that allows users to send pictures that only appear on their screen for a limited time so they can not be saved .
