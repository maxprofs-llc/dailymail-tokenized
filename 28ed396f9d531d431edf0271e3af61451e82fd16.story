...
Research group leader Professor Ruth Brack-Werner said : ` -LSB- Geranium -RSB- extracts are a very promising lead for the development of the first scientifically validated phytomedicine against HIV-1 .

` -LSB- The -RSB- extracts attack HIV-1 with a mode of action that is different from all anti-HIV-1 drugs in clinical use .

` Therefore -LSB- they -RSB- may be a valuable supplement for established anti-HIV therapies .

The plant extract prevents the virus invading human cells and replicating inside the human body

` Furthermore , -LSB- the -RSB- extracts are attractive candidates for increasing anti-HIV-1 therapy options in resource-limited settings , since they are easy to produce and do not require refrigeration .

` The results of our study and the proven safety of -LSB- the -RSB- extracts encourages their testing in HIV-1 infected individuals as a next step . '

According to the World Health Organisation -LRB- WHO -RRB- , more than 35 million people in the world are infected with HIV , the majority with HIV-1 .

Without treatment , HIV destroys the immune system and causes acquired immunodeficiency syndrome -LRB- AIDS -RRB- , which is a life-threatening disease .
