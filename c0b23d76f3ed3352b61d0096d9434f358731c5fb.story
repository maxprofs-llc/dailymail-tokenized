...
A German automotive company has unveiled a conceptual futuristic car body -LRB- pictured -RRB- that it claims will only be possible thanks to the 3D printing process
...
In the future the car 's internal body could be made using high-resolution fuse deposition modelling -LRB- FDM -RRB- machines .
...
In the future the car body could be made in one piece using high-resolution fuse deposition modelling -LRB- FDM -RRB- machines and then sheathed in metal to protect it .
...
The structure -LRB- illustrated bottom -RRB- is inspired by the shape of a turtle shell and is designed so that it will provide protection and cushioning , just like the animal 's shell -LRB- pictured top -RRB-

In the future the car body -LRB- illustrated -RRB- could be made in one piece using high-resolution fuse deposition modelling -LRB- FDM -RRB- machines

EDAG claims that cars based on organic structures ` can not be built using conventional tools ' .
...
Cars need to be strong to withstand collisions so the German firm plans to introduce ` endless carbon fibres ' to the 3D printed frame -LRB- illustrated -RRB- during the production process , which they say will give the body the strength and stiffness needed
...
Designers used a turtle shell to inspire the shape of the car body to create a body that ` cushions and supports ' an interior carriage , surrounded by reinforcing metals -LRB- illustrated -RRB-
...
Experts believe the concept -LRB- pictured -RRB- is over a decade away from becoming reality , but production of components using FDM machines is feasible at the moment
