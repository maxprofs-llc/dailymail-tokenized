...
Dr Jason Hong , of the university 's Human-Computer Interaction Institute , wrote on a blog : `` A vast majority of people -LRB- 95 % -RRB- were surprised that Brightest Flashlight used location data , but no one -LRB- 0 % -RRB- was surprised that Google Maps did so .

` Here , we can use level of surprise as one form of privacy . If people are n't surprised , then from our perspective it 's less of a privacy issue , since people have some level of informed consent .
...
` It 's worth pointing out too that a lot of this information seems to be used for advertising rather than malicious purposes -LRB- though it obviously depends on your definition of malicious -RRB- .
...
` And the developers can hide behind what the app store offers -LRB- for disclosure options -RRB- .
