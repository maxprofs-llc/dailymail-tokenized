It gives an unprecedented glimpse into the body , and could revolutionise medicine .
...
This animation reveals a model for what happens in metastasis , showing cancer cells -LRB- green -RRB- crawling through a primary tumor -LRB- orange spider web -RRB- .
...
` What happens is you end up designing the questions you ask around the tools that are available , ' Legant says .

Infections in the body : T cell expressing a plasmid -LRB- orange -RRB- approaching a target cell expressing a plasma membrane marker fused to tagRFP -LRB- blue -RRB- , as seen from the side -LRB- top -RRB- and from the viewpoint of the
APC -LRB- bottom -RRB- .
...
Volume renderings at eight consecutive time points of a single specimen of the protozoan T. thermophila taken from a 4D data set spanning 1250 time points .

The new microscope operates in two modes .

One uses the principles of structured illumination to create very high-resolution images . In this case , the final image is created by collecting and processing multiple images of every plane of the sample . Imaging can be sped up to capture faster processes , albeit at lower resolution , with an alternative ` dithered ' mode .
...
Cells in prophase -LRB- left -RRB- and anaphase -LRB- right -RRB- , The graph shows the distribution of growth rates at
different stages of mitosis , averaged across nine to twelve cells .
...
` We know what the microscope can offer in terms of the imaging , but I think there are a lot of applications we have n't even thought of yet , ' Legant says .
...
Called lattice light-sheet microscopy , technique generates 3-D images and videos
