...
Although the term ` Internet of Things ' -LRB- IoT -RRB- first appeared in 2005 , there is still no widely accepted definition .
...
For example , the term IoT can include the Radio Frequency Identification -LRB- RFID -RRB- tags businesses place on products in stores to track their inventory , or sensors that monitor electricity use in hotels .
...
Ms Ramirez continued : ` If I 'm wearing a fitness band that tracks how many calories I consume I would n't want to share that data with an insurance company . '
...
The report added : ` The Commission recognises this industry is in its relatively early stages -LSB- and -RSB- does not believe that the privacy and security risks , though real , need to be addressed through IoT-specific legislation at this time .
...
A BullGuard survey has revealed that ` an alarmingly high number ' of people do n't give much consideration to what they post online .

For example , while 64 per cent of respondents said they give thought to their online reputation 36 per cent said they did n't .
...
There are also industry-led bodies that are already working on securing and standardising the IoT protocols for smart gadgets -LRB- illustrated in this graphic -RRB- . For example , the AllSeen Alliance has developed ' a secure , persistent connectivity protocol ' between Wi-Fi routers and cloud providers

IoT gadgets include the the August smart lock -LRB- pictured left -RRB- . Fitted to the existing door lock , the battery-powered device is controlled by the August app . To open the lock , anyone with a code can approach the door , enable their phone 's Bluetooth and press the relevant address from the app -LRB- pictured right -RRB-
...
Another device is a smart security alarm called Canary -LRB- pictured -RRB- . It can be connected to smart lights from LiFx . The lights could then flash in the bedroom , to silently alert homeowners to an intruder downstairs
...
Guidelines were announced by the Federal Trade Commission -LRB- FTC -RRB-
