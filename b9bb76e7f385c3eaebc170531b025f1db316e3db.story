Despite some experts claiming it ca n't be done , the race is on to build a robot with the same kind of consciousness as the human brain .
...
Earlier this month , researchers from Stanford University created the Neurogrid , pictured - a computer chip based on the human brain that is 9,000 times faster than current computers . The $ 40,000 -LRB- # 23,600 -RRB- circuit board mimics the brain on the power it takes to run a tablet computer
...
Professor Phil Maguire , from the National University of Ireland in Maynooth , said computers ca n't handle any process that completely integrates information , so they can not be conscious and capable of feeling .
...
` The further ahead the leader gets , the faster he is able to run . Eventually , competitors are left so far behind that they can not catch up . '
