...
` Precautionary measures ' : Health Secretary Jeremy Hunt -LRB- pictured yesterday -RRB- is ` very confident ' the NHS will be able to cope if Ebola arrived in the UK
...
A charity warned that the outbreak was ` speeding up rather than slowing down ' and the EU pledged # 1.6 million to stopping it spreading .
