...
But every building material has some theoretical limit beyond which it can not be used and , before even higher Lego towers can be built , it would be sensible how much the plastic bricks can suffer .
...
which is the equivalent of having 350kg -LRB- a third of a tonne -RRB- pushing
down on the brick .
...
With an average 2x2 Lego brick having a mass of 1.152 g and the total mass a single brick can carry being 432kg , dividing the former by the latter gives the grand total of bricks a single Lego brick can support : 375,000 .

Multiply that by the height of the brick - 9.6 mm - and it turns out that , theoretically , a tower of Lego 3.5 km -LRB- 2.17 miles -RRB- could be built before the one at the bottom has any problems .
...
` So if the Greek gods wanted to build a new temple on Mount Olympus , and Mount Olympus was n't available , they could just - but no more - do it with Lego bricks , ' he added .

` As long as they do n't jump up and down too much . '
