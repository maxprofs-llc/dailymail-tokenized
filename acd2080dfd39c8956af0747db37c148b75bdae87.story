...
` Progress on this issue has been very slow and in the meantime thousands of drivers are avoiding fines and bans simply because their cars can not be easily traced . '

The figures were released following a freedom of information -LRB- FOI -RRB- request to police authorities in England and Wales by IAM .
...
` The figures come as no surprise as we do n't yet have cross border enforcement using the EU nation 's vehicle registers .

` This may change if a revised directive succeeds in the EU -LRB- in 2015 -RRB- - the UK opted out of the previous one along with Denmark and Ireland but will be forced to take part in the next one . '
...
` The problem with cross border enforcement is it could become just a money-related system of fines which wo n't in itself help road safety as licence endorsements are also needed to change attitudes . '
