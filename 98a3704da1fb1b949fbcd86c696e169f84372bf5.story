...
However , it also seems that while temperatures drop , stress levels rise , with December and February following closely behind .
...
'Em ployers need to be tuned in to the turn of mood and if possible look at reducing the workload to improve well-being .
