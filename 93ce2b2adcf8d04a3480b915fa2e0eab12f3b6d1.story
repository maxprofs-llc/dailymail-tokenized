...
An app created for California-based Apple 's iOS predicts when you 'll die . Called Deadline -LRB- pictured -RRB- It apparently uses Apple 's new HealthKit technology to give you a ` ticker '

` You 're going to die . Sorry , we all do eventually , ' company Gist LLC writes on their iTunes page . The app costs # 0.69 -LRB- $ 0.99 -RRB- and is available now for Apple devices with iOS 8 or later .
...
The ticker -LRB- left -RRB- shows you the time down to the second that you 'll die . Exercising more and improving your health -LRB- right -RRB- increases life expectancy . However some have said the app just uses a random algorithm
...
App created for California-based Apple 's iOS predicts when you 'll die
