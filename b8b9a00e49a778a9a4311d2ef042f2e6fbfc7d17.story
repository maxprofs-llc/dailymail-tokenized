...
Users can now talk to the Google Translate app and get a written translation of what they 're saying , in real time , on the screen -LRB- pictured -RRB- . The update will begin rolling out to both iOS and Android users from today
...
Once the two languages have been recognised , the app will be poised to translate speech , meaning the user does n't need to press the mic button again .
...
Now , while using the Translate app , users can point their camera at a sign or text and see the translated text overlaid the screen - even if they do n't have a data connection .
...
The app has also updated its Word Lens tool . Word Lens lets people use camera mode to take a photo of text and get a translation in 36 languages . Now , while using the Translate app , users can point their camera at a sign or text and see the translated text overlaid on the screen - even if they do n't have a data connection

The move builds on Google 's current tools , which offer written translation of 90 languages , as well spoken translations in a select number of languages on Android devices -LRB- pictured -RRB-

Rumours of the Google update come a month after Microsoft released a preview of Skype Translator -LRB- pictured -RRB- . It lets people of different languages talk to each other on video calls . The software translates Spanish or English into text and speech , using a Windows 8.1 device
...
Microsoft first unveiled the technology -LRB- pictured -RRB- two years ago . At the time , though , it was deemed too inaccurate to release to the general public . But a breakthrough by the Skype and Microsoft Translator teams in neural network-based speech recognition reduced errors in speech recognition by more than 30 per cent
