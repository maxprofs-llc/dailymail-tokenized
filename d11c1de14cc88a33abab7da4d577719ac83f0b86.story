Scientists at the Large Hadron Collider -LRB- LHC -RRB- in Cern , Geneva say they have discovered two new subatomic particles by smashing protons together .
...
The Large Hadron Collider in Geneva has discovered two new particles . The discovery was made by smashing protons at 99.9999 % the speed of light -LRB- illustration shown -RRB- . The two new particles are called Xi_b ' - and Xi_b * and are each six times more massive than a proton

The new particles were created by firing protons around the 17-mile -LRB- 27km -RRB- tube of the LHC , specifically the Large Hadron Collider Beauty -LRB- LHCb -RRB- experiment .
...
Discovering new particles is n't that rare at Cern - Dr Patrick Koppenburg from the Netherlands ' Nikhef Institute told the Wall Street Journal that three to five are discovered every year .
...
Quarks are said to have six ` flavours ' : Up , Down , Charm , Strange , Top and Bottom -LRB- also known as Beauty -RRB- .
...
But , he added : ` Here we have two in one go , which is quite extraordinary . '
...
This graph shows the results from the LHCb that confirmed the existence of the particles . Xi_b ' - is the first peak and Xi_b * - is the second peak . The black points are the signal sample and the hatched red histogram is a control sample . The blue curve represents a model including the two new particles , fitted to the data

The new particles were created by firing protons around the 17-mile -LRB- 27km -RRB- tube of the LHC , specifically the Large Hadron Collider Beauty -LRB- LHCb -RRB- experiment , pictured
...
Sometimes ,
quarks interact with corresponding anti-particles -LRB- such as
anti-quarks -RRB- , which have the same mass but opposite charges .
...
In this latest research the new X_iB particles are made of one ` strange ' , one ` down ' and one ` bottom ' -LRB- or beauty -RRB- quark .
...
` The Xi_b ' - is very close in mass to the sum of its decay products : if it had been just a little lighter , we would n't have seen it at all using the decay signature that we were looking for . '

Dr Steven Blusk from Syracuse University in New York added : ` This is a very exciting result . Thanks to LHCb 's excellent hadron identification , which is unique among the LHC experiments , we were able to separate a very clean and strong signal from the background .

` It demonstrates once again the sensitivity and how precise the LHCb detector is . '

Subatomic particles can be largely classified in two groups -LRB- shown in graphic -RRB- : Fermions , which include quarks and leptons , are those that make up matter , while bosons are said to be the ` force ' particles

Finding new particles improves our knowledge of subatomic physics -LRB- illustrated is an atom with eletrons -RRB- , and it also reveals how the universe works beyond our models . The finding of two particles in one experiment was also described as being ` extraordinary '

In addition to finding out the mass of the particles , the scientists also discovered how unstable the particles were .

The results match up with predictions based on the theory of Quantum Chromodynamics -LRB- QCD -RRB- .
...
Testing QCD at high precision is key to refining our understanding of quark dynamics , models of which are tremendously difficult to calculate .

` If we want to find new physics beyond the Standard Model , we need first to have a sharp picture , ' said Dr Koppenburg .

` Such high precision studies will help us to differentiate between Standard Model effects and anything new or unexpected in the future . '

The latest measurements were made with data taken at the LHC during 2011-2012 .

The LHC is currently being prepared - after its first long shutdown - to operate at higher energies and with more intense beams . It is scheduled to restart by spring 2015 .

@highlight

The Large Hadron Collider in Geneva has discovered two new particles
