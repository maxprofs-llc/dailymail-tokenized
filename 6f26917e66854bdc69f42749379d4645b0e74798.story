...
Facebook has created an automated service that monitors sites for stolen credentials . It checks credentials to see if they match those being used on Facebook , and the site assured users the process is automated , meaning it does n't know or store a user 's actual Facebook password
...
This means if a list is stolen , the plain text passwords ca n't be obtained easily .

Since Facebook stores passwords securely as hashes , it ca n't compare a password directly to the database .

Instead , it hashes it , and compares the hashes . If the email and hash combination does n't match , the site does n't take any action .
...
To protect users , Facebook offers Login Approvals -LRB- pictured -RRB- , which adds an extra layer of security to an account . When enabled , users must enter a code from their phone when logging in from a new browser
...
Mr Long assured users that because this is an automated process , the site does n't know or store a user 's actual Facebook password .
...
Site assured users the process is automated , meaning it does n't know or store a user 's actual Facebook password
