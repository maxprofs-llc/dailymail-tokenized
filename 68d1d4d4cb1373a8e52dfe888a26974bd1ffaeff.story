Humans have used pigeons to carry messages to desired locations for centuries , but how the birds find their way home has remained a mystery .
...
No-one had previously explained how the birds -LRB- stock image -RRB- determine their position . Previous studies have suggested that pigeons develop ` map sense ' and navigate using smells , or a geomagnetic map

Scinetists believe that huge flocks of birds decide when to change direction in mid flight by using a kind of ` democratic hierarchy ' .

In 2010 , a team from Britain and Hungary strapped tiny global position systems -LRB- GPS -RRB- to pigeons to work out how they operated as a well-ordered group rather than chaotic individuals .

They recorded the flight paths of individual birds and then analysed interactions between them .

Scinetists found that pigeon flocks use a flexible system of leadership where almost every member plays a part , but high-ranking birds have more power .
...
` These hierarchies are flexible in the sense that the leading role of any given bird can vary over time , ' said Professor Dora Biro of the zoology department at Britain 's Oxford University
...
A previous study showed that huge flocks of pigeons -LRB- pictured -RRB- decide when to change direction in mid flight by using a kind of ` democratic hierarchy '

@highlight

Scientists conducted an experiment over a crater in the Ukraine with unusual gravity , to study the navigational systems of homing pigeons
