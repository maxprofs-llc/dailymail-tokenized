...
` Unfortunately , it 's very difficult to detect where this is happening , as the discharge is intermittent , ca n't always be seen with the naked eye and existing tests are complex and expensive '

But now his team have shown that tampons can glow in ultra-violet -LRB- UV -RRB- light , because they absorb chemicals found in products containing ` optical brighteners ' which are used to whiten and brighten colours .

Experts think tampons -LRB- pictured left -RRB- could be a cheap solution to detecting pollutants in rivers . On the right , Professor Lerner tests for sewage pollution in a stream in Sheffield , UK , using a conductivity and temperature meter - a more expensive but less effective method than using tampons and UV lighting

Tampons absorb chemicals commonly used on toilet paper , laundry detergents -LRB- pictured with a stock image -RRB- and shampoos , which glow under UV light , meaning that they could shed light on previously undetectable mis-plumbed pathways

Engineers have shown that tampons can glow in ultra-violet -LRB- UV -RRB- light , because they absorb chemicals found in products containing ` optical brighteners ' which are used to whiten and brighten colours .

Optical brighteners are found in toilet paper , laundry detergents and shampoos .

Lab trials determined that just five seconds exposure in a solution containing 0.01 ml of detergent per litre of water - over 300 times more dilute than would be expected in a surface water pipe -- enabled a tampon to glow for 30 days .
