...
It 's not clear when the drug could become available and if health regulators will allow it to be sold without a prescription as it is dangerous for people with heart disease and those on some medications -LRB- file picture -RRB-
...
` It 's the sort of thing that does n't necessarily need to be restricted to doctors ' prescribing - but it needs to be given with care to people with heart disease or those taking some heart drugs .
