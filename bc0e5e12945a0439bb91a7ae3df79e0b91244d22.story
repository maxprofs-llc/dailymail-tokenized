...
Hundreds of flights were cancelled or delayed yesterday after problems with a telephone system at the National Air Traffic Service -LRB- Nats -RRB- centre in Swanwick , Hampshire .
...
Air traffic control chiefs announced at 7.30 pm on Saturday that they had finally solved the glitch , 14 hours after the problems began .

Earlier they had missed a self-imposed 6.30 pm target for fixing the issue .
...
Bored : A woman looks fed-up in Terminal Three at Heathrow -LRB- left -RRB- while another sleeps at Gatwick -LRB- right -RRB-

Up above : This map from FlightRadar24 shows the real-time position of all planes over the London region just after 8.30 am today . Aircraft can be seen grouped over Stansted -LRB- top centre -RRB- and Gatwick -LRB- bottom centre -RRB-
...
Problems : Heathrow had cancelled 60 flights by 9.45 am , with that figure split roughly equally between departures and arrivals
...
Delays : Passengers at Gatwick Airport -LRB- file picture -RRB- were warned they could be waiting for ' a couple of hours '

Grounded : London Stansted Airport -LRB- file picture -RRB- said all of its departing flights were subject to delays of between 30 minutes and two hours
...
A
spokesman for Nats said last night : ` As of 7.30 pm we had handled 3,250
flights today - around 90 per cent of the traffic handled last Saturday
-LRB- 3,613 flights -RRB- . '
...
Problems : A spokesman for Heathrow Airport -LRB- file picture -RRB- said it was ` currently experiencing some delays '

The # 623 million National Air Traffic Services -LRB- NATS -RRB- centre yesterday experienced a failure of ` a very complex and sophisticated system ' .
...
Issue : A computing glitch in the early hours of the morning at the Nats control centre -LRB- pictured -RRB- in Swanwick , Hampshire , meant the night-time operation failed to properly switch over to the daytime system
