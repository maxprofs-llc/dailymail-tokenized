...
She said the contract is based on the number of inmates , not the number of medical procedures provided , so the surgery would n't increase the state 's costs .
