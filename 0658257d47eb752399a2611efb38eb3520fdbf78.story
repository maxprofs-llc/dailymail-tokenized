...
Hemingway Design and Guy Holloway 's Jack in a Box starts off as a simple cardboard house -LRB- left -RRB- , but when switched on , the inflatable structure inside begins to fill with air powered by an integrated fan . The dolls ' house roof opens and the walls collapse to allow the organic structure -LRB- left -RRB- to grow out of the box

STUDIO EGRET WEST in collaboration with Andrew Logan made Puzzle House -LRB- left -RRB- , when not in use it 's a tidy colourful rectangular box , and when in play mode , the construction explodes into 7 separate pieces . HLM and JuJu Ross Design/A & J Hilliard Cabinet Makers : Sound -LSB- Play -RSB- ce -LRB- right -RRB- is an interactive tower - different sounds are generated by a marble running through the system
...
Multi-story was designed by DUGGAN MORRIS ARCHITECTS in collaboration with Unit 22 Modelmakers and in consultation with Christina , mother of high functioning autistic Louis -LRB- 5 -RRB- ; the house has a set of rooms arranged in either a stack or plan form
