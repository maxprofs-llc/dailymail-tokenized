...
Using one photo of a 3 year-old , the software automatically renders images of his face at multiple ages while keeping his identity -LRB- and the milk moustache -RRB-
...
` Our extensive user studies demonstrated age progression results that are so convincing that people ca n't distinguish them from reality , ' said co-author Steven Seitz , Professor of Computer Science and Engineering .
...
Spitting image : Here , real photos of a child -LRB- right in each pair -RRB- are compared to images that used the software -LRB- left in each pair -RRB- to generate an aged face , with surprisingly accurate results . As the software only deals with faces , however , hair and other features like clothing are added artificially
...
In each pair of these images showing babies growing up , the rendered image is on the left and a real photo of the same age is on the right -LRB- again , hair and clothing are artificially added -RRB-
