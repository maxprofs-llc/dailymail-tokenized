...
The prototype 30 kW-class solid-state laser -LRB- SSL -RRB- weapon system developed under the leadership of the Naval Sea Systems Command -LRB- NAVSEA -RRB- , the LaWS integrates six commercial 5.4 kW fibre lasers with a beam combiner originated by the Naval Research Laboratory .
...
Using a video game-like controller -LRB- pictured -RRB- , that sailor will be able to manage the laser 's power to accomplish a range of effects against a threat , from disabling to complete destruction .

Rear Adm. Matthew L. Klunder , chief of naval research , said that during the test sailors began using the system in ways its developers did n't fully anticipate , such as for long-range surveillance .
...
The prototype , an improved version of the Laser Weapon System -LRB- LaWS -RRB- , was installed on USS Ponce for at-sea testing in the Persian Gulf .

The prototype 30 kW-class solid-state laser -LRB- SSL -RRB- weapon system was developed under the leadership of the Naval Sea Systems Command -LRB- NAVSEA -RRB- .
...
The U.S. Navy is has declared an experimental laser weapon on its Afloat Forward Staging Base -LRB- AFSB -RRB- in the Persian Gulf an operational asset and U.S. Central Command has given permission for the commander of the ship to defend itself with the weapon .
