...
They used forensic tests to compare
fibres from the shroud with a range of ancient fabric samples . And they
discovered that the material could have been made in Jesus 's lifetime .

Their results contradict a landmark
1988 study , spearheaded by the British Museum , which used carbon dating
to examine the cloth .

It said the shroud , which has an
imprint of a bearded man with wounds consistent to being nailed to a
cross , was actually made in the Middle Ages -- more than 1,000 years
...
The findings are in a new book called Il Mistero della Sindone -LRB- The Mystery of the Shroud -RRB- which is published on Good Friday .

The
authors , Professor Giulio Fanti , an expert in mechanical and thermal
...
Key
to the findings are three new tests , two chemical ones and one
...
The
results dated the fibres from the cloth to a period between 300BC to
...
However ,
some scientists have since claimed that contamination over the ages
from water damage and fire , were not taken sufficiently into account and
could have distorted the results .

Since
then , there have been several requests for fresh tests but Church
...
Before
he retired last month pope Emeritus Benedict XVI gave permission for
the Shroud to go on display as a ` last gift ' to the millions of
