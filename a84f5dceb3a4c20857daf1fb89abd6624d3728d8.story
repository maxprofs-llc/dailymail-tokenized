...
However , this has n't stopped Google filing a patent for a system that would do just that .
...
However , the system would n't be completely automated . A user would have to approve a suggestion made by the bot before it is posted in their name .
