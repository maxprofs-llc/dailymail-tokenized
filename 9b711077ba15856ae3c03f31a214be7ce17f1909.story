...
The latest devices were revealed today as part of a new report from the European ATM Security Team -LRB- EAST -RRB- , which warns they are already in use across Europe - with many of the fraudulent numbers being shipped to the US .
...
According to a new report from the European ATM Security Team -LRB- EAST -RRB- , a novel form of mini-skimmer was reported by one country .

While most card skimmers are made to sit directly on top of the existing card slot , these newer mini-skimmers fit snugly inside the card reader throat , obscuring most of the device .

This card skimmer was made to fit inside certain kinds of cash machines made by NCR .

` New versions of insert skimmers -LRB- skimmers placed inside the card reader throat -RRB- are getting harder to detect , ' the EAST report concludes .

The miniaturized insert skimmer was used in tandem with a tiny spy camera to record each customer 's PIN .

The image on the left shows the hidden camera situated just to the left of the large square battery ; the photo on the right shows the false ATM fascia that obscures the hidden camera as it was found attached to the compromised ATM -LRB- notice the tiny pinhole at the top left edge of the device -RRB- .
...
' A new form of mini-skimmer was seen in one country and another reported that skimming devices are being left in place for longer periods -LRB- 4-5 days on average -RRB- . '
...
` Naturally , ATM hackers in Europe will ship the stolen card data over to thieves here in the U.S. , who then can encode the stolen card data onto fresh -LRB- chipless -RRB- cards and pull cash out of the machines here and in Latin America . '
