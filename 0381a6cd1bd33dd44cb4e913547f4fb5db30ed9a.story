...
But the singer 's entourage can now rest easy with the creation of an iPhone-powered machine that rapidly sorts M&M s into different colours .
...
A London-based blogger has created an iPhone-powered machine that sorts M&M s into different colours .
...
` I do n't stop the M&M for colour recognition . Instead I use an iPhone to capture the colour of the M&M as it is in freefall , ' the anonymous blogger wrote on his site .
...
Once the camera registers the M&M 's colour , a Bluetooth module attached to an Arduino-powered motor that fires off the correct electromagnet gate -LRB- pictured -RRB- to do the physical sorting
...
There is , however , a drawback for bands such as Van Halen who reportedly requested a rider for M&M s with the brown ones remove .
...
It uses an iPhone 5s camera which recognises each M&M s ' colour
