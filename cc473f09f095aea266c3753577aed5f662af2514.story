...
The Congress and its ally NCP are both in power in the state with almost equal number of seats shared between them . The portfolios are divided between the two in such a manner that the Congress does n't interfere in the departments held by the NCP and vice versa . Take for example the CCTV promise .
...
Even in the case of bad roads in the state , the chief minister has not been able to assert much as the Public Works Department -LRB- PWD -RRB- and the Maharashtra State Road Development Corporation -LRB- MSRDC -RRB- are headed by NCP ministers .
