...
Similarly , figures in the second and third quarter of this year show a drop in sales - which is likely to be due to the fact a new iPad was set to launch - yet the chart does n't accurately reflect this .
...
He does highlight , however , that Apple has n't overplayed the sales all the way through the chart , adding that although the distances between the labels are the same above 30 million , the gap between zero and 30 million is smaller .

By creating this smaller gap , it gives the appearance of lower sales at the start of the first quarter .

Also , for context , cumulative sales and quarterly sales are n't the same thing .
...
with a new high resolution 7.9 inch Retina display , which also has the
