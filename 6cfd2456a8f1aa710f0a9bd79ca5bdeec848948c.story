...
The Flush Toilet Finder app -LRB- pictured -RRB- uses a global database of 100,000 public toilets , and a phone 's GPS location , to find nearby public conveniences . Users can search for a location and pan the Google Maps to see nearby options , as well as add any public toilets that are missing from the database
...
` -LSB- It -RSB- also provides information about whether toilets have disabled access , whether people need to obtain a key for access , and whether the facilities are free or not . '
...
It was built by Jake Ruston , 21 , from Rotherham , South Yorkshire -LRB- pictured -RRB- . The results can be filtered to show which toilets charge a fee , need a key , or give disabled access . Within the first two weeks of launch , the free app has been downloaded more than 10,000 times on iOS and Android devices
...
Users can additionally add toilets that are n't already included on the app
