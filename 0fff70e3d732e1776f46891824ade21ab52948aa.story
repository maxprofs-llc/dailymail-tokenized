...
Nasa first began researching nuclear thermal rockets as part of its Nuclear Engine for Rocket Vehicle Application -LRB- NERVA -RRB- programme in 1959 .
...
Engineers have proposed using seven launches -LRB- shown above -RRB- to carry cargo and crew to Mars in 2033
...
Nasa engineers have proposed the above design for the fuel element for a small nuclear rocket engine using uranium carbide -LRB- UC2 -RRB- particles contained within graphite that could be used within a rover or space probe
