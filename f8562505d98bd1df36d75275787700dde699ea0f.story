...
Compatibility : Works with smartphones with screen of 4.7 inches to 5.2 inches

Features : Natural breathing system and anti-fog crystal lenses

Price : Earlybird price of $ 69 -LRB- # 47 -RRB- via Kickstarter .
...
The app will run on iOs , Android , Windows Phone , Blackberry and Oculus devices and will be compatible with Google Cardboard , meaning it does n't have to be used by swimmers wearing the headset

The waterproof ` mask ' fits over a person 's face and has two eye holes to let them see the screen . The snorkel means they can float facing downwards -LRB- pictured -RRB- without worrying about coming up for air , taking in the virtual scenery as if they were snorkeling on holiday
...
` The platform is available in a special version that can be adapted to tablets , allowing the whole family to find complete information on marine life , ' they added , meaning that the headset does n't always have to be used in water .
...
The headset , with access to the app , can be pre-ordered on Kickstarter for $ 69 -LRB- # 47 -RRB- with estimated delivery in December .
...
Headset 's available to pre-order from Kickstarter from $ 69 -LRB- # 47 -RRB-