...
In the case of a wormhole , a shortcut is made by warping the fabric of space-time .
Imagine folding a piece of paper with two pencil marks drawn on it to
...
If
the paper is now bent and folded over almost double - the equivalent to
warping space-time - then poking the pencil through the paper provides
a much shorter way of linking the two points , in the same way a
wormhole would create a shortcut .
...
In their experiment they made use of the closely related , fictitious , case where the photon travels through normal space-time and interacts with another photon that is stuck in a time-travelling loop through a wormhole , known as a closed timelike curve -LRB- CTC -RRB- .
...
` The
properties of quantum particles are `` fuzzy '' or uncertain to start with ,
so this gives them enough wiggle room to avoid inconsistent time travel
situations , ' said professor Timothy Ralph , one of the researchers on the latest study .
...
Einstein 's theory suggests the possibility of travelling backwards in time by following a space-time path that returns to the starting point in space but at an earlier time - a closed timelike curve -LRB- CTC -RRB- .
