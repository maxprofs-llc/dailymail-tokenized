...
A team of researchers have identified a new weakness in Android , Windows and iOS mobile operating systems . They found that their method was successful 92 per cent of the time when they tried to hack Gmail accounts -LRB- stock image -RRB- and said that other apps were also easily accessible
...
` The assumption has always been that these apps ca n't interfere with each other easily , ' said Zhiyun Qian , of the Computer Science and Engineering Department at UC Riverside .
...
To keep smartphones as secure as possible , Dr Qian advises users not to install untrusted apps , which could give hackers -LRB- illustrated with a stock image -RRB- access . He said that in the future , side channels should be eliminated or more carefully regulated within operating systems
...
` But the thing is , you have to do it at the right time so the user does n't notice . We do that and that 's what makes our attack unique . '
