...
Intel plans on incorporating a 3D scanner into a tablet set to be released next year -LRB- a concept is pictured -RRB- . It would allow users to scan an object and manipulate the 3D image on their screen using hand gestures , before possible deciding to print it out using a 3D printer
...
Intel is keen to find new applications for its technology and has launched a $ 1 million -LRB- # 619,772 -RRB- prize to encourage developers to create apps for the tablet .
