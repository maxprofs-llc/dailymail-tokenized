...
The Paris Observatory says 30 June 2015 will be a second longer . An extra second will be added at 11:59:60 pm UTC to sync up clocks -LRB- stock image shown -RRB- . This is to account for discrepancy between Earth time and atomic time . It is the 26th leap second to be added since 1972

The extra unit will be added at 11:59:60 pm UTC on 30 June , bringing the total number of seconds for 2015 up to 31,536,001 .

In it is the 26th time in history since 1972 that a leap second will have been added .

The decision to add an extra second year was announced by the Paris Observatory and the International Earth Rotation Service -LRB- IERS -RRB- .
...
To alleviate the problem some companies , such as Google , add fractions of a second over the preceding year so that they do n't need to make a sudden jump - known as a ` leap smear ' .

It might be the last leap second added , as some countries want to scrap the practice . The last leap second in 2012 caused problems for some companies when their systems failed to cope with the change . The second is added because Earth 's rotation -LRB- image from space shown -RRB- does not match up with atomic time
...
` They add an extra second to something called UTC -LRB- Coordinated Universal Time -RRB- in order to make sure the rate of UTC is the same as atomic time , ' he said .

` For that day -LSB- June 30 -RSB- there 'll be 86,401 seconds , instead of 86,400 seconds . The length of the day for you and I and everyone on the Earth will have an extra second . '

The discrepancies between Earth time as calculated by its rotation -LRB- UTC -RRB- and atomic time -LRB- UT1 -RRB- is shown here . Atomic time can be taken to be the line at zero , while the ` slowing ' Earth time -LRB- and the extra seconds added -RRB- can be seen by the spikes on the green line . A second is added when it lags by about 0.6 seconds
...
An extra second will be added at 11:59:60 pm UTC to sync up clocks
