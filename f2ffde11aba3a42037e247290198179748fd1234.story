The top word of 2013 is ' 404 ' - the internet code for failure , commonly seen when a webpage does n't load .
...
Following closely behind is the word ` fail , ' ` hashtag , ' @pontifex ' -LRB- Pope Francis ' Twitter handle -RRB- , and ` optic , ' the new term for ` narrative . '
...
Fail -- The single word fail , often used as a complete sentence -LRB- Fail ! -RRB- to signify failure of an effort , project , or endeavor .

Hashtag -- The ` number sign ' and ` pound sign ' reborn as the all-powerful Twitter hashtag .

@Pontifex -- The Hashage of the ever-more popular Pope Franciscus -LRB- Francis -RRB- .
...
Drones -- Unmanned aerial vehicles -LRB- UAV -RRB- that are piloted remotely or by on-board computers used for killing scores or even hundreds of those considered enemy combatants of the US .
