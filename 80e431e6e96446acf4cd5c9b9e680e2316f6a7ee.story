...
Fieri took the stand for a testimony that lasted just a few minutes to confirm that he did n't not know Wade and did not give him permission to take his $ 200,000 car out of a San Francisco dealership on March 8 , 2011 .
...
var nbcLP ={ -RCB- ; nbcLP.aRandomNumber = Math.floor -LRB- Math.random -LRB- -RRB- * 10000 -RRB- ; nbcLP.currentPageLoc = encodeURIComponent -LRB- window.location.href -RRB- ; nbcLP.currentSiteLoc = encodeURIComponent -LRB- window.location.host -RRB- ; nbcLP.defaultWidth = 646 ; nbcLP.defaultHeight = 367 ; nbcLP.cmsID = `` 229631951 '' ; nbcLP.vidPid = `` 9vbbN_vQaWCf '' ; nbcLP.vidSec = `` news '' ; nbcLP.vidSubSec = `` local '' ; nbcLP.vidFrame = document.getElementById -LRB- `` nbcLP229631951 '' -RRB- ; nbcLP.vidFrame.style.border = `` none '' ; nbcLP.vidFrame.width = nbcLP.defaultWidth ; nbcLP.vidFrame.height = nbcLP.defaultHeight ; nbcLP.vidFrame.scrolling = `` no '' ; nbcLP.vidFrame.src = `` http://www.nbcbayarea.com/templates/nbc_partner_player?cmsID= '' + nbcLP.cmsID + '' & videoID = '' + nbcLP.vidPid + '' & width = '' + nbcLP.defaultWidth + '' & height = '' + nbcLP.defaultHeight + '' & sec = '' + nbcLP.vidSec + '' & subsec = '' + nbcLP.vidSubSec + '' & turl = '' + nbcLP.currentSiteLoc + '' & ourl = '' + nbcLP.currentPageLoc + '' & rand = '' + nbcLP.aRandomNumber ;
