...
According to Chen , using the trailer-search data along seasonal information and a film 's ` franchise status ' -LRB- i.e. whether it 's a James Bond or Twilight movie -RRB- , can predict the opening weekend box office takings with 94 per cent accuracy .
...
` Our hypothesis is that once a film has opened , search ad clicks are a strong indicator of intent to purchase a ticket whereas the intent associated with a search query is more varied -LRB- i.e. , undecided moviegoers searching for reviews -RRB- , ' writes Chen .
