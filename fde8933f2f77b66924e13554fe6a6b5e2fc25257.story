...
` But with a possible British referendum on the EU , they are worried about the centenary being used for Germany-bashing by the British Press . For understandable reasons , given Germany 's history , just using the word ` krieg ' -LSB- war -RSB- is very difficult . '

Mr Pickles said it would be a ` tremendous tragedy ' if the occasion was used to bash Germany and its Great War ally Turkey .

` Equally , it would be a tragedy if we forgot what happened , if we forgot why we fought , if we forgot we won , ' he added . Some # 5.3 million will be spent sending two ` student ambassadors ' and a teacher from every state secondary school to sites of battles including the Somme , Verdun and Fromelles from spring next year .
