...
` If the affected version -LSB- of WebView -RSB- is before 4.4 , we generally do not develop the patches ourselves , but welcome patches with the report for consideration , ' said Google .
...
` However , a billion people do n't rely on old versions of my software to manage and safeguard the most personal details of their lives .
...
` In that light , I 'm hoping Google reconsiders if -LRB- when -RRB- the next privacy-busting vulnerability becomes public knowledge . '
