If the current list of more than 800 emojis just is n't enough for you , an app will let you create your own using any image you can find .
...
Imoji was created by San Francisco-based Tom Smith . It turns any image into a sticker to be used in texts and iMessages -LRB- pictured left -RRB- . Photos from the web , or from the user 's own phone gallery , can be cropped and trimmed using built-in editing tools -LRB- pictured right -RRB-
...
All imojis can be set to private , or public . There is also a library of imojis created by other users that includes images of celebrities and cartoon characters -LRB- pictured left -RRB- . To send an imoji , drag the sticker into the centre of the on-screen circle -LRB- pictured -RRB- to open the messaging app . Choose recipients and send
...
According
to Tech Crunch , future releases will add more sharing options , so
stickers can be sent on Whatsapp , Facebook , Twitter , and more .
...
a bowing -LRB- apologising -RRB- businessman , a face wearing a mask , a white
