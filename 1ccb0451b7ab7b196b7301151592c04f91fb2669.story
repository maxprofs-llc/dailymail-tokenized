...
The battery powered Switchmate uses a physical toggle inside the device to flip traditional wall mounted light switches -LRB- shown above -RRB- - working like a robotic finger than can be controlled using a mobile phone app
...
The team behind Switchmate are currently taking pre-orders with a single unit costing $ 49 -LRB- # 32 -RRB- . However , at that price , it means kitting out the average home is unlikely to be cheap .
...
Switchmate can be used with two different switch types - toggle switches -LRB- left -RRB- and rocker switches -LRB- right -RRB-

The developers say Switchmate will be available in three different colours - gold , silver and white -LRB- all above -RRB-

The device -LRB- shown above -RRB- can still be used like a traditional light switch by pressing the button in the middle
...
However , the device can not currently be used to control dimmer switches