Tesla founder Elon Musk has unveiled a ` revolutionary ' $ 3,000 -LRB- # 1,980 -RRB- battery which he claims can run an entire home for eight hours .
...
Tesla has unveiled a $ 3,000 -LRB- # 1,980 -RRB- home battery that can power an entire house for eight hours . Powerwall is three feet wide and four feet tall , weighs 220lbs , and can be installed on an outside or inside wall . The left images shows the 10kWh version while on the right is the 7kWh device
...
Pictured is the ` powerpack ' . Elon Musk -LRB- right -RRB- describes it as an ` infinitely scalable system ' that comes in 100 kWh battery blocks that can scale from 500 kWH up to 10 MWh and higher
