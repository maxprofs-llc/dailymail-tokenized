...
According to researchers , people are now more than likely to ask for ` splosh ' , ` chupley ' or ` blish ' when they fancy a cup of tea
...
Researchers at Winchester University referred to the new household language as ` kitchen-table lingo ' , and say it is used to bond with family members
...
They said that while slang is often used
by young people as a way of excluding adults , these words were used as a
way of collaborating between the generations .

Chupley tea

Melly television remote

Slabby-gangaroot dried up ketchup

Gruds underpants

Frarping scratching one 's backside

Trunklements grandparents ' belongings
...
Examples include ` choong ' and ` peng ' , meaning attractive , and ` blud ' for friend .

The word ` merk ' has evolved to mean ` to humiliate ' among west London teenagers , but originates from American street gangs where it is used as a verb to describe murder .

Other words and phrases used by teenagers , such as ` totes ' - or totally - and ` amazeballs ' - meaning amazing - also feature in the new dictionary .

There is also ` nim-nimnim ' , describing boring adult conversation , and ` meh ' , a verbal shrug of indifference .
...
Texters are using abbreviations such as ` YOLO ' -LRB- you only live once -RRB- , ` LMAO ' -LRB- laughing my ass off -RRB- and ` CBA ' -LRB- ca n't be arsed -RRB- .

Teenagers are also adopting old-fashioned words picked up from grandparents as ` gran slang ' .

Thorne said he found teenagers using old-fashioned words such as ` reek ' , ` trek ' , ` luka ' -LRB- from lucre -RRB- , ` galavanting ' and ` rapscallion ' as new slang .

But some critics say slang lowers educational standards and damages the career prospects of youngsters .

Professor Mark Pagel , an evolutionary biologist at Reading University , said : ` There is nothing inherently inferior about slang but it does n't cross boundaries very well .
