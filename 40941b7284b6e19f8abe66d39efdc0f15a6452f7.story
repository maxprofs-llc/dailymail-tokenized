...
In line with the delivery options already available on Waitrose.com , the service is free if the purchase is over # 50 and an order placed before 11.45 am can be collected the next day .
...
` Collection lockers will unlock the potential to reach customers in locations where we do n't have a shop and which are very convenient , such as on the way home from work or the school run .
