...
The cash-strapped island needed an # 8.5 billion package to bailout its lenders , but savers with more than # 85,000 in its banks were told they would lose 40 per cent of their money under conditions imposed by the European Union .
...
The new study on the impact of independence on financial services and banking , also states that Scotland could have ` significant difficulties ' providing protection which would match schemes such as the UK 's Financial Services Compensation Scheme -LRB- FSCS -RRB- which protects deposits in UK banks up to # 85,000 .

It also states that members of defined benefit pension schemes would not be covered by the Pension Protection Fund -LRB- PPF -RRB- , with an independent Scotland required to provide such protection through a similar guarantee fund under EU rules .
...
` The retail deposit market in a separate Scotland would be dominated by only two large banks -LRB- RBS and BoS -RRB- and , if one of these were to fail , the costs for compensating the depositors would fall almost entirely on the one remaining bank . '

It continues : ` If Scotland were to be become independent , it could create particular difficulties for the FSCS . In an independent Scottish state , FSCS-eligible deposits held by Scottish firms -LRB- and which would therefore be covered by the Scottish compensation scheme -RRB- would be over 100 % of Scotland 's GDP , representing a significant contingent liability of the state - and a much more significant proportion than in the UK as a whole .
