...
But now researchers based at the Swiss Federal Institute of Technology in Lausanne -LRB- EPFL -RRB- , have captured the first ever snapshot of light behaving as both a wave and particle .
...
Scientists have developed a camera system that lets users see round corners using laser light .

The system takes advantage of the way light is reflected and refracted to reconstruct the shape of objects outside the field of view .

Researchers at the University of Bonn and the University of British Columbia in Vancouver , used a laser to scatter light on a surface . is shone on a surface

In a demonstration , a laser was shone on a white wall , while a camera watches the scene . All it can see initially through the lens is a ` spot ' of light .

A computer records the image and the data is processed so the outlines of an object behind the screen gradually appear .
...
The Aurora Borealis -LRB- shown above -RRB- is caused by photons particles thrown out by gas atoms high in the Earth 's atmosphere as they collide with high energy charged particles carried by the solar wind from the sun

White light splitting into different colours through a prism -LRB- above -RRB- shows how it behaves like a wave
