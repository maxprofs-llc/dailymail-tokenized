...
Quantum entanglement is a physical phenomenon that occurs when pairs or groups of particles are generated or interact in ways such that the quantum state of each particle can not be described independently -- instead , a quantum state may be given for the system as a whole .

Superpositions are produced , such as the possibility of being in two places at once , which defies intuition .

In addition , when two particles are entangled a connection is generated : measuring the state of one -LRB- whether they are in one place or another , or spinning one way or another , for example -RRB- affects the state of the other particle instantly , no matter how far away from each other they are .
...
Until now , in order to increase the ` computing ' capacity of these particle systems , scientists have mainly turned to increasing the number of entangled particles , each of them in a two-dimensional state of superposition : a qubit -LRB- the quantum equivalent to an information bit , but with values which can be 1 , 0 or an overlap of both values -RRB- .
...
It included the participation of Marcus Huber , researcher from the Group of Quantum Information and Quantum Phenomena from the UAB Department of Physics , as well as visiting researcher at the Institute of Photonic Sciences -LRB- ICFO -RRB- .
