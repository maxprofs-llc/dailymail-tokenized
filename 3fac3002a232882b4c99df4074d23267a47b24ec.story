...
One law firm in Alberta , Canada , is using a wearable fitness device - the Fitbit -LRB- pictured -RRB- - to show the effects an accident has had on a client , marking the first time a wearable has been used in a courtroom
...
Vivametrica claims that the method is non-invasive and provides ` valid , objective and individualised information ' for personal injury cases , which may be caused by car accident -LRB- illustrated -RRB- for example
